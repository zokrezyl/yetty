...
option(YETTY_ENABLE_FEATURE_YIMAGE    "yimage — image complex"     ON)
...
option(YETTY_ENABLE_FEATURE_YMESH     "ymesh — 3D mesh complex"    ON)
option(YETTY_ENABLE_FEATURE_YVIDEO    "yvideo — video complex"     ON)
...
option(YETTY_ENABLE_TOOL_YFSPY           "yfspy tool (Python-shader plot)"   ON)
...
option(YETTY_ENABLE_TOOL_YDU             "ydu tool (disk-usage treemap)"     ON)
option(YETTY_ENABLE_TOOL_YPERF           "yperf tool (perf/flame workbench)" ON)
...
# World-coverage Noto font set (script faces + CJK + Color Emoji), part of
# the lib-fonts noarch tarball and shipped into the runtime fonts dir on
...
# (the MSDF CDBs from the same tarball still ship).
...
option(YETTY_ENABLE_TOOL_YCHART          "ychart CLI (CSV/JSON/YAML → ydraw OSC)" ON)
