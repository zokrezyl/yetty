...
cp ./build-desktop-ytrace-release/tools/yslide/yslide $HOME/.local/bin/


cp ./build-desktop-ytrace-release/demo/ygui/01_button_test/demo-ygui-01-button $HOME/.local/bin/
cp ./build-desktop-ytrace-release/demo/ygui/02_coord_debug/demo-ygui-02-coord $HOME/.local/bin/
