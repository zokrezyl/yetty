...
enum yetty_yrdawn_method_id {
    ...
    YETTY_YRDAWN_METHOD_wgpuDeviceCreateErrorExternalTexture = 275,
    YETTY_YRDAWN_METHOD_wgpuDeviceCreateErrorShaderModule = 276,
    YETTY_YRDAWN_METHOD_wgpuDeviceCreateErrorTexture = 277,
    YETTY_YRDAWN_METHOD_wgpuDeviceCreateExternalTexture = 278,
    YETTY_YRDAWN_METHOD_wgpuDeviceCreatePipelineLayout = 279,
    YETTY_YRDAWN_METHOD_wgpuDeviceCreateQuerySet = 280,
    YETTY_YRDAWN_METHOD_wgpuDeviceCreateRenderBundleEncoder = 281,
    YETTY_YRDAWN_METHOD_wgpuDeviceCreateRenderPipeline = 282,
    YETTY_YRDAWN_METHOD_wgpuDeviceCreateRenderPipelineAsync = 283,
    YETTY_YRDAWN_METHOD_wgpuDeviceCreateResourceTable = 284,
    YETTY_YRDAWN_METHOD_wgpuDeviceCreateSampler = 285,
    YETTY_YRDAWN_METHOD_wgpuDeviceCreateShaderModule = 286,
    YETTY_YRDAWN_METHOD_wgpuDeviceCreateTexture = 287,
    YETTY_YRDAWN_METHOD_wgpuDeviceDestroy = 288,
    YETTY_YRDAWN_METHOD_wgpuDeviceForceLoss = 289,
    YETTY_YRDAWN_METHOD_wgpuDeviceGetAHardwareBufferProperties = 290,
    YETTY_YRDAWN_METHOD_wgpuDeviceGetAdapter = 291,
    YETTY_YRDAWN_METHOD_wgpuDeviceGetAdapterInfo = 292,
    YETTY_YRDAWN_METHOD_wgpuDeviceGetFeatures = 293,
    YETTY_YRDAWN_METHOD_wgpuDeviceGetLimits = 294,
    YETTY_YRDAWN_METHOD_wgpuDeviceGetLostFuture = 295,
    YETTY_YRDAWN_METHOD_wgpuDeviceHasFeature = 296,
    YETTY_YRDAWN_METHOD_wgpuDeviceImportSharedBufferMemory = 297,
    YETTY_YRDAWN_METHOD_wgpuDeviceImportSharedFence = 298,
    YETTY_YRDAWN_METHOD_wgpuDeviceImportSharedTextureMemory = 299,
    YETTY_YRDAWN_METHOD_wgpuDeviceInjectError = 300,
    YETTY_YRDAWN_METHOD_wgpuDevicePopErrorScope = 301,
    YETTY_YRDAWN_METHOD_wgpuDevicePushErrorScope = 302,
    YETTY_YRDAWN_METHOD_wgpuDeviceSetLabel = 303,
    YETTY_YRDAWN_METHOD_wgpuDeviceSetLoggingCallback = 304,
    YETTY_YRDAWN_METHOD_wgpuDeviceValidateTextureDescriptor = 305,
    YETTY_YRDAWN_METHOD_wgpuExternalTextureAddRef = 306,
    YETTY_YRDAWN_METHOD_wgpuExternalTextureDestroy = 307,
    YETTY_YRDAWN_METHOD_wgpuExternalTextureExpire = 308,
    YETTY_YRDAWN_METHOD_wgpuExternalTextureRefresh = 309,
    YETTY_YRDAWN_METHOD_wgpuExternalTextureRelease = 310,
    YETTY_YRDAWN_METHOD_wgpuExternalTextureSetLabel = 311,
    YETTY_YRDAWN_METHOD_wgpuGetInstanceFeatures = 312,
    YETTY_YRDAWN_METHOD_wgpuGetInstanceLimits = 313,
    YETTY_YRDAWN_METHOD_wgpuGetProcAddress = 314,
    YETTY_YRDAWN_METHOD_wgpuHasInstanceFeature = 315,
    YETTY_YRDAWN_METHOD_wgpuInstanceAddRef = 316,
    YETTY_YRDAWN_METHOD_wgpuInstanceCreateSurface = 317,
    YETTY_YRDAWN_METHOD_wgpuInstanceGetWGSLLanguageFeatures = 318,
    YETTY_YRDAWN_METHOD_wgpuInstanceHasWGSLLanguageFeature = 319,
    YETTY_YRDAWN_METHOD_wgpuInstanceProcessEvents = 320,
    YETTY_YRDAWN_METHOD_wgpuInstanceWaitAny = 321,
    YETTY_YRDAWN_METHOD_wgpuPipelineLayoutAddRef = 322,
    YETTY_YRDAWN_METHOD_wgpuPipelineLayoutRelease = 323,
    YETTY_YRDAWN_METHOD_wgpuPipelineLayoutSetLabel = 324,
    YETTY_YRDAWN_METHOD_wgpuQuerySetAddRef = 325,
    YETTY_YRDAWN_METHOD_wgpuQuerySetDestroy = 326,
    YETTY_YRDAWN_METHOD_wgpuQuerySetGetCount = 327,
    YETTY_YRDAWN_METHOD_wgpuQuerySetGetType = 328,
    YETTY_YRDAWN_METHOD_wgpuQuerySetRelease = 329,
    YETTY_YRDAWN_METHOD_wgpuQuerySetSetLabel = 330,
    YETTY_YRDAWN_METHOD_wgpuQueueAddRef = 331,
    YETTY_YRDAWN_METHOD_wgpuQueueCopyExternalTextureForBrowser = 332,
    YETTY_YRDAWN_METHOD_wgpuQueueCopyTextureForBrowser = 333,
    YETTY_YRDAWN_METHOD_wgpuQueueOnSubmittedWorkDone = 334,
    YETTY_YRDAWN_METHOD_wgpuQueueSetLabel = 335,
    YETTY_YRDAWN_METHOD_wgpuQueueSubmit = 336,
    YETTY_YRDAWN_METHOD_wgpuQueueWriteBuffer = 337,
    YETTY_YRDAWN_METHOD_wgpuQueueWriteTexture = 338,
    YETTY_YRDAWN_METHOD_wgpuRenderBundleAddRef = 339,
    YETTY_YRDAWN_METHOD_wgpuRenderBundleEncoderAddRef = 340,
    YETTY_YRDAWN_METHOD_wgpuRenderBundleEncoderDraw = 341,
    YETTY_YRDAWN_METHOD_wgpuRenderBundleEncoderDrawIndexed = 342,
    YETTY_YRDAWN_METHOD_wgpuRenderBundleEncoderDrawIndexedIndirect = 343,
    YETTY_YRDAWN_METHOD_wgpuRenderBundleEncoderDrawIndirect = 344,
    YETTY_YRDAWN_METHOD_wgpuRenderBundleEncoderFinish = 345,
    YETTY_YRDAWN_METHOD_wgpuRenderBundleEncoderInsertDebugMarker = 346,
    YETTY_YRDAWN_METHOD_wgpuRenderBundleEncoderPopDebugGroup = 347,
    YETTY_YRDAWN_METHOD_wgpuRenderBundleEncoderPushDebugGroup = 348,
    YETTY_YRDAWN_METHOD_wgpuRenderBundleEncoderRelease = 349,
    YETTY_YRDAWN_METHOD_wgpuRenderBundleEncoderSetBindGroup = 350,
    YETTY_YRDAWN_METHOD_wgpuRenderBundleEncoderSetImmediates = 351,
    YETTY_YRDAWN_METHOD_wgpuRenderBundleEncoderSetIndexBuffer = 352,
    YETTY_YRDAWN_METHOD_wgpuRenderBundleEncoderSetLabel = 353,
    YETTY_YRDAWN_METHOD_wgpuRenderBundleEncoderSetPipeline = 354,
    YETTY_YRDAWN_METHOD_wgpuRenderBundleEncoderSetResourceTable = 355,
    YETTY_YRDAWN_METHOD_wgpuRenderBundleEncoderSetVertexBuffer = 356,
    YETTY_YRDAWN_METHOD_wgpuRenderBundleRelease = 357,
    YETTY_YRDAWN_METHOD_wgpuRenderBundleSetLabel = 358,
    YETTY_YRDAWN_METHOD_wgpuRenderPassEncoderAddRef = 359,
    YETTY_YRDAWN_METHOD_wgpuRenderPassEncoderBeginOcclusionQuery = 360,
    YETTY_YRDAWN_METHOD_wgpuRenderPassEncoderDraw = 361,
    YETTY_YRDAWN_METHOD_wgpuRenderPassEncoderDrawIndexed = 362,
    YETTY_YRDAWN_METHOD_wgpuRenderPassEncoderDrawIndexedIndirect = 363,
    YETTY_YRDAWN_METHOD_wgpuRenderPassEncoderDrawIndirect = 364,
    YETTY_YRDAWN_METHOD_wgpuRenderPassEncoderEnd = 365,
    YETTY_YRDAWN_METHOD_wgpuRenderPassEncoderEndOcclusionQuery = 366,
    YETTY_YRDAWN_METHOD_wgpuRenderPassEncoderExecuteBundles = 367,
    YETTY_YRDAWN_METHOD_wgpuRenderPassEncoderInsertDebugMarker = 368,
    YETTY_YRDAWN_METHOD_wgpuRenderPassEncoderMultiDrawIndexedIndirect = 369,
    YETTY_YRDAWN_METHOD_wgpuRenderPassEncoderMultiDrawIndirect = 370,
    YETTY_YRDAWN_METHOD_wgpuRenderPassEncoderPixelLocalStorageBarrier = 371,
    YETTY_YRDAWN_METHOD_wgpuRenderPassEncoderPopDebugGroup = 372,
    YETTY_YRDAWN_METHOD_wgpuRenderPassEncoderPushDebugGroup = 373,
    YETTY_YRDAWN_METHOD_wgpuRenderPassEncoderRelease = 374,
    YETTY_YRDAWN_METHOD_wgpuRenderPassEncoderSetBindGroup = 375,
    YETTY_YRDAWN_METHOD_wgpuRenderPassEncoderSetBlendConstant = 376,
    YETTY_YRDAWN_METHOD_wgpuRenderPassEncoderSetImmediates = 377,
    YETTY_YRDAWN_METHOD_wgpuRenderPassEncoderSetIndexBuffer = 378,
    YETTY_YRDAWN_METHOD_wgpuRenderPassEncoderSetLabel = 379,
    YETTY_YRDAWN_METHOD_wgpuRenderPassEncoderSetPipeline = 380,
    YETTY_YRDAWN_METHOD_wgpuRenderPassEncoderSetResourceTable = 381,
    YETTY_YRDAWN_METHOD_wgpuRenderPassEncoderSetScissorRect = 382,
    YETTY_YRDAWN_METHOD_wgpuRenderPassEncoderSetStencilReference = 383,
    YETTY_YRDAWN_METHOD_wgpuRenderPassEncoderSetVertexBuffer = 384,
    YETTY_YRDAWN_METHOD_wgpuRenderPassEncoderSetViewport = 385,
    YETTY_YRDAWN_METHOD_wgpuRenderPassEncoderWriteTimestamp = 386,
    YETTY_YRDAWN_METHOD_wgpuRenderPipelineAddRef = 387,
    YETTY_YRDAWN_METHOD_wgpuRenderPipelineGetBindGroupLayout = 388,
    YETTY_YRDAWN_METHOD_wgpuRenderPipelineRelease = 389,
    YETTY_YRDAWN_METHOD_wgpuRenderPipelineSetLabel = 390,
    YETTY_YRDAWN_METHOD_wgpuResourceTableAddRef = 391,
    YETTY_YRDAWN_METHOD_wgpuResourceTableDestroy = 392,
    YETTY_YRDAWN_METHOD_wgpuResourceTableGetSize = 393,
    YETTY_YRDAWN_METHOD_wgpuResourceTableInsertBinding = 394,
    YETTY_YRDAWN_METHOD_wgpuResourceTableRelease = 395,
    YETTY_YRDAWN_METHOD_wgpuResourceTableRemoveBinding = 396,
    YETTY_YRDAWN_METHOD_wgpuResourceTableUpdate = 397,
    YETTY_YRDAWN_METHOD_wgpuSamplerAddRef = 398,
    YETTY_YRDAWN_METHOD_wgpuSamplerRelease = 399,
    YETTY_YRDAWN_METHOD_wgpuSamplerSetLabel = 400,
    YETTY_YRDAWN_METHOD_wgpuShaderModuleAddRef = 401,
    YETTY_YRDAWN_METHOD_wgpuShaderModuleGetCompilationInfo = 402,
    YETTY_YRDAWN_METHOD_wgpuShaderModuleRelease = 403,
    YETTY_YRDAWN_METHOD_wgpuShaderModuleSetLabel = 404,
    YETTY_YRDAWN_METHOD_wgpuSharedBufferMemoryAddRef = 405,
    YETTY_YRDAWN_METHOD_wgpuSharedBufferMemoryBeginAccess = 406,
    YETTY_YRDAWN_METHOD_wgpuSharedBufferMemoryCreateBuffer = 407,
    YETTY_YRDAWN_METHOD_wgpuSharedBufferMemoryEndAccess = 408,
    YETTY_YRDAWN_METHOD_wgpuSharedBufferMemoryEndAccessStateFreeMembers = 409,
    YETTY_YRDAWN_METHOD_wgpuSharedBufferMemoryGetProperties = 410,
    YETTY_YRDAWN_METHOD_wgpuSharedBufferMemoryIsDeviceLost = 411,
    YETTY_YRDAWN_METHOD_wgpuSharedBufferMemoryRelease = 412,
    YETTY_YRDAWN_METHOD_wgpuSharedBufferMemorySetLabel = 413,
    YETTY_YRDAWN_METHOD_wgpuSharedFenceAddRef = 414,
    YETTY_YRDAWN_METHOD_wgpuSharedFenceExportInfo = 415,
    YETTY_YRDAWN_METHOD_wgpuSharedFenceRelease = 416,
    YETTY_YRDAWN_METHOD_wgpuSharedFenceSetLabel = 417,
    YETTY_YRDAWN_METHOD_wgpuSharedTextureMemoryAddRef = 418,
    YETTY_YRDAWN_METHOD_wgpuSharedTextureMemoryBeginAccess = 419,
    YETTY_YRDAWN_METHOD_wgpuSharedTextureMemoryCreateTexture = 420,
    YETTY_YRDAWN_METHOD_wgpuSharedTextureMemoryEndAccess = 421,
    YETTY_YRDAWN_METHOD_wgpuSharedTextureMemoryEndAccessStateFreeMembers = 422,
    YETTY_YRDAWN_METHOD_wgpuSharedTextureMemoryGetProperties = 423,
    YETTY_YRDAWN_METHOD_wgpuSharedTextureMemoryIsDeviceLost = 424,
    YETTY_YRDAWN_METHOD_wgpuSharedTextureMemoryRelease = 425,
    YETTY_YRDAWN_METHOD_wgpuSharedTextureMemorySetLabel = 426,
    YETTY_YRDAWN_METHOD_wgpuSupportedFeaturesFreeMembers = 427,
    YETTY_YRDAWN_METHOD_wgpuSupportedInstanceFeaturesFreeMembers = 428,
    YETTY_YRDAWN_METHOD_wgpuSupportedWGSLLanguageFeaturesFreeMembers = 429,
    YETTY_YRDAWN_METHOD_wgpuSurfaceAddRef = 430,
    YETTY_YRDAWN_METHOD_wgpuSurfaceCapabilitiesFreeMembers = 431,
    YETTY_YRDAWN_METHOD_wgpuSurfaceConfigure = 432,
    YETTY_YRDAWN_METHOD_wgpuSurfaceGetCapabilities = 433,
    YETTY_YRDAWN_METHOD_wgpuSurfaceGetCurrentTexture = 434,
    YETTY_YRDAWN_METHOD_wgpuSurfacePresent = 435,
    YETTY_YRDAWN_METHOD_wgpuSurfaceRelease = 436,
    YETTY_YRDAWN_METHOD_wgpuSurfaceSetLabel = 437,
    YETTY_YRDAWN_METHOD_wgpuSurfaceUnconfigure = 438,
    YETTY_YRDAWN_METHOD_wgpuTexelBufferViewAddRef = 439,
    YETTY_YRDAWN_METHOD_wgpuTexelBufferViewRelease = 440,
    YETTY_YRDAWN_METHOD_wgpuTexelBufferViewSetLabel = 441,
    YETTY_YRDAWN_METHOD_wgpuTextureAddRef = 442,
    YETTY_YRDAWN_METHOD_wgpuTextureCreateErrorView = 443,
    YETTY_YRDAWN_METHOD_wgpuTextureCreateView = 444,
    YETTY_YRDAWN_METHOD_wgpuTextureDestroy = 445,
    YETTY_YRDAWN_METHOD_wgpuTextureGetDepthOrArrayLayers = 446,
    YETTY_YRDAWN_METHOD_wgpuTextureGetDimension = 447,
    YETTY_YRDAWN_METHOD_wgpuTextureGetFormat = 448,
    YETTY_YRDAWN_METHOD_wgpuTextureGetHeight = 449,
    YETTY_YRDAWN_METHOD_wgpuTextureGetMipLevelCount = 450,
    YETTY_YRDAWN_METHOD_wgpuTextureGetSampleCount = 451,
    YETTY_YRDAWN_METHOD_wgpuTextureGetTextureBindingViewDimension = 452,
    YETTY_YRDAWN_METHOD_wgpuTextureGetUsage = 453,
    YETTY_YRDAWN_METHOD_wgpuTextureGetWidth = 454,
    YETTY_YRDAWN_METHOD_wgpuTexturePin = 455,
    YETTY_YRDAWN_METHOD_wgpuTextureRelease = 456,
    YETTY_YRDAWN_METHOD_wgpuTextureSetLabel = 457,
    YETTY_YRDAWN_METHOD_wgpuTextureSetOwnershipForMemoryDump = 458,
    YETTY_YRDAWN_METHOD_wgpuTextureUnpin = 459,
    YETTY_YRDAWN_METHOD_wgpuTextureViewAddRef = 460,
    YETTY_YRDAWN_METHOD_wgpuTextureViewRelease = 461,
    YETTY_YRDAWN_METHOD_wgpuTextureViewSetLabel = 462,
};
