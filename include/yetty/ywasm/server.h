/*
 * server.h — interface between the ywasm-layer (handle table owner) and
 * the codegen-emitted server dispatcher.
 *
 * ywasm_server_dispatch is generated by src/yetty/ywasm/generate.py: given a
 ...
 */
#ifndef YETTY_YWASM_SERVER_H
#define YETTY_YWASM_SERVER_H
...
#define YWASM_DISPATCH_DEFERRED 0xFFFFFFFFu
 ...
 *
 *   struct ywasm_arena a = {0};
 *   T *obj = ywasm_arena_alloc(&a, sizeof(T));
...
/* Generated by src/yetty/ywasm/generate.py. Returns enum yetty_ywasm_reply_status
 * for sync calls, or YWASM_DISPATCH_DEFERRED for async calls whose REPLY
