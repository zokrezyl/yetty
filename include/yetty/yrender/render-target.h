...
struct yetty_yrender_target_ops {
    ...
    struct yetty_ycore_void_result (*clear)(struct yetty_ydraw_target *self);
	 ...
	 * be NULL for targets that don't complex layers. */
    ...
    void (*refresh_full)(struct yetty_ydraw_target *self);
    ...
    bool (*is_busy)(const struct yetty_ydraw_target *self);
    ...
    void (*notify_render_skipped)(struct yetty_ydraw_target *self);
};
