 ...
 */
#ifndef YETTY_YPAINT_CORE_PRIM_ITER_H
#define YETTY_YPAINT_CORE_PRIM_ITER_H
...
enum yetty_ypaint_core_prim_iter_status {
...
YETTY_YRESULT_DECLARE(yetty_ypaint_core_prim_iter_status,
                      enum yetty_ypaint_core_prim_iter_status);

struct yetty_ypaint_core_prim_iter {
...
#endif /* YETTY_YPAINT_CORE_PRIM_ITER_H */
