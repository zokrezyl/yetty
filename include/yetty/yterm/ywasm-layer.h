/*
 * ywasm-layer — server side of the WebGPU-over-OSC bridge.
 *
 ...
 * UNKNOWN_METHOD replies until src/yetty/ywasm/generate.py lands the
 * per-method dispatch. The handle table is here but empty.
 */
#ifndef YETTY_YTERM_YWASM_LAYER_H
#define YETTY_YTERM_YWASM_LAYER_H
...
#endif /* YETTY_YTERM_YWASM_LAYER_H */
