...
typedef struct yetty_ycore_void_result (*yetty_yrender_layer_fn)(
    struct yetty_yterm_terminal_layer *layer, WGPUTextureView target,
...
typedef void (*yetty_yterm_cursor_fn)(struct yetty_yterm_terminal_layer *source,
                                      struct grid_cursor_pos cursor_pos, void *userdata);
...
struct yetty_yterm_terminal_layer_ops {
   ...
   * "<flag>;<base64...>" for yface-encoded messages. */
    struct yetty_ycore_void_result (*write)(struct yetty_yterm_terminal_layer *self, int osc_code,
                                            const char *data, size_t len);
    struct yetty_ycore_void_result (*resize_grid)(struct yetty_yterm_terminal_layer *self,
   ...
   * zoom (YETTY_EVENT_ZOOM_CELL_SIZE). */
    struct yetty_ycore_void_result (*set_cell_size)(struct yetty_yterm_terminal_layer *self,
   ...
   * blend-stage zoom which is a post-rasterization bitmap stretch. */
    struct yetty_ycore_void_result (*set_visual_zoom)(struct yetty_yterm_terminal_layer *self,
    ...
    struct yetty_ycore_void_result (*render)(struct yetty_yterm_terminal_layer *self,
   ...
   * transparent texture) */
    ...
    int (*on_char)(struct yetty_yterm_terminal_layer *self, uint32_t codepoint, int mods);
