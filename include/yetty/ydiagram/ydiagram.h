 ...
 * caller owns the buffer and frees it via yetty_ydraw_core_draw_list_destroy.
 *
...
YETTY_YRESULT_DECLARE(yetty_ydiagram_buffer, struct yetty_ydraw_core_draw_list *);
