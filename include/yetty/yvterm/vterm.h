...
void yetty_yvterm_vterm_set_content_inset(struct yetty_yclass_object *obj, float top, float right, float bottom, float left);
void yetty_yvterm_vterm_get_content_inset(struct yetty_yclass_object *obj, float *out_top, float *out_right, float *out_bottom, float *out_left);
void yetty_yvterm_vterm_set_clear_hook(struct yetty_yclass_object *obj, yetty_yvterm_clear_hook_fn fn, void *userdata);
void yetty_yvterm_vterm_cursor(struct yetty_yclass_object *obj, uint32_t *out_row, uint32_t *out_col, uint32_t *out_visible);
...
struct yetty_ycore_void_result yetty_yvterm_vterm_add_primitive_ref(struct yetty_yclass_object *obj, uint32_t row, uint32_t col, uint16_t rel_line, uint16_t index_in_list);
...
struct yetty_ycore_void_result yetty_yvterm_vterm_add_composite_ref(struct yetty_yclass_object *obj, uint32_t row, uint32_t col, uint16_t rel_line, uint16_t index_in_list);
