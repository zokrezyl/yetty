...
struct yetty_ydraw_core_id_result yetty_ysdf_add_rounded_x(
    struct yetty_ydraw_core_buffer *buf, uint32_t z_order, uint32_t fill_color,
...
struct yetty_ydraw_core_id_result yetty_ysdf_add_pentagram(
    struct yetty_ydraw_core_buffer *buf, uint32_t z_order, uint32_t fill_color,
...
struct yetty_ydraw_core_id_result yetty_ysdf_add_sphere_3d(
    struct yetty_ydraw_core_buffer *buf, uint32_t z_order, uint32_t fill_color,
