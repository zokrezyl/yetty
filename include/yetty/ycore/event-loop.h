...
struct yetty_ycore_server_callbacks {
    void *ctx;
    /* New client connected, returns connection-specific context */
    void *(*on_connect)(void *ctx, struct yetty_ycore_conn *conn);
    /* Allocate buffer for reading */
    void (*on_alloc)(void *conn_ctx, size_t suggested, char **buf, size_t *len);
    /* Data received */
    void (*on_data)(void *conn_ctx, struct yetty_ycore_conn *conn, const char *data, long nread);
    /* Client disconnected */
    void (*on_disconnect)(void *conn_ctx);
};

/* TCP client callbacks */
struct yetty_ycore_client_callbacks {
    void *ctx;
    /* Connected to server */
    void (*on_connect)(void *ctx, struct yetty_ycore_conn *conn);
    /* Connection failed */
    ...
    /* Data received */
    void (*on_data)(void *ctx, struct yetty_ycore_conn *conn, const char *data, long nread);
    /* Disconnected */
...
struct yetty_ycore_event_loop_ops {
    struct yetty_ycore_void_result (*destroy)(struct yetty_yplatform_event_loop *self);

    struct yetty_ycore_void_result (*start)(struct yetty_yplatform_event_loop *self);
    struct yetty_ycore_void_result (*stop)(struct yetty_yplatform_event_loop *self);

    struct yetty_ycore_void_result (*register_listener)(struct yetty_yplatform_event_loop *self,
    ...
    struct yetty_ycore_int_result (*dispatch)(struct yetty_yplatform_event_loop *self,
                                              const struct yetty_yui_event *event);
    struct yetty_ycore_void_result (*broadcast)(struct yetty_yplatform_event_loop *self,
                                                const struct yetty_yui_event *event);
    ...
    struct yetty_ycore_void_result (*unregister_pty_pipe)(struct yetty_yplatform_event_loop *self,
                                                          yetty_ycore_pipe_id id);

    /* Timer management */
    struct yetty_ycore_timer_id_result (*create_timer)(struct yetty_yplatform_event_loop *self);
    struct yetty_ycore_void_result (*config_timer)(struct yetty_yplatform_event_loop *self,
                                                   yetty_ycore_timer_id id, int timeout_ms);
    struct yetty_ycore_void_result (*start_timer)(struct yetty_yplatform_event_loop *self,
                                                  yetty_ycore_timer_id id);
    struct yetty_ycore_void_result (*stop_timer)(struct yetty_yplatform_event_loop *self,
                                                 yetty_ycore_timer_id id);
    struct yetty_ycore_void_result (*destroy_timer)(struct yetty_yplatform_event_loop *self,
                                                    yetty_ycore_timer_id id);
    ...
    struct yetty_ycore_void_result (*start_tcp_server)(struct yetty_yplatform_event_loop *self,
                                                       yetty_ycore_tcp_server_id id);
    struct yetty_ycore_void_result (*stop_tcp_server)(struct yetty_yplatform_event_loop *self,
                                                      yetty_ycore_tcp_server_id id);
    ...
    struct yetty_ycore_void_result (*stop_tcp_client)(struct yetty_yplatform_event_loop *self,
                                                      yetty_ycore_tcp_client_id id);

    /* TCP connection operations (works for both server and client connections) */
    struct yetty_ycore_size_result (*tcp_send)(struct yetty_ycore_conn *conn, const void *data,
                                               size_t len);
    struct yetty_ycore_void_result (*tcp_close)(struct yetty_ycore_conn *conn);

    void (*request_render)(struct yetty_yplatform_event_loop *self);
    ...
    void (*post_to_loop)(struct yetty_yplatform_event_loop *self, void (*fn)(void *), void *arg);
};
