...
struct yetty_yclass_object *yetty_yrich_document_find(struct yetty_yclass_object *obj, yetty_yrich_element_id id);
/* Hit-test in reverse z-order (last drawn = topmost). */
struct yetty_yclass_object *yetty_yrich_document_element_at(struct yetty_yclass_object *obj, float x, float y);
