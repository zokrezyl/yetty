 ...
 * struct/scalar return type used by yflame's yclass methods.
 * Hand-written — codegen will NOT overwrite. */
#ifndef YETTY_YCLASSGEN_YFLAME_TYPES_H
#define YETTY_YCLASSGEN_YFLAME_TYPES_H
...
#endif /* YETTY_YCLASSGEN_YFLAME_TYPES_H */
