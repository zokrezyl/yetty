...
YETTY_YRESULT_DECLARE(ygui_engine_ptr, struct yetty_ygui_old_engine *);
struct yetty_ygui_old_widget;
struct yetty_ygui_old_theme;
...
typedef enum {
    YETTY_YGUI_OLD_WIDGET_BUTTON,
    YETTY_YGUI_OLD_WIDGET_LABEL,
    YETTY_YGUI_OLD_WIDGET_SLIDER,
    YETTY_YGUI_OLD_WIDGET_CHECKBOX,
    YETTY_YGUI_OLD_WIDGET_TEXTINPUT,
    YETTY_YGUI_OLD_WIDGET_PANEL,
    YETTY_YGUI_OLD_WIDGET_HBOX,
    YETTY_YGUI_OLD_WIDGET_VBOX,
    YETTY_YGUI_OLD_WIDGET_DROPDOWN,
    YETTY_YGUI_OLD_WIDGET_LISTBOX,
    YETTY_YGUI_OLD_WIDGET_TABLE,
    YETTY_YGUI_OLD_WIDGET_TABBAR,
    YETTY_YGUI_OLD_WIDGET_COLORPICKER,
    YETTY_YGUI_OLD_WIDGET_SCROLLAREA,
    YETTY_YGUI_OLD_WIDGET_PROGRESS,
    YETTY_YGUI_OLD_WIDGET_SEPARATOR,
    YETTY_YGUI_OLD_WIDGET_POPUP,
    YETTY_YGUI_OLD_WIDGET_COLLAPSING_HEADER,
    YETTY_YGUI_OLD_WIDGET_TOOLTIP,
    YETTY_YGUI_OLD_WIDGET_SELECTABLE,
    YETTY_YGUI_OLD_WIDGET_CHOICEBOX,
    YETTY_YGUI_OLD_WIDGET_VSCROLLBAR,
    YETTY_YGUI_OLD_WIDGET_HSCROLLBAR,
     ...
     * list returned by yetty_ygui_old_widget_tree_node_children(). */
    YETTY_YGUI_OLD_WIDGET_TREE_NODE,
     ...
     * view. See yetty_ygui_old_engine_window in this file. */
    YETTY_YGUI_OLD_WIDGET_WINDOW,
    /* Floating menu of clickable items. Inherits the visuals of
     * YETTY_YGUI_OLD_WIDGET_POPUP (shadow + rounded body + optional modal
     * overlay) and specialises it for vertically stacked rows. Items
     * are stored as label/callback pairs inside the widget — no
     * sub-widgets needed. See yetty_ygui_old_engine_popup_menu. */
    YETTY_YGUI_OLD_WIDGET_POPUP_MENU,
    /* PDF viewer: owns N per-page draw_lists; emits font header + only
     * visible pages translated by (widget_origin + page_y - scroll_y).
     * See yetty/ygui-old/ygui_ypdf.h for construction + scroll API. */
    YETTY_YGUI_OLD_WIDGET_YPDF,
     ...
     * yetty_ygui_old_engine_splitter docs). */
    YETTY_YGUI_OLD_WIDGET_SPLITTER,
    /* Multi-line editable text. Cursor + typing + Backspace + Enter +
     * Home/End + arrow keys, viewport scrolling. Selection / clipboard
     * not yet implemented. */
    YETTY_YGUI_OLD_WIDGET_TEXTAREA,
    /* Pill-shaped on/off control with sliding thumb. Same callback
     * shape as checkbox. */
    YETTY_YGUI_OLD_WIDGET_TOGGLE,
    /* Small pill label with optional ✕ close button. on_remove fires
     * when the user clicks ✕. */
    YETTY_YGUI_OLD_WIDGET_CHIP,
    /* Horizontal sequence of clickable segments separated by ' › '.
     * on_change fires with the clicked segment index. */
    YETTY_YGUI_OLD_WIDGET_BREADCRUMBS,
    /* Editable text input with a dropdown of suggested values reached
     * via a small arrow button on the right side. */
    YETTY_YGUI_OLD_WIDGET_COMBO,
    /* Horizontal strip of menu buttons; each opens an attached
     * popup_menu anchored beneath the click. */
    YETTY_YGUI_OLD_WIDGET_MENUBAR,
    /* Numbered-step indicator: circles + connecting lines + per-step
     * state (complete / current / upcoming). */
    YETTY_YGUI_OLD_WIDGET_STEPPER,
    /* Compact month calendar with prev/next month navigation. */
    YETTY_YGUI_OLD_WIDGET_DATEPICKER,
    /* File / folder picker — list of directory entries with
     * navigation. Often used inside a modal popup. */
    YETTY_YGUI_OLD_WIDGET_FILEPICKER,
    /* Bottom-of-window status strip: short primary text + optional
     * right-aligned secondary text (e.g. "Ready  |  ln 12, col 3"). */
    YETTY_YGUI_OLD_WIDGET_STATUSBAR,
    YETTY_YGUI_OLD_WIDGET_CUSTOM,
} ygui_widget_type_t;

typedef enum {
    YETTY_YGUI_OLD_EVENT_NONE = 0,
    YETTY_YGUI_OLD_EVENT_CLICK,
    YETTY_YGUI_OLD_EVENT_PRESS,
    YETTY_YGUI_OLD_EVENT_RELEASE,
    YETTY_YGUI_OLD_EVENT_CHANGE,
    YETTY_YGUI_OLD_EVENT_SCROLL,
    YETTY_YGUI_OLD_EVENT_FOCUS,
    YETTY_YGUI_OLD_EVENT_BLUR,
    YETTY_YGUI_OLD_EVENT_KEY,
    YETTY_YGUI_OLD_EVENT_TEXT,
} ygui_event_type_t;

typedef enum {
    YETTY_YGUI_OLD_FLAG_NONE = 0,
    YETTY_YGUI_OLD_FLAG_HOVER = 1 << 0,
    YETTY_YGUI_OLD_FLAG_PRESSED = 1 << 1,
    YETTY_YGUI_OLD_FLAG_FOCUSED = 1 << 2,
    YETTY_YGUI_OLD_FLAG_DISABLED = 1 << 3,
    YETTY_YGUI_OLD_FLAG_CHECKED = 1 << 4,
    YETTY_YGUI_OLD_FLAG_OPEN = 1 << 5,
    YETTY_YGUI_OLD_FLAG_VISIBLE = 1 << 6,
} ygui_flags_t;

/* Canvas mode: how canvas size relates to display size */
typedef enum {
    YETTY_YGUI_OLD_CANVAS_FIXED, /* Canvas size stays constant */
    YETTY_YGUI_OLD_CANVAS_FIT    /* Canvas size = card pixel size (card_cells * cell_pixels) */
} ygui_canvas_mode_t;
...
typedef enum {
    YETTY_YGUI_OLD_SCALE_OFF, /* Widgets keep positions/sizes (may clip) */
    YETTY_YGUI_OLD_SCALE_ON   /* Widgets scale proportionally with canvas */
} ygui_scale_mode_t;
...
typedef enum {
    YETTY_YGUI_OLD_LAYOUT_MANUAL = 0, /* default: children at authored x/y/w/h */
    YETTY_YGUI_OLD_LAYOUT_FLEX        /* row/column flex container */
} ygui_layout_mode_t;

typedef enum { YETTY_YGUI_OLD_FLEX_ROW = 0, YETTY_YGUI_OLD_FLEX_COLUMN } ygui_flex_direction_t;

typedef enum {
    YETTY_YGUI_OLD_JUSTIFY_START = 0,
    YETTY_YGUI_OLD_JUSTIFY_CENTER,
    YETTY_YGUI_OLD_JUSTIFY_END,
    YETTY_YGUI_OLD_JUSTIFY_SPACE_BETWEEN,
    YETTY_YGUI_OLD_JUSTIFY_SPACE_AROUND,
    YETTY_YGUI_OLD_JUSTIFY_SPACE_EVENLY
} ygui_justify_t;
...
typedef enum {
    ...
    YETTY_YGUI_OLD_ALIGN_START,
    YETTY_YGUI_OLD_ALIGN_CENTER,
    YETTY_YGUI_OLD_ALIGN_END,
    YETTY_YGUI_OLD_ALIGN_STRETCH,
    YETTY_YGUI_OLD_ALIGN_BASELINE /* cross-axis: line up children by text baseline */
} ygui_align_t;

typedef enum {
    YETTY_YGUI_OLD_FLEX_NOWRAP = 0,
    YETTY_YGUI_OLD_FLEX_WRAP /* break to new line when children overflow */
} ygui_flex_wrap_t;

typedef enum {
    YETTY_YGUI_OLD_POSITION_RELATIVE = 0, /* default — participates in flex flow */
    YETTY_YGUI_OLD_POSITION_ABSOLUTE      /* skipped by flex; positioned at authored x/y */
} ygui_position_t;

struct yetty_ygui_old_layout {
...
/* Keyboard callback */
typedef void (*ygui_key_callback_t)(struct yetty_ygui_old_engine *engine, uint32_t key, int mods,
                                    void *userdata);

/* Widget-specific callbacks */
typedef void (*ygui_click_callback_t)(struct yetty_ygui_old_widget *widget, void *userdata);
typedef void (*ygui_change_callback_t)(struct yetty_ygui_old_widget *widget, float value,
                                       void *userdata);
typedef void (*ygui_text_callback_t)(struct yetty_ygui_old_widget *widget, const char *text,
                                     void *userdata);
typedef void (*ygui_check_callback_t)(struct yetty_ygui_old_widget *widget, int checked,
                                      void *userdata);

/* Resize callback — called whenever the canvas size changes (terminal
 * resize, cell-pixel-size change, or yetty_ygui_old_engine_set_size).
 *
 ...
 * prev_w / prev_h are 0. */
typedef void (*ygui_resize_callback_t)(struct yetty_ygui_old_engine *engine, float new_w, float new_h,
 ...
 *
 * Lifecycle:
 *   1. eng = yetty_ygui_old_engine_create({.name = "myapp"}).value
 ...
 *   3. yetty_ygui_old_engine_run(eng) — blocks on the engine's own loop until
 *      shutdown.
 *   4. yetty_ygui_old_engine_destroy(eng) — unsubscribes, drops the card,
...
struct yetty_ygui_old_engine_args {
...
struct yetty_ycore_void_result yetty_ygui_old_engine_destroy(struct yetty_ygui_old_engine *engine);

/* Render a frame (clear buffer → rebuild → serialize → send OSC)
 * Usually not needed - engine auto-renders when dirty. */
struct yetty_ycore_void_result yetty_ygui_old_engine_render(struct yetty_ygui_old_engine *engine);

/* Run only the layout pass — no rendering, no OSC.
 * After this call, every visible widget has resolved layout_x/y/w/h available
 * through yetty_ygui_old_widget_get_layout_box(). Useful for tests, headless
 * inspection, and tools that want to query post-flex geometry without
 * triggering a render. */
struct yetty_ycore_void_result yetty_ygui_old_engine_layout(struct yetty_ygui_old_engine *engine);
 ...
 * via yetty_ygui_old_engine_buffer_data() / _size(). Used by unit tests
 * to feed the producer output directly into a yfigure_container's
 * process_records (skipping the OSC envelope codec). */
struct yetty_ycore_void_result yetty_ygui_old_engine_render_headless(struct yetty_ygui_old_engine *engine);
 ...
 * engine_destroy. */
const void *yetty_ygui_old_engine_buffer_data(const struct yetty_ygui_old_engine *engine);
size_t yetty_ygui_old_engine_buffer_size(const struct yetty_ygui_old_engine *engine);

/* Run the engine's event loop. Blocks until yetty_ygui_old_engine_stop() is
...
void yetty_ygui_old_engine_stop(struct yetty_ygui_old_engine *engine);

/* Configuration */
void yetty_ygui_old_engine_set_size(struct yetty_ygui_old_engine *engine, float width, float height);
struct pixel_size_result yetty_ygui_old_engine_get_size(const struct yetty_ygui_old_engine *engine);
void yetty_ygui_old_engine_set_theme(struct yetty_ygui_old_engine *engine, struct yetty_ygui_old_theme *theme);

/* Keyboard callback */
void yetty_ygui_old_engine_on_key(struct yetty_ygui_old_engine *engine, ygui_key_callback_t callback,
                              void *userdata);

/* Legacy event callback (all events go through one callback) */
void yetty_ygui_old_engine_set_event_callback(struct yetty_ygui_old_engine *engine,
                                          ygui_event_callback_t callback, void *userdata);

/* State */
int yetty_ygui_old_engine_is_dirty(const struct yetty_ygui_old_engine *engine);
void yetty_ygui_old_engine_mark_dirty(struct yetty_ygui_old_engine *engine);
...
void yetty_ygui_old_engine_mouse_down(struct yetty_ygui_old_engine *engine, float x, float y, int button);
void yetty_ygui_old_engine_mouse_up(struct yetty_ygui_old_engine *engine, float x, float y, int button);
void yetty_ygui_old_engine_mouse_move(struct yetty_ygui_old_engine *engine, float x, float y);
...
int yetty_ygui_old_engine_has_pressed_widget(const struct yetty_ygui_old_engine *engine);
...
struct yetty_ygui_old_widget *yetty_ygui_old_engine_hovered_widget(const struct yetty_ygui_old_engine *engine);
struct yetty_ygui_old_widget *yetty_ygui_old_engine_pressed_widget(const struct yetty_ygui_old_engine *engine);

/* Get the widget's type tag. Returns the underlying YETTY_YGUI_OLD_WIDGET_*
...
void yetty_ygui_old_engine_key_down(struct yetty_ygui_old_engine *engine, uint32_t key, int mods);
void yetty_ygui_old_engine_key_up(struct yetty_ygui_old_engine *engine, uint32_t key, int mods);
void yetty_ygui_old_engine_text_input(struct yetty_ygui_old_engine *engine, const char *utf8);
 ...
 * yetty_ygui_old_engine_notify (printf-style); cards stack top-down with the
 ...
 * TTL via yetty_ygui_old_engine_notify_ttl if you want a different value, or
 * 0 to make it sticky (user must click to dismiss).
 * ========================================================================= */
enum yetty_ygui_old_severity {
    YETTY_YGUI_OLD_SEV_INFO = 0,
    YETTY_YGUI_OLD_SEV_WARN,
    YETTY_YGUI_OLD_SEV_ERROR,
};
...
void yetty_ygui_old_engine_on_resize(struct yetty_ygui_old_engine *engine, ygui_resize_callback_t callback,
                                 void *userdata);

/* View state (read-only, updated from OSC 777779 events) */
float yetty_ygui_old_engine_get_zoom(const struct yetty_ygui_old_engine *engine);
float yetty_ygui_old_engine_get_scroll_x(const struct yetty_ygui_old_engine *engine);
float yetty_ygui_old_engine_get_scroll_y(const struct yetty_ygui_old_engine *engine);

/* Subscribe to view change events (zoom/scroll by user) */
void yetty_ygui_old_engine_subscribe_view_changes(struct yetty_ygui_old_engine *engine, int enable);

/* Control card view (app → yetty) */
void yetty_ygui_old_engine_set_zoom(struct yetty_ygui_old_engine *engine, float level);
void yetty_ygui_old_engine_scroll_to(struct yetty_ygui_old_engine *engine, float x, float y);
void yetty_ygui_old_engine_scroll_by(struct yetty_ygui_old_engine *engine, float dx, float dy);
 ...
 * — get a handle to it via yetty_ygui_old_widget_window_body() and add
...
void yetty_ygui_old_widget_window_set_title(struct yetty_ygui_old_widget *window, const char *title);
const char *yetty_ygui_old_widget_window_get_title(const struct yetty_ygui_old_widget *window);
...
void yetty_ygui_old_engine_close_preserve(struct yetty_ygui_old_engine *engine);
 ...
 *
 * Typical wiring:
 *   m = yetty_ygui_old_engine_popup_menu(engine, "app_menu", 0, 0, 220);
 *   yetty_ygui_old_widget_popup_menu_add_item(m, "About",   on_about, app);
 *   yetty_ygui_old_widget_popup_menu_add_separator(m);
 *   yetty_ygui_old_widget_popup_menu_add_item(m, "Close",   on_close, app);
 *   yetty_ygui_old_widget_window_set_menu(window, m);
 *
 * The menu starts closed. Open it via yetty_ygui_old_widget_popup_menu_open_at
 ...
 * children to it the usual way (yetty_ygui_old_widget_add_child) or apply CSS.
 *
 ...
 *
 * Use change_callback on the tabbar (yetty_ygui_old_widget_tabbar_on_change) to
...
void yetty_ygui_old_widget_tabbar_set_active(struct yetty_ygui_old_widget *tabbar, int index);
int yetty_ygui_old_widget_tabbar_get_active(const struct yetty_ygui_old_widget *tabbar);
int yetty_ygui_old_widget_tabbar_count(const struct yetty_ygui_old_widget *tabbar);
...
void yetty_ygui_old_widget_tabbar_remove_tab(struct yetty_ygui_old_widget *tabbar, int index);
...
/* Button */
void yetty_ygui_old_widget_button_on_click(struct yetty_ygui_old_widget *button,
                                       ygui_click_callback_t callback, void *userdata);

/* Slider */
void yetty_ygui_old_widget_slider_on_change(struct yetty_ygui_old_widget *slider,
                                        ygui_change_callback_t callback, void *userdata);

/* Checkbox */
void yetty_ygui_old_widget_checkbox_on_change(struct yetty_ygui_old_widget *checkbox,
                                          ygui_check_callback_t callback, void *userdata);

/* TextInput */
void yetty_ygui_old_widget_textinput_on_change(struct yetty_ygui_old_widget *input,
 ...
 *
 *   group = yetty_ygui_old_engine_radio_group(eng, "fruit", 0, 0, 200, 100);
 ...
 *   yetty_ygui_old_widget_radio_group_on_change(group, my_cb, NULL);
 *===========================================================================*/
 ...
 *
 *   left  = panel(...,  300, 0);
 *   split = yetty_ygui_old_engine_splitter(eng, "sp", 0, 0, 6, 0);
 *   right = panel(...,  500, 0);
 ...
 *   yetty_ygui_old_widget_dialog_args args = {
 *       .id = "save_q", .title = "Save changes?",
 *       .message = "Unsaved edits will be lost.",
 *       .buttons = btns, .button_count = 2,
 *       .on_button = my_cb, .userdata = self,
 *   };
 *   dlg = yetty_ygui_old_engine_dialog(engine, &args);
 *   yetty_ygui_old_widget_popup_set_open(dlg, 1);
 *
...
typedef void (*yetty_ygui_old_dialog_button_fn)(struct yetty_ygui_old_widget *dialog, int button_index,
                                            void *userdata);

struct yetty_ygui_old_dialog_args {
    const char *id;
    const char *title;
    const char *message;
    const char *const *buttons; /* button_count labels */
    int button_count;
    yetty_ygui_old_dialog_button_fn on_button;
    void *userdata;
 ...
 *
 *   sa = yetty_ygui_old_engine_scrollarea(eng, "sa", 0, 0, 0, 0);
 *   yetty_ygui_old_widget_apply_css(sa, "flex: 1 0 0; align-self: stretch;");
 *   yetty_ygui_old_widget_add_child(sa, my_long_vbox);
 *
 ...
 *
 *   bar = yetty_ygui_old_engine_menubar(eng, "mb", 0, 0, 800, 28);
 *   file_m = yetty_ygui_old_engine_popup_menu(eng, "fm", 0, 0, 180);
 *   yetty_ygui_old_widget_popup_menu_add_item(file_m, "New",  ...);
 *   yetty_ygui_old_widget_menubar_add(bar, "File", file_m);
 *===========================================================================*/
 ...
 * yetty_ygui_old_widget_scrollbar_set_value puts there). */
 ...
 *
 * Construction:
 *   t = yetty_ygui_old_engine_table(engine, "procs", x, y, w, h);
 *   const char *names[]   = {"PID", "USER",  "%CPU", "COMMAND"};
 *   const float widths[]  = {  60,    100,      60,        0  };  // 0 = stretch
 *   yetty_ygui_old_widget_table_set_columns(t, names, widths, 4);
 *
 *   const char *cells[] = {"1", "root", "0.0", "/sbin/init"};
 *   yetty_ygui_old_widget_table_add_row(t, cells, 4);
 *
...
typedef void (*yetty_ygui_old_table_select_fn)(struct yetty_ygui_old_widget *table, int row,
                                           void *userdata);
...
/* Auto-allocated children list (a YETTY_YGUI_OLD_WIDGET_LIST). Use as the
...
struct yetty_ygui_old_widget *yetty_ygui_old_engine_find(struct yetty_ygui_old_engine *engine, const char *id);
struct yetty_ygui_old_widget *yetty_ygui_old_engine_widget_at(struct yetty_ygui_old_engine *engine, float x,
                                                      float y);
 ...
 * their default theme:
 *   theme = yetty_ygui_old_theme_create_default();
 *   yetty_ygui_old_theme_apply_config(theme, config);
...
void yetty_ygui_old_engine_set_input_fd(struct yetty_ygui_old_engine *engine, int fd);
void yetty_ygui_old_engine_set_output_fd(struct yetty_ygui_old_engine *engine, int fd);
...
void yetty_ygui_old_engine_set_output_pty(struct yetty_ygui_old_engine *engine,
...
void yetty_ygui_old_engine_set_card_size(struct yetty_ygui_old_engine *engine, int card_w, int card_h);
...
void yetty_ygui_old_engine_set_display_pixel_size(struct yetty_ygui_old_engine *engine, float width,
                                              float height);
...
const char *yetty_ygui_old_get_error(void);
...
const char *yetty_ygui_old_version(void);
