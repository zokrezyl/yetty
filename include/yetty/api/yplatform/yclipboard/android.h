...
/* Object API for regular class(es) `android_clipboard` (implementation module: yplatform).
 * Fully generated from the source .c — do not edit. The API does
 * not encode whether an implementation dispatches in-process or
 * over RPC; it declares the typed methods, create(), properties,
 * exposed functions, and the types those signatures use. */
#ifndef YETTY_YCLASSGEN_API_YPLATFORM_YCLIPBOARD_ANDROID_H
#define YETTY_YCLASSGEN_API_YPLATFORM_YCLIPBOARD_ANDROID_H
...
#ifndef YETTY_YCLASSGEN_TYPE_YETTY_YPLATFORM_ANDROID_CLIPBOARD_PTR_RESULT
#define YETTY_YCLASSGEN_TYPE_YETTY_YPLATFORM_ANDROID_CLIPBOARD_PTR_RESULT
struct yetty_yplatform_android_clipboard_ptr_result {
    int ok;
    union {
        struct yetty_yplatform_android_clipboard *value;
