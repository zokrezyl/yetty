...
/* Object API for regular class(es) `ios_window` (implementation module: yplatform).
 * Fully generated from the source .c — do not edit. The API does
 * not encode whether an implementation dispatches in-process or
 * over RPC; it declares the typed methods, create(), properties,
 * exposed functions, and the types those signatures use. */
#ifndef YETTY_YCLASSGEN_API_YPLATFORM_YWINDOW_IOS_TVOS_H
#define YETTY_YCLASSGEN_API_YPLATFORM_YWINDOW_IOS_TVOS_H
...
#ifndef YETTY_YCLASSGEN_TYPE_YETTY_YPLATFORM_IOS_WINDOW_PTR_RESULT
#define YETTY_YCLASSGEN_TYPE_YETTY_YPLATFORM_IOS_WINDOW_PTR_RESULT
