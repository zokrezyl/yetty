...
/* Object API for regular class(es) `30_radio` (implementation module: demoygui).
 * Fully generated from the source .c — do not edit. The API does
 * not encode whether an implementation dispatches in-process or
 * over RPC; it declares the typed methods, create(), properties,
 * exposed functions, and the types those signatures use. */
#ifndef YETTY_YCLASSGEN_API_DEMOYGUI_30_RADIO_MAIN_H
#define YETTY_YCLASSGEN_API_DEMOYGUI_30_RADIO_MAIN_H
...
#ifndef YETTY_YCLASSGEN_TYPE_YETTY_DEMOYGUI_30_RADIO_PTR_RESULT
#define YETTY_YCLASSGEN_TYPE_YETTY_DEMOYGUI_30_RADIO_PTR_RESULT
