...
/* Object API for regular class(es) `ynodes` (implementation module: ygui).
 * Fully generated from the source .c — do not edit. The API does
 * not encode whether an implementation dispatches in-process or
 * over RPC; it declares the typed methods, create(), properties,
 * exposed functions, and the types those signatures use. */
#ifndef YETTY_YCLASSGEN_API_YGUI_WIDGETS_YNODES_H
#define YETTY_YCLASSGEN_API_YGUI_WIDGETS_YNODES_H
...
typedef struct yetty_ycore_void_result (*yetty_ygui_ynodes_link_cb)(struct yetty_yclass_object *, struct yetty_yclass_object *, int, struct yetty_yclass_object *, int, void *);
...
#ifndef YETTY_YCLASSGEN_TYPE_YETTY_YGUI_YNODES_PTR_RESULT
#define YETTY_YCLASSGEN_TYPE_YETTY_YGUI_YNODES_PTR_RESULT
 ...
 * View.
 *---------------------------------------------------------------------------*/
struct yetty_ycore_void_result yetty_ygui_ynodes_view(const struct yetty_yclass_object *editor, float *pan_x, float *pan_y, float *zoom);
