...
/* Object API for regular class(es) `dropdown` (implementation module: ygui).
 * Fully generated from the source .c — do not edit. The API does
 * not encode whether an implementation dispatches in-process or
 * over RPC; it declares the typed methods, create(), properties,
 * exposed functions, and the types those signatures use. */
#ifndef YETTY_YCLASSGEN_API_YGUI_WIDGETS_DROPDOWN_H
#define YETTY_YCLASSGEN_API_YGUI_WIDGETS_DROPDOWN_H
...
#ifndef YETTY_YCLASSGEN_TYPE_YETTY_YGUI_DROPDOWN_PTR_RESULT
#define YETTY_YCLASSGEN_TYPE_YETTY_YGUI_DROPDOWN_PTR_RESULT
struct yetty_ygui_dropdown_ptr_result {
    int ok;
    union {
        struct yetty_ygui_dropdown *value;
