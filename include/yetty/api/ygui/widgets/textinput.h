...
struct yetty_ycore_char_ptr_result yetty_ygui_textinput_get_selection(const struct yetty_yclass_object *obj);
...
struct yetty_ycore_void_result yetty_ygui_textinput_insert_text(struct yetty_yclass_object *obj, const char *text);
 ...
 * handled locally. */
struct yetty_ycore_int_result yetty_ygui_textinput_handle_key(struct yetty_yclass_object *obj, uint32_t key, int mods);
