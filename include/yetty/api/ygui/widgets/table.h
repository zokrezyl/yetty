...
/* Object API for regular class(es) `table` (implementation module: ygui).
 * Fully generated from the source .c — do not edit. The API does
 * not encode whether an implementation dispatches in-process or
 * over RPC; it declares the typed methods, create(), properties,
 * exposed functions, and the types those signatures use. */
#ifndef YETTY_YCLASSGEN_API_YGUI_WIDGETS_TABLE_H
#define YETTY_YCLASSGEN_API_YGUI_WIDGETS_TABLE_H
...
#ifndef YETTY_YCLASSGEN_TYPE_YETTY_YGUI_TABLE_PTR_RESULT
#define YETTY_YCLASSGEN_TYPE_YETTY_YGUI_TABLE_PTR_RESULT
struct yetty_ygui_table_ptr_result {
    int ok;
    union {
        struct yetty_ygui_table *value;
