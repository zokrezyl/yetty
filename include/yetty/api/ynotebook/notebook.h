...
/* Object API for regular class(es) `output, cell, notebook` (implementation module: ynotebook).
 * Fully generated from the source .c — do not edit. The API does
 * not encode whether an implementation dispatches in-process or
 * over RPC; it declares the typed methods, create(), properties,
 * exposed functions, and the types those signatures use. */
#ifndef YETTY_YCLASSGEN_API_YNOTEBOOK_NOTEBOOK_H
#define YETTY_YCLASSGEN_API_YNOTEBOOK_NOTEBOOK_H
...
#ifndef YETTY_YCLASSGEN_TYPE_YETTY_YNOTEBOOK_OUTPUT_PTR_RESULT
#define YETTY_YCLASSGEN_TYPE_YETTY_YNOTEBOOK_OUTPUT_PTR_RESULT
...
struct yetty_yclass_object_ptr_result yetty_ynotebook_output_to(
    struct yetty_ynotebook_output *data);
...
#ifndef YETTY_YCLASSGEN_TYPE_YETTY_YNOTEBOOK_CELL_PTR_RESULT
#define YETTY_YCLASSGEN_TYPE_YETTY_YNOTEBOOK_CELL_PTR_RESULT
...
#ifndef YETTY_YCLASSGEN_TYPE_YETTY_YNOTEBOOK_NOTEBOOK_PTR_RESULT
#define YETTY_YCLASSGEN_TYPE_YETTY_YNOTEBOOK_NOTEBOOK_PTR_RESULT
