...
/* Object API for regular class(es) `button` (implementation module: ygui2).
 * Fully generated from the source .c — do not edit. The API does
 * not encode whether an implementation dispatches in-process or
 * over RPC; it declares the typed methods, create(), properties,
 * exposed functions, and the types those signatures use. */
#ifndef YETTY_YCLASSGEN_API_YGUI2_WIDGETS_BUTTON_H
#define YETTY_YCLASSGEN_API_YGUI2_WIDGETS_BUTTON_H
...
struct yetty_ygui2_button;
#ifndef YETTY_YCLASSGEN_TYPE_YETTY_YGUI2_BUTTON_PTR_RESULT
#define YETTY_YCLASSGEN_TYPE_YETTY_YGUI2_BUTTON_PTR_RESULT
struct yetty_ygui2_button_ptr_result {
    int ok;
    union {
        struct yetty_ygui2_button *value;
