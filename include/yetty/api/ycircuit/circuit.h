...
/* Object API for regular class(es) `circuit` (implementation module: ycircuit).
 * Fully generated from the source .c — do not edit. The API does
 * not encode whether an implementation dispatches in-process or
 * over RPC; it declares the typed methods, create(), properties,
 * exposed functions, and the types those signatures use. */
#ifndef YETTY_YCLASSGEN_API_YCIRCUIT_CIRCUIT_H
#define YETTY_YCLASSGEN_API_YCIRCUIT_CIRCUIT_H
...
struct yetty_ycore_void_result yetty_ycircuit_emit_osc(const struct yetty_ydraw_drawable_list *list, int fd);
