...
/* Object API for regular class(es) `document` (implementation module: yrich).
 * Fully generated from the source .c — do not edit. The API does
 * not encode whether an implementation dispatches in-process or
 * over RPC; it declares the typed methods, create(), properties,
 * exposed functions, and the types those signatures use. */
#ifndef YETTY_YCLASSGEN_API_YRICH_DOCUMENT_H
#define YETTY_YCLASSGEN_API_YRICH_DOCUMENT_H
...
#ifndef YETTY_YCLASSGEN_TYPE_YETTY_YRICH_DOCUMENT_PTR_RESULT
#define YETTY_YCLASSGEN_TYPE_YETTY_YRICH_DOCUMENT_PTR_RESULT
...
struct yetty_ycore_void_result yetty_yrich_super_void(struct yetty_yclass_object *obj, const struct yetty_yclass *self_class, yetty_yclass_method_id_t method_id);
...
struct yetty_ycore_void_result yetty_yrich_document_set_buffer(struct yetty_yclass_object *obj, struct yetty_ydraw_drawable_list *drawable_list);
struct yetty_yrich_drawable_list_ptr_result yetty_yrich_document_buffer(struct yetty_yclass_object *obj);
struct yetty_ycore_void_result yetty_yrich_document_set_bg_color(struct yetty_yclass_object *obj, uint32_t color);
struct yetty_ycore_uint32_result yetty_yrich_document_bg_color(struct yetty_yclass_object *obj);
struct yetty_ycore_void_result yetty_yrich_document_set_dirty_cb(struct yetty_yclass_object *obj, yetty_yrich_dirty_cb callback, void *userdata);
struct yetty_ycore_void_result yetty_yrich_document_set_sync_cb(struct yetty_yclass_object *obj, yetty_yrich_sync_cb callback, void *userdata);
...
struct yetty_yrich_operation_ptr_result yetty_yrich_document_create_op(struct yetty_yclass_object *obj, uint32_t op_type);
...
struct yetty_ycore_void_result yetty_yrich_document_add_element(struct yetty_yclass_object *obj, struct yetty_yclass_object *element_obj);
struct yetty_ycore_void_result yetty_yrich_document_remove_element(struct yetty_yclass_object *obj, yetty_yrich_element_id id);
struct yetty_yclass_object_ptr_result yetty_yrich_document_find(struct yetty_yclass_object *obj, yetty_yrich_element_id id);
/* Hit-test in reverse z-order (last drawn = topmost). */
struct yetty_yclass_object_ptr_result yetty_yrich_document_element_at(struct yetty_yclass_object *obj, float x, float y);
struct yetty_yrich_selection_ptr_result yetty_yrich_document_selection(struct yetty_yclass_object *obj);
struct yetty_ycore_int_result yetty_yrich_document_is_selected(struct yetty_yclass_object *obj, yetty_yrich_element_id id);
...
struct yetty_ycore_void_result yetty_yrich_document_execute(struct yetty_yclass_object *obj, struct yetty_yrich_command *cmd);
