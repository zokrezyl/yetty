...
struct yetty_ycore_void_result yetty_yrich_paragraph_set_text(struct yetty_yclass_object *obj, const char *text, size_t len);
/* Style setters — the data slice is private to this TU; the yaml loader and
 * future bindings reach the style through these. */
struct yetty_ycore_void_result yetty_yrich_paragraph_set_font_size(struct yetty_yclass_object *obj, float font_size);
struct yetty_ycore_void_result yetty_yrich_paragraph_set_color(struct yetty_yclass_object *obj, uint32_t color);
struct yetty_ycore_void_result yetty_yrich_paragraph_set_format(struct yetty_yclass_object *obj, uint32_t format);
struct yetty_ycore_void_result yetty_yrich_ydoc_set_page_width(struct yetty_yclass_object *obj, float width);
struct yetty_ycore_void_result yetty_yrich_ydoc_set_margin(struct yetty_yclass_object *obj, float margin);
struct yetty_yclass_object_ptr_result yetty_yrich_ydoc_add_paragraph(struct yetty_yclass_object *obj, const char *text, size_t text_len);
struct yetty_yclass_object_ptr_result yetty_yrich_ydoc_paragraph_at(struct yetty_yclass_object *obj, int32_t index);
/* Set the inline image's source (a file path decoded at render time). NULL/empty
 * clears it. */
struct yetty_ycore_void_result yetty_yrich_inline_image_set_source(struct yetty_yclass_object *obj, const char *source);
/* The inline image's source path, or NULL when unset. */
struct yetty_ycore_const_char_ptr_result yetty_yrich_inline_image_source(struct yetty_yclass_object *obj);
/* Set the image's document-space bounds (position + display size). */
struct yetty_ycore_void_result yetty_yrich_inline_image_set_bounds(struct yetty_yclass_object *obj, float x, float y, float width, float height);
/* Read the image's document-space bounds. Any out pointer may be NULL. */
struct yetty_ycore_void_result yetty_yrich_inline_image_bounds(struct yetty_yclass_object *obj, float *out_x, float *out_y, float *out_width, float *out_height);
...
struct yetty_yclass_object_ptr_result yetty_yrich_ydoc_image_at(struct yetty_yclass_object *obj, int32_t index);
struct yetty_yclass_object_ptr_result yetty_yrich_ydoc_insert_image(struct yetty_yclass_object *obj, int32_t paragraph_index, float width, float height);
...
struct yetty_ycore_void_result yetty_yrich_ydoc_set_styled_font_mask(struct yetty_yclass_object *obj, uint32_t mask);
...
struct yetty_ycore_void_result yetty_yrich_ydoc_insert_horizontal_rule(struct yetty_yclass_object *obj);
...
struct yetty_ycore_void_result yetty_yrich_ydoc_insert_table(struct yetty_yclass_object *obj, uint32_t rows, uint32_t cols);
 ...
 * dispatches here. */
struct yetty_ycore_void_result yetty_yrich_ydoc_table_edit(struct yetty_yclass_object *obj, uint32_t op);
 ...
 * pointer may be NULL. */
struct yetty_ycore_void_result yetty_yrich_ydoc_word_count(struct yetty_yclass_object *obj, uint32_t *out_words, uint32_t *out_chars, uint32_t *out_chars_no_spaces, uint32_t *out_paragraphs);
...
struct yetty_ycore_int_result yetty_yrich_ydoc_find_next(struct yetty_yclass_object *obj, const char *query);
...
struct yetty_ycore_int_result yetty_yrich_ydoc_find_prev(struct yetty_yclass_object *obj, const char *query);
...
struct yetty_ycore_int_result yetty_yrich_ydoc_replace_all(struct yetty_yclass_object *obj, const char *query, const char *replacement);
/* Extra vertical gap above the paragraph, in px (0 removes it). Undoable. */
struct yetty_ycore_void_result yetty_yrich_ydoc_set_space_before(struct yetty_yclass_object *obj, float px);
/* Extra vertical gap below the paragraph, in px (0 removes it). Undoable. */
struct yetty_ycore_void_result yetty_yrich_ydoc_set_space_after(struct yetty_yclass_object *obj, float px);
/* Nest a list item one level deeper (direction > 0) or shallower (<= 0);
 * no-op on non-list paragraphs. Undoable. Wired to Tab / Shift+Tab. */
struct yetty_ycore_void_result yetty_yrich_ydoc_change_list_level(struct yetty_yclass_object *obj, int32_t direction);
...
struct yetty_ycore_void_result yetty_yrich_ydoc_set_link(struct yetty_yclass_object *obj, const char *url);
...
struct yetty_ycore_const_char_ptr_result yetty_yrich_ydoc_link_at_caret(struct yetty_yclass_object *obj);
...
struct yetty_ycore_const_char_ptr_result yetty_yrich_ydoc_link_url(struct yetty_yclass_object *obj, uint32_t link_id);
...
struct yetty_ycore_void_result yetty_yrich_ydoc_apply_run_link(struct yetty_yclass_object *obj, struct yetty_yclass_object *paragraph_obj, int32_t start, int32_t end, const char *url);
...
struct yetty_ycore_void_result yetty_yrich_ydoc_set_bookmark(struct yetty_yclass_object *obj, const char *name);
 ...
 * the command layer. */
struct yetty_ycore_void_result yetty_yrich_ydoc_set_list(struct yetty_yclass_object *obj, uint32_t kind);
...
struct yetty_ycore_void_result yetty_yrich_ydoc_place_caret(struct yetty_yclass_object *obj, int32_t paragraph_index, int32_t position);
...
struct yetty_ycore_int_result yetty_yrich_ydoc_goto_bookmark(struct yetty_yclass_object *obj, const char *name);
...
struct yetty_ycore_void_result yetty_yrich_ydoc_select_range(struct yetty_yclass_object *obj, int32_t anchor_paragraph, int32_t anchor_offset, int32_t focus_paragraph, int32_t focus_offset);
...
struct yetty_ycore_void_result yetty_yrich_ydoc_set_source_path(struct yetty_yclass_object *obj, const char *path);
struct yetty_ycore_const_char_ptr_result yetty_yrich_ydoc_source_path(struct yetty_yclass_object *obj);
...
struct yetty_ycore_void_result yetty_yrich_paragraph_set_line_spacing(struct yetty_yclass_object *obj, float spacing);
struct yetty_ycore_float_result yetty_yrich_paragraph_indent(struct yetty_yclass_object *obj);
struct yetty_ycore_uint32_result yetty_yrich_paragraph_heading_level(struct yetty_yclass_object *obj);
...
struct yetty_ycore_void_result yetty_yrich_paragraph_set_heading_level(struct yetty_yclass_object *obj, uint32_t level);
struct yetty_ycore_void_result yetty_yrich_paragraph_set_indent(struct yetty_yclass_object *obj, float indent);
...
struct yetty_ycore_void_result yetty_yrich_paragraph_set_alignment(struct yetty_yclass_object *obj, uint32_t halign);
...
struct yetty_ycore_void_result yetty_yrich_paragraph_set_list_kind(struct yetty_yclass_object *obj, uint32_t list_kind);
struct yetty_ycore_uint32_result yetty_yrich_paragraph_list_checked(struct yetty_yclass_object *obj);
struct yetty_ycore_void_result yetty_yrich_paragraph_set_list_checked(struct yetty_yclass_object *obj, uint32_t checked);
...
struct yetty_ycore_void_result yetty_yrich_paragraph_set_block_kind(struct yetty_yclass_object *obj, uint32_t block_kind);
/* Table dimensions/cells — loader/saver side; editing is via the ydoc. */
struct yetty_ycore_void_result yetty_yrich_paragraph_table_size(struct yetty_yclass_object *obj, uint32_t *out_rows, uint32_t *out_cols);
/* Allocate the cell grid (clears any prior one). block_kind is set to table. */
struct yetty_ycore_void_result yetty_yrich_paragraph_set_table(struct yetty_yclass_object *obj, uint32_t rows, uint32_t cols);
struct yetty_ycore_const_char_ptr_result yetty_yrich_paragraph_table_cell(struct yetty_yclass_object *obj, uint32_t row, uint32_t col);
struct yetty_ycore_void_result yetty_yrich_paragraph_set_table_cell(struct yetty_yclass_object *obj, uint32_t row, uint32_t col, const char *text);
...
struct yetty_ycore_void_result yetty_yrich_paragraph_set_space_before(struct yetty_yclass_object *obj, float px);
struct yetty_ycore_float_result yetty_yrich_paragraph_space_after(struct yetty_yclass_object *obj);
struct yetty_ycore_void_result yetty_yrich_paragraph_set_space_after(struct yetty_yclass_object *obj, float px);
struct yetty_ycore_uint32_result yetty_yrich_paragraph_list_level(struct yetty_yclass_object *obj);
struct yetty_ycore_void_result yetty_yrich_paragraph_set_list_level(struct yetty_yclass_object *obj, uint32_t level);
struct yetty_ycore_size_result yetty_yrich_paragraph_run_count(struct yetty_yclass_object *obj);
struct yetty_ycore_void_result yetty_yrich_paragraph_run_get(struct yetty_yclass_object *obj, size_t index, int32_t *out_start, int32_t *out_end, uint32_t *out_format, uint32_t *out_color, uint32_t *out_bg_color, float *out_font_size);
/* Hyperlink id of run `index` (0 = no link); resolves to a URL via the owning
 * ydoc's link table. Serializer side. */
struct yetty_ycore_uint32_result yetty_yrich_paragraph_run_link_id(struct yetty_yclass_object *obj, size_t index);
/* Name the bookmark anchored at this paragraph (NULL/empty clears it). */
struct yetty_ycore_void_result yetty_yrich_paragraph_set_bookmark(struct yetty_yclass_object *obj, const char *name);
/* Bookmark name anchoring this paragraph, or NULL when none. */
struct yetty_ycore_const_char_ptr_result yetty_yrich_paragraph_bookmark(struct yetty_yclass_object *obj);
/* Append one styled run — loader-side; ranges must arrive sorted and
 * non-overlapping (the writer emits them that way). */
struct yetty_ycore_void_result yetty_yrich_paragraph_add_run(struct yetty_yclass_object *obj, int32_t start, int32_t end, uint32_t format, uint32_t color, uint32_t bg_color, float font_size);
