...
#define YFSVM_MAX_EXECUTION_STEPS 8192u
...
typedef enum yetty_yfsvm_YfsvmOpcode {
    ...
    YETTY_YFSVM_OP_JMP = 0x08,
    YETTY_YFSVM_OP_JMP_IF_ZERO = 0x09,
    YETTY_YFSVM_OP_JMP_IF_NONZERO = 0x0A,
    YETTY_YFSVM_OP_JMP_IF_LT = 0x0B,
    YETTY_YFSVM_OP_JMP_IF_GE = 0x0C,
