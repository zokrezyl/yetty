...
static inline struct yetty_ymesh_vec3 yetty_ymesh_vec3_sub(struct yetty_ymesh_vec3 a,
                                                           struct yetty_ymesh_vec3 b)
{
    return (struct yetty_ymesh_vec3){a.x - b.x, a.y - b.y, a.z - b.z};
}

static inline struct yetty_ymesh_vec3 yetty_ymesh_vec3_cross(struct yetty_ymesh_vec3 a,
                                                             struct yetty_ymesh_vec3 b)
{
...
static inline struct yetty_ymesh_mat4 yetty_ymesh_mat4_perspective(float fov_y_rad, float aspect,
...
static inline struct yetty_ymesh_mat4 yetty_ymesh_mat4_lookat(struct yetty_ymesh_vec3 eye,
                                                              struct yetty_ymesh_vec3 center,
                                                              struct yetty_ymesh_vec3 up)
{
...
static inline struct yetty_ymesh_mat4 yetty_ymesh_mat4_mul(struct yetty_ymesh_mat4 a,
                                                           struct yetty_ymesh_mat4 b)
{
