 ...
 */
#ifndef YETTY_YDRAW_SCROLLBUFFER_H
#define YETTY_YDRAW_SCROLLBUFFER_H
...
struct yetty_ydraw_scrollbuffer_cell {
    uint16_t col;
    uint16_t ref_count;
...
struct yetty_ydraw_scrollbuffer_decode_sinks {
    void *ctx;
...
#endif /* YETTY_YDRAW_SCROLLBUFFER_H */
