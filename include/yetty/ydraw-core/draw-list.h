...
YETTY_YRESULT_DECLARE(yetty_ydraw_core_draw_list, struct yetty_ydraw_core_draw_list *);
...
struct yetty_ydraw_core_draw_list_config {
    float scene_min_x;
    float scene_min_y;
    float scene_max_x;
    float scene_max_y;
...
struct yetty_ydraw_core_draw_list_result yetty_ydraw_core_draw_list_config_buffer_create(
    const struct yetty_ydraw_core_draw_list_config *config YETTY_ANNOT_NULLABLE);
...
void yetty_ydraw_core_draw_list_destroy(
    struct yetty_ydraw_core_draw_list *buf YETTY_ANNOT_CALLEE_OWNED);
...
struct yetty_ydraw_core_id_result yetty_ydraw_core_draw_list_add_prim(
    struct yetty_ydraw_core_draw_list *buf, const void *data YETTY_ANNOT_ARRAY(size), size_t size);
