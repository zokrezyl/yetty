...
struct yetty_ydraw_core_complex_prim_instance {
     ...
     * yetty_ydraw_core_complex_prim_instance_destroy. May be NULL during
    ...
    struct yetty_ycore_void_result (*render)(struct yetty_ydraw_core_complex_prim_instance *self,
                                             struct yetty_ydraw_core_target *target, float x,
                                             float y);
};

YETTY_YRESULT_DECLARE(yetty_ydraw_core_complex_prim_instance_ptr,
                      struct yetty_ydraw_core_complex_prim_instance *);
...
struct yetty_ydraw_core_concrete_factory {
    ...
    struct yetty_ydraw_core_complex_prim_instance_ptr_result (*create_instance)(
...
YETTY_YRESULT_DECLARE(yetty_ydraw_core_complex_prim_factory_ptr,
                      struct yetty_ydraw_core_complex_prim_factory *);
...
void yetty_ydraw_core_complex_prim_factory_destroy(
    struct yetty_ydraw_core_complex_prim_factory *factory YETTY_ANNOT_CALLEE_OWNED);
...
void yetty_ydraw_core_complex_prim_instance_destroy(
    struct yetty_ydraw_core_complex_prim_instance *instance YETTY_ANNOT_CALLEE_OWNED);
