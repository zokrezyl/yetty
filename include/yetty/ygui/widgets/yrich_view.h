...
struct yetty_ycore_void_result yetty_ygui_yrich_view_set_document(struct yetty_ygui_object *obj, struct yetty_yrich_document *doc, int own);
...
struct yetty_ycore_void_result yetty_ygui_yrich_view_content_size(const struct yetty_ygui_object *obj, float *w, float *h);
struct yetty_ycore_void_result yetty_ygui_yrich_view_feed_key(struct yetty_ygui_object *obj, uint32_t key, struct yetty_yrich_input_mods mods);
struct yetty_ycore_void_result yetty_ygui_yrich_view_feed_text(struct yetty_ygui_object *obj, const char *text, size_t len);
