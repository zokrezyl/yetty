...
typedef struct yetty_ycore_void_result (*yetty_yplatform_window_manager_configure_fn)(
    struct yetty_yclass_object *, void *, struct yetty_ycore_xthread_event_pipe *,
    struct yetty_ycore_xthread_event_pipe *);
...
typedef struct yetty_ycore_void_result (
    *yetty_yplatform_window_manager_begin_interactive_resize_fn)(struct yetty_yclass_object *, int);
