...
struct yetty_yclass_object_ptr_result yetty_yjupyter_message_to(
    struct yetty_yjupyter_message *data);
...
struct yetty_yjupyter_session_ptr_result yetty_yjupyter_session_from(
    struct yetty_yclass_object *obj);
struct yetty_yclass_object_ptr_result yetty_yjupyter_session_to(
    struct yetty_yjupyter_session *data);
