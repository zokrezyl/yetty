...
static void check_int(const char *label, JSContext *ctx, const char *src, int32_t expect)
{
...
static void run_cases(JSContext *ctx)
{
    ...
    check_int("return-const-str", ctx, "(function(){return 'hello';})().length", 5);
    ...
    check_int("hot-const-loop", ctx,
              ...
              "for(var i=0;i<1000;i++)s=f();s",
              11);

    /* Stage 2: locals, args, branches, calls. */
    check_int("local-var", ctx, "(function(){var x=17;return x;})()", 17);
    check_int("local-reassign", ctx, "(function(){var x=1;x=2;x=3;return x;})()", 3);
    check_int("arg-passthrough", ctx, "(function(a){return a;})(41)", 41);
    check_int("arg-second", ctx, "(function(a,b){return b;})(1,99)", 99);
    check_int("if-true-branch", ctx, "(function(){if(true)return 8;return 0;})()", 8);
    check_int("if-false-branch", ctx, "(function(){if(false)return 8;return 3;})()", 3);
    check_int("if-else", ctx, "(function(x){if(x)return 10;else return 20;})(0)", 20);
    check_int("ternary-const", ctx, "(function(){return true?5:6;})()", 5);
    check_int("call-leaf", ctx,
              "var g=function(){return 7;};"
              "var f=function(){return g();};f()",
              7);
    check_int("call-with-arg", ctx,
              "var id=function(z){return z;};"
              "(function(){return id(55);})()",
              55);
    check_int("call-two-args", ctx,
              "var pick=function(a,b){return b;};"
              "(function(){return pick(1,2);})()",
              2);
    check_int("nested-locals", ctx, "(function(){var a=2;var b=3;var c=a;return c;})()", 2);
    check_int("logical-guard", ctx, "(function(x){if(x){return 1;}return 2;})(null)", 2);
    check_int("string-len-local", ctx, "(function(){var s='abcd';return s;})().length", 4);
    ...
    check_int("branch-hot", ctx,
              ...
              "var s=0;for(var i=0;i<2000;i++)s=f(i&1);s",
              9);
    ...
    check_int("throw-then-recover", ctx,
              ...
              63);
    check_throws("tdz-uncaught", ctx, "var g=function(){ return q; let q=1; }; g()");
    ...
    check_int("sum-loop", ctx, "(function(){var s=0;for(var i=0;i<100;i++)s=s+i;return s;})()",
              4950);
    check_int("sum-loop-big", ctx,
              "(function(){var s=0;for(var i=0;i<10000;i++)s=s+i;return s;})()", 49995000);
    check_int("mul-loop", ctx, "(function(){var p=1;for(var i=1;i<=10;i++)p=p*i;return p;})()",
              3628800);
    check_int("while-countdown", ctx,
              "(function(){var n=50;var c=0;while(n>0){n=n-1;c=c+1;}return c;})()", 50);
    ...
    check_int("fib-iterative", ctx,
              ...
              6765);
    check_int("post-inc-expr", ctx, "(function(){var i=5;var j=i++;return i*10+j;})()", 65);
    check_int("mod-div", ctx, "(function(){return (17%5)*10+((20/4)|0);})()", 25);
    check_int("float-mixed", ctx, "(function(){var x=1.5;var y=2.5;return (x+y)===4?1:0;})()", 1);
    check_int("string-concat", ctx,
              "(function(){var s='';for(var i=0;i<3;i++)s=s+'x';return s;})().length", 3);
    ...
    check_int("hot-arith-loop", ctx,
              ...
              "var r=0;for(var k=0;k<200;k++)r=f(100);r",
              14850);

    /* Stage 4: property access, arrays, methods, closures. */
    check_int("prop-read", ctx, "var o={a:5,b:7};(function(x){return x.a+x.b;})(o)", 12);
    check_int("prop-write", ctx, "(function(){var o={a:1};o.a=9;return o.a;})()", 9);
    check_int("array-index", ctx, "var a=[10,20,30];(function(x){return x[0]+x[2];})(a)", 40);
    check_int("array-write", ctx, "(function(){var a=[0,0,0];a[1]=42;return a[1];})()", 42);
    check_int("array-length", ctx, "(function(x){return x.length;})([1,2,3,4,5])", 5);
    ...
    check_int("method-chain-hot", ctx,
              ...
              "var s=0;for(var i=0;i<100;i++)s=o.step();s",
              302);
    check_throws("prop-of-null", ctx, "(function(x){return x.foo;})(null)");
    ...
    check_int("constructor-hot", ctx,
              ...
              "var s=0;for(var i=0;i<100;i++)s=f(i);s",
              99);
}
