...
function(_yetty_test_shim_source token out_var)
    ...
    elseif(token STREQUAL "platform_time")
        set(${out_var} "${YETTY_ROOT}/src/yetty/yplatform/time/default.c" PARENT_SCOPE)
    elseif(token STREQUAL "workpool")
        ...
        message(FATAL_ERROR "yetty_add_c_test: unknown SHIM '${token}' "
                            "(known: trace platform_thread platform_term platform_time workpool)")
    endif()
endfunction()
