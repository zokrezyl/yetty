#!/bin/bash
# Demo for the biomine shadertoy glyph.
#   wgsl:     src/yetty/yfont/glyph-shaders/0x00fb-biomine.wgsl
#   local_id: 0xfb  ->  PUA-B codepoint U+1000FB
...
#       -e demo/scripts/shader-glyph/shadertoy/0x00fb-biomine.sh
#
# Env: ROWS (16), COLS (64).
ROWS=${ROWS:-16}
COLS=${COLS:-64}
codepoint='\xf4\x80\x83\xbb'   # U+1000FB

printf '=== shadertoy glyph: biomine (local_id 0xfb) ===\n\n'
