#!/bin/bash
# Demo for the julia shadertoy glyph.
#   wgsl:     src/yetty/yfont/glyph-shaders/0x00fc-julia.wgsl
#   local_id: 0xfc  ->  PUA-B codepoint U+1000FC
...
#       -e demo/scripts/shader-glyph/shadertoy/0x00fc-julia.sh
#
# Env: ROWS (16), COLS (64).
ROWS=${ROWS:-16}
COLS=${COLS:-64}
codepoint='\xf4\x80\x83\xbc'   # U+1000FC

printf '=== shadertoy glyph: julia (local_id 0xfc) ===\n\n'
