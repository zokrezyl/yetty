#!/bin/bash
# Demo for the butterfly-flock shadertoy glyph.
#   wgsl:     src/yetty/yfont/glyph-shaders/0x00f5-butterfly-flock.wgsl
#   local_id: 0xf5  ->  PUA-B codepoint U+1000F5
...
#       -e demo/scripts/shader-glyph/shadertoy/0x00f5-butterfly-flock.sh
#
# Env: ROWS (16), COLS (64).
ROWS=${ROWS:-16}
COLS=${COLS:-64}
codepoint='\xf4\x80\x83\xb5'   # U+1000F5

printf '=== shadertoy glyph: butterfly-flock (local_id 0xf5) ===\n\n'
