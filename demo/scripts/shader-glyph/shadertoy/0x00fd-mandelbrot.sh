#!/bin/bash
# Demo for the mandelbrot shadertoy glyph.
#   wgsl:     src/yetty/yfont/glyph-shaders/0x00fd-mandelbrot.wgsl
#   local_id: 0xfd  ->  PUA-B codepoint U+1000FD
...
#       -e demo/scripts/shader-glyph/shadertoy/0x00fd-mandelbrot.sh
#
# Env: ROWS (16), COLS (64).
ROWS=${ROWS:-16}
COLS=${COLS:-64}
codepoint='\xf4\x80\x83\xbd'   # U+1000FD

printf '=== shadertoy glyph: mandelbrot (local_id 0xfd) ===\n\n'
