...
struct [[clang::annotate("class@demoygui:02_coord_debug")]] [[clang::annotate(
    "parent@yguiapp:app")]] yetty_demoygui_02_coord_debug {
    int unused;
};
...
YETTY_YRESULT_DECLARE(yetty_demoygui_02_coord_debug_ptr, struct yetty_demoygui_02_coord_debug *);
