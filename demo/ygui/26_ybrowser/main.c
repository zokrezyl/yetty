...
struct [[clang::annotate("class@demoygui:26_ybrowser")]] [[clang::annotate("parent@yguiapp:app")]]
yetty_demoygui_26_ybrowser {
    int unused;
};
...
YETTY_YRESULT_DECLARE(yetty_demoygui_26_ybrowser_ptr, struct yetty_demoygui_26_ybrowser *);
