...
int main(void) {
    ...
    { struct ygui_engine_ptr_result _eng_r = yetty_ygui_old_engine_create((struct yetty_ygui_old_engine_args){.name = "edge-test"});
    ...
    /* Title */
    yetty_ygui_old_engine_label(g_engine, "title", 20, 15, "Edge Test - Click button boundaries");
    ...
    yetty_ygui_old_engine_label(g_engine, "info1", BTN1_X, 130, info1);
    yetty_ygui_old_engine_label(g_engine, "info2", BTN2_X, 130, info2);
    yetty_ygui_old_engine_label(g_engine, "info3", BTN3_X, 130, info3);

    /* Test buttons at exact positions */
    struct yetty_ygui_old_widget* btn1 = yetty_ygui_old_engine_button(g_engine, "btn1", BTN1_X, BTN1_Y, BTN1_W, BTN1_H, "BTN1");
    yetty_ygui_old_widget_button_on_click(btn1, on_btn1, NULL);

    struct yetty_ygui_old_widget* btn2 = yetty_ygui_old_engine_button(g_engine, "btn2", BTN2_X, BTN2_Y, BTN2_W, BTN2_H, "BTN2");
    yetty_ygui_old_widget_button_on_click(btn2, on_btn2, NULL);

    struct yetty_ygui_old_widget* btn3 = yetty_ygui_old_engine_button(g_engine, "btn3", BTN3_X, BTN3_Y, BTN3_W, BTN3_H, "BTN3");
    yetty_ygui_old_widget_button_on_click(btn3, on_btn3, NULL);

    /* Instructions */
    yetty_ygui_old_engine_label(g_engine, "instr1", 20, 160, "Click at x=49 (should MISS btn1)");
    yetty_ygui_old_engine_label(g_engine, "instr2", 20, 180, "Click at x=50 (should HIT btn1 left edge)");
    yetty_ygui_old_engine_label(g_engine, "instr3", 20, 200, "Click at x=149 (should HIT btn1 right edge)");
    yetty_ygui_old_engine_label(g_engine, "instr4", 20, 220, "Click at x=150 (should MISS btn1)");

    /* Quit */
    struct yetty_ygui_old_widget* quit = yetty_ygui_old_engine_button(g_engine, "quit", 400, 200, 80, 35, "Quit");
