...
struct [[clang::annotate("class@demoygui:27_yjungle")]] [[clang::annotate("parent@yguiapp:app")]]
yetty_demoygui_27_yjungle {
    int unused;
};
...
YETTY_YRESULT_DECLARE(yetty_demoygui_27_yjungle_ptr, struct yetty_demoygui_27_yjungle *);
                                            ...
                                            struct yetty_yclass_object *root)
{
    ...
    struct yetty_ygui_layout_const_ptr_result layout_res = yetty_ygui_widget_layout_get(jr.value);
...
{
    return yetty_yguiapp_run_main(argc, argv, yetty_demoygui_27_yjungle_class_get().value);
}

#include "yetty/gen/impl/demoygui/27_yjungle/main.c"
