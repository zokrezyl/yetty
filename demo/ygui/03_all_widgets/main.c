...
struct [[clang::annotate("class@demoygui:03_all_widgets")]] [[clang::annotate(
    "parent@yguiapp:app")]] yetty_demoygui_03_all_widgets {
    int unused;
};
...
YETTY_YRESULT_DECLARE(yetty_demoygui_03_all_widgets_ptr, struct yetty_demoygui_03_all_widgets *);
                                            ...
                                            struct yetty_yclass_object *root)
{
    ...
    err_ok(yetty_ygui_progress_set_value(r.value, 0.6f));
    {
        struct yetty_yclass_object *w = r.value;
        {
            struct yetty_ygui_layout_const_ptr_result layout_res5 = yetty_ygui_widget_layout_get(w);
...
{
    return yetty_yguiapp_run_main(argc, argv, yetty_demoygui_03_all_widgets_class_get().value);
}

#include "yetty/gen/impl/demoygui/03_all_widgets/main.c"
