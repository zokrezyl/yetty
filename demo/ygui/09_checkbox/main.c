...
struct [[clang::annotate("class@demoygui:09_checkbox")]] [[clang::annotate("parent@yguiapp:app")]]
yetty_demoygui_09_checkbox {
    int unused;
};
...
YETTY_YRESULT_DECLARE(yetty_demoygui_09_checkbox_ptr, struct yetty_demoygui_09_checkbox *);
                                            ...
                                            struct yetty_yclass_object *root)
{
    ...
    for (size_t i = 0; i < sizeof(labels) / sizeof(labels[0]); ++i) {
        ...
        struct yetty_yclass_object *w = r.value;
        {
            ...
            YETTY_RETURN_IF_ERR(yetty_ycore_void, layout_res, "09_checkbox: layout_get");
...
{
    return yetty_yguiapp_run_main(argc, argv, yetty_demoygui_09_checkbox_class_get().value);
}

#include "yetty/gen/impl/demoygui/09_checkbox/main.c"
