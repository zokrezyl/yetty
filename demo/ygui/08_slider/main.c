...
struct [[clang::annotate("class@demoygui:08_slider")]] [[clang::annotate("parent@yguiapp:app")]]
yetty_demoygui_08_slider {
    int unused;
};
...
YETTY_YRESULT_DECLARE(yetty_demoygui_08_slider_ptr, struct yetty_demoygui_08_slider *);
...
{
    return yetty_yguiapp_run_main(argc, argv, yetty_demoygui_08_slider_class_get().value);
}

#include "yetty/gen/impl/demoygui/08_slider/main.c"
