...
struct [[clang::annotate("class@demoygui:07_label_and_button")]] [[clang::annotate(
    "parent@yguiapp:app")]] yetty_demoygui_07_label_and_button {
    int unused;
};
...
YETTY_YRESULT_DECLARE(yetty_demoygui_07_label_and_button_ptr,
...
{
    return yetty_yguiapp_run_main(argc, argv, yetty_demoygui_07_label_and_button_class_get().value);
}

#include "yetty/gen/impl/demoygui/07_label_and_button/main.c"
