...
struct [[clang::annotate("class@demoygui:15_dashboard")]] [[clang::annotate("parent@yguiapp:app")]]
yetty_demoygui_15_dashboard {
    int unused;
};
...
YETTY_YRESULT_DECLARE(yetty_demoygui_15_dashboard_ptr, struct yetty_demoygui_15_dashboard *);
...
{
    return yetty_yguiapp_run_main(argc, argv, yetty_demoygui_15_dashboard_class_get().value);
}

#include "yetty/gen/impl/demoygui/15_dashboard/main.c"
