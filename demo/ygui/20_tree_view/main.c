...
struct [[clang::annotate("class@demoygui:20_tree_view")]] [[clang::annotate("parent@yguiapp:app")]]
yetty_demoygui_20_tree_view {
    int unused;
};
...
YETTY_YRESULT_DECLARE(yetty_demoygui_20_tree_view_ptr, struct yetty_demoygui_20_tree_view *);
                                            ...
                                            struct yetty_yclass_object *root)
{
    ...
    err_ok(yetty_ygui_tree_node_set_open(tr.value, 1));
    {
        ...
        YETTY_RETURN_IF_ERR(yetty_ycore_void, layout_res, "20_tree_view: layout_get");
...
{
    return yetty_yguiapp_run_main(argc, argv, yetty_demoygui_20_tree_view_class_get().value);
}

#include "yetty/gen/impl/demoygui/20_tree_view/main.c"
