...
struct [[clang::annotate("class@demoygui:13_color_mixer")]] [[clang::annotate(
    "parent@yguiapp:app")]] yetty_demoygui_13_color_mixer {
    int unused;
};
...
YETTY_YRESULT_DECLARE(yetty_demoygui_13_color_mixer_ptr, struct yetty_demoygui_13_color_mixer *);
