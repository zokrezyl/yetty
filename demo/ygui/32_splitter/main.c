...
struct [[clang::annotate("class@demoygui:32_splitter")]] [[clang::annotate("parent@yguiapp:app")]]
yetty_demoygui_32_splitter {
    int unused;
};
...
YETTY_YRESULT_DECLARE(yetty_demoygui_32_splitter_ptr, struct yetty_demoygui_32_splitter *);
