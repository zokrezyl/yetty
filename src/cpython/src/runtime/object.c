...
PyObject *
pyp_new(enum pyp_kind kind, PyTypeObject *type)
{
...
{
    switch (constant_id) {
    case Py_CONSTANT_NONE:     return Py_None;
    case Py_CONSTANT_FALSE:    return Py_False;
    case Py_CONSTANT_TRUE:     return Py_True;
    case Py_CONSTANT_ELLIPSIS: return Py_Ellipsis;
    case Py_CONSTANT_ZERO:     return PyLong_FromLong(0);
    case Py_CONSTANT_ONE:      return PyLong_FromLong(1);
    case Py_CONSTANT_EMPTY_STR:   return PyUnicode_FromString("");
    case Py_CONSTANT_EMPTY_BYTES: return PyBytes_FromStringAndSize("", 0);
    case Py_CONSTANT_EMPTY_TUPLE: return PyTuple_Pack(0);
    default:                   return Py_None;
    }
}

void
_Py_Dealloc(PyObject *o)
{
...
PyObject *PyObject_GetAttr(PyObject *o, PyObject *name) { (void)o; (void)name; return NULL; }
int PyObject_SetAttr(PyObject *o, PyObject *name, PyObject *v) { (void)o; (void)name; (void)v; return 0; }
PyObject *PyObject_CallNoArgs(PyObject *func) { (void)func; return NULL; }
PyObject *PyObject_CallFunction(PyObject *c, const char *fmt, ...) { (void)c; (void)fmt; return NULL; }
PyObject *PyObject_Vectorcall(PyObject *c, PyObject *const *a, size_t n, PyObject *k)
{ (void)c; (void)a; (void)n; (void)k; return NULL; }
PyObject *_PyObject_MakeTpCall(void *ts, PyObject *c, PyObject *const *a, Py_ssize_t n, PyObject *k)
{ (void)ts; (void)c; (void)a; (void)n; (void)k; return NULL; }
PyObject *_Py_CheckFunctionResult(void *ts, PyObject *c, PyObject *result, const char *where)
{ (void)ts; (void)c; (void)where; return result; }
PyObject *PyImport_ImportModuleAttrString(const char *m, const char *a) { (void)m; (void)a; return NULL; }
...
PyThreadState *PyThreadState_Get(void) { return pyp_tstate(); }

int _Py_ReachedRecursionLimitWithMargin(void *tstate, int margin_count)
{ (void)tstate; (void)margin_count; return 0; }   /* never hit the limit */
