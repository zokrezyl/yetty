                          ...
                          void *_resp, size_t _resp_max)
{
    ...
    if (YETTY_IS_ERR(_hr_obj)) {
        yetty_ycore_error_print(stderr,
            "[skel] yetty_ygui_widget_on_press: handle_resolve", _hr_obj.error);
        yetty_ycore_error_destroy(_hr_obj.error);
        if (_resp_max < 1) return 0;
        ((uint8_t *)_resp)[0] = 1;
        return 1;
    }
    struct yetty_ycore_int_result _r = yetty_ygui_widget_on_press(&_local, (struct yetty_yclass_object *)_hr_obj.value, _a.x, _a.y, _a.button);
    if (_resp_max < 1) return 0;
    if (YETTY_IS_ERR(_r)) {
                          ...
                          void *_resp, size_t _resp_max)
{
    ...
    if (YETTY_IS_ERR(_hr_obj)) {
        yetty_ycore_error_print(stderr,
            "[skel] yetty_ygui_widget_on_release: handle_resolve", _hr_obj.error);
        yetty_ycore_error_destroy(_hr_obj.error);
        if (_resp_max < 1) return 0;
        ((uint8_t *)_resp)[0] = 1;
        return 1;
    }
    struct yetty_ycore_int_result _r = yetty_ygui_widget_on_release(&_local, (struct yetty_yclass_object *)_hr_obj.value, _a.x, _a.y, _a.button);
    if (_resp_max < 1) return 0;
    if (YETTY_IS_ERR(_r)) {
                          ...
                          void *_resp, size_t _resp_max)
{
    ...
    if (YETTY_IS_ERR(_hr_obj)) {
        yetty_ycore_error_print(stderr,
            "[skel] yetty_ygui_widget_emit_body: handle_resolve", _hr_obj.error);
        yetty_ycore_error_destroy(_hr_obj.error);
        if (_resp_max < 1) return 0;
        ((uint8_t *)_resp)[0] = 1;
        return 1;
    ...
    if (YETTY_IS_ERR(_hr_emit_ctx)) {
        yetty_ycore_error_print(stderr,
            "[skel] yetty_ygui_widget_emit_body: handle_resolve", _hr_emit_ctx.error);
        yetty_ycore_error_destroy(_hr_emit_ctx.error);
        if (_resp_max < 1) return 0;
        ((uint8_t *)_resp)[0] = 1;
        return 1;
    }
    struct yetty_ycore_void_result _r = yetty_ygui_widget_emit_body(&_local, (struct yetty_yclass_object *)_hr_obj.value, (struct yetty_ygui_emit_ctx *)_hr_emit_ctx.value);
    if (_resp_max < 1) return 0;
    if (YETTY_IS_ERR(_r)) {
