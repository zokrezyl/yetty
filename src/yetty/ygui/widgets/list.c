                                           ...
                                           struct yetty_yclass_object *yclass_obj)
{
    ...
    struct yetty_ycore_void_result sr = yetty_ygui_super_void(
        obj, yetty_ygui_class_expect(yetty_ygui_list_class_get(), "yetty_ygui_list_class_get"),
...
int yetty_ygui_list_get_selected(const struct yetty_ygui_object *obj)
{
    ...
    return ((struct list_data *)yetty_ygui_data_get(
                ...
                yetty_ygui_class_expect(yetty_ygui_list_class_get(), "yetty_ygui_list_class_get")))
        ->selected;
}
