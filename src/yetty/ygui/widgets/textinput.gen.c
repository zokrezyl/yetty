...
struct yetty_yclass_ptr_result yetty_ygui_textinput_class_get(void)
{
    ...
    if (YETTY_IS_ERR(mixin_class_r_0)) {
        yerror("yetty_ygui_textinput_class_get: mixin0 accessor failed: %s",
               mixin_class_r_0.error.msg);
        return YETTY_ERR(yetty_yclass_ptr, "yetty_ygui_textinput_class_get: mixin0 accessor failed",
                         mixin_class_r_0);
    }
...
/* ---- ygui/textinput: class name -> accessor ---------------------- */
...
struct yetty_ycore_void_result yetty_ygui_textinput_register_hooks(void)
{
    ...
    YETTY_RETURN_IF_ERR(yetty_ycore_void, add_accessor_r,
                        "yetty_ygui_textinput_register_hooks: accessor");
