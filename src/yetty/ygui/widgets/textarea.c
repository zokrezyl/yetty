...
struct [[clang::annotate("class@ygui:textarea")]] [[clang::annotate(
    "parent@ygui:primitive_widget")]] textarea_data {
    char *text;
};
                                           ...
                                           struct yetty_yclass_object *yclass_obj)
{
    ...
    struct yetty_ycore_void_result sr = yetty_ygui_super_void(
        obj,
        yetty_ygui_textarea_class_get().value,
    ...
    struct textarea_data *d = d_dr.value;
    d->text = NULL;
...
[[clang::annotate("expose")]]
struct yetty_ycore_const_char_ptr_result yetty_ygui_textarea_get_text(const struct yetty_ygui_object *obj)
{
    if (!obj) {
        return YETTY_OK(yetty_ycore_const_char_ptr, "");
    }
    struct yetty_ygui_void_ptr_result d_dr = yetty_ygui_data_get_result((struct yetty_ygui_object *)obj, yetty_ygui_textarea_class_get().value);
