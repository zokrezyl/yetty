...
struct [[clang::annotate("class@ygui:ynodes")]] [[clang::annotate(
    "parent@ygui:primitive_widget")]] nodes_data {
    float pan_x, pan_y;
    float zoom;
...
{
    return yetty_ygui_class_expect(yetty_ygui_ynodes_class_get(), "yetty_ygui_ynodes_class_get");
}
