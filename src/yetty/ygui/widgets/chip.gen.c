...
struct yetty_ygui_chip_data_ptr_result yetty_ygui_chip_data(struct yetty_ygui_object *obj)
{
    ...
    if (YETTY_IS_ERR(class_r)) {
        yerror("yetty_ygui_chip_data: class accessor failed: %s", class_r.error.msg);
        return YETTY_ERR(yetty_ygui_chip_data_ptr, "yetty_ygui_chip_data: class accessor failed", class_r);
    }
