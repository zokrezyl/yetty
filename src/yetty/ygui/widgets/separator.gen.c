...
struct yetty_yclass_object *yetty_ygui_separator_to(struct yetty_ygui_separator *data)
{
    if (!data) {
        return NULL;
    }
...
/* ---- ygui/separator: class name -> accessor ---------------------- */
...
struct yetty_ycore_void_result yetty_ygui_separator_register_hooks(void)
{
    ...
    YETTY_RETURN_IF_ERR(yetty_ycore_void, add_accessor_r,
                        "yetty_ygui_separator_register_hooks: accessor");
