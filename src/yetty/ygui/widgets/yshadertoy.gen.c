...
[[maybe_unused]]
static yetty_ygui_widget_emit_container_fn yetty_ygui_yshadertoy_yetty_ygui_widget_emit_container_check = emit_container;
[[maybe_unused]]
static yetty_ygui_widget_emit_body_fn yetty_ygui_yshadertoy_yetty_ygui_widget_emit_body_check = emit_body;
...
struct yetty_yclass_ptr_result yetty_ygui_yshadertoy_class_get(void)
{
    ...
    if (YETTY_IS_ERR(parent_class_r)) {
        yerror("yetty_ygui_yshadertoy_class_get: parent accessor failed: %s", parent_class_r.error.msg);
        return YETTY_ERR(yetty_yclass_ptr, "yetty_ygui_yshadertoy_class_get: parent accessor failed", parent_class_r);
    }
    struct yetty_yclass_ptr_result register_class_r =
        yetty_yclass_register(&desc, ops, sizeof(ops) / sizeof(ops[0]),
                              parent_class_r.value, NULL, 0);
    if (YETTY_IS_ERR(register_class_r)) {
        yerror("yetty_ygui_yshadertoy_class_get: class_register failed: %s", register_class_r.error.msg);
        return YETTY_ERR(yetty_yclass_ptr, "yetty_ygui_yshadertoy_class_get: class_register failed", register_class_r);
    }
...
struct yetty_ygui_yshadertoy_ptr_result yetty_ygui_yshadertoy_from(struct yetty_yclass_object *obj)
{
    ...
    if (YETTY_IS_ERR(class_r))
        return YETTY_ERR(yetty_ygui_yshadertoy_ptr, "yetty_ygui_yshadertoy_from: class accessor", class_r);
    struct yetty_yclass_void_ptr_result slice_r =
        yetty_yclass_object_data(obj, class_r.value);
    if (YETTY_IS_ERR(slice_r))
        return YETTY_ERR(yetty_ygui_yshadertoy_ptr, "yetty_ygui_yshadertoy_from: object_data", slice_r);
