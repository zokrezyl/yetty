...
struct yetty_ycore_int_result yetty_ygui_widget_on_press(struct yetty_yclass_ctx * ctx, struct yetty_yclass_object * obj, float x, float y, int button)
{
...
#pragma pack(pop)
        ...
        return ((yetty_ygui_widget_on_press_fn)dispatch_impl_r.value)(ctx, obj, x, y, button);
    }
}

struct yetty_ycore_int_result yetty_ygui_widget_on_release(struct yetty_yclass_ctx * ctx, struct yetty_yclass_object * obj, float x, float y, int button)
{
    static yetty_yclass_method_slot method_slot = YETTY_YCLASS_METHOD_SLOT_UNDEFINED;
    if (method_slot == YETTY_YCLASS_METHOD_SLOT_UNDEFINED) {
        struct yetty_yclass_method_slot_result method_slot_r =
...
#pragma pack(pop)
        ...
        return ((yetty_ygui_widget_on_release_fn)dispatch_impl_r.value)(ctx, obj, x, y, button);
    }
}
...
struct yetty_ycore_void_result yetty_ygui_widget_emit_body(struct yetty_yclass_ctx * ctx, struct yetty_yclass_object * obj, struct yetty_ygui_emit_ctx * emit_ctx)
{
    static yetty_yclass_method_slot method_slot = YETTY_YCLASS_METHOD_SLOT_UNDEFINED;
    if (method_slot == YETTY_YCLASS_METHOD_SLOT_UNDEFINED) {
        struct yetty_yclass_method_slot_result method_slot_r =
    ...
    return ((yetty_ygui_widget_emit_body_fn)dispatch_impl_r.value)(ctx, obj, emit_ctx);
}
