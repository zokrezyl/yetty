...
/* ---- ygui/widget: class name -> accessor ---------------------- */
...
struct yetty_ycore_void_result yetty_ygui_widget_register_hooks(void)
{
    ...
    YETTY_RETURN_IF_ERR(yetty_ycore_void, add_accessor_r,
                        "yetty_ygui_widget_register_hooks: accessor");
    {
        struct yetty_ycore_void_result add_skel_r =
            yetty_yclass_rpc_add_skel_lookup(yetty_ygui_widget_skel_lookup);
        YETTY_RETURN_IF_ERR(yetty_ycore_void, add_skel_r, "yetty_ygui_widget_register_hooks: skel");
    }
    return YETTY_OK_VOID();
}
