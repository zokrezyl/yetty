...
struct yetty_yclass_ptr_result yetty_ygui_widget_class_get(void)
{
    ...
    if (YETTY_IS_ERR(register_class_r)) {
        yerror("yetty_ygui_widget_class_get: class_register failed: %s", register_class_r.error.msg);
...
struct yetty_ycore_int_result yetty_ygui_widget_on_press(struct yetty_yclass_object * obj, float x, float y, int button)
{
    ...
    if (!obj) return YETTY_ERR(yetty_ycore_int, "yetty_ygui_widget_on_press: NULL object");
...
#pragma pack(push, 1)
        struct {
            ...
            float y;
            int button;
        } wire_args = { container_of((struct yetty_yclass_object *)obj, struct yetty_yclass_proxy, header)->handle, x, y, button };
#pragma pack(pop)
        uint8_t *resp_buf = NULL;
        size_t response_len = 0;
        struct yetty_ycore_void_result rpc_call_r = yetty_yclass_rpc_call_alloc(
        ...
        if (resp_buf[0] != 0) {
            ...
            struct yetty_ycore_int_result remote_error =
                YETTY_ERR(yetty_ycore_int, "yetty_ygui_widget_on_press: remote impl returned error");
            remote_error.error.cause = remote_chain;
            return remote_error;
        }
...
struct yetty_ycore_int_result yetty_ygui_widget_on_release(struct yetty_yclass_object * obj, float x, float y, int button)
{
    ...
    if (!obj) return YETTY_ERR(yetty_ycore_int, "yetty_ygui_widget_on_release: NULL object");
...
#pragma pack(pop)
        ...
        if (resp_buf[0] != 0) {
            ...
            free(resp_buf);
            struct yetty_ycore_int_result remote_error =
                YETTY_ERR(yetty_ycore_int, "yetty_ygui_widget_on_release: remote impl returned error");
            remote_error.error.cause = remote_chain;
            return remote_error;
        }
        if (response_len != 1 + sizeof(int)) {
            free(resp_buf);
            return YETTY_ERR(yetty_ycore_int, "yetty_ygui_widget_on_release: truncated RPC payload");
        }
        int return_value;
        memcpy(&return_value, resp_buf + 1, sizeof(return_value));
        free(resp_buf);
...
#pragma pack(pop)
        ...
        if (resp_buf[0] != 0) {
            ...
            free(resp_buf);
            struct yetty_ycore_int_result remote_error =
                YETTY_ERR(yetty_ycore_int, "yetty_ygui_widget_on_motion: remote impl returned error");
            remote_error.error.cause = remote_chain;
            return remote_error;
        }
        if (response_len != 1 + sizeof(int)) {
...
struct yetty_ycore_void_result yetty_ygui_widget_emit_body(struct yetty_yclass_object * obj, struct yetty_ygui_emit_ctx * emit_ctx)
{
    ...
    if (!obj) return YETTY_ERR(yetty_ycore_void, "yetty_ygui_widget_emit_body: NULL object");
...
struct yetty_ycore_int_result yetty_ygui_widget_on_scroll(struct yetty_yclass_object * obj, float x, float y, float dx, float dy)
{
    ...
    if (method_slot == YETTY_YCLASS_METHOD_SLOT_UNDEFINED) {
        struct yetty_yclass_method_slot_result method_slot_r =
            yetty_yclass_method_slot_get("yetty_ygui", (yetty_yclass_method_id_t)yetty_ygui_widget_on_scroll);
        if (YETTY_IS_ERR(method_slot_r))
            return YETTY_ERR(yetty_ycore_int, "yetty_ygui_widget_on_scroll: method_slot_get failed", method_slot_r);
        method_slot = method_slot_r.value;
    }

    if (!obj) return YETTY_ERR(yetty_ycore_int, "yetty_ygui_widget_on_scroll: NULL object");

    if (obj->session) {
        struct uint32_result remote_id_r =
            yetty_yclass_rpc_session_ensure_remote_id(obj->session, method_slot);
        YETTY_RETURN_IF_ERR(yetty_ycore_int, remote_id_r, "yetty_ygui_widget_on_scroll: ensure_remote_id failed");
        uint32_t remote_id = remote_id_r.value;
/* Byte-exact wire layout — #pragma pack matches the first-party
 * convention (yvnc/ydvnc/libvterm) and compiles on MSVC, unlike a GNU
 * packed attribute. */
#pragma pack(push, 1)
        struct {
            ...
            float dx;
            float dy;
        } wire_args = { container_of((struct yetty_yclass_object *)obj, struct yetty_yclass_proxy, header)->handle, x, y, dx, dy };
#pragma pack(pop)
        uint8_t *resp_buf = NULL;
        size_t response_len = 0;
        struct yetty_ycore_void_result rpc_call_r = yetty_yclass_rpc_call_alloc(
            obj->session, YETTY_YCLASS_RPC_OP_CALL, remote_id, &wire_args, sizeof(wire_args),
            &resp_buf, &response_len);
        YETTY_RETURN_IF_ERR(yetty_ycore_int, rpc_call_r, "yetty_ygui_widget_on_scroll: RPC call failed");
        if (response_len < 1) {
            free(resp_buf);
        ...
        if (resp_buf[0] != 0) {
            ...
            free(resp_buf);
            struct yetty_ycore_int_result remote_error =
                YETTY_ERR(yetty_ycore_int, "yetty_ygui_widget_on_scroll: remote impl returned error");
            remote_error.error.cause = remote_chain;
            return remote_error;
        }
        if (response_len != 1 + sizeof(int)) {
        ...
        struct yetty_yclass_ptr_result object_class_r =
            yetty_yclass_object_class(obj);
        YETTY_RETURN_IF_ERR(yetty_ycore_int, object_class_r, "yetty_ygui_widget_on_scroll: object_class failed");
        struct yetty_yclass_impl_t_result dispatch_impl_r =
            yetty_yclass_dispatch_lookup(object_class_r.value, method_slot);
        YETTY_RETURN_IF_ERR(yetty_ycore_int, dispatch_impl_r, "yetty_ygui_widget_on_scroll: dispatch_lookup failed");
...
size_t yetty_ygui_constructor_skel(const void *body, size_t body_len,
...
#pragma pack(pop)
    ...
    struct yetty_ycore_void_result call_r = yetty_ygui_constructor((struct yetty_yclass_object *)obj_resolve_r.value);
...
YETTY_EXTERNAL_CALLBACK
size_t yetty_ygui_destructor_skel(const void *body, size_t body_len,
                   void *resp, size_t resp_max)
{
/* Byte-exact wire layout — #pragma pack matches the first-party
 * convention (yvnc/ydvnc/libvterm) and compiles on MSVC, unlike a GNU
...
#pragma pack(pop)
    ...
    struct yetty_ycore_void_result call_r = yetty_ygui_destructor((struct yetty_yclass_object *)obj_resolve_r.value);
    if (resp_max < 1) return 0;
    if (YETTY_IS_ERR(call_r)) {
...
YETTY_EXTERNAL_CALLBACK
size_t yetty_ygui_widget_on_press_skel(const void *body, size_t body_len,
                   void *resp, size_t resp_max)
{
/* Byte-exact wire layout — #pragma pack matches the first-party
 * convention (yvnc/ydvnc/libvterm) and compiles on MSVC, unlike a GNU
...
#pragma pack(pop)
    ...
    struct yetty_ycore_int_result call_r = yetty_ygui_widget_on_press((struct yetty_yclass_object *)obj_resolve_r.value, wire_args.x, wire_args.y, wire_args.button);
    if (resp_max < 1) return 0;
    if (YETTY_IS_ERR(call_r)) {
...
YETTY_EXTERNAL_CALLBACK
size_t yetty_ygui_widget_on_release_skel(const void *body, size_t body_len,
                   void *resp, size_t resp_max)
{
/* Byte-exact wire layout — #pragma pack matches the first-party
 * convention (yvnc/ydvnc/libvterm) and compiles on MSVC, unlike a GNU
...
#pragma pack(pop)
    ...
    struct yetty_ycore_int_result call_r = yetty_ygui_widget_on_release((struct yetty_yclass_object *)obj_resolve_r.value, wire_args.x, wire_args.y, wire_args.button);
    if (resp_max < 1) return 0;
    if (YETTY_IS_ERR(call_r)) {
...
YETTY_EXTERNAL_CALLBACK
size_t yetty_ygui_widget_on_motion_skel(const void *body, size_t body_len,
                   void *resp, size_t resp_max)
{
/* Byte-exact wire layout — #pragma pack matches the first-party
 * convention (yvnc/ydvnc/libvterm) and compiles on MSVC, unlike a GNU
...
#pragma pack(pop)
    ...
    struct yetty_ycore_int_result call_r = yetty_ygui_widget_on_motion((struct yetty_yclass_object *)obj_resolve_r.value, wire_args.x, wire_args.y);
    if (resp_max < 1) return 0;
    if (YETTY_IS_ERR(call_r)) {
...
YETTY_EXTERNAL_CALLBACK
size_t yetty_ygui_widget_on_scroll_skel(const void *body, size_t body_len,
                   void *resp, size_t resp_max)
{
/* Byte-exact wire layout — #pragma pack matches the first-party
 * convention (yvnc/ydvnc/libvterm) and compiles on MSVC, unlike a GNU
...
#pragma pack(pop)
    ...
    struct yetty_ycore_int_result call_r = yetty_ygui_widget_on_scroll((struct yetty_yclass_object *)obj_resolve_r.value, wire_args.x, wire_args.y, wire_args.dx, wire_args.dy);
    if (resp_max < 1) return 0;
    if (YETTY_IS_ERR(call_r)) {
