...
static void yzoo_emit_shape(struct yetty_ydraw_draw_list *buf, uint32_t z_order, int choice,
...
static uint32_t yzoo_emit_curve(struct yetty_ydraw_draw_list *buf, uint32_t z_order, float p0x,
