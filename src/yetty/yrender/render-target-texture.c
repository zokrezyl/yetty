...
struct yetty_yrender_render_target_texture {
    struct yetty_ydraw_core_target base; /* viewport stored here */
    WGPUDevice device;
    WGPUQueue queue;
...
static void render_target_texture_destroy(struct yetty_ydraw_core_target *self)
{
...
static WGPUTextureView render_target_texture_get_view(const struct yetty_ydraw_core_target *self)
{
...
static WGPUTexture render_target_texture_get_texture(const struct yetty_ydraw_core_target *self)
{
    const struct yetty_yrender_render_target_texture *rt =
        (const struct yetty_yrender_render_target_texture *)self;
    return rt->texture;
...
static struct yetty_ycore_void_result render_target_texture_set_visual_zoom(
    struct yetty_ydraw_core_target *self, float scale, float offset_x, float offset_y)
{
    struct yetty_yrender_render_target_texture *rt =
        (struct yetty_yrender_render_target_texture *)self;
    if (!(scale > 0.0f)) {
