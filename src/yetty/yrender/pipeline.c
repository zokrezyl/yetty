...
struct flatten_state {
    ...
    const struct yetty_ypaint_core_gpu_resource_set *visited[MAX_VISITED_RS];
...
static void collect(struct flatten_state *st, const struct yetty_ypaint_core_gpu_resource_set *rs)
{
...
struct yetty_yrender_pipeline_ptr_result yetty_yrender_pipeline_create(
    ...
    struct yetty_ypaint_core_gpu_allocator *allocator,
    const struct yetty_ypaint_core_gpu_resource_set *template_rs)
{
