...
struct yetty_yrender_render_target_vnc {
    ...
    struct yetty_ydraw_core_target *inner; /* Texture target for actual rendering */
...
static void render_target_vnc_destroy(struct yetty_ydraw_core_target *self)
{
...
static struct yetty_ycore_void_result render_target_vnc_clear(struct yetty_ydraw_core_target *self)
{
    struct yetty_yrender_render_target_vnc *rt = (struct yetty_yrender_render_target_vnc *)self;
...
static struct yetty_ycore_void_result render_target_vnc_blend(
    struct yetty_ydraw_core_target *self, struct yetty_ydraw_core_target **sources, size_t count)
{
    struct yetty_yrender_render_target_vnc *rt = (struct yetty_yrender_render_target_vnc *)self;
    return rt->inner->ops->blend(rt->inner, sources, count);
}

static WGPUTextureView render_target_vnc_get_view(const struct yetty_ydraw_core_target *self)
{
    const struct yetty_yrender_render_target_vnc *rt =
        (const struct yetty_yrender_render_target_vnc *)self;
    return rt->inner->ops->get_view(rt->inner);
}

static WGPUTexture render_target_vnc_get_texture(const struct yetty_ydraw_core_target *self)
{
    const struct yetty_yrender_render_target_vnc *rt =
        (const struct yetty_yrender_render_target_vnc *)self;
...
static struct yetty_ycore_void_result render_target_vnc_resize(
    struct yetty_ydraw_core_target *self, struct yetty_yrender_viewport viewport)
{
    struct yetty_yrender_render_target_vnc *rt = (struct yetty_yrender_render_target_vnc *)self;
...
static struct yetty_ycore_void_result render_target_vnc_present(
    struct yetty_ydraw_core_target *self)
{
    struct yetty_yrender_render_target_vnc *rt = (struct yetty_yrender_render_target_vnc *)self;
...
static bool render_target_vnc_is_busy(const struct yetty_ydraw_core_target *self)
{
    const struct yetty_yrender_render_target_vnc *rt =
        (const struct yetty_yrender_render_target_vnc *)self;
...
static void render_target_vnc_notify_render_skipped(struct yetty_ydraw_core_target *self)
{
    struct yetty_yrender_render_target_vnc *rt = (struct yetty_yrender_render_target_vnc *)self;
    if (rt->vnc_server) {
