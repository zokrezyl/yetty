    ...
    struct yetty_yclass_object *obj, const char *data_json, const char *metadata_json)
{
    ...
    if (method_slot == YETTY_YCLASS_METHOD_SLOT_UNDEFINED) {
        ...
        if (YETTY_IS_ERR(method_slot_r)) {
            return YETTY_ERR(yetty_ycore_void,
                             "yetty_ynotebook_mime_bundle_from_json_text: method_slot_get failed",
                             method_slot_r);
        }
    ...
    if (!obj) {
        return YETTY_ERR(yetty_ycore_void,
                         "yetty_ynotebook_mime_bundle_from_json_text: NULL object");
    }
    ...
    YETTY_RETURN_IF_ERR(yetty_ycore_void, object_class_r,
                        "yetty_ynotebook_mime_bundle_from_json_text: object_class failed");
    struct yetty_yclass_impl_t_result dispatch_impl_r =
        yetty_yclass_dispatch_lookup(object_class_r.value, method_slot);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, dispatch_impl_r,
                        "yetty_ynotebook_mime_bundle_from_json_text: dispatch_lookup failed");
    return ((yetty_ynotebook_mime_bundle_from_json_text_fn)dispatch_impl_r.value)(obj, data_json,
                                                                                  metadata_json);
}
    ...
    struct yetty_yclass_object *obj)
{
    ...
    if (method_slot == YETTY_YCLASS_METHOD_SLOT_UNDEFINED) {
        struct yetty_yclass_method_slot_result method_slot_r = yetty_yclass_method_slot_get(
            "yetty_ynotebook", (yetty_yclass_method_id_t)yetty_ynotebook_mime_bundle_to_json_text);
        if (YETTY_IS_ERR(method_slot_r)) {
            return YETTY_ERR(yetty_ycore_char_ptr,
                             "yetty_ynotebook_mime_bundle_to_json_text: method_slot_get failed",
                             method_slot_r);
        }
        method_slot = method_slot_r.value;
    }
    ...
    if (!obj) {
        return YETTY_ERR(yetty_ycore_char_ptr,
                         "yetty_ynotebook_mime_bundle_to_json_text: NULL object");
    }

    struct yetty_yclass_ptr_result object_class_r = yetty_yclass_object_class(obj);
    YETTY_RETURN_IF_ERR(yetty_ycore_char_ptr, object_class_r,
                        "yetty_ynotebook_mime_bundle_to_json_text: object_class failed");
    struct yetty_yclass_impl_t_result dispatch_impl_r =
        yetty_yclass_dispatch_lookup(object_class_r.value, method_slot);
    YETTY_RETURN_IF_ERR(yetty_ycore_char_ptr, dispatch_impl_r,
                        "yetty_ynotebook_mime_bundle_to_json_text: dispatch_lookup failed");
...
struct yetty_ycore_size_result yetty_ynotebook_mime_bundle_count(struct yetty_yclass_object *obj)
{
    ...
    if (method_slot == YETTY_YCLASS_METHOD_SLOT_UNDEFINED) {
        struct yetty_yclass_method_slot_result method_slot_r = yetty_yclass_method_slot_get(
            "yetty_ynotebook", (yetty_yclass_method_id_t)yetty_ynotebook_mime_bundle_count);
        if (YETTY_IS_ERR(method_slot_r)) {
            return YETTY_ERR(yetty_ycore_size,
                             "yetty_ynotebook_mime_bundle_count: method_slot_get failed",
                             method_slot_r);
        }
        method_slot = method_slot_r.value;
    }
    ...
    if (!obj) {
        return YETTY_ERR(yetty_ycore_size, "yetty_ynotebook_mime_bundle_count: NULL object");
    }

    struct yetty_yclass_ptr_result object_class_r = yetty_yclass_object_class(obj);
    YETTY_RETURN_IF_ERR(yetty_ycore_size, object_class_r,
                        "yetty_ynotebook_mime_bundle_count: object_class failed");
    struct yetty_yclass_impl_t_result dispatch_impl_r =
        yetty_yclass_dispatch_lookup(object_class_r.value, method_slot);
    YETTY_RETURN_IF_ERR(yetty_ycore_size, dispatch_impl_r,
                        "yetty_ynotebook_mime_bundle_count: dispatch_lookup failed");
    ...
    struct yetty_yclass_object *obj, size_t index)
{
    ...
    if (method_slot == YETTY_YCLASS_METHOD_SLOT_UNDEFINED) {
        struct yetty_yclass_method_slot_result method_slot_r = yetty_yclass_method_slot_get(
            "yetty_ynotebook", (yetty_yclass_method_id_t)yetty_ynotebook_mime_bundle_mime_at);
        if (YETTY_IS_ERR(method_slot_r)) {
            return YETTY_ERR(yetty_ycore_const_char_ptr,
                             "yetty_ynotebook_mime_bundle_mime_at: method_slot_get failed",
                             method_slot_r);
        }
        method_slot = method_slot_r.value;
    }
    ...
    if (!obj) {
        return YETTY_ERR(yetty_ycore_const_char_ptr,
                         "yetty_ynotebook_mime_bundle_mime_at: NULL object");
    }

    struct yetty_yclass_ptr_result object_class_r = yetty_yclass_object_class(obj);
    YETTY_RETURN_IF_ERR(yetty_ycore_const_char_ptr, object_class_r,
                        "yetty_ynotebook_mime_bundle_mime_at: object_class failed");
    struct yetty_yclass_impl_t_result dispatch_impl_r =
        yetty_yclass_dispatch_lookup(object_class_r.value, method_slot);
    YETTY_RETURN_IF_ERR(yetty_ycore_const_char_ptr, dispatch_impl_r,
                        "yetty_ynotebook_mime_bundle_mime_at: dispatch_lookup failed");
    ...
    struct yetty_yclass_object *obj, size_t index)
{
    ...
    if (method_slot == YETTY_YCLASS_METHOD_SLOT_UNDEFINED) {
        struct yetty_yclass_method_slot_result method_slot_r = yetty_yclass_method_slot_get(
            "yetty_ynotebook", (yetty_yclass_method_id_t)yetty_ynotebook_mime_bundle_kind_at);
        if (YETTY_IS_ERR(method_slot_r)) {
            return YETTY_ERR(yetty_ycore_const_char_ptr,
                             "yetty_ynotebook_mime_bundle_kind_at: method_slot_get failed",
                             method_slot_r);
        }
        method_slot = method_slot_r.value;
    }
    ...
    if (!obj) {
        return YETTY_ERR(yetty_ycore_const_char_ptr,
                         "yetty_ynotebook_mime_bundle_kind_at: NULL object");
    }

    struct yetty_yclass_ptr_result object_class_r = yetty_yclass_object_class(obj);
    YETTY_RETURN_IF_ERR(yetty_ycore_const_char_ptr, object_class_r,
                        "yetty_ynotebook_mime_bundle_kind_at: object_class failed");
    struct yetty_yclass_impl_t_result dispatch_impl_r =
        yetty_yclass_dispatch_lookup(object_class_r.value, method_slot);
    YETTY_RETURN_IF_ERR(yetty_ycore_const_char_ptr, dispatch_impl_r,
                        "yetty_ynotebook_mime_bundle_kind_at: dispatch_lookup failed");
                                                                    ...
                                                                    size_t *out_len)
{
    ...
    if (method_slot == YETTY_YCLASS_METHOD_SLOT_UNDEFINED) {
        struct yetty_yclass_method_slot_result method_slot_r = yetty_yclass_method_slot_get(
            "yetty_ynotebook", (yetty_yclass_method_id_t)yetty_ynotebook_mime_bundle_bytes_at);
        if (YETTY_IS_ERR(method_slot_r)) {
            return YETTY_ERR(yetty_ycore_void,
                             "yetty_ynotebook_mime_bundle_bytes_at: method_slot_get failed",
                             method_slot_r);
        }
        method_slot = method_slot_r.value;
    }
    ...
    if (!obj) {
        return YETTY_ERR(yetty_ycore_void, "yetty_ynotebook_mime_bundle_bytes_at: NULL object");
    }

    struct yetty_yclass_ptr_result object_class_r = yetty_yclass_object_class(obj);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, object_class_r,
                        "yetty_ynotebook_mime_bundle_bytes_at: object_class failed");
    struct yetty_yclass_impl_t_result dispatch_impl_r =
        yetty_yclass_dispatch_lookup(object_class_r.value, method_slot);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, dispatch_impl_r,
                        "yetty_ynotebook_mime_bundle_bytes_at: dispatch_lookup failed");
    return ((yetty_ynotebook_mime_bundle_bytes_at_fn)dispatch_impl_r.value)(obj, index, out_bytes,
                                                                            out_len);
}
    ...
    struct yetty_yclass_object *obj, size_t index)
{
    ...
    if (method_slot == YETTY_YCLASS_METHOD_SLOT_UNDEFINED) {
        struct yetty_yclass_method_slot_result method_slot_r = yetty_yclass_method_slot_get(
            "yetty_ynotebook", (yetty_yclass_method_id_t)yetty_ynotebook_mime_bundle_json_at);
        if (YETTY_IS_ERR(method_slot_r)) {
            return YETTY_ERR(yetty_ycore_char_ptr,
                             "yetty_ynotebook_mime_bundle_json_at: method_slot_get failed",
                             method_slot_r);
        }
        method_slot = method_slot_r.value;
    }
    ...
    if (!obj) {
        return YETTY_ERR(yetty_ycore_char_ptr, "yetty_ynotebook_mime_bundle_json_at: NULL object");
    }

    struct yetty_yclass_ptr_result object_class_r = yetty_yclass_object_class(obj);
    YETTY_RETURN_IF_ERR(yetty_ycore_char_ptr, object_class_r,
                        "yetty_ynotebook_mime_bundle_json_at: object_class failed");
    struct yetty_yclass_impl_t_result dispatch_impl_r =
        yetty_yclass_dispatch_lookup(object_class_r.value, method_slot);
    YETTY_RETURN_IF_ERR(yetty_ycore_char_ptr, dispatch_impl_r,
                        "yetty_ynotebook_mime_bundle_json_at: dispatch_lookup failed");
...
struct yetty_ycore_void_result yetty_ynotebook_mime_bundle_destroy(struct yetty_yclass_object *obj)
{
    ...
    if (method_slot == YETTY_YCLASS_METHOD_SLOT_UNDEFINED) {
        struct yetty_yclass_method_slot_result method_slot_r = yetty_yclass_method_slot_get(
            "yetty_ynotebook", (yetty_yclass_method_id_t)yetty_ynotebook_mime_bundle_destroy);
        if (YETTY_IS_ERR(method_slot_r)) {
            return YETTY_ERR(yetty_ycore_void,
                             "yetty_ynotebook_mime_bundle_destroy: method_slot_get failed",
                             method_slot_r);
        }
        method_slot = method_slot_r.value;
    }
    ...
    if (!obj) {
        return YETTY_ERR(yetty_ycore_void, "yetty_ynotebook_mime_bundle_destroy: NULL object");
    }

    struct yetty_yclass_ptr_result object_class_r = yetty_yclass_object_class(obj);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, object_class_r,
                        "yetty_ynotebook_mime_bundle_destroy: object_class failed");
    struct yetty_yclass_impl_t_result dispatch_impl_r =
        yetty_yclass_dispatch_lookup(object_class_r.value, method_slot);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, dispatch_impl_r,
                        "yetty_ynotebook_mime_bundle_destroy: dispatch_lookup failed");
    ...
    struct yetty_yclass_ctx *ctx)
{
     ...
     * response isn't silently swallowed. */
    {
        ...
        if (YETTY_IS_ERR(translate_class_r)) {
            yetty_ycore_error_print(stderr,
                                    "yetty_ynotebook_mime_bundle_create: translate_class (degraded "
                                    "— will lazy-resolve)",
    ...
    if (!proxy) {
        return YETTY_ERR(yetty_yclass_object_ptr,
                         "yetty_ynotebook_mime_bundle_create: calloc(proxy) failed");
    }
