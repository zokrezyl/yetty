                                                       ...
                                                       uint32_t flags)
{
    ...
    return ((yetty_ychrome_configure_fn)dispatch_impl_r.value)(ctx, obj, window_manager,
...
struct yetty_yclass_object_ptr_result yetty_ychrome_chrome_create(struct yetty_yclass_ctx *ctx)
{
    ...
    if (YETTY_IS_ERR(create_call_r)) {
        return YETTY_ERR(yetty_yclass_object_ptr, "yetty_ychrome_chrome_create: CREATE call failed",
                         create_call_r);
    }
    ...
    if (!proxy) {
        return YETTY_ERR(yetty_yclass_object_ptr,
                         "yetty_ychrome_chrome_create: calloc(proxy) failed");
    }
...
/* ---- ychrome/chrome: class name -> accessor ---------------------- */
static struct yetty_yclass_ptr_result yetty_ychrome_chrome_accessor_lookup(const char *name)
{
...
struct yetty_ycore_void_result yetty_ychrome_chrome_register_hooks(void)
{
    struct yetty_ycore_void_result add_accessor_r =
        yetty_yclass_add_accessor_lookup(yetty_ychrome_chrome_accessor_lookup);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, add_accessor_r,
                        "yetty_ychrome_chrome_register_hooks: accessor");
...
struct yetty_ycore_void_result yetty_ychrome_register(void)
{
    ...
    {
        struct yetty_ycore_void_result hook_r = yetty_ychrome_chrome_register_hooks();
        YETTY_RETURN_IF_ERR(yetty_ycore_void, hook_r, "yetty_ychrome_register: chrome");
    }
    registered = true;
    return YETTY_OK_VOID();
}
