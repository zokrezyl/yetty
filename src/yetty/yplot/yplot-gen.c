...
struct yetty_yetty_yplot_factory {
...
static struct yetty_yetty_yplot_factory *yetty_yetty_yplot_factory_from_base(struct yetty_ypaint_core_concrete_factory *base)
{
    return (struct yetty_yetty_yplot_factory *)base;
}
                       ...
                       struct yetty_yrender_target *target, float x, float y)
{
    ...
    struct yetty_yetty_yplot_factory *factory = yetty_yetty_yplot_factory_from_base(self->factory);
    if (!factory->pipeline)
...
yplot_compile_pipeline(struct yetty_ypaint_core_concrete_factory *self,
                        ...
                        struct yetty_yrender_gpu_allocator *allocator)
{
    struct yetty_yetty_yplot_factory *factory = yetty_yetty_yplot_factory_from_base(self);
...
struct yetty_ypaint_core_concrete_factory *yetty_yetty_yetty_yplot_factory_create(void)
{
    struct yetty_yetty_yplot_factory *factory = calloc(1, sizeof(struct yetty_yetty_yplot_factory));
    if (!factory)
        return NULL;
...
void yetty_yetty_yetty_yplot_factory_destroy(struct yetty_ypaint_core_concrete_factory *self)
{
    if (!self)
        return;
