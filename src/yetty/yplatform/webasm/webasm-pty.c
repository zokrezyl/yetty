...
static struct yetty_yplatform_pty_pipe_source *webasm_pty_pipe_source(
...
struct yetty_ycore_void_result webasm_pty_init(struct webasm_pty *pty, struct yetty_yconfig *config)
{
