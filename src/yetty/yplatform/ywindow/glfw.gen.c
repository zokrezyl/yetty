...
[[maybe_unused]]
static yetty_yplatform_window_open_fn yetty_yplatform_glfw_window_yetty_yplatform_window_open_check = glfw_window_open;
[[maybe_unused]]
static yetty_yplatform_window_destroy_fn yetty_yplatform_glfw_window_yetty_yplatform_window_destroy_check = glfw_window_destroy;
[[maybe_unused]]
static yetty_yplatform_window_get_size_fn yetty_yplatform_glfw_window_yetty_yplatform_window_get_size_check = glfw_window_get_size;
[[maybe_unused]]
static yetty_yplatform_window_get_framebuffer_size_fn yetty_yplatform_glfw_window_yetty_yplatform_window_get_framebuffer_size_check = glfw_window_get_framebuffer_size;
[[maybe_unused]]
static yetty_yplatform_window_get_content_scale_fn yetty_yplatform_glfw_window_yetty_yplatform_window_get_content_scale_check = glfw_window_get_content_scale;
[[maybe_unused]]
static yetty_yplatform_window_should_close_fn yetty_yplatform_glfw_window_yetty_yplatform_window_should_close_check = glfw_window_should_close;
[[maybe_unused]]
static yetty_yplatform_window_set_title_fn yetty_yplatform_glfw_window_yetty_yplatform_window_set_title_check = glfw_window_set_title;
[[maybe_unused]]
static yetty_yplatform_window_create_surface_fn yetty_yplatform_glfw_window_yetty_yplatform_window_create_surface_check = glfw_window_create_surface;
...
struct yetty_yclass_ptr_result yetty_yplatform_glfw_window_class_get(void)
{
    ...
    static const struct yetty_yclass_op ops[] = {
        {"yetty_yplatform", "window_open", (yetty_yclass_method_id_t)yetty_yplatform_window_open, (yetty_yclass_impl_t)glfw_window_open},
        {"yetty_yplatform", "window_destroy", (yetty_yclass_method_id_t)yetty_yplatform_window_destroy, (yetty_yclass_impl_t)glfw_window_destroy},
        {"yetty_yplatform", "window_get_size", (yetty_yclass_method_id_t)yetty_yplatform_window_get_size, (yetty_yclass_impl_t)glfw_window_get_size},
        {"yetty_yplatform", "window_get_framebuffer_size", (yetty_yclass_method_id_t)yetty_yplatform_window_get_framebuffer_size, (yetty_yclass_impl_t)glfw_window_get_framebuffer_size},
        {"yetty_yplatform", "window_get_content_scale", (yetty_yclass_method_id_t)yetty_yplatform_window_get_content_scale, (yetty_yclass_impl_t)glfw_window_get_content_scale},
        {"yetty_yplatform", "window_should_close", (yetty_yclass_method_id_t)yetty_yplatform_window_should_close, (yetty_yclass_impl_t)glfw_window_should_close},
        {"yetty_yplatform", "window_set_title", (yetty_yclass_method_id_t)yetty_yplatform_window_set_title, (yetty_yclass_impl_t)glfw_window_set_title},
        {"yetty_yplatform", "window_create_surface", (yetty_yclass_method_id_t)yetty_yplatform_window_create_surface, (yetty_yclass_impl_t)glfw_window_create_surface},
    };
    struct yetty_yclass_ptr_result parent_class_r = yetty_yplatform_window_class_get();
    if (YETTY_IS_ERR(parent_class_r)) {
        yerror("yetty_yplatform_glfw_window_class_get: parent accessor failed: %s", parent_class_r.error.msg);
        return YETTY_ERR(yetty_yclass_ptr, "yetty_yplatform_glfw_window_class_get: parent accessor failed", parent_class_r);
    }
    struct yetty_yclass_ptr_result register_class_r =
        yetty_yclass_register(&desc, ops, sizeof(ops) / sizeof(ops[0]),
                              parent_class_r.value, NULL, 0);
    if (YETTY_IS_ERR(register_class_r)) {
        yerror("yetty_yplatform_glfw_window_class_get: class_register failed: %s", register_class_r.error.msg);
        return YETTY_ERR(yetty_yclass_ptr, "yetty_yplatform_glfw_window_class_get: class_register failed", register_class_r);
    }
    cls = register_class_r.value;
    return register_class_r;
}

struct yetty_yplatform_glfw_window_ptr_result yetty_yplatform_glfw_window_from(struct yetty_yclass_object *obj)
{
    struct yetty_yclass_ptr_result class_r = yetty_yplatform_glfw_window_class_get();
    if (YETTY_IS_ERR(class_r))
        return YETTY_ERR(yetty_yplatform_glfw_window_ptr, "yetty_yplatform_glfw_window_from: class accessor", class_r);
    struct yetty_yclass_void_ptr_result slice_r =
        yetty_yclass_object_data(obj, class_r.value);
    if (YETTY_IS_ERR(slice_r))
        return YETTY_ERR(yetty_yplatform_glfw_window_ptr, "yetty_yplatform_glfw_window_from: object_data", slice_r);
    return YETTY_OK(yetty_yplatform_glfw_window_ptr, (struct yetty_yplatform_glfw_window *)slice_r.value);
}

struct yetty_yclass_object *yetty_yplatform_glfw_window_to(struct yetty_yplatform_glfw_window *data)
{
    if (!data)
        return NULL;
    struct yetty_yclass_ptr_result class_r = yetty_yplatform_glfw_window_class_get();
...
struct yetty_yclass_object_ptr_result yetty_yplatform_glfw_window_create(struct yetty_yclass_ctx *ctx);
struct yetty_yclass_object_ptr_result yetty_yplatform_glfw_window_create(struct yetty_yclass_ctx *ctx)
{
    ...
    if (YETTY_IS_ERR(class_accessor_r))
        return YETTY_ERR(yetty_yclass_object_ptr,
                         "yetty_yplatform_glfw_window_create: class accessor failed", class_accessor_r);
     ...
     * response isn't silently swallowed. */
    {
        struct yetty_ycore_void_result translate_class_r =
            yetty_yclass_rpc_session_translate_class(ctx->session, "yetty_yplatform_glfw_window");
        if (YETTY_IS_ERR(translate_class_r)) {
            yetty_ycore_error_print(stderr,
                "yetty_yplatform_glfw_window_create: translate_class (degraded — will lazy-resolve)",
    ...
    uint64_t handle = 0;
    const char *class_name = "yetty_yplatform_glfw_window";
    ...
    if (YETTY_IS_ERR(create_call_r))
        return YETTY_ERR(yetty_yclass_object_ptr,
                         "yetty_yplatform_glfw_window_create: CREATE call failed", create_call_r);
    if (create_call_r.value != sizeof(handle) || !handle)
        return YETTY_ERR(yetty_yclass_object_ptr,
                         "yetty_yplatform_glfw_window_create: CREATE returned no/invalid handle");
    ...
    if (!proxy)
        return YETTY_ERR(yetty_yclass_object_ptr, "yetty_yplatform_glfw_window_create: calloc(proxy) failed");
