    ...
    struct yetty_yclass_object *obj)
{
    ...
    if (YETTY_IS_ERR(class_r)) {
        return YETTY_ERR(yetty_yplatform_window_ptr, "yetty_yplatform_window_from: class accessor",
                         class_r);
    }
    struct yetty_yclass_void_ptr_result slice_r = yetty_yclass_object_data(obj, class_r.value);
    if (YETTY_IS_ERR(slice_r)) {
        return YETTY_ERR(yetty_yplatform_window_ptr, "yetty_yplatform_window_from: object_data",
                         slice_r);
    }
...
struct yetty_yclass_object_ptr_result yetty_yplatform_window_to(struct yetty_yplatform_window *data)
{
    ...
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, class_r,
                        "yetty_yplatform_window_to: class accessor");
    struct yetty_ycore_size_result offset_r =
        yetty_yclass_object_data_offset(class_r.value, class_r.value);
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, offset_r,
                        "yetty_yplatform_window_to: data offset");
                                                           ...
                                                           int width, int height, const char *title)
{
    ...
    if (method_slot == YETTY_YCLASS_METHOD_SLOT_UNDEFINED) {
        struct yetty_yclass_method_slot_result method_slot_r = yetty_yclass_method_slot_get(
            "yetty_yplatform", (yetty_yclass_method_id_t)yetty_yplatform_window_open);
        if (YETTY_IS_ERR(method_slot_r)) {
            return YETTY_ERR(yetty_ycore_void,
                             "yetty_yplatform_window_open: method_slot_get failed", method_slot_r);
        }
        method_slot = method_slot_r.value;
    }

    if (!obj) {
        return YETTY_ERR(yetty_ycore_void, "yetty_yplatform_window_open: NULL object");
    }
    ...
    YETTY_RETURN_IF_ERR(yetty_ycore_void, object_class_r,
                        "yetty_yplatform_window_open: object_class failed");
    struct yetty_yclass_impl_t_result dispatch_impl_r =
        yetty_yclass_dispatch_lookup(object_class_r.value, method_slot);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, dispatch_impl_r,
                        "yetty_yplatform_window_open: dispatch_lookup failed");
                                                               ...
                                                               int *width, int *height)
{
    ...
    if (method_slot == YETTY_YCLASS_METHOD_SLOT_UNDEFINED) {
        struct yetty_yclass_method_slot_result method_slot_r = yetty_yclass_method_slot_get(
            "yetty_yplatform", (yetty_yclass_method_id_t)yetty_yplatform_window_get_size);
        if (YETTY_IS_ERR(method_slot_r)) {
            return YETTY_ERR(yetty_ycore_void,
                             "yetty_yplatform_window_get_size: method_slot_get failed",
                             method_slot_r);
        }
        method_slot = method_slot_r.value;
    }
    ...
    if (!obj) {
        return YETTY_ERR(yetty_ycore_void, "yetty_yplatform_window_get_size: NULL object");
    }

    struct yetty_yclass_ptr_result object_class_r = yetty_yclass_object_class(obj);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, object_class_r,
                        "yetty_yplatform_window_get_size: object_class failed");
    struct yetty_yclass_impl_t_result dispatch_impl_r =
        yetty_yclass_dispatch_lookup(object_class_r.value, method_slot);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, dispatch_impl_r,
                        "yetty_yplatform_window_get_size: dispatch_lookup failed");
    ...
    struct yetty_yclass_object *obj, int *width, int *height)
{
    ...
    if (method_slot == YETTY_YCLASS_METHOD_SLOT_UNDEFINED) {
        ...
        if (YETTY_IS_ERR(method_slot_r)) {
            return YETTY_ERR(yetty_ycore_void,
                             "yetty_yplatform_window_get_framebuffer_size: method_slot_get failed",
                             method_slot_r);
        }
        method_slot = method_slot_r.value;
    }
    ...
    if (!obj) {
        return YETTY_ERR(yetty_ycore_void,
                         "yetty_yplatform_window_get_framebuffer_size: NULL object");
    }

    struct yetty_yclass_ptr_result object_class_r = yetty_yclass_object_class(obj);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, object_class_r,
                        "yetty_yplatform_window_get_framebuffer_size: object_class failed");
    struct yetty_yclass_impl_t_result dispatch_impl_r =
        yetty_yclass_dispatch_lookup(object_class_r.value, method_slot);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, dispatch_impl_r,
                        "yetty_yplatform_window_get_framebuffer_size: dispatch_lookup failed");
    return ((yetty_yplatform_window_get_framebuffer_size_fn)dispatch_impl_r.value)(obj, width,
                                                                                   height);
}
    ...
    struct yetty_yclass_object *obj, float *xscale, float *yscale)
{
    ...
    if (method_slot == YETTY_YCLASS_METHOD_SLOT_UNDEFINED) {
        struct yetty_yclass_method_slot_result method_slot_r = yetty_yclass_method_slot_get(
            "yetty_yplatform", (yetty_yclass_method_id_t)yetty_yplatform_window_get_content_scale);
        if (YETTY_IS_ERR(method_slot_r)) {
            return YETTY_ERR(yetty_ycore_void,
                             "yetty_yplatform_window_get_content_scale: method_slot_get failed",
                             method_slot_r);
        }
        method_slot = method_slot_r.value;
    }
    ...
    if (!obj) {
        return YETTY_ERR(yetty_ycore_void, "yetty_yplatform_window_get_content_scale: NULL object");
    }

    struct yetty_yclass_ptr_result object_class_r = yetty_yclass_object_class(obj);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, object_class_r,
                        "yetty_yplatform_window_get_content_scale: object_class failed");
    struct yetty_yclass_impl_t_result dispatch_impl_r =
        yetty_yclass_dispatch_lookup(object_class_r.value, method_slot);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, dispatch_impl_r,
                        "yetty_yplatform_window_get_content_scale: dispatch_lookup failed");
    return ((yetty_yplatform_window_get_content_scale_fn)dispatch_impl_r.value)(obj, xscale,
                                                                                yscale);
}
...
struct yetty_ycore_int_result yetty_yplatform_window_should_close(struct yetty_yclass_object *obj)
{
    ...
    if (method_slot == YETTY_YCLASS_METHOD_SLOT_UNDEFINED) {
        struct yetty_yclass_method_slot_result method_slot_r = yetty_yclass_method_slot_get(
            "yetty_yplatform", (yetty_yclass_method_id_t)yetty_yplatform_window_should_close);
        if (YETTY_IS_ERR(method_slot_r)) {
            return YETTY_ERR(yetty_ycore_int,
                             "yetty_yplatform_window_should_close: method_slot_get failed",
                             method_slot_r);
        }
        method_slot = method_slot_r.value;
    }
    ...
    if (!obj) {
        return YETTY_ERR(yetty_ycore_int, "yetty_yplatform_window_should_close: NULL object");
    }

    struct yetty_yclass_ptr_result object_class_r = yetty_yclass_object_class(obj);
    YETTY_RETURN_IF_ERR(yetty_ycore_int, object_class_r,
                        "yetty_yplatform_window_should_close: object_class failed");
    struct yetty_yclass_impl_t_result dispatch_impl_r =
        yetty_yclass_dispatch_lookup(object_class_r.value, method_slot);
    YETTY_RETURN_IF_ERR(yetty_ycore_int, dispatch_impl_r,
                        "yetty_yplatform_window_should_close: dispatch_lookup failed");
                                                                ...
                                                                const char *title)
{
    ...
    if (method_slot == YETTY_YCLASS_METHOD_SLOT_UNDEFINED) {
        struct yetty_yclass_method_slot_result method_slot_r = yetty_yclass_method_slot_get(
            "yetty_yplatform", (yetty_yclass_method_id_t)yetty_yplatform_window_set_title);
        if (YETTY_IS_ERR(method_slot_r)) {
            return YETTY_ERR(yetty_ycore_void,
                             "yetty_yplatform_window_set_title: method_slot_get failed",
                             method_slot_r);
        }
        method_slot = method_slot_r.value;
    }
    ...
    if (!obj) {
        return YETTY_ERR(yetty_ycore_void, "yetty_yplatform_window_set_title: NULL object");
    }

    struct yetty_yclass_ptr_result object_class_r = yetty_yclass_object_class(obj);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, object_class_r,
                        "yetty_yplatform_window_set_title: object_class failed");
    struct yetty_yclass_impl_t_result dispatch_impl_r =
        yetty_yclass_dispatch_lookup(object_class_r.value, method_slot);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, dispatch_impl_r,
                        "yetty_yplatform_window_set_title: dispatch_lookup failed");
...
struct yetty_ycore_void_result yetty_yplatform_window_destroy(struct yetty_yclass_object *obj)
{
    ...
    if (method_slot == YETTY_YCLASS_METHOD_SLOT_UNDEFINED) {
        struct yetty_yclass_method_slot_result method_slot_r = yetty_yclass_method_slot_get(
            "yetty_yplatform", (yetty_yclass_method_id_t)yetty_yplatform_window_destroy);
        if (YETTY_IS_ERR(method_slot_r)) {
            return YETTY_ERR(yetty_ycore_void,
                             "yetty_yplatform_window_destroy: method_slot_get failed",
                             method_slot_r);
        }
        method_slot = method_slot_r.value;
    }
    ...
    if (!obj) {
        return YETTY_ERR(yetty_ycore_void, "yetty_yplatform_window_destroy: NULL object");
    }

    struct yetty_yclass_ptr_result object_class_r = yetty_yclass_object_class(obj);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, object_class_r,
                        "yetty_yplatform_window_destroy: object_class failed");
    struct yetty_yclass_impl_t_result dispatch_impl_r =
        yetty_yclass_dispatch_lookup(object_class_r.value, method_slot);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, dispatch_impl_r,
                        "yetty_yplatform_window_destroy: dispatch_lookup failed");
    ...
    struct yetty_yclass_object *obj, void *instance)
{
    ...
    if (method_slot == YETTY_YCLASS_METHOD_SLOT_UNDEFINED) {
        struct yetty_yclass_method_slot_result method_slot_r = yetty_yclass_method_slot_get(
            "yetty_yplatform", (yetty_yclass_method_id_t)yetty_yplatform_window_create_surface);
        if (YETTY_IS_ERR(method_slot_r)) {
            return YETTY_ERR(yetty_yclass_void_ptr,
                             "yetty_yplatform_window_create_surface: method_slot_get failed",
                             method_slot_r);
        }
        method_slot = method_slot_r.value;
    }
    ...
    if (!obj) {
        return YETTY_ERR(yetty_yclass_void_ptr,
                         "yetty_yplatform_window_create_surface: NULL object");
    }

    struct yetty_yclass_ptr_result object_class_r = yetty_yclass_object_class(obj);
    YETTY_RETURN_IF_ERR(yetty_yclass_void_ptr, object_class_r,
                        "yetty_yplatform_window_create_surface: object_class failed");
    struct yetty_yclass_impl_t_result dispatch_impl_r =
        yetty_yclass_dispatch_lookup(object_class_r.value, method_slot);
    YETTY_RETURN_IF_ERR(yetty_yclass_void_ptr, dispatch_impl_r,
                        "yetty_yplatform_window_create_surface: dispatch_lookup failed");
...
struct yetty_yclass_object_ptr_result yetty_yplatform_window_create(struct yetty_yclass_ctx *ctx)
{
    ...
    if (!proxy) {
        return YETTY_ERR(yetty_yclass_object_ptr,
                         "yetty_yplatform_window_create: calloc(proxy) failed");
    }
