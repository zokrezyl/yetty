...
[[maybe_unused]]
static yetty_yplatform_clipboard_set_text_fn yetty_yplatform_webasm_clipboard_yetty_yplatform_clipboard_set_text_check = webasm_clipboard_set_text;
[[maybe_unused]]
static yetty_yplatform_clipboard_request_paste_fn yetty_yplatform_webasm_clipboard_yetty_yplatform_clipboard_request_paste_check = webasm_clipboard_request_paste;
...
struct yetty_yclass_ptr_result yetty_yplatform_webasm_clipboard_class_get(void)
{
    ...
    static const struct yetty_yclass_op ops[] = {
        {"yetty_yplatform", "clipboard_set_text", (yetty_yclass_method_id_t)yetty_yplatform_clipboard_set_text, (yetty_yclass_impl_t)webasm_clipboard_set_text},
        {"yetty_yplatform", "clipboard_request_paste", (yetty_yclass_method_id_t)yetty_yplatform_clipboard_request_paste, (yetty_yclass_impl_t)webasm_clipboard_request_paste},
    };
    struct yetty_yclass_ptr_result parent_class_r = yetty_yplatform_clipboard_class_get();
    if (YETTY_IS_ERR(parent_class_r)) {
        yerror("yetty_yplatform_webasm_clipboard_class_get: parent accessor failed: %s", parent_class_r.error.msg);
        return YETTY_ERR(yetty_yclass_ptr, "yetty_yplatform_webasm_clipboard_class_get: parent accessor failed", parent_class_r);
    }
    struct yetty_yclass_ptr_result register_class_r =
        yetty_yclass_register(&desc, ops, sizeof(ops) / sizeof(ops[0]),
                              parent_class_r.value, NULL, 0);
    if (YETTY_IS_ERR(register_class_r)) {
        yerror("yetty_yplatform_webasm_clipboard_class_get: class_register failed: %s", register_class_r.error.msg);
        return YETTY_ERR(yetty_yclass_ptr, "yetty_yplatform_webasm_clipboard_class_get: class_register failed", register_class_r);
    }
...
struct yetty_yplatform_webasm_clipboard_ptr_result yetty_yplatform_webasm_clipboard_from(struct yetty_yclass_object *obj)
{
    ...
    if (YETTY_IS_ERR(class_r))
        return YETTY_ERR(yetty_yplatform_webasm_clipboard_ptr, "yetty_yplatform_webasm_clipboard_from: class accessor", class_r);
    struct yetty_yclass_void_ptr_result slice_r =
        yetty_yclass_object_data(obj, class_r.value);
    if (YETTY_IS_ERR(slice_r))
        return YETTY_ERR(yetty_yplatform_webasm_clipboard_ptr, "yetty_yplatform_webasm_clipboard_from: object_data", slice_r);
    return YETTY_OK(yetty_yplatform_webasm_clipboard_ptr, (struct yetty_yplatform_webasm_clipboard *)slice_r.value);
}

struct yetty_yclass_object *yetty_yplatform_webasm_clipboard_to(struct yetty_yplatform_webasm_clipboard *data)
{
    if (!data)
        return NULL;
    struct yetty_yclass_ptr_result class_r = yetty_yplatform_webasm_clipboard_class_get();
...
struct yetty_yclass_object_ptr_result yetty_yplatform_webasm_clipboard_create(struct yetty_yclass_ctx *ctx)
{
    ...
    if (YETTY_IS_ERR(class_accessor_r))
        return YETTY_ERR(yetty_yclass_object_ptr,
                         "yetty_yplatform_webasm_clipboard_create: class accessor failed", class_accessor_r);
     ...
     * response isn't silently swallowed. */
    {
        struct yetty_ycore_void_result translate_class_r =
            yetty_yclass_rpc_session_translate_class(ctx->session, "yetty_yplatform_webasm_clipboard");
        if (YETTY_IS_ERR(translate_class_r)) {
            yetty_ycore_error_print(stderr,
                "yetty_yplatform_webasm_clipboard_create: translate_class (degraded — will lazy-resolve)",
    ...
    uint64_t handle = 0;
    const char *class_name = "yetty_yplatform_webasm_clipboard";
    ...
    if (YETTY_IS_ERR(create_call_r))
        return YETTY_ERR(yetty_yclass_object_ptr,
                         "yetty_yplatform_webasm_clipboard_create: CREATE call failed", create_call_r);
    if (create_call_r.value != sizeof(handle) || !handle)
        return YETTY_ERR(yetty_yclass_object_ptr,
                         "yetty_yplatform_webasm_clipboard_create: CREATE returned no/invalid handle");
    ...
    if (!proxy)
        return YETTY_ERR(yetty_yclass_object_ptr, "yetty_yplatform_webasm_clipboard_create: calloc(proxy) failed");
