...
static yetty_yplatform_clipboard_set_text_fn
    yetty_yplatform_webasm_clipboard_yetty_yplatform_clipboard_set_text_check =
        webasm_clipboard_set_text;
YETTY_MAYBE_UNUSED
static yetty_yplatform_clipboard_request_paste_fn
    yetty_yplatform_webasm_clipboard_yetty_yplatform_clipboard_request_paste_check =
...
struct yetty_yclass_object *yetty_yplatform_webasm_clipboard_to(
    ...
    struct yetty_yclass_ctx *ctx)
{
     ...
     * response isn't silently swallowed. */
    {
        struct yetty_ycore_void_result translate_class_r = yetty_yclass_rpc_session_translate_class(
            ctx->session, "yetty_yplatform_webasm_clipboard");
        if (YETTY_IS_ERR(translate_class_r)) {
            yetty_ycore_error_print(stderr,
                                    "yetty_yplatform_webasm_clipboard_create: translate_class "
    ...
    if (YETTY_IS_ERR(create_call_r)) {
        return YETTY_ERR(yetty_yclass_object_ptr,
                         "yetty_yplatform_webasm_clipboard_create: CREATE call failed",
                         create_call_r);
    }
    ...
    if (!proxy) {
        return YETTY_ERR(yetty_yclass_object_ptr,
                         "yetty_yplatform_webasm_clipboard_create: calloc(proxy) failed");
    }
