...
static struct yetty_yclass_ptr_result yetty_yplatform_ywindow_chrome_accessor_lookup(
    const char *name)
{
#ifdef YETTY_PLATFORM_GLFW
...
#endif
    if (strcmp(name, "yetty_yplatform_window_chrome") == 0 &&
        yetty_yplatform_window_chrome_class_get) {
