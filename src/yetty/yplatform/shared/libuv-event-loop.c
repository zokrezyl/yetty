...
static struct yetty_ycore_void_result libuv_unregister_pty_pipe(struct yetty_yevent_event_loop *self,
...
static struct yetty_ycore_size_result libuv_tcp_send(struct yetty_yevent_conn *conn, const void *data,
                                                     size_t len);
