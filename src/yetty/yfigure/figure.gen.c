                                                              ...
                                                              float content_w, float content_h)
{
    ...
    return ((yetty_yfigure_set_content_size_fn)dispatch_impl_r.value)(ctx, obj, content_w,
                                                                      content_h);
}
...
/* ---- yfigure/figure: class name -> accessor ---------------------- */
...
struct yetty_ycore_void_result yetty_yfigure_figure_register_hooks(void)
{
    ...
    YETTY_RETURN_IF_ERR(yetty_ycore_void, add_accessor_r,
                        "yetty_yfigure_figure_register_hooks: accessor");
    return YETTY_OK_VOID();
}
