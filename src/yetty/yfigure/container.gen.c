...
#pragma pack(pop)
        ...
        if (resp_buf[0] != 0) {
            ...
            struct yetty_ycore_void_result remote_error =
                YETTY_ERR(yetty_ycore_void, "yetty_yfigure_constructor: remote impl returned error");
...
#pragma pack(pop)
        ...
        if (response_len < 1) {
            free(resp_buf);
            return YETTY_ERR(yetty_ycore_void, "yetty_yfigure_remove_child_by_id: short RPC response");
        }
        if (resp_buf[0] != 0) {
            struct yetty_ycore_error *remote_chain =
                yetty_ycore_error_deserialize(resp_buf + 1, response_len - 1);
            free(resp_buf);
            struct yetty_ycore_void_result remote_error =
                YETTY_ERR(yetty_ycore_void, "yetty_yfigure_remove_child_by_id: remote impl returned error");
            remote_error.error.cause = remote_chain;
            return remote_error;
        }
        free(resp_buf);
...
#pragma pack(pop)
        ...
        if (response_len < 1) {
            free(resp_buf);
            return YETTY_ERR(yetty_ycore_void, "yetty_yfigure_raise_child_by_id: short RPC response");
        }
        if (resp_buf[0] != 0) {
            struct yetty_ycore_error *remote_chain =
                yetty_ycore_error_deserialize(resp_buf + 1, response_len - 1);
            free(resp_buf);
            struct yetty_ycore_void_result remote_error =
                YETTY_ERR(yetty_ycore_void, "yetty_yfigure_raise_child_by_id: remote impl returned error");
            remote_error.error.cause = remote_chain;
            return remote_error;
        }
        free(resp_buf);
...
#pragma pack(pop)
        ...
        if (resp_buf[0] != 0) {
            ...
            free(resp_buf);
            struct yetty_ycore_void_result remote_error =
                YETTY_ERR(yetty_ycore_void, "yetty_yfigure_process_records: remote impl returned error");
            remote_error.error.cause = remote_chain;
            return remote_error;
        }
        free(resp_buf);
...
size_t yetty_yfigure_constructor_skel(const void *body, size_t body_len,
...
#pragma pack(pop)
    ...
    struct yetty_ycore_void_result call_r = yetty_yfigure_constructor((struct yetty_yclass_object *)obj_resolve_r.value);
...
YETTY_EXTERNAL_CALLBACK
size_t yetty_yfigure_process_records_skel(const void *body, size_t body_len,
                   void *resp, size_t resp_max)
{
/* Byte-exact wire layout — #pragma pack matches the first-party
 * convention (yvnc/ydvnc/libvterm) and compiles on MSVC, unlike a GNU
...
#pragma pack(pop)
    ...
    struct yetty_ycore_void_result call_r = yetty_yfigure_process_records((struct yetty_yclass_object *)obj_resolve_r.value, bytes_buf);
    if (resp_max < 1) return 0;
    if (YETTY_IS_ERR(call_r)) {
