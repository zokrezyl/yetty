                                                      ...
                                                      uint32_t flags)
{
    ...
    if (method_slot == YETTY_YCLASS_METHOD_SLOT_UNDEFINED) {
        struct yetty_yclass_method_slot_result method_slot_r = yetty_yclass_method_slot_get(
            "yetty_yflame", (yetty_yclass_method_id_t)yetty_yflame_configure);
        if (YETTY_IS_ERR(method_slot_r)) {
            return YETTY_ERR(yetty_ycore_void, "yetty_yflame_configure: method_slot_get failed",
                             method_slot_r);
        }
    ...
    if (!obj) {
        return YETTY_ERR(yetty_ycore_void, "yetty_yflame_configure: NULL object");
    }
    ...
    YETTY_RETURN_IF_ERR(yetty_ycore_void, object_class_r,
                        "yetty_yflame_configure: object_class failed");
    struct yetty_yclass_impl_t_result dispatch_impl_r =
        yetty_yclass_dispatch_lookup(object_class_r.value, method_slot);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, dispatch_impl_r,
                        "yetty_yflame_configure: dispatch_lookup failed");
    return ((yetty_yflame_configure_fn)dispatch_impl_r.value)(ctx, obj, width, frame_height,
                                                              min_width, flags);
}
                                                  ...
                                                  const char *input, size_t len)
{
    ...
    if (method_slot == YETTY_YCLASS_METHOD_SLOT_UNDEFINED) {
        struct yetty_yclass_method_slot_result method_slot_r = yetty_yclass_method_slot_get(
            "yetty_yflame", (yetty_yclass_method_id_t)yetty_yflame_parse);
        if (YETTY_IS_ERR(method_slot_r)) {
            return YETTY_ERR(yetty_ycore_void, "yetty_yflame_parse: method_slot_get failed",
                             method_slot_r);
        }
        method_slot = method_slot_r.value;
    }
    ...
    if (!obj) {
        return YETTY_ERR(yetty_ycore_void, "yetty_yflame_parse: NULL object");
    }

    struct yetty_yclass_ptr_result object_class_r = yetty_yclass_object_class(obj);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, object_class_r,
                        "yetty_yflame_parse: object_class failed");
    struct yetty_yclass_impl_t_result dispatch_impl_r =
        yetty_yclass_dispatch_lookup(object_class_r.value, method_slot);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, dispatch_impl_r,
                        "yetty_yflame_parse: dispatch_lookup failed");
                                                            ...
                                                            struct yetty_yclass_object *obj)
{
    ...
    if (method_slot == YETTY_YCLASS_METHOD_SLOT_UNDEFINED) {
        struct yetty_yclass_method_slot_result method_slot_r = yetty_yclass_method_slot_get(
            "yetty_yflame", (yetty_yclass_method_id_t)yetty_yflame_render);
        if (YETTY_IS_ERR(method_slot_r)) {
            return YETTY_ERR(yetty_ydraw_drawable_list,
                             "yetty_yflame_render: method_slot_get failed", method_slot_r);
        }
        method_slot = method_slot_r.value;
    }

    if (!obj) {
        return YETTY_ERR(yetty_ydraw_drawable_list, "yetty_yflame_render: NULL object");
    }

    struct yetty_yclass_ptr_result object_class_r = yetty_yclass_object_class(obj);
    YETTY_RETURN_IF_ERR(yetty_ydraw_drawable_list, object_class_r,
                        "yetty_yflame_render: object_class failed");
    struct yetty_yclass_impl_t_result dispatch_impl_r =
        yetty_yclass_dispatch_lookup(object_class_r.value, method_slot);
    YETTY_RETURN_IF_ERR(yetty_ydraw_drawable_list, dispatch_impl_r,
                        "yetty_yflame_render: dispatch_lookup failed");
                                                    ...
                                                    float y)
{
    ...
    if (method_slot == YETTY_YCLASS_METHOD_SLOT_UNDEFINED) {
        struct yetty_yclass_method_slot_result method_slot_r = yetty_yclass_method_slot_get(
            "yetty_yflame", (yetty_yclass_method_id_t)yetty_yflame_hit_test);
        if (YETTY_IS_ERR(method_slot_r)) {
            return YETTY_ERR(yetty_ycore_int, "yetty_yflame_hit_test: method_slot_get failed",
                             method_slot_r);
        }
        method_slot = method_slot_r.value;
    }
    ...
    if (!obj) {
        return YETTY_ERR(yetty_ycore_int, "yetty_yflame_hit_test: NULL object");
    }

    struct yetty_yclass_ptr_result object_class_r = yetty_yclass_object_class(obj);
    YETTY_RETURN_IF_ERR(yetty_ycore_int, object_class_r,
                        "yetty_yflame_hit_test: object_class failed");
    struct yetty_yclass_impl_t_result dispatch_impl_r =
        yetty_yclass_dispatch_lookup(object_class_r.value, method_slot);
    YETTY_RETURN_IF_ERR(yetty_ycore_int, dispatch_impl_r,
                        "yetty_yflame_hit_test: dispatch_lookup failed");
                                                  ...
                                                  struct yetty_yclass_object *obj, int32_t node_id)
{
    ...
    if (method_slot == YETTY_YCLASS_METHOD_SLOT_UNDEFINED) {
        struct yetty_yclass_method_slot_result method_slot_r = yetty_yclass_method_slot_get(
            "yetty_yflame", (yetty_yclass_method_id_t)yetty_yflame_focus);
        if (YETTY_IS_ERR(method_slot_r)) {
            return YETTY_ERR(yetty_ycore_void, "yetty_yflame_focus: method_slot_get failed",
                             method_slot_r);
        }
        method_slot = method_slot_r.value;
    }
    ...
    if (!obj) {
        return YETTY_ERR(yetty_ycore_void, "yetty_yflame_focus: NULL object");
    }

    struct yetty_yclass_ptr_result object_class_r = yetty_yclass_object_class(obj);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, object_class_r,
                        "yetty_yflame_focus: object_class failed");
    struct yetty_yclass_impl_t_result dispatch_impl_r =
        yetty_yclass_dispatch_lookup(object_class_r.value, method_slot);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, dispatch_impl_r,
                        "yetty_yflame_focus: dispatch_lookup failed");
                                                         ...
                                                         struct yetty_yclass_object *obj)
{
    ...
    if (method_slot == YETTY_YCLASS_METHOD_SLOT_UNDEFINED) {
        struct yetty_yclass_method_slot_result method_slot_r = yetty_yclass_method_slot_get(
            "yetty_yflame", (yetty_yclass_method_id_t)yetty_yflame_focus_parent);
        if (YETTY_IS_ERR(method_slot_r)) {
            return YETTY_ERR(yetty_ycore_void, "yetty_yflame_focus_parent: method_slot_get failed",
                             method_slot_r);
        }
        method_slot = method_slot_r.value;
    }
    ...
    if (!obj) {
        return YETTY_ERR(yetty_ycore_void, "yetty_yflame_focus_parent: NULL object");
    }

    struct yetty_yclass_ptr_result object_class_r = yetty_yclass_object_class(obj);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, object_class_r,
                        "yetty_yflame_focus_parent: object_class failed");
    struct yetty_yclass_impl_t_result dispatch_impl_r =
        yetty_yclass_dispatch_lookup(object_class_r.value, method_slot);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, dispatch_impl_r,
                        "yetty_yflame_focus_parent: dispatch_lookup failed");
                                                  ...
                                                  struct yetty_yclass_object *obj)
{
    ...
    if (method_slot == YETTY_YCLASS_METHOD_SLOT_UNDEFINED) {
        struct yetty_yclass_method_slot_result method_slot_r = yetty_yclass_method_slot_get(
            "yetty_yflame", (yetty_yclass_method_id_t)yetty_yflame_reset);
        if (YETTY_IS_ERR(method_slot_r)) {
            return YETTY_ERR(yetty_ycore_void, "yetty_yflame_reset: method_slot_get failed",
                             method_slot_r);
        }
        method_slot = method_slot_r.value;
    }
    ...
    if (!obj) {
        return YETTY_ERR(yetty_ycore_void, "yetty_yflame_reset: NULL object");
    }

    struct yetty_yclass_ptr_result object_class_r = yetty_yclass_object_class(obj);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, object_class_r,
                        "yetty_yflame_reset: object_class failed");
    struct yetty_yclass_impl_t_result dispatch_impl_r =
        yetty_yclass_dispatch_lookup(object_class_r.value, method_slot);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, dispatch_impl_r,
                        "yetty_yflame_reset: dispatch_lookup failed");
                                                          ...
                                                          int32_t node_id)
{
    ...
    if (method_slot == YETTY_YCLASS_METHOD_SLOT_UNDEFINED) {
        struct yetty_yclass_method_slot_result method_slot_r = yetty_yclass_method_slot_get(
            "yetty_yflame", (yetty_yclass_method_id_t)yetty_yflame_set_highlight);
        if (YETTY_IS_ERR(method_slot_r)) {
            return YETTY_ERR(yetty_ycore_void, "yetty_yflame_set_highlight: method_slot_get failed",
                             method_slot_r);
        }
        method_slot = method_slot_r.value;
    }
    ...
    if (!obj) {
        return YETTY_ERR(yetty_ycore_void, "yetty_yflame_set_highlight: NULL object");
    }

    struct yetty_yclass_ptr_result object_class_r = yetty_yclass_object_class(obj);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, object_class_r,
                        "yetty_yflame_set_highlight: object_class failed");
    struct yetty_yclass_impl_t_result dispatch_impl_r =
        yetty_yclass_dispatch_lookup(object_class_r.value, method_slot);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, dispatch_impl_r,
                                                    ...
                                                    struct yetty_yclass_object *obj)
{
    ...
    if (method_slot == YETTY_YCLASS_METHOD_SLOT_UNDEFINED) {
        struct yetty_yclass_method_slot_result method_slot_r = yetty_yclass_method_slot_get(
            "yetty_yflame", (yetty_yclass_method_id_t)yetty_yflame_destroy);
        if (YETTY_IS_ERR(method_slot_r)) {
            return YETTY_ERR(yetty_ycore_void, "yetty_yflame_destroy: method_slot_get failed",
                             method_slot_r);
        }
        method_slot = method_slot_r.value;
    }
    ...
    if (!obj) {
        return YETTY_ERR(yetty_ycore_void, "yetty_yflame_destroy: NULL object");
    }

    struct yetty_yclass_ptr_result object_class_r = yetty_yclass_object_class(obj);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, object_class_r,
                        "yetty_yflame_destroy: object_class failed");
    struct yetty_yclass_impl_t_result dispatch_impl_r =
        yetty_yclass_dispatch_lookup(object_class_r.value, method_slot);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, dispatch_impl_r,
                        "yetty_yflame_destroy: dispatch_lookup failed");
...
struct yetty_yclass_object_ptr_result yetty_yflame_flame_create(struct yetty_yclass_ctx *ctx)
{
     ...
     * response isn't silently swallowed. */
    {
        ...
        if (YETTY_IS_ERR(translate_class_r)) {
            yetty_ycore_error_print(
                stderr, "yetty_yflame_flame_create: translate_class (degraded — will lazy-resolve)",
    ...
    if (YETTY_IS_ERR(create_call_r)) {
        return YETTY_ERR(yetty_yclass_object_ptr, "yetty_yflame_flame_create: CREATE call failed",
                         create_call_r);
    }
    ...
    if (!proxy) {
        return YETTY_ERR(yetty_yclass_object_ptr,
                         "yetty_yflame_flame_create: calloc(proxy) failed");
    }
...
/* ---- yflame/flame: class name -> accessor ---------------------- */
static struct yetty_yclass_ptr_result yetty_yflame_flame_accessor_lookup(const char *name)
{
...
struct yetty_ycore_void_result yetty_yflame_flame_register_hooks(void)
{
    struct yetty_ycore_void_result add_accessor_r =
        yetty_yclass_add_accessor_lookup(yetty_yflame_flame_accessor_lookup);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, add_accessor_r,
                        "yetty_yflame_flame_register_hooks: accessor");
...
struct yetty_ycore_void_result yetty_yflame_register(void)
{
    ...
    {
        struct yetty_ycore_void_result hook_r = yetty_yflame_flame_register_hooks();
        YETTY_RETURN_IF_ERR(yetty_ycore_void, hook_r, "yetty_yflame_register: flame");
    }
    registered = true;
    return YETTY_OK_VOID();
}
