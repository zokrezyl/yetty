 ...
 */
#ifndef YETTY_YPAINT_CORE_FONT_PRIM_INTERNAL_H
#define YETTY_YPAINT_CORE_FONT_PRIM_INTERNAL_H
 ...
 * yetty_ypaint_core_font_prim_size_for(name_len, ttf_len) bytes. */
...
#endif /* YETTY_YPAINT_CORE_FONT_PRIM_INTERNAL_H */
