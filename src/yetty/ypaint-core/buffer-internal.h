 ...
 * surface lives in include/yetty/ypaint-core/buffer.h.
 *
 ...
 */
#ifndef YETTY_YPAINT_CORE_BUFFER_INTERNAL_H
#define YETTY_YPAINT_CORE_BUFFER_INTERNAL_H
...
#endif /* YETTY_YPAINT_CORE_BUFFER_INTERNAL_H */
