...
YETTY_ANNOTATE("local@ymap:configure") static struct yetty_ycore_void_result
...
YETTY_ANNOTATE("local@ymap:set_provider") static struct yetty_ycore_void_result
...
YETTY_ANNOTATE("local@ymap:set_custom_provider") static struct yetty_ycore_void_result
...
YETTY_ANNOTATE("local@ymap:set_center") static struct yetty_ycore_void_result
...
YETTY_ANNOTATE("local@ymap:set_zoom") static struct yetty_ycore_void_result
    map_set_zoom(struct yetty_yclass_object *obj, uint32_t zoom)
{
    struct yetty_yclass_void_ptr_result map_r = map_from_obj(obj);
...
YETTY_ANNOTATE("local@ymap:set_viewport") static struct yetty_ycore_void_result
...
YETTY_ANNOTATE("local@ymap:pan_by_pixels") static struct yetty_ycore_void_result
...
YETTY_ANNOTATE("local@ymap:zoom_by_at") static struct yetty_ycore_int_result
...
YETTY_ANNOTATE("local@ymap:get_zoom") static struct yetty_ycore_int_result
    map_get_zoom(struct yetty_yclass_object *obj)
{
    struct yetty_yclass_void_ptr_result map_r = map_from_obj(obj);
...
YETTY_ANNOTATE("local@ymap:geolocate") static struct yetty_ycore_void_result
    map_geolocate(struct yetty_yclass_object *obj)
{
    struct yetty_yclass_void_ptr_result map_r = map_from_obj(obj);
...
YETTY_ANNOTATE("local@ymap:attribution") static struct yetty_ycore_const_char_ptr_result
    map_attribution(struct yetty_yclass_object *obj)
{
    struct yetty_yclass_void_ptr_result map_r = map_from_obj(obj);
...
YETTY_ANNOTATE("local@ymap:is_vector") static struct yetty_ycore_int_result
    map_is_vector(struct yetty_yclass_object *obj)
{
    struct yetty_yclass_void_ptr_result map_r = map_from_obj(obj);
...
YETTY_ANNOTATE("local@ymap:render") static struct yetty_ydraw_drawable_list_result
    map_render(struct yetty_yclass_object *obj)
{
    struct yetty_yclass_void_ptr_result map_r = map_from_obj(obj);
...
YETTY_ANNOTATE("local@ymap:destroy") static struct yetty_ycore_void_result
    map_destroy(struct yetty_yclass_object *obj)
{
    if (!obj) {
        return YETTY_OK_VOID();
    }
