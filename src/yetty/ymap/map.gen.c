...
/* ---- ymap/map: class name -> accessor ---------------------- */
static struct yetty_yclass_ptr_result yetty_ymap_map_accessor_lookup(const char *name)
{
...
struct yetty_ycore_void_result yetty_ymap_map_register_hooks(void)
{
    struct yetty_ycore_void_result add_accessor_r =
        yetty_yclass_add_accessor_lookup(yetty_ymap_map_accessor_lookup);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, add_accessor_r,
                        "yetty_ymap_map_register_hooks: accessor");
...
struct yetty_ycore_void_result yetty_ymap_register(void)
{
    ...
    {
        struct yetty_ycore_void_result hook_r = yetty_ymap_map_register_hooks();
        YETTY_RETURN_IF_ERR(yetty_ycore_void, hook_r, "yetty_ymap_register: map");
    }
    registered = true;
    return YETTY_OK_VOID();
}
