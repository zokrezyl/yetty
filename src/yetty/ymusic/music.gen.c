...
struct yetty_ycore_void_result yetty_ymusic_configure(struct yetty_yclass_object * obj, float width, float staff_space, uint32_t flags);
struct yetty_ycore_void_result yetty_ymusic_parse(struct yetty_yclass_object * obj, const char * input, size_t len);
struct yetty_ydraw_drawable_list_result yetty_ymusic_render(struct yetty_yclass_object * obj);
struct yetty_ycore_int_result yetty_ymusic_hit_test(struct yetty_yclass_object * obj, float x, float y);
struct yetty_ycore_void_result yetty_ymusic_set_highlight(struct yetty_yclass_object * obj, int32_t element_id);
struct yetty_ycore_void_result yetty_ymusic_destroy(struct yetty_yclass_object * obj);
typedef struct yetty_ycore_void_result (*yetty_ymusic_configure_fn)(struct yetty_yclass_object *, float, float, uint32_t);
typedef struct yetty_ycore_void_result (*yetty_ymusic_parse_fn)(struct yetty_yclass_object *, const char *, size_t);
typedef struct yetty_ydraw_drawable_list_result (*yetty_ymusic_render_fn)(struct yetty_yclass_object *);
typedef struct yetty_ycore_int_result (*yetty_ymusic_hit_test_fn)(struct yetty_yclass_object *, float, float);
typedef struct yetty_ycore_void_result (*yetty_ymusic_set_highlight_fn)(struct yetty_yclass_object *, int32_t);
...
[[maybe_unused]]
static yetty_ymusic_set_highlight_fn yetty_ymusic_music_yetty_ymusic_set_highlight_check = music_set_highlight;
[[maybe_unused]]
...
struct yetty_yclass_ptr_result yetty_ymusic_music_class_get(void)
{
    ...
    static const struct yetty_yclass_op ops[] = {
        {"yetty_ymusic", "configure", (yetty_yclass_method_id_t)yetty_ymusic_configure, (yetty_yclass_impl_t)music_configure},
        {"yetty_ymusic", "parse", (yetty_yclass_method_id_t)yetty_ymusic_parse, (yetty_yclass_impl_t)music_parse},
        {"yetty_ymusic", "render", (yetty_yclass_method_id_t)yetty_ymusic_render, (yetty_yclass_impl_t)music_render},
        {"yetty_ymusic", "hit_test", (yetty_yclass_method_id_t)yetty_ymusic_hit_test, (yetty_yclass_impl_t)music_hit_test},
        {"yetty_ymusic", "set_highlight", (yetty_yclass_method_id_t)yetty_ymusic_set_highlight, (yetty_yclass_impl_t)music_set_highlight},
        {"yetty_ymusic", "destroy", (yetty_yclass_method_id_t)yetty_ymusic_destroy, (yetty_yclass_impl_t)music_obj_destroy},
    };
    struct yetty_yclass_ptr_result register_class_r =
        yetty_yclass_register(&desc, ops, sizeof(ops) / sizeof(ops[0]),
                              NULL, NULL, 0);
    if (YETTY_IS_ERR(register_class_r)) {
        yerror("yetty_ymusic_music_class_get: class_register failed: %s", register_class_r.error.msg);
        return YETTY_ERR(yetty_yclass_ptr, "yetty_ymusic_music_class_get: class_register failed", register_class_r);
    }
...
struct yetty_ymusic_music_ptr_result yetty_ymusic_music_from(struct yetty_yclass_object *obj)
{
    ...
    if (YETTY_IS_ERR(class_r))
        return YETTY_ERR(yetty_ymusic_music_ptr, "yetty_ymusic_music_from: class accessor", class_r);
...
struct yetty_yclass_object_ptr_result yetty_ymusic_music_create(struct yetty_yclass_ctx *ctx)
{
     ...
     * response isn't silently swallowed. */
    {
        struct yetty_ycore_void_result translate_class_r =
            yetty_yclass_rpc_session_translate_class(ctx->session, "yetty_ymusic_music");
        if (YETTY_IS_ERR(translate_class_r)) {
            yetty_ycore_error_print(stderr,
                "yetty_ymusic_music_create: translate_class (degraded — will lazy-resolve)",
    ...
    uint64_t handle = 0;
    const char *class_name = "yetty_ymusic_music";
    ...
    if (YETTY_IS_ERR(create_call_r))
        return YETTY_ERR(yetty_yclass_object_ptr,
                         "yetty_ymusic_music_create: CREATE call failed", create_call_r);
    if (create_call_r.value != sizeof(handle) || !handle)
        return YETTY_ERR(yetty_yclass_object_ptr,
                         "yetty_ymusic_music_create: CREATE returned no/invalid handle");
    ...
    if (!proxy)
        return YETTY_ERR(yetty_yclass_object_ptr, "yetty_ymusic_music_create: calloc(proxy) failed");
