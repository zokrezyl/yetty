                                                      ...
                                                      float staff_space, uint32_t flags)
{
    ...
    if (method_slot == YETTY_YCLASS_METHOD_SLOT_UNDEFINED) {
        struct yetty_yclass_method_slot_result method_slot_r = yetty_yclass_method_slot_get(
            "yetty_ymusic", (yetty_yclass_method_id_t)yetty_ymusic_configure);
        if (YETTY_IS_ERR(method_slot_r)) {
            return YETTY_ERR(yetty_ycore_void, "yetty_ymusic_configure: method_slot_get failed",
                             method_slot_r);
        }
    ...
    if (!obj) {
        return YETTY_ERR(yetty_ycore_void, "yetty_ymusic_configure: NULL object");
    }
    ...
    YETTY_RETURN_IF_ERR(yetty_ycore_void, object_class_r,
                        "yetty_ymusic_configure: object_class failed");
                                                  ...
                                                  const char *input, size_t len)
{
    ...
    if (method_slot == YETTY_YCLASS_METHOD_SLOT_UNDEFINED) {
        struct yetty_yclass_method_slot_result method_slot_r = yetty_yclass_method_slot_get(
            "yetty_ymusic", (yetty_yclass_method_id_t)yetty_ymusic_parse);
        if (YETTY_IS_ERR(method_slot_r)) {
            return YETTY_ERR(yetty_ycore_void, "yetty_ymusic_parse: method_slot_get failed",
                             method_slot_r);
        }
        method_slot = method_slot_r.value;
    }
    ...
    if (!obj) {
        return YETTY_ERR(yetty_ycore_void, "yetty_ymusic_parse: NULL object");
    }

    struct yetty_yclass_ptr_result object_class_r = yetty_yclass_object_class(obj);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, object_class_r,
                        "yetty_ymusic_parse: object_class failed");
    struct yetty_yclass_impl_t_result dispatch_impl_r =
        yetty_yclass_dispatch_lookup(object_class_r.value, method_slot);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, dispatch_impl_r,
                                                            ...
                                                            struct yetty_yclass_object *obj)
{
    ...
    if (method_slot == YETTY_YCLASS_METHOD_SLOT_UNDEFINED) {
        struct yetty_yclass_method_slot_result method_slot_r = yetty_yclass_method_slot_get(
            "yetty_ymusic", (yetty_yclass_method_id_t)yetty_ymusic_render);
        if (YETTY_IS_ERR(method_slot_r)) {
            return YETTY_ERR(yetty_ydraw_drawable_list,
                             "yetty_ymusic_render: method_slot_get failed", method_slot_r);
        }
        method_slot = method_slot_r.value;
    }

    if (!obj) {
        return YETTY_ERR(yetty_ydraw_drawable_list, "yetty_ymusic_render: NULL object");
    }

    struct yetty_yclass_ptr_result object_class_r = yetty_yclass_object_class(obj);
    YETTY_RETURN_IF_ERR(yetty_ydraw_drawable_list, object_class_r,
                        "yetty_ymusic_render: object_class failed");
    struct yetty_yclass_impl_t_result dispatch_impl_r =
        yetty_yclass_dispatch_lookup(object_class_r.value, method_slot);
                                                    ...
                                                    float y)
{
    ...
    if (method_slot == YETTY_YCLASS_METHOD_SLOT_UNDEFINED) {
        struct yetty_yclass_method_slot_result method_slot_r = yetty_yclass_method_slot_get(
            "yetty_ymusic", (yetty_yclass_method_id_t)yetty_ymusic_hit_test);
        if (YETTY_IS_ERR(method_slot_r)) {
            return YETTY_ERR(yetty_ycore_int, "yetty_ymusic_hit_test: method_slot_get failed",
                             method_slot_r);
        }
        method_slot = method_slot_r.value;
    }
    ...
    if (!obj) {
        return YETTY_ERR(yetty_ycore_int, "yetty_ymusic_hit_test: NULL object");
    }

    struct yetty_yclass_ptr_result object_class_r = yetty_yclass_object_class(obj);
    YETTY_RETURN_IF_ERR(yetty_ycore_int, object_class_r,
                        "yetty_ymusic_hit_test: object_class failed");
    struct yetty_yclass_impl_t_result dispatch_impl_r =
        yetty_yclass_dispatch_lookup(object_class_r.value, method_slot);
                                                          ...
                                                          int32_t element_id)
{
    ...
    if (method_slot == YETTY_YCLASS_METHOD_SLOT_UNDEFINED) {
        struct yetty_yclass_method_slot_result method_slot_r = yetty_yclass_method_slot_get(
            "yetty_ymusic", (yetty_yclass_method_id_t)yetty_ymusic_set_highlight);
        if (YETTY_IS_ERR(method_slot_r)) {
            return YETTY_ERR(yetty_ycore_void, "yetty_ymusic_set_highlight: method_slot_get failed",
                             method_slot_r);
        }
        method_slot = method_slot_r.value;
    }
    ...
    if (!obj) {
        return YETTY_ERR(yetty_ycore_void, "yetty_ymusic_set_highlight: NULL object");
    }

    struct yetty_yclass_ptr_result object_class_r = yetty_yclass_object_class(obj);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, object_class_r,
                        "yetty_ymusic_set_highlight: object_class failed");
    struct yetty_yclass_impl_t_result dispatch_impl_r =
        yetty_yclass_dispatch_lookup(object_class_r.value, method_slot);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, dispatch_impl_r,
                                                    ...
                                                    struct yetty_yclass_object *obj)
{
    ...
    if (method_slot == YETTY_YCLASS_METHOD_SLOT_UNDEFINED) {
        struct yetty_yclass_method_slot_result method_slot_r = yetty_yclass_method_slot_get(
            "yetty_ymusic", (yetty_yclass_method_id_t)yetty_ymusic_destroy);
        if (YETTY_IS_ERR(method_slot_r)) {
            return YETTY_ERR(yetty_ycore_void, "yetty_ymusic_destroy: method_slot_get failed",
                             method_slot_r);
        }
        method_slot = method_slot_r.value;
    }
    ...
    if (!obj) {
        return YETTY_ERR(yetty_ycore_void, "yetty_ymusic_destroy: NULL object");
    }

    struct yetty_yclass_ptr_result object_class_r = yetty_yclass_object_class(obj);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, object_class_r,
                        "yetty_ymusic_destroy: object_class failed");
    struct yetty_yclass_impl_t_result dispatch_impl_r =
        yetty_yclass_dispatch_lookup(object_class_r.value, method_slot);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, dispatch_impl_r,
...
struct yetty_yclass_object_ptr_result yetty_ymusic_music_create(struct yetty_yclass_ctx *ctx)
{
     ...
     * response isn't silently swallowed. */
    {
        ...
        if (YETTY_IS_ERR(translate_class_r)) {
            yetty_ycore_error_print(
                stderr, "yetty_ymusic_music_create: translate_class (degraded — will lazy-resolve)",
    ...
    if (YETTY_IS_ERR(create_call_r)) {
        return YETTY_ERR(yetty_yclass_object_ptr, "yetty_ymusic_music_create: CREATE call failed",
                         create_call_r);
    }
...
/* ---- ymusic/music: class name -> accessor ---------------------- */
static struct yetty_yclass_ptr_result yetty_ymusic_music_accessor_lookup(const char *name)
{
...
struct yetty_ycore_void_result yetty_ymusic_music_register_hooks(void)
{
    struct yetty_ycore_void_result add_accessor_r =
        yetty_yclass_add_accessor_lookup(yetty_ymusic_music_accessor_lookup);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, add_accessor_r,
                        "yetty_ymusic_music_register_hooks: accessor");
...
struct yetty_ycore_void_result yetty_ymusic_register(void)
{
    ...
    {
        struct yetty_ycore_void_result hook_r = yetty_ymusic_music_register_hooks();
        YETTY_RETURN_IF_ERR(yetty_ycore_void, hook_r, "yetty_ymusic_register: music");
    }
    registered = true;
    return YETTY_OK_VOID();
}
