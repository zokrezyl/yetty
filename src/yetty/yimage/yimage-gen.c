...
static struct yetty_ydraw_gpu_resource_set yimage_lib_rs;
...
static void yimage_populate_rs(struct yetty_ydraw_gpu_resource_set *rs)
{
    yimage_init_lib_rs();
    ...
    rs->children[0] = (struct yetty_ydraw_gpu_resource_set *)&yimage_lib_rs;
    rs->children_count = 1;
...
static struct yetty_ydraw_figure_instance_ptr_result yimage_create_instance(
