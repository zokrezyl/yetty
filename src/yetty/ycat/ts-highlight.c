...
static struct yetty_ycore_void_result emit_runs(struct yetty_ydraw_drawable_list *buf,
                                                             ...
                                                             const struct yetty_ycat_config *config)
{
    ...
    if (!color_map && err) {
        return YETTY_ERR(yetty_ydraw_drawable_list, err);
    }
    ...
    if (YETTY_IS_ERR(er)) {
        ...
        return YETTY_ERR(yetty_ydraw_drawable_list, "ts-highlight: emit_runs failed", er);
    }
    return br;
}
                                                             ...
                                                             const struct yetty_ycat_config *config)
{
    ...
    (void)grammar_name;
    (void)config;
    return YETTY_ERR(yetty_ydraw_drawable_list, "tree-sitter not compiled in");
}
