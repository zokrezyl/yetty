...
const char *yetty_ycat_grammar_from_extension(const char *ext)
{
    ...
    if (strcasecmp(ext, "cpp") == 0 || strcasecmp(ext, "cc") == 0 || strcasecmp(ext, "cxx") == 0 ||
        strcasecmp(ext, "hpp") == 0 || strcasecmp(ext, "hxx") == 0 || strcasecmp(ext, "hh") == 0) {
        return "cpp";
    }
    if (strcasecmp(ext, "py") == 0 || strcasecmp(ext, "pyi") == 0) {
        return "python";
    }
    if (strcasecmp(ext, "js") == 0 || strcasecmp(ext, "mjs") == 0 || strcasecmp(ext, "cjs") == 0 ||
        strcasecmp(ext, "jsx") == 0) {
        return "javascript";
    }
    ...
    if (strcasecmp(ext, "sh") == 0 || strcasecmp(ext, "bash") == 0 || strcasecmp(ext, "zsh") == 0) {
        return "bash";
    }
    ...
    if (strcasecmp(ext, "md") == 0 || strcasecmp(ext, "markdown") == 0 ||
        strcasecmp(ext, "mdown") == 0 || strcasecmp(ext, "mkd") == 0) {
        return "markdown";
    }
    return NULL;
}
