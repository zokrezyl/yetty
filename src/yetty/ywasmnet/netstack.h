/* ywasmnet netstack — a userspace TCP/IP stack (lwIP) in the browser.
 *
...
#ifndef YETTY_YWASMNET_NETSTACK_H
#define YETTY_YWASMNET_NETSTACK_H
...
#endif /* YETTY_YWASMNET_NETSTACK_H */
