...
/* ---- yterm: install hooks before main ------------------------- */

__attribute__((constructor))
static void yetty_yterm_install_hooks(void)
{
    struct yetty_ycore_void_result add_accessor_r =
        yetty_yclass_add_accessor_lookup(yetty_yterm_accessor_lookup);
    if (YETTY_IS_ERR(add_accessor_r)) {
        yetty_ycore_error_print(stderr, "yetty_yterm_install_hooks", add_accessor_r.error);
