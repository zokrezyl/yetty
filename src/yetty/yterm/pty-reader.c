...
struct yetty_yterm_pty_reader_result yetty_yterm_pty_reader_create(struct yetty_platform_pty *pty)
{
    ...
    struct yetty_ywire_wire_statemachine_ptr_result sr =
        yetty_ywire_wire_statemachine_create(pty);
    if (YETTY_IS_ERR(sr)) {
        free(r);
...
struct yetty_ycore_void_result yetty_yterm_pty_reader_destroy(struct yetty_yterm_pty_reader *reader)
{
    ...
    if (reader->osc_statemachine) {
        struct yetty_ycore_void_result r =
            yetty_ywire_wire_statemachine_destroy(reader->osc_statemachine);
        if (YETTY_IS_ERR(r)) {
            free(reader);
    ...
    struct yetty_yterm_pty_reader *reader, struct yetty_yrender_terminal_layer *layer)
{
    ...
    return yetty_ywire_wire_statemachine_set_default(reader->osc_statemachine, layer);
}
    ...
    struct yetty_yrender_terminal_layer *layer)
{
    ...
    return yetty_ywire_wire_statemachine_register(reader->osc_statemachine, code, layer);
}
                                                           ...
                                                           const char *data, size_t len)
{
    ...
    struct yetty_ycore_void_result fr =
        yetty_ywire_wire_statemachine_feed(reader->osc_statemachine, data, len);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, fr, "pty_reader: feed");
    struct yetty_ycore_void_result pr =
        yetty_ywire_wire_statemachine_process(reader->osc_statemachine);
