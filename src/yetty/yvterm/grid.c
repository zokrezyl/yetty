 ...
 * Exposed so the renderer can read attrs for bold/italic/underline/strike. */
 ...
 * need to drop external yfigures that the grid model does not own. Exposed so
 * the terminal can install it through the generated setter. */
