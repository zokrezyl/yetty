...
[[maybe_unused]]
static yetty_yfigure_render_fn yetty_yvterm_grid_yetty_yfigure_render_check = grid_figure_render_slot;
[[maybe_unused]]
static yetty_yfigure_destroy_fn yetty_yvterm_grid_yetty_yfigure_destroy_check = grid_figure_destroy_slot;
...
struct yetty_yclass_ptr_result yetty_yvterm_grid_class_get(void)
{
    ...
    static const struct yetty_yclass_op ops[] = {
        {"yetty_yfigure", "render", (yetty_yclass_method_id_t)yetty_yfigure_render, (yetty_yclass_impl_t)grid_figure_render_slot},
        {"yetty_yfigure", "destroy", (yetty_yclass_method_id_t)yetty_yfigure_destroy, (yetty_yclass_impl_t)grid_figure_destroy_slot},
    };
    ...
    if (YETTY_IS_ERR(parent_class_r)) {
        ...
        return YETTY_ERR(yetty_yclass_ptr, "yetty_yvterm_grid_class_get: parent accessor failed", parent_class_r);
    }
