...
struct yetty_ycore_void_result yetty_yvterm_register(void)
{
    ...
    {
        struct yetty_ycore_void_result hook_r = yetty_yvterm_shader_glyph_figure_register_hooks();
        YETTY_RETURN_IF_ERR(yetty_ycore_void, hook_r, "yetty_yvterm_register: shader_glyph_figure");
    }
    registered = true;
    return YETTY_OK_VOID();
}
