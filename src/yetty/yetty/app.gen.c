...
struct yetty_yclass_ptr_result yetty_yetty_app_class_get(void)
{
    ...
    static const struct yetty_yclass_op ops[] = {
        {"yetty_yapp", "init", (yetty_yclass_method_id_t)yetty_yapp_init, (yetty_yclass_impl_t)yetty_app_init},
        {"yetty_yapp", "run", (yetty_yclass_method_id_t)yetty_yapp_run, (yetty_yclass_impl_t)yetty_app_run},
    };
    ...
    if (YETTY_IS_ERR(parent_class_r)) {
        ...
        return YETTY_ERR(yetty_yclass_ptr, "yetty_yetty_app_class_get: parent accessor failed", parent_class_r);
    }
    ...
    if (YETTY_IS_ERR(register_class_r)) {
        ...
        return YETTY_ERR(yetty_yclass_ptr, "yetty_yetty_app_class_get: class_register failed", register_class_r);
    }
...
struct yetty_yclass_object *yetty_yetty_app_to(struct yetty_yetty_app *data)
{
    if (!data)
        return NULL;
    struct yetty_yclass_ptr_result class_r = yetty_yetty_app_class_get();
...
struct yetty_yclass_object_ptr_result yetty_yetty_app_create(struct yetty_yclass_ctx *ctx)
{
    ...
    if (YETTY_IS_ERR(class_accessor_r))
        return YETTY_ERR(yetty_yclass_object_ptr,
                         "yetty_yetty_app_create: class accessor failed", class_accessor_r);
     ...
     * response isn't silently swallowed. */
    {
        ...
        if (YETTY_IS_ERR(translate_class_r)) {
            yetty_ycore_error_print(stderr,
                "yetty_yetty_app_create: translate_class (degraded — will lazy-resolve)",
    ...
    if (YETTY_IS_ERR(create_call_r))
        return YETTY_ERR(yetty_yclass_object_ptr,
                         "yetty_yetty_app_create: CREATE call failed", create_call_r);
