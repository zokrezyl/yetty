...
def generate_ysdf2_classes(prims: list[dict], out: Path) -> None:
    ...
    for p in prims:
        ...
        lines.append("    struct uint32_result z_r = yetty_ydrawlist2_shape_z_get(obj);")
        lines.append(f'    YETTY_RETURN_IF_ERR(yetty_ycore_void, z_r, "ysdf2 {name} pack: z");')
        ...
        lines.append("    }")
        lines.append("    data[off++] = z_r.value;")
