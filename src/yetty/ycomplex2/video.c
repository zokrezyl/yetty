                                                 ...
                                                 struct yetty_ydraw_drawable_list *list)
{
    ...
    if (video->video_w == 0 || video->video_h == 0) {
        return YETTY_ERR(yetty_ycore_void,
                         "ycomplex2 video pack: video_w/video_h required (SPS dimensions)");
    }
    ...
    YETTY_RETURN_IF_ERR(yetty_ycore_void, append_r, "ycomplex2 video pack: append");
    return YETTY_OK_VOID();
}
