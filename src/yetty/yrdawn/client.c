                                               ...
                                               uint32_t req_id, const void *body, size_t body_len)
{
    ...
    struct yetty_ycore_void_result emit =
        yetty_yface_emit_to_fd(c->out_fd, YETTY_YRDAWN_OSC_CS_CMD, 1, NULL, 0, frame, total);
    free(frame);
...
struct yetty_ycore_void_result yetty_yrdawn_client_send_bye(struct yetty_yrdawn_client *c)
{
    ...
    struct yetty_ycore_void_result emit =
        yetty_yface_emit_to_fd(c->out_fd, YETTY_YRDAWN_OSC_CS_BYE, 0, NULL, 0, &bye, sizeof(bye));
