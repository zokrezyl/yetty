 ...
 *
 * The full definition lives here in the owning .c (this TU does not include
 * its own generated figure.h); the `expose` annotation tells codegen to
 * reproduce it into the public figure.h for consumers. yframework.h only
 * forward-declares the struct, so this fuller definition is compatible.
 *=========================================================================*/
