...
struct yetty_yclass_ptr_result yetty_yrdawn_figure_class_get(void) __attribute__((weak));
...
{
    if (strcmp(name, "yetty_yrdawn_figure") == 0 && yetty_yrdawn_figure_class_get) {
