...
/* Split-specific */
struct yetty_ycore_void_result yetty_yui_split_set_first(struct yetty_yui_tile *split,
                                                         struct yetty_yui_tile *tile);

struct yetty_ycore_void_result yetty_yui_split_set_second(struct yetty_yui_tile *split,
                                                          struct yetty_yui_tile *tile);

struct yetty_ycore_void_result yetty_yui_split_set_ratio(struct yetty_yui_tile *split, float ratio);
...
enum yetty_yui_orientation yetty_yui_split_orientation(const struct yetty_yui_tile *split);

/* Pane-specific */
struct yetty_ycore_void_result yetty_yui_pane_push_view(struct yetty_yui_tile *pane,
                                                        struct yetty_yui_view *view);

struct yetty_ycore_void_result yetty_yui_pane_pop_view(struct yetty_yui_tile *pane);
...
int yetty_yui_pane_has_view(const struct yetty_yui_tile *pane, yetty_ycore_object_id view_id);
