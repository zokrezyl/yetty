...
[[maybe_unused]]
static yetty_yrich_constructor_fn yetty_yrich_shape_yetty_yrich_constructor_check = shape_constructor;
[[maybe_unused]]
static yetty_yrich_element_destroy_fn yetty_yrich_shape_yetty_yrich_element_destroy_check = shape_destroy;
[[maybe_unused]]
static yetty_yrich_element_bounds_fn yetty_yrich_shape_yetty_yrich_element_bounds_check = shape_bounds;
[[maybe_unused]]
static yetty_yrich_element_is_editable_fn yetty_yrich_shape_yetty_yrich_element_is_editable_check = shape_is_editable;
[[maybe_unused]]
static yetty_yrich_element_begin_edit_fn yetty_yrich_shape_yetty_yrich_element_begin_edit_check = shape_begin_edit;
[[maybe_unused]]
static yetty_yrich_element_end_edit_fn yetty_yrich_shape_yetty_yrich_element_end_edit_check = shape_end_edit;
[[maybe_unused]]
static yetty_yrich_element_is_editing_fn yetty_yrich_shape_yetty_yrich_element_is_editing_check = shape_is_editing;
[[maybe_unused]]
static yetty_yrich_element_render_fn yetty_yrich_shape_yetty_yrich_element_render_check = shape_render;
[[maybe_unused]]
static yetty_yrich_element_insert_text_fn yetty_yrich_shape_yetty_yrich_element_insert_text_check = shape_insert_text;
[[maybe_unused]]
static yetty_yrich_element_delete_sel_fn yetty_yrich_shape_yetty_yrich_element_delete_sel_check = shape_delete_sel;
...
struct yetty_yclass_ptr_result yetty_yrich_shape_class_get(void)
{
    ...
    static const struct yetty_yclass_op ops[] = {
        {"yetty_yrich", "constructor", (yetty_yclass_method_id_t)yetty_yrich_constructor, (yetty_yclass_impl_t)shape_constructor},
        {"yetty_yrich", "element_destroy", (yetty_yclass_method_id_t)yetty_yrich_element_destroy, (yetty_yclass_impl_t)shape_destroy},
        {"yetty_yrich", "element_bounds", (yetty_yclass_method_id_t)yetty_yrich_element_bounds, (yetty_yclass_impl_t)shape_bounds},
        {"yetty_yrich", "element_is_editable", (yetty_yclass_method_id_t)yetty_yrich_element_is_editable, (yetty_yclass_impl_t)shape_is_editable},
        {"yetty_yrich", "element_begin_edit", (yetty_yclass_method_id_t)yetty_yrich_element_begin_edit, (yetty_yclass_impl_t)shape_begin_edit},
        {"yetty_yrich", "element_end_edit", (yetty_yclass_method_id_t)yetty_yrich_element_end_edit, (yetty_yclass_impl_t)shape_end_edit},
        {"yetty_yrich", "element_is_editing", (yetty_yclass_method_id_t)yetty_yrich_element_is_editing, (yetty_yclass_impl_t)shape_is_editing},
        {"yetty_yrich", "element_render", (yetty_yclass_method_id_t)yetty_yrich_element_render, (yetty_yclass_impl_t)shape_render},
        {"yetty_yrich", "element_insert_text", (yetty_yclass_method_id_t)yetty_yrich_element_insert_text, (yetty_yclass_impl_t)shape_insert_text},
        {"yetty_yrich", "element_delete_sel", (yetty_yclass_method_id_t)yetty_yrich_element_delete_sel, (yetty_yclass_impl_t)shape_delete_sel},
    };
    ...
    if (YETTY_IS_ERR(parent_class_r)) {
        ...
        return YETTY_ERR(yetty_yclass_ptr, "yetty_yrich_shape_class_get: parent accessor failed", parent_class_r);
    }
    struct yetty_yclass_ptr_result register_class_r =
        yetty_yclass_register(&desc, ops, sizeof(ops) / sizeof(ops[0]),
                              parent_class_r.value, NULL, 0);
    if (YETTY_IS_ERR(register_class_r)) {
        yerror("yetty_yrich_shape_class_get: class_register failed: %s", register_class_r.error.msg);
        return YETTY_ERR(yetty_yclass_ptr, "yetty_yrich_shape_class_get: class_register failed", register_class_r);
    }
...
[[maybe_unused]]
static yetty_yrich_constructor_fn yetty_yrich_slides_yetty_yrich_constructor_check = slides_constructor;
[[maybe_unused]]
static yetty_yrich_document_destroy_fn yetty_yrich_slides_yetty_yrich_document_destroy_check = slides_destroy;
[[maybe_unused]]
static yetty_yrich_document_content_width_fn yetty_yrich_slides_yetty_yrich_document_content_width_check = slides_content_width;
[[maybe_unused]]
static yetty_yrich_document_content_height_fn yetty_yrich_slides_yetty_yrich_document_content_height_check = slides_content_height;
[[maybe_unused]]
static yetty_yrich_document_render_fn yetty_yrich_slides_yetty_yrich_document_render_check = slides_render;
[[maybe_unused]]
static yetty_yrich_slides_set_current_fn yetty_yrich_slides_yetty_yrich_slides_set_current_check = slides_set_current;
[[maybe_unused]]
...
struct yetty_yclass_ptr_result yetty_yrich_slides_class_get(void)
{
    ...
    static const struct yetty_yclass_op ops[] = {
        {"yetty_yrich", "constructor", (yetty_yclass_method_id_t)yetty_yrich_constructor, (yetty_yclass_impl_t)slides_constructor},
        {"yetty_yrich", "document_destroy", (yetty_yclass_method_id_t)yetty_yrich_document_destroy, (yetty_yclass_impl_t)slides_destroy},
        {"yetty_yrich", "document_content_width", (yetty_yclass_method_id_t)yetty_yrich_document_content_width, (yetty_yclass_impl_t)slides_content_width},
        {"yetty_yrich", "document_content_height", (yetty_yclass_method_id_t)yetty_yrich_document_content_height, (yetty_yclass_impl_t)slides_content_height},
        {"yetty_yrich", "document_render", (yetty_yclass_method_id_t)yetty_yrich_document_render, (yetty_yclass_impl_t)slides_render},
        {"yetty_yrich", "slides_set_current", (yetty_yclass_method_id_t)yetty_yrich_slides_set_current, (yetty_yclass_impl_t)slides_set_current},
        {"yetty_yrich", "slides_next", (yetty_yclass_method_id_t)yetty_yrich_slides_next, (yetty_yclass_impl_t)slides_next},
        {"yetty_yrich", "slides_prev", (yetty_yclass_method_id_t)yetty_yrich_slides_prev, (yetty_yclass_impl_t)slides_prev},
    };
    struct yetty_yclass_ptr_result parent_class_r = yetty_yrich_document_class_get();
    if (YETTY_IS_ERR(parent_class_r)) {
        yerror("yetty_yrich_slides_class_get: parent accessor failed: %s", parent_class_r.error.msg);
        return YETTY_ERR(yetty_yclass_ptr, "yetty_yrich_slides_class_get: parent accessor failed", parent_class_r);
    }
    struct yetty_yclass_ptr_result register_class_r =
        yetty_yclass_register(&desc, ops, sizeof(ops) / sizeof(ops[0]),
                              parent_class_r.value, NULL, 0);
    if (YETTY_IS_ERR(register_class_r)) {
        yerror("yetty_yrich_slides_class_get: class_register failed: %s", register_class_r.error.msg);
        return YETTY_ERR(yetty_yclass_ptr, "yetty_yrich_slides_class_get: class_register failed", register_class_r);
    }
    cls = register_class_r.value;
    return register_class_r;
}
...
struct yetty_yrich_slides_ptr_result yetty_yrich_slides_from(struct yetty_yclass_object *obj)
{
    ...
    if (YETTY_IS_ERR(class_r))
        return YETTY_ERR(yetty_yrich_slides_ptr, "yetty_yrich_slides_from: class accessor", class_r);
    struct yetty_yclass_void_ptr_result slice_r =
        yetty_yclass_object_data(obj, class_r.value);
    if (YETTY_IS_ERR(slice_r))
...
struct yetty_ycore_void_result yetty_yrich_slides_set_current(struct yetty_yclass_object * obj, int32_t index)
{
    ...
    if (method_slot == YETTY_YCLASS_METHOD_SLOT_UNDEFINED) {
        struct yetty_yclass_method_slot_result method_slot_r =
            yetty_yclass_method_slot_get("yetty_yrich", (yetty_yclass_method_id_t)yetty_yrich_slides_set_current);
    ...
    if (obj->session) {
        ...
        YETTY_RETURN_IF_ERR(yetty_ycore_void, remote_id_r, "yetty_yrich_slides_set_current: ensure_remote_id failed");
...
#pragma pack(pop)
        ...
        if (response_len < 1) {
            free(resp_buf);
            return YETTY_ERR(yetty_ycore_void, "yetty_yrich_slides_set_current: short RPC response");
        }
        if (resp_buf[0] != 0) {
            ...
            struct yetty_ycore_void_result remote_error =
                YETTY_ERR(yetty_ycore_void, "yetty_yrich_slides_set_current: remote impl returned error");
...
struct yetty_ycore_void_result yetty_yrich_slides_next(struct yetty_yclass_object * obj)
{
    ...
    if (method_slot == YETTY_YCLASS_METHOD_SLOT_UNDEFINED) {
        struct yetty_yclass_method_slot_result method_slot_r =
            yetty_yclass_method_slot_get("yetty_yrich", (yetty_yclass_method_id_t)yetty_yrich_slides_next);
        if (YETTY_IS_ERR(method_slot_r))
    ...
    if (obj->session) {
        struct uint32_result remote_id_r =
            yetty_yclass_rpc_session_ensure_remote_id(obj->session, method_slot);
        YETTY_RETURN_IF_ERR(yetty_ycore_void, remote_id_r, "yetty_yrich_slides_next: ensure_remote_id failed");
        uint32_t remote_id = remote_id_r.value;
/* Byte-exact wire layout — #pragma pack matches the first-party
 * convention (yvnc/ydvnc/libvterm) and compiles on MSVC, unlike a GNU
 * packed attribute. */
...
#pragma pack(pop)
        ...
        if (resp_buf[0] != 0) {
            ...
            free(resp_buf);
            struct yetty_ycore_void_result remote_error =
                YETTY_ERR(yetty_ycore_void, "yetty_yrich_slides_next: remote impl returned error");
            remote_error.error.cause = remote_chain;
            return remote_error;
        }
        free(resp_buf);
...
struct yetty_ycore_void_result yetty_yrich_slides_prev(struct yetty_yclass_object * obj)
{
    ...
    if (method_slot == YETTY_YCLASS_METHOD_SLOT_UNDEFINED) {
        struct yetty_yclass_method_slot_result method_slot_r =
            yetty_yclass_method_slot_get("yetty_yrich", (yetty_yclass_method_id_t)yetty_yrich_slides_prev);
        if (YETTY_IS_ERR(method_slot_r))
    ...
    if (obj->session) {
        struct uint32_result remote_id_r =
            yetty_yclass_rpc_session_ensure_remote_id(obj->session, method_slot);
        YETTY_RETURN_IF_ERR(yetty_ycore_void, remote_id_r, "yetty_yrich_slides_prev: ensure_remote_id failed");
        uint32_t remote_id = remote_id_r.value;
/* Byte-exact wire layout — #pragma pack matches the first-party
 * convention (yvnc/ydvnc/libvterm) and compiles on MSVC, unlike a GNU
 * packed attribute. */
...
#pragma pack(pop)
        ...
        if (resp_buf[0] != 0) {
            ...
            free(resp_buf);
            struct yetty_ycore_void_result remote_error =
                YETTY_ERR(yetty_ycore_void, "yetty_yrich_slides_prev: remote impl returned error");
            remote_error.error.cause = remote_chain;
            return remote_error;
        }
        free(resp_buf);
...
size_t yetty_yrich_slides_set_current_skel(const void *body, size_t body_len,
...
#pragma pack(pop)
    ...
    if (YETTY_IS_ERR(obj_resolve_r)) {
        yetty_ycore_error_print(stderr,
            "[skel] yetty_yrich_slides_set_current: handle_resolve", obj_resolve_r.error);
        if (resp_max < 1) {
    ...
    struct yetty_ycore_void_result call_r = yetty_yrich_slides_set_current((struct yetty_yclass_object *)obj_resolve_r.value, wire_args.index);
...
YETTY_EXTERNAL_CALLBACK
size_t yetty_yrich_slides_next_skel(const void *body, size_t body_len,
                   void *resp, size_t resp_max)
{
/* Byte-exact wire layout — #pragma pack matches the first-party
 * convention (yvnc/ydvnc/libvterm) and compiles on MSVC, unlike a GNU
...
#pragma pack(pop)
    ...
    if (YETTY_IS_ERR(obj_resolve_r)) {
        yetty_ycore_error_print(stderr,
            "[skel] yetty_yrich_slides_next: handle_resolve", obj_resolve_r.error);
        if (resp_max < 1) {
            yetty_ycore_error_destroy(obj_resolve_r.error);
            return 0;
        }
    ...
    struct yetty_ycore_void_result call_r = yetty_yrich_slides_next((struct yetty_yclass_object *)obj_resolve_r.value);
    if (resp_max < 1) return 0;
    if (YETTY_IS_ERR(call_r)) {
...
YETTY_EXTERNAL_CALLBACK
size_t yetty_yrich_slides_prev_skel(const void *body, size_t body_len,
                   void *resp, size_t resp_max)
{
/* Byte-exact wire layout — #pragma pack matches the first-party
 * convention (yvnc/ydvnc/libvterm) and compiles on MSVC, unlike a GNU
...
#pragma pack(pop)
    ...
    if (YETTY_IS_ERR(obj_resolve_r)) {
        yetty_ycore_error_print(stderr,
            "[skel] yetty_yrich_slides_prev: handle_resolve", obj_resolve_r.error);
        if (resp_max < 1) {
            yetty_ycore_error_destroy(obj_resolve_r.error);
            return 0;
        }
    ...
    struct yetty_ycore_void_result call_r = yetty_yrich_slides_prev((struct yetty_yclass_object *)obj_resolve_r.value);
    if (resp_max < 1) return 0;
    if (YETTY_IS_ERR(call_r)) {
...
struct yetty_yclass_object_ptr_result yetty_yrich_shape_create(struct yetty_yclass_ctx *ctx)
{
    ...
    if (YETTY_IS_ERR(class_accessor_r))
        return YETTY_ERR(yetty_yclass_object_ptr,
                         "yetty_yrich_shape_create: class accessor failed", class_accessor_r);
     ...
     * response isn't silently swallowed. */
    {
        ...
        if (YETTY_IS_ERR(translate_class_r)) {
            yetty_ycore_error_print(stderr,
                "yetty_yrich_shape_create: translate_class (degraded — will lazy-resolve)",
    ...
    if (YETTY_IS_ERR(create_call_r))
        return YETTY_ERR(yetty_yclass_object_ptr,
                         "yetty_yrich_shape_create: CREATE call failed", create_call_r);
...
struct yetty_yclass_object_ptr_result yetty_yrich_slides_create(struct yetty_yclass_ctx *ctx)
{
     ...
     * response isn't silently swallowed. */
    {
        ...
        if (YETTY_IS_ERR(translate_class_r)) {
            yetty_ycore_error_print(stderr,
                "yetty_yrich_slides_create: translate_class (degraded — will lazy-resolve)",
                translate_class_r.error);
            yetty_ycore_error_destroy(translate_class_r.error);
        }
    }
    ...
    if (YETTY_IS_ERR(create_call_r))
        return YETTY_ERR(yetty_yclass_object_ptr,
                         "yetty_yrich_slides_create: CREATE call failed", create_call_r);
    if (create_call_r.value != sizeof(handle) || !handle)
        return YETTY_ERR(yetty_yclass_object_ptr,
    ...
    struct yetty_yclass_proxy *proxy = calloc(1, sizeof(*proxy));
    if (!proxy)
        return YETTY_ERR(yetty_yclass_object_ptr, "yetty_yrich_slides_create: calloc(proxy) failed");
    proxy->header.klass = klass;
    /* Link the session onto the proxy so its methods marshal over it — they
     * read obj->session instead of taking a ctx argument. */
    proxy->header.session = ctx->session;
