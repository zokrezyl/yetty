...
6. **Complete GUI input wiring.** Preserve modifiers through `yrich_view` (fix `mods=0`), wire double/triple click and context menus, and route keyboard, pointer, clipboard, and IME events through semantic editor commands.
