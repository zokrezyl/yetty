...
static size_t yetty_yrich_constructor_skel(const void *body, size_t body_len, void *resp,
                                           size_t resp_max)
{
 ...
 * status wire response at this boundary. */
YETTY_EXTERNAL_CALLBACK
static size_t yetty_yrich_document_content_width_skel(const void *body, size_t body_len, void *resp,
                                                      size_t resp_max)
{
/* Byte-exact wire layout — #pragma pack matches the first-party
 * convention (yvnc/ydvnc/libvterm) and compiles on MSVC, unlike a GNU
 ...
 * status wire response at this boundary. */
YETTY_EXTERNAL_CALLBACK
static size_t yetty_yrich_document_content_height_skel(const void *body, size_t body_len,
 ...
 * status wire response at this boundary. */
YETTY_EXTERNAL_CALLBACK
static size_t yetty_yrich_document_undo_skel(const void *body, size_t body_len, void *resp,
                                             size_t resp_max)
{
/* Byte-exact wire layout — #pragma pack matches the first-party
 * convention (yvnc/ydvnc/libvterm) and compiles on MSVC, unlike a GNU
 ...
 * status wire response at this boundary. */
YETTY_EXTERNAL_CALLBACK
static size_t yetty_yrich_document_redo_skel(const void *body, size_t body_len, void *resp,
                                             size_t resp_max)
{
/* Byte-exact wire layout — #pragma pack matches the first-party
 * convention (yvnc/ydvnc/libvterm) and compiles on MSVC, unlike a GNU
 ...
 * status wire response at this boundary. */
YETTY_EXTERNAL_CALLBACK
static size_t yetty_yrich_document_on_mouse_down_skel(const void *body, size_t body_len, void *resp,
                                                      size_t resp_max)
{
/* Byte-exact wire layout — #pragma pack matches the first-party
 * convention (yvnc/ydvnc/libvterm) and compiles on MSVC, unlike a GNU
 ...
 * status wire response at this boundary. */
YETTY_EXTERNAL_CALLBACK
static size_t yetty_yrich_document_on_mouse_up_skel(const void *body, size_t body_len, void *resp,
                                                    size_t resp_max)
{
/* Byte-exact wire layout — #pragma pack matches the first-party
 * convention (yvnc/ydvnc/libvterm) and compiles on MSVC, unlike a GNU
 ...
 * status wire response at this boundary. */
YETTY_EXTERNAL_CALLBACK
static size_t yetty_yrich_document_on_mouse_drag_skel(const void *body, size_t body_len, void *resp,
                                                      size_t resp_max)
{
/* Byte-exact wire layout — #pragma pack matches the first-party
 * convention (yvnc/ydvnc/libvterm) and compiles on MSVC, unlike a GNU
 ...
 * status wire response at this boundary. */
YETTY_EXTERNAL_CALLBACK
static size_t yetty_yrich_document_on_mouse_double_click_skel(const void *body, size_t body_len,
                                                              void *resp, size_t resp_max)
{
/* Byte-exact wire layout — #pragma pack matches the first-party
 * convention (yvnc/ydvnc/libvterm) and compiles on MSVC, unlike a GNU
 ...
 * status wire response at this boundary. */
YETTY_EXTERNAL_CALLBACK
static size_t yetty_yrich_document_on_key_down_skel(const void *body, size_t body_len, void *resp,
                                                    size_t resp_max)
{
/* Byte-exact wire layout — #pragma pack matches the first-party
 * convention (yvnc/ydvnc/libvterm) and compiles on MSVC, unlike a GNU
 ...
 * status wire response at this boundary. */
YETTY_EXTERNAL_CALLBACK
static size_t yetty_yrich_document_on_text_input_skel(const void *body, size_t body_len, void *resp,
                                                      size_t resp_max)
{
/* Byte-exact wire layout — #pragma pack matches the first-party
 * convention (yvnc/ydvnc/libvterm) and compiles on MSVC, unlike a GNU
 ...
 * status wire response at this boundary. */
YETTY_EXTERNAL_CALLBACK
static size_t yetty_yrich_element_hit_test_skel(const void *body, size_t body_len, void *resp,
                                                size_t resp_max)
{
/* Byte-exact wire layout — #pragma pack matches the first-party
 * convention (yvnc/ydvnc/libvterm) and compiles on MSVC, unlike a GNU
 ...
 * status wire response at this boundary. */
YETTY_EXTERNAL_CALLBACK
static size_t yetty_yrich_element_is_editable_skel(const void *body, size_t body_len, void *resp,
                                                   size_t resp_max)
{
/* Byte-exact wire layout — #pragma pack matches the first-party
 * convention (yvnc/ydvnc/libvterm) and compiles on MSVC, unlike a GNU
 ...
 * status wire response at this boundary. */
YETTY_EXTERNAL_CALLBACK
static size_t yetty_yrich_element_begin_edit_skel(const void *body, size_t body_len, void *resp,
                                                  size_t resp_max)
{
/* Byte-exact wire layout — #pragma pack matches the first-party
 * convention (yvnc/ydvnc/libvterm) and compiles on MSVC, unlike a GNU
 ...
 * status wire response at this boundary. */
YETTY_EXTERNAL_CALLBACK
static size_t yetty_yrich_element_end_edit_skel(const void *body, size_t body_len, void *resp,
                                                size_t resp_max)
{
/* Byte-exact wire layout — #pragma pack matches the first-party
 * convention (yvnc/ydvnc/libvterm) and compiles on MSVC, unlike a GNU
 ...
 * status wire response at this boundary. */
YETTY_EXTERNAL_CALLBACK
static size_t yetty_yrich_element_is_editing_skel(const void *body, size_t body_len, void *resp,
                                                  size_t resp_max)
{
/* Byte-exact wire layout — #pragma pack matches the first-party
 * convention (yvnc/ydvnc/libvterm) and compiles on MSVC, unlike a GNU
 ...
 * status wire response at this boundary. */
YETTY_EXTERNAL_CALLBACK
static size_t yetty_yrich_element_insert_text_skel(const void *body, size_t body_len, void *resp,
                                                   size_t resp_max)
{
/* Byte-exact wire layout — #pragma pack matches the first-party
 * convention (yvnc/ydvnc/libvterm) and compiles on MSVC, unlike a GNU
 ...
 * status wire response at this boundary. */
YETTY_EXTERNAL_CALLBACK
static size_t yetty_yrich_element_delete_sel_skel(const void *body, size_t body_len, void *resp,
                                                  size_t resp_max)
{
/* Byte-exact wire layout — #pragma pack matches the first-party
 * convention (yvnc/ydvnc/libvterm) and compiles on MSVC, unlike a GNU
 ...
 * status wire response at this boundary. */
YETTY_EXTERNAL_CALLBACK
static size_t yetty_yrich_slides_set_current_skel(const void *body, size_t body_len, void *resp,
                                                  size_t resp_max)
{
/* Byte-exact wire layout — #pragma pack matches the first-party
 * convention (yvnc/ydvnc/libvterm) and compiles on MSVC, unlike a GNU
 ...
 * status wire response at this boundary. */
YETTY_EXTERNAL_CALLBACK
static size_t yetty_yrich_slides_next_skel(const void *body, size_t body_len, void *resp,
                                           size_t resp_max)
{
/* Byte-exact wire layout — #pragma pack matches the first-party
 * convention (yvnc/ydvnc/libvterm) and compiles on MSVC, unlike a GNU
 ...
 * status wire response at this boundary. */
YETTY_EXTERNAL_CALLBACK
static size_t yetty_yrich_slides_prev_skel(const void *body, size_t body_len, void *resp,
                                           size_t resp_max)
{
/* Byte-exact wire layout — #pragma pack matches the first-party
 * convention (yvnc/ydvnc/libvterm) and compiles on MSVC, unlike a GNU
 ...
 * status wire response at this boundary. */
YETTY_EXTERNAL_CALLBACK
static size_t yetty_yrich_spreadsheet_set_grid_size_skel(const void *body, size_t body_len,
                                                         void *resp, size_t resp_max)
{
/* Byte-exact wire layout — #pragma pack matches the first-party
 * convention (yvnc/ydvnc/libvterm) and compiles on MSVC, unlike a GNU
 ...
 * status wire response at this boundary. */
YETTY_EXTERNAL_CALLBACK
static size_t yetty_yrich_spreadsheet_set_row_height_skel(const void *body, size_t body_len,
                                                          void *resp, size_t resp_max)
{
/* Byte-exact wire layout — #pragma pack matches the first-party
 * convention (yvnc/ydvnc/libvterm) and compiles on MSVC, unlike a GNU
 ...
 * status wire response at this boundary. */
YETTY_EXTERNAL_CALLBACK
static size_t yetty_yrich_spreadsheet_set_col_width_skel(const void *body, size_t body_len,
                                                         void *resp, size_t resp_max)
{
/* Byte-exact wire layout — #pragma pack matches the first-party
 * convention (yvnc/ydvnc/libvterm) and compiles on MSVC, unlike a GNU
 ...
 * status wire response at this boundary. */
YETTY_EXTERNAL_CALLBACK
static size_t yetty_yrich_spreadsheet_set_cell_value_skel(const void *body, size_t body_len,
                                                          void *resp, size_t resp_max)
{
/* Byte-exact wire layout — #pragma pack matches the first-party
 * convention (yvnc/ydvnc/libvterm) and compiles on MSVC, unlike a GNU
 ...
 * status wire response at this boundary. */
YETTY_EXTERNAL_CALLBACK
static size_t yetty_yrich_ydoc_toggle_format_skel(const void *body, size_t body_len, void *resp,
                                                  size_t resp_max)
{
/* Byte-exact wire layout — #pragma pack matches the first-party
 * convention (yvnc/ydvnc/libvterm) and compiles on MSVC, unlike a GNU
 ...
 * status wire response at this boundary. */
YETTY_EXTERNAL_CALLBACK
static size_t yetty_yrich_ydoc_set_text_color_skel(const void *body, size_t body_len, void *resp,
                                                   size_t resp_max)
{
/* Byte-exact wire layout — #pragma pack matches the first-party
 * convention (yvnc/ydvnc/libvterm) and compiles on MSVC, unlike a GNU
 ...
 * status wire response at this boundary. */
YETTY_EXTERNAL_CALLBACK
static size_t yetty_yrich_ydoc_set_alignment_skel(const void *body, size_t body_len, void *resp,
                                                  size_t resp_max)
{
/* Byte-exact wire layout — #pragma pack matches the first-party
 * convention (yvnc/ydvnc/libvterm) and compiles on MSVC, unlike a GNU
 ...
 * status wire response at this boundary. */
YETTY_EXTERNAL_CALLBACK
static size_t yetty_yrich_ydoc_set_heading_skel(const void *body, size_t body_len, void *resp,
                                                size_t resp_max)
{
/* Byte-exact wire layout — #pragma pack matches the first-party
 * convention (yvnc/ydvnc/libvterm) and compiles on MSVC, unlike a GNU
 ...
 * status wire response at this boundary. */
YETTY_EXTERNAL_CALLBACK
static size_t yetty_yrich_ydoc_change_font_size_skel(const void *body, size_t body_len, void *resp,
                                                     size_t resp_max)
{
/* Byte-exact wire layout — #pragma pack matches the first-party
 * convention (yvnc/ydvnc/libvterm) and compiles on MSVC, unlike a GNU
