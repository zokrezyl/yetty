 ...
 * to a widget's `struct yetty_ygui_old_layout`. Designed for ergonomic
 ...
 *
 * See ygui.h doc comment on yetty_ygui_old_widget_apply_css for the full
...
static const struct align_kw align_keywords[] = {
    {"auto", YETTY_YGUI_OLD_ALIGN_AUTO},        {"start", YETTY_YGUI_OLD_ALIGN_START},
    {"flex-start", YETTY_YGUI_OLD_ALIGN_START}, {"center", YETTY_YGUI_OLD_ALIGN_CENTER},
    {"end", YETTY_YGUI_OLD_ALIGN_END},          {"flex-end", YETTY_YGUI_OLD_ALIGN_END},
    {"stretch", YETTY_YGUI_OLD_ALIGN_STRETCH},  {"baseline", YETTY_YGUI_OLD_ALIGN_BASELINE},
};
...
static const struct justify_kw justify_keywords[] = {
    {"start", YETTY_YGUI_OLD_JUSTIFY_START},
    {"flex-start", YETTY_YGUI_OLD_JUSTIFY_START},
    {"center", YETTY_YGUI_OLD_JUSTIFY_CENTER},
    {"end", YETTY_YGUI_OLD_JUSTIFY_END},
    {"flex-end", YETTY_YGUI_OLD_JUSTIFY_END},
    {"space-between", YETTY_YGUI_OLD_JUSTIFY_SPACE_BETWEEN},
    {"space-around", YETTY_YGUI_OLD_JUSTIFY_SPACE_AROUND},
    {"space-evenly", YETTY_YGUI_OLD_JUSTIFY_SPACE_EVENLY},
};
                      ...
                      const char *val, size_t vlen, struct css_diag *diag)
{
    ...
    if (css_eqi(prop, plen, "display")) {
        if (css_eqi(val, vlen, "flex")) {
            w->layout.mode = YETTY_YGUI_OLD_LAYOUT_FLEX;
        } else if (css_eqi(val, vlen, "manual") || css_eqi(val, vlen, "block")) {
            w->layout.mode = YETTY_YGUI_OLD_LAYOUT_MANUAL;
        } else {
    ...
    if (css_eqi(prop, plen, "flex-direction")) {
        if (css_eqi(val, vlen, "row")) {
            w->layout.direction = YETTY_YGUI_OLD_FLEX_ROW;
        } else if (css_eqi(val, vlen, "column")) {
            w->layout.direction = YETTY_YGUI_OLD_FLEX_COLUMN;
        } else {
    ...
    if (css_eqi(prop, plen, "flex-wrap")) {
        if (css_eqi(val, vlen, "nowrap")) {
            w->layout.wrap = YETTY_YGUI_OLD_FLEX_NOWRAP;
        } else if (css_eqi(val, vlen, "wrap")) {
            w->layout.wrap = YETTY_YGUI_OLD_FLEX_WRAP;
        } else {
    ...
    if (css_eqi(prop, plen, "position")) {
        if (css_eqi(val, vlen, "relative") || css_eqi(val, vlen, "static")) {
            w->layout.position = YETTY_YGUI_OLD_POSITION_RELATIVE;
        } else if (css_eqi(val, vlen, "absolute")) {
            w->layout.position = YETTY_YGUI_OLD_POSITION_ABSOLUTE;
        } else {
