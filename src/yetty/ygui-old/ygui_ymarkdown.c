...
static struct yetty_ygui_old_widget *attach_to_rich(struct yetty_ygui_old_engine *engine, const char *id,
                                                ...
                                                struct yetty_ymarkdown_render_result r)
{
    ...
    yetty_ygui_old_widget_rich_set_buffer(widget, r.value.buffer);
    return widget;
}

struct yetty_ygui_old_widget *yetty_ygui_old_engine_ymarkdown_from_file(struct yetty_ygui_old_engine *engine,
...
struct yetty_ygui_old_widget *yetty_ygui_old_engine_ymarkdown_from_buffer(struct yetty_ygui_old_engine *engine,
                                                                  const char *id, float x, float y,
                                                                  float w, float h,
...
struct yetty_ygui_old_widget *yetty_ygui_old_engine_ymarkdown_default(struct yetty_ygui_old_engine *engine,
                                                              const char *id, float x, float y,
                                                              float w, float h)
{
    ...
    return yetty_ygui_old_engine_ymarkdown_from_buffer(engine, id, x, y, w, h, g_ymarkdown_default_data,
