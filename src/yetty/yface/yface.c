    ...
    }
    {
        struct yetty_ycore_void_result r =
            yetty_ywire_wire_statemachine_set_envelope_default_buffered(
                y->sm, /*has_args=*/1, yface_on_envelope, y);
...
{
    return yetty_ywire_emit_to_fd(fd, YETTY_YWIRE_ENVELOPE_OSC, osc_code, /*has_args=*/1, compressed,
                                  args, args_len, body, body_len);
}
