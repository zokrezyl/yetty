...
struct yetty_yclass_ptr_result yetty_yjupyter_client_class_get(void)
{
    ...
    static const struct yetty_yclass_op ops[] = {
        {"yetty_yjupyter", "client_open", (yetty_yclass_method_id_t)yetty_yjupyter_client_open,
         (yetty_yclass_impl_t)client_open},
        {"yetty_yjupyter", "client_execute",
         (yetty_yclass_method_id_t)yetty_yjupyter_client_execute,
         (yetty_yclass_impl_t)client_execute},
        {"yetty_yjupyter", "client_poll", (yetty_yclass_method_id_t)yetty_yjupyter_client_poll,
         (yetty_yclass_impl_t)client_poll},
        {"yetty_yjupyter", "client_kernel_state",
         (yetty_yclass_method_id_t)yetty_yjupyter_client_kernel_state,
         (yetty_yclass_impl_t)client_kernel_state},
        {"yetty_yjupyter", "client_tag_for",
         (yetty_yclass_method_id_t)yetty_yjupyter_client_tag_for,
         (yetty_yclass_impl_t)client_tag_for},
        {"yetty_yjupyter", "client_close", (yetty_yclass_method_id_t)yetty_yjupyter_client_close,
         (yetty_yclass_impl_t)client_close},
        {"yetty_yjupyter", "client_destroy",
         (yetty_yclass_method_id_t)yetty_yjupyter_client_destroy,
         (yetty_yclass_impl_t)client_destroy},
    };
    struct yetty_yclass_ptr_result register_class_r =
        yetty_yclass_register(&desc, ops, sizeof(ops) / sizeof(ops[0]), NULL, NULL, 0);
    if (YETTY_IS_ERR(register_class_r)) {
        yerror("yetty_yjupyter_client_class_get: class_register failed: %s",
               register_class_r.error.msg);
        return YETTY_ERR(yetty_yclass_ptr, "yetty_yjupyter_client_class_get: class_register failed",
                         register_class_r);
    }
...
struct yetty_yjupyter_client_ptr_result yetty_yjupyter_client_from(struct yetty_yclass_object *obj)
{
    ...
    if (YETTY_IS_ERR(class_r)) {
        return YETTY_ERR(yetty_yjupyter_client_ptr, "yetty_yjupyter_client_from: class accessor",
                         class_r);
    }
    struct yetty_yclass_void_ptr_result slice_r = yetty_yclass_object_data(obj, class_r.value);
    if (YETTY_IS_ERR(slice_r)) {
        return YETTY_ERR(yetty_yjupyter_client_ptr, "yetty_yjupyter_client_from: object_data",
                         slice_r);
    }
...
struct yetty_yclass_object_ptr_result yetty_yjupyter_client_to(struct yetty_yjupyter_client *data)
{
    ...
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, class_r,
                        "yetty_yjupyter_client_to: class accessor");
...
struct yetty_yclass_object_ptr_result yetty_yjupyter_client_create(struct yetty_yclass_ctx *ctx)
{
    ...
    if (!proxy) {
        return YETTY_ERR(yetty_yclass_object_ptr,
                         "yetty_yjupyter_client_create: calloc(proxy) failed");
    }
