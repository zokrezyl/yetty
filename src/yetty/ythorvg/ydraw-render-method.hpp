 ...
 * into a yetty_ydraw_core_buffer.
 *
 * Ported from yetty-poc/src/yetty/ythorvg/ydraw-render-method.h with the
 * YDrawBuffer dependency replaced by yetty_ydraw_core_buffer + ysdf
...
class YDrawRenderMethod : public tvg::RenderMethod
{
  public:
    ...
    explicit YDrawRenderMethod(yetty_ydraw_core_buffer *buffer);
  ...
  private:
    ...
    yetty_ydraw_core_buffer *_buffer = nullptr; // borrowed
    uint32_t _width = 0;
    uint32_t _height = 0;
