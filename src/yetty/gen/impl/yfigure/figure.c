...
YETTY_MAYBE_UNUSED
static yetty_yfigure_apply_scroll_anchor_fn yetty_yfigure_figure_yetty_yfigure_apply_scroll_anchor_check = yetty_yfigure_figure_default_apply_scroll_anchor;
...
struct yetty_yclass_ptr_result yetty_yfigure_figure_class_get(void)
{
    ...
    static const struct yetty_yclass_op ops[] = {
        ...
        {"yetty_yfigure", "apply_scroll_anchor", (yetty_yclass_method_id_t)yetty_yfigure_apply_scroll_anchor, (yetty_yclass_impl_t)yetty_yfigure_figure_default_apply_scroll_anchor},
    };
...
struct yetty_yfigure_figure_ptr_result yetty_yfigure_figure_from(struct yetty_yclass_object *obj)
{
    ...
    if (YETTY_IS_ERR(class_r))
        return YETTY_ERR(yetty_yfigure_figure_ptr, "yetty_yfigure_figure_from: class accessor", class_r);
    struct yetty_yclass_void_ptr_result slice_r =
        yetty_yclass_object_data(obj, class_r.value);
    if (YETTY_IS_ERR(slice_r))
        return YETTY_ERR(yetty_yfigure_figure_ptr, "yetty_yfigure_figure_from: object_data", slice_r);
...
struct yetty_yclass_object_ptr_result yetty_yfigure_figure_to(struct yetty_yfigure_figure *data)
{
    ...
    struct yetty_yclass_ptr_result class_r = yetty_yfigure_figure_class_get();
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, class_r, "yetty_yfigure_figure_to: class accessor");
