...
typedef struct yetty_ycore_void_result (*yetty_ydummy_set_shader_fn)(struct yetty_yclass_object *,
                                                                     struct yetty_ycore_buffer);
typedef struct yetty_ycore_void_result (*yetty_ydummy_set_rect_fn)(struct yetty_yclass_object *,
                                                                   float, float, float, float);
typedef struct yetty_ycore_void_result (*yetty_ydummy_set_time_fn)(struct yetty_yclass_object *,
                                                                   float);
...
struct yetty_yclass_ptr_result yetty_ydummy_canvas_class_get(void)
{
    ...
    static const struct yetty_yclass_op ops[] = {
        {"yetty_ydummy", "constructor", (yetty_yclass_method_id_t)yetty_ydummy_constructor,
         (yetty_yclass_impl_t)canvas_constructor},
        {"yetty_ydummy", "set_shader", (yetty_yclass_method_id_t)yetty_ydummy_set_shader,
         (yetty_yclass_impl_t)canvas_set_shader},
        {"yetty_ydummy", "set_rect", (yetty_yclass_method_id_t)yetty_ydummy_set_rect,
         (yetty_yclass_impl_t)canvas_set_rect},
        {"yetty_ydummy", "set_time", (yetty_yclass_method_id_t)yetty_ydummy_set_time,
         (yetty_yclass_impl_t)canvas_set_time},
        {"yetty_ydummy", "destroy", (yetty_yclass_method_id_t)yetty_ydummy_destroy,
         (yetty_yclass_impl_t)canvas_destroy},
    };
    struct yetty_yclass_ptr_result register_class_r =
        yetty_yclass_register(&desc, ops, sizeof(ops) / sizeof(ops[0]), NULL, NULL, 0);
    if (YETTY_IS_ERR(register_class_r)) {
        yerror("yetty_ydummy_canvas_class_get: class_register failed: %s",
               register_class_r.error.msg);
        return YETTY_ERR(yetty_yclass_ptr, "yetty_ydummy_canvas_class_get: class_register failed",
                         register_class_r);
    }
...
struct yetty_ydummy_canvas_ptr_result yetty_ydummy_canvas_from(struct yetty_yclass_object *obj)
{
    ...
    if (YETTY_IS_ERR(class_r)) {
        return YETTY_ERR(yetty_ydummy_canvas_ptr, "yetty_ydummy_canvas_from: class accessor",
                         class_r);
    }
...
struct yetty_ycore_void_result yetty_ydummy_constructor(struct yetty_yclass_object *obj)
{
    ...
    if (method_slot == YETTY_YCLASS_METHOD_SLOT_UNDEFINED) {
        struct yetty_yclass_method_slot_result method_slot_r = yetty_yclass_method_slot_get(
            "yetty_ydummy", (yetty_yclass_method_id_t)yetty_ydummy_constructor);
        if (YETTY_IS_ERR(method_slot_r)) {
            return YETTY_ERR(yetty_ycore_void, "yetty_ydummy_constructor: method_slot_get failed",
                             method_slot_r);
        }
    ...
    if (!obj) {
        return YETTY_ERR(yetty_ycore_void, "yetty_ydummy_constructor: NULL object");
    }
    ...
    YETTY_RETURN_IF_ERR(yetty_ycore_void, object_class_r,
                        "yetty_ydummy_constructor: object_class failed");
    struct yetty_yclass_impl_t_result dispatch_impl_r =
        yetty_yclass_dispatch_lookup(object_class_r.value, method_slot);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, dispatch_impl_r,
                        "yetty_ydummy_constructor: dispatch_lookup failed");
...
size_t yetty_ydummy_set_shader_skel(const void *body, size_t body_len, void *resp, size_t resp_max)
{
...
#pragma pack(pop)
    ...
    if (body_len != sizeof(wire_args) + (size_t)wire_args.wgsl_len) {
        return 0;
    }
    ...
    if (YETTY_IS_ERR(obj_resolve_r)) {
        yetty_ycore_error_print(stderr, "[skel] yetty_ydummy_set_shader: handle_resolve",
                                obj_resolve_r.error);
        if (resp_max < 1) {
    ...
    struct yetty_ycore_void_result call_r =
        yetty_ydummy_set_shader((struct yetty_yclass_object *)obj_resolve_r.value, wgsl_buf);
    if (resp_max < 1) {
        return 0;
    }
...
YETTY_EXTERNAL_CALLBACK
size_t yetty_ydummy_set_rect_skel(const void *body, size_t body_len, void *resp, size_t resp_max)
{
/* Byte-exact wire layout — #pragma pack matches the first-party
 * convention (yvnc/ydvnc/libvterm) and compiles on MSVC, unlike a GNU
 * packed attribute. */
...
#pragma pack(pop)
    ...
    struct yetty_yclass_void_ptr_result obj_resolve_r =
        yetty_yclass_rpc_handle_resolve(wire_args.obj_handle);
    if (YETTY_IS_ERR(obj_resolve_r)) {
        yetty_ycore_error_print(stderr, "[skel] yetty_ydummy_set_rect: handle_resolve",
                                obj_resolve_r.error);
        if (resp_max < 1) {
            yetty_ycore_error_destroy(obj_resolve_r.error);
            return 0;
    ...
    struct yetty_ycore_void_result call_r =
        yetty_ydummy_set_rect((struct yetty_yclass_object *)obj_resolve_r.value, wire_args.min_x,
...
YETTY_EXTERNAL_CALLBACK
size_t yetty_ydummy_set_time_skel(const void *body, size_t body_len, void *resp, size_t resp_max)
{
/* Byte-exact wire layout — #pragma pack matches the first-party
 * convention (yvnc/ydvnc/libvterm) and compiles on MSVC, unlike a GNU
 * packed attribute. */
...
#pragma pack(pop)
    ...
    struct yetty_yclass_void_ptr_result obj_resolve_r =
        yetty_yclass_rpc_handle_resolve(wire_args.obj_handle);
    if (YETTY_IS_ERR(obj_resolve_r)) {
        yetty_ycore_error_print(stderr, "[skel] yetty_ydummy_set_time: handle_resolve",
                                obj_resolve_r.error);
        if (resp_max < 1) {
            yetty_ycore_error_destroy(obj_resolve_r.error);
            return 0;
    ...
    struct yetty_ycore_void_result call_r =
        yetty_ydummy_set_time((struct yetty_yclass_object *)obj_resolve_r.value, wire_args.seconds);
    if (resp_max < 1) {
        return 0;
    }
    if (YETTY_IS_ERR(call_r)) {
...
YETTY_EXTERNAL_CALLBACK
size_t yetty_ydummy_destroy_skel(const void *body, size_t body_len, void *resp, size_t resp_max)
{
/* Byte-exact wire layout — #pragma pack matches the first-party
 * convention (yvnc/ydvnc/libvterm) and compiles on MSVC, unlike a GNU
 * packed attribute. */
...
#pragma pack(pop)
    ...
    struct yetty_yclass_void_ptr_result obj_resolve_r =
        yetty_yclass_rpc_handle_resolve(wire_args.obj_handle);
    if (YETTY_IS_ERR(obj_resolve_r)) {
        yetty_ycore_error_print(stderr, "[skel] yetty_ydummy_destroy: handle_resolve",
                                obj_resolve_r.error);
        if (resp_max < 1) {
            yetty_ycore_error_destroy(obj_resolve_r.error);
            return 0;
    ...
    struct yetty_ycore_void_result call_r =
        yetty_ydummy_destroy((struct yetty_yclass_object *)obj_resolve_r.value);
    if (resp_max < 1) {
        return 0;
    }
    if (YETTY_IS_ERR(call_r)) {
...
struct yetty_yclass_object_ptr_result yetty_ydummy_canvas_create(struct yetty_yclass_ctx *ctx)
{
    ...
    struct yetty_ycore_void_result ctor_r = yetty_ydummy_constructor(alloc_r.value);
    if (YETTY_IS_ERR(ctor_r)) {
        ...
        return YETTY_ERR(yetty_yclass_object_ptr, "yetty_ydummy_canvas_create: constructor failed",
                         ctor_r);
    }
    return alloc_r;
}
...
static yetty_yclass_rpc_skel_fn yetty_ydummy_skel_lookup(yetty_yclass_method_slot slot)
{
    ...
    for (size_t i = 0; i < sizeof(yetty_ydummy_skel_rows) / sizeof(yetty_ydummy_skel_rows[0]);
         ++i) {
