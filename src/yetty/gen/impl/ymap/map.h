...
struct yetty_ycore_void_result yetty_ymap_provider_info(uint32_t index, const char **out_name, const char **out_attribution, uint32_t *out_max_zoom, int *out_is_vector);
...
struct yetty_ycore_void_result yetty_ymap_emit_osc(const struct yetty_ydraw_drawable_list *list, int fd);
