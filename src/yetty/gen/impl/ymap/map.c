...
YETTY_MAYBE_UNUSED
static yetty_ymap_overlay_geojson_fn yetty_ymap_map_yetty_ymap_overlay_geojson_check = map_overlay_geojson;
YETTY_MAYBE_UNUSED
...
struct yetty_yclass_ptr_result yetty_ymap_map_class_get(void)
{
    ...
    static const struct yetty_yclass_op ops[] = {
        ...
        {"yetty_ymap", "overlay_geojson", (yetty_yclass_method_id_t)yetty_ymap_overlay_geojson, (yetty_yclass_impl_t)map_overlay_geojson},
