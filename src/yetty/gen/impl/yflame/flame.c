...
YETTY_MAYBE_UNUSED
static yetty_yflame_highlight_name_fn yetty_yflame_flame_yetty_yflame_highlight_name_check = flame_highlight_name;
YETTY_MAYBE_UNUSED
static yetty_yflame_focus_name_fn yetty_yflame_flame_yetty_yflame_focus_name_check = flame_focus_name;
YETTY_MAYBE_UNUSED
static yetty_yflame_set_baseline_fn yetty_yflame_flame_yetty_yflame_set_baseline_check = flame_set_baseline;
YETTY_MAYBE_UNUSED
static yetty_yflame_node_name_fn yetty_yflame_flame_yetty_yflame_node_name_check = flame_node_name;
YETTY_MAYBE_UNUSED
static yetty_yflame_node_value_fn yetty_yflame_flame_yetty_yflame_node_value_check = flame_node_value;
YETTY_MAYBE_UNUSED
static yetty_yflame_root_value_fn yetty_yflame_flame_yetty_yflame_root_value_check = flame_root_value;
YETTY_MAYBE_UNUSED
...
struct yetty_yclass_ptr_result yetty_yflame_flame_class_get(void)
{
    ...
    static const struct yetty_yclass_op ops[] = {
        ...
        {"yetty_yflame", "highlight_name", (yetty_yclass_method_id_t)yetty_yflame_highlight_name, (yetty_yclass_impl_t)flame_highlight_name},
        {"yetty_yflame", "focus_name", (yetty_yclass_method_id_t)yetty_yflame_focus_name, (yetty_yclass_impl_t)flame_focus_name},
        {"yetty_yflame", "set_baseline", (yetty_yclass_method_id_t)yetty_yflame_set_baseline, (yetty_yclass_impl_t)flame_set_baseline},
        {"yetty_yflame", "node_name", (yetty_yclass_method_id_t)yetty_yflame_node_name, (yetty_yclass_impl_t)flame_node_name},
        {"yetty_yflame", "node_value", (yetty_yclass_method_id_t)yetty_yflame_node_value, (yetty_yclass_impl_t)flame_node_value},
        {"yetty_yflame", "root_value", (yetty_yclass_method_id_t)yetty_yflame_root_value, (yetty_yclass_impl_t)flame_root_value},
