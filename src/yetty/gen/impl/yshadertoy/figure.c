...
YETTY_MAYBE_UNUSED
static yetty_yfigure_process_bytes_fn yetty_yshadertoy_figure_yetty_yfigure_process_bytes_check = figure_process_bytes_slot;
...
struct yetty_yclass_ptr_result yetty_yshadertoy_figure_class_get(void)
{
    ...
    static const struct yetty_yclass_op ops[] = {
        ...
        {"yetty_yfigure", "process_bytes", (yetty_yclass_method_id_t)yetty_yfigure_process_bytes, (yetty_yclass_impl_t)figure_process_bytes_slot},
    };
    struct yetty_yclass_ptr_result parent_class_r = yetty_yfigure_figure_class_get();
    if (YETTY_IS_ERR(parent_class_r)) {
        yerror("yetty_yshadertoy_figure_class_get: parent accessor failed: %s", parent_class_r.error.msg);
    ...
    if (YETTY_IS_ERR(register_class_r)) {
        yerror("yetty_yshadertoy_figure_class_get: class_register failed: %s", register_class_r.error.msg);
...
struct yetty_yshadertoy_figure_ptr_result yetty_yshadertoy_figure_from(struct yetty_yclass_object *obj)
{
    ...
    if (YETTY_IS_ERR(class_r))
        return YETTY_ERR(yetty_yshadertoy_figure_ptr, "yetty_yshadertoy_figure_from: class accessor", class_r);
    struct yetty_yclass_void_ptr_result slice_r =
        yetty_yclass_object_data(obj, class_r.value);
    if (YETTY_IS_ERR(slice_r))
        return YETTY_ERR(yetty_yshadertoy_figure_ptr, "yetty_yshadertoy_figure_from: object_data", slice_r);
...
struct yetty_yclass_object_ptr_result yetty_yshadertoy_figure_to(struct yetty_yshadertoy_figure *data)
{
    ...
    struct yetty_yclass_ptr_result class_r = yetty_yshadertoy_figure_class_get();
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, class_r, "yetty_yshadertoy_figure_to: class accessor");
    struct yetty_ycore_size_result offset_r =
        yetty_yclass_object_data_offset(class_r.value, class_r.value);
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, offset_r, "yetty_yshadertoy_figure_to: data offset");
...
struct yetty_yclass_object_ptr_result yetty_yshadertoy_figure_create(struct yetty_yclass_ctx *ctx)
{
    ...
    if (ctx && ctx->session)
        return YETTY_ERR(yetty_yclass_object_ptr,
                         "yetty_yshadertoy_figure_create: remote create unsupported for a split-mode class; "
...
/* ---- yshadertoy: class name -> accessor (lazy) ---------------------- */

static struct yetty_yclass_ptr_result yetty_yshadertoy_accessor_lookup(const char *name)
{
...
/* ---- yshadertoy: explicit yclass-RPC hook registration ------------- */
...
struct yetty_ycore_void_result yetty_yshadertoy_register(void)
{
    ...
    struct yetty_ycore_void_result add_accessor_r =
        yetty_yclass_add_accessor_lookup(yetty_yshadertoy_accessor_lookup);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, add_accessor_r,
                        "yetty_yshadertoy_register: add_accessor_lookup");
    registered = true;
    return YETTY_OK_VOID();
}
