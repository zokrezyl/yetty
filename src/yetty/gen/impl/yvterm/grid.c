...
struct yetty_yclass_ptr_result yetty_yvterm_grid_class_get(void)
{
    ...
    if (YETTY_IS_ERR(register_class_r)) {
        yerror("yetty_yvterm_grid_class_get: class_register failed: %s", register_class_r.error.msg);
        return YETTY_ERR(yetty_yclass_ptr, "yetty_yvterm_grid_class_get: class_register failed", register_class_r);
    }
...
struct yetty_yclass_object_ptr_result yetty_yvterm_grid_to(struct yetty_yvterm_grid *data)
{
    ...
    struct yetty_yclass_ptr_result class_r = yetty_yvterm_grid_class_get();
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, class_r, "yetty_yvterm_grid_to: class accessor");
    struct yetty_ycore_size_result offset_r =
        yetty_yclass_object_data_offset(class_r.value, class_r.value);
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, offset_r, "yetty_yvterm_grid_to: data offset");
...
struct yetty_yclass_object_ptr_result yetty_yvterm_grid_create(struct yetty_yclass_ctx *ctx)
{
    ...
    if (ctx && ctx->session)
        return YETTY_ERR(yetty_yclass_object_ptr,
                         "yetty_yvterm_grid_create: remote create unsupported for a split-mode class; "
    ...
    if (YETTY_IS_ERR(class_accessor_r))
        return YETTY_ERR(yetty_yclass_object_ptr,
                         "yetty_yvterm_grid_create: class accessor failed", class_accessor_r);
...
struct yetty_yclass_ptr_result yetty_yvterm_grid_class_get(void);
struct yetty_ycore_void_result yetty_yvterm_grid_register(void);

/* ---- yvterm_grid: class name -> accessor (lazy) ---------------------- */
...
/* ---- yvterm_grid: explicit yclass-RPC hook registration ------------- */
...
struct yetty_ycore_void_result yetty_yvterm_grid_register(void)
{
    ...
    YETTY_RETURN_IF_ERR(yetty_ycore_void, add_accessor_r,
                        "yetty_yvterm_grid_register: add_accessor_lookup");
    registered = true;
    return YETTY_OK_VOID();
}
...
struct yetty_ycore_void_result yetty_yvterm_register(void)
{
...

    {
        ...
        struct yetty_ycore_void_result sub_r = yetty_yvterm_grid_register();
        YETTY_RETURN_IF_ERR(yetty_ycore_void, sub_r,
                            "yetty_yvterm_register: submodule yvterm_grid");
    }
    {
        /* Submodule aggregator is always compiled into the same
         * library, so this strong call is always resolved. */
        struct yetty_ycore_void_result sub_r = yetty_yvterm_vterm_register();
        YETTY_RETURN_IF_ERR(yetty_ycore_void, sub_r,
                            "yetty_yvterm_register: submodule yvterm_vterm");
    }
    registered = true;
    return YETTY_OK_VOID();
}
