...
struct yetty_yclass_ptr_result yetty_yapp_app_class_get(void)
{
    ...
    static const struct yetty_yclass_descriptor desc = {
        ...
        .data_size = sizeof(struct yetty_yapp_app),
    ...
    static const struct yetty_yclass_op ops[] = {
        ...
        {"yetty_yapp", "quit", (yetty_yclass_method_id_t)yetty_yapp_quit, (yetty_yclass_impl_t)yapp_default_quit},
    };
...
struct yetty_yclass_object_ptr_result yetty_yapp_app_to(struct yetty_yapp_app *data)
{
    ...
    struct yetty_yclass_ptr_result class_r = yetty_yapp_app_class_get();
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, class_r, "yetty_yapp_app_to: class accessor");
    struct yetty_ycore_size_result offset_r =
        yetty_yclass_object_data_offset(class_r.value, class_r.value);
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, offset_r, "yetty_yapp_app_to: data offset");
...
struct yetty_yclass_object_ptr_result yetty_yapp_app_create(struct yetty_yclass_ctx *ctx)
{
    ydebug("class=yetty_yapp_app");
    if (ctx && ctx->session)
        return YETTY_ERR(yetty_yclass_object_ptr,
                         "yetty_yapp_app_create: remote create unsupported for a split-mode class; "
...
/* ---- yapp: explicit yclass-RPC hook registration ------------- */
...
struct yetty_ycore_void_result yetty_yapp_register(void)
{
    ...
    struct yetty_ycore_void_result add_accessor_r =
        yetty_yclass_add_accessor_lookup(yetty_yapp_accessor_lookup);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, add_accessor_r,
                        "yetty_yapp_register: add_accessor_lookup");
    registered = true;
    return YETTY_OK_VOID();
}
