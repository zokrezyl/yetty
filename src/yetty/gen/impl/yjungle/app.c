...
YETTY_MAYBE_UNUSED
static yetty_yapp_run_fn yetty_yjungle_app_yetty_yapp_run_check = yjungle_app_run;
...
struct yetty_yclass_ptr_result yetty_yjungle_app_class_get(void)
{
    ...
    static const struct yetty_yclass_descriptor desc = {
        .name = "yetty_yjungle_app",
        .type = YETTY_YCLASS_TYPE_REGULAR,
        .data_size = sizeof(struct yetty_yjungle_app),
...
struct yetty_yclass_object_ptr_result yetty_yjungle_app_to(struct yetty_yjungle_app *data)
{
    ...
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, offset_r, "yetty_yjungle_app_to: data offset");
...
struct yetty_yclass_object_ptr_result yetty_yjungle_app_create(struct yetty_yclass_ctx *ctx)
{
    ydebug("class=yetty_yjungle_app");
    if (ctx && ctx->session) {
        return YETTY_ERR(
            yetty_yclass_object_ptr,
            "yetty_yjungle_app_create: remote create unsupported for a split-mode class; "
...
struct yetty_yclass_ptr_result yetty_yjungle_app_class_get(void);
struct yetty_ycore_void_result yetty_yjungle_register(void);

/* ---- yjungle: class name -> accessor (lazy) ---------------------- */

static struct yetty_yclass_ptr_result yetty_yjungle_accessor_lookup(const char *name)
{
    if (strcmp(name, "yetty_yjungle_app") == 0) {
        return yetty_yjungle_app_class_get();
    }
    /* "Not mine": OK with NULL value -- yetty_yclass_by_name walks to next hook. */
    return YETTY_OK(yetty_yclass_ptr, NULL);
}

/* ---- yjungle: explicit yclass-RPC hook registration ------------- */
...
struct yetty_ycore_void_result yetty_yjungle_register(void)
{
    ...
    struct yetty_ycore_void_result add_accessor_r =
        yetty_yclass_add_accessor_lookup(yetty_yjungle_accessor_lookup);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, add_accessor_r,
                        "yetty_yjungle_register: add_accessor_lookup");
    registered = true;
    return YETTY_OK_VOID();
}
