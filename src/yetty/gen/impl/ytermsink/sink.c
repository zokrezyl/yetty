...
struct yetty_yclass_ptr_result yetty_ytermsink_sink_class_get(void)
{
    ...
    static const struct yetty_yclass_op ops[] = {
        {"yetty_ytermsink", "pty_write", (yetty_yclass_method_id_t)yetty_ytermsink_pty_write,
         (yetty_yclass_impl_t)yetty_ytermsink_sink_default_pty_write},
        {"yetty_ytermsink", "request_render",
         (yetty_yclass_method_id_t)yetty_ytermsink_request_render,
         (yetty_yclass_impl_t)yetty_ytermsink_sink_default_request_render},
        {"yetty_ytermsink", "mouse_sub", (yetty_yclass_method_id_t)yetty_ytermsink_mouse_sub,
         (yetty_yclass_impl_t)yetty_ytermsink_sink_default_mouse_sub},
    ...
    if (YETTY_IS_ERR(register_class_r)) {
        yerror("yetty_ytermsink_sink_class_get: class_register failed: %s",
               register_class_r.error.msg);
        return YETTY_ERR(yetty_yclass_ptr, "yetty_ytermsink_sink_class_get: class_register failed",
                         register_class_r);
    }
...
struct yetty_ytermsink_sink_ptr_result yetty_ytermsink_sink_from(struct yetty_yclass_object *obj)
{
    ...
    if (YETTY_IS_ERR(class_r)) {
        return YETTY_ERR(yetty_ytermsink_sink_ptr, "yetty_ytermsink_sink_from: class accessor",
                         class_r);
    }
    struct yetty_yclass_void_ptr_result slice_r = yetty_yclass_object_data(obj, class_r.value);
    if (YETTY_IS_ERR(slice_r)) {
        return YETTY_ERR(yetty_ytermsink_sink_ptr, "yetty_ytermsink_sink_from: object_data",
                         slice_r);
    }
...
struct yetty_yclass_object_ptr_result yetty_ytermsink_sink_to(struct yetty_ytermsink_sink *data)
{
    ...
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, class_r,
                        "yetty_ytermsink_sink_to: class accessor");
