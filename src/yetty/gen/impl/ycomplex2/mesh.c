...
struct yetty_ycore_int_result yetty_ycomplex2_mesh_layer_get(struct yetty_yclass_object *obj)
{
    struct yetty_ycomplex2_mesh_ptr_result data = yetty_ycomplex2_mesh_from(obj);
    if (YETTY_IS_ERR(data)) {
        return YETTY_ERR(yetty_ycore_int, "yetty_ycomplex2_mesh_layer_get: data block", data);
    }
                                                              ...
                                                              int32_t value)
{
    struct yetty_ycomplex2_mesh_ptr_result data = yetty_ycomplex2_mesh_from(obj);
    if (YETTY_IS_ERR(data)) {
        return YETTY_ERR(yetty_ycore_void, "yetty_ycomplex2_mesh_layer_set: data block", data);
    }
...
struct uint32_result yetty_ycomplex2_mesh_id_get(struct yetty_yclass_object *obj)
{
    struct yetty_ycomplex2_mesh_ptr_result data = yetty_ycomplex2_mesh_from(obj);
    if (YETTY_IS_ERR(data)) {
        return YETTY_ERR(uint32, "yetty_ycomplex2_mesh_id_get: data block", data);
    }
                                                           ...
                                                           uint32_t value)
{
    struct yetty_ycomplex2_mesh_ptr_result data = yetty_ycomplex2_mesh_from(obj);
    if (YETTY_IS_ERR(data)) {
        return YETTY_ERR(yetty_ycore_void, "yetty_ycomplex2_mesh_id_set: data block", data);
    }
    data.value->id = value;
    return YETTY_OK_VOID();
}
