...
static yetty_ycomplex2_set_wgsl_path_fn
    yetty_ycomplex2_shadertoy_yetty_ycomplex2_set_wgsl_path_shadertoy_set_wgsl_path_check =
        shadertoy_set_wgsl_path;
YETTY_MAYBE_UNUSED
static yetty_ydrawlist2_pack_fn
    yetty_ycomplex2_shadertoy_yetty_ydrawlist2_pack_shadertoy_pack_check = shadertoy_pack;
...
struct yetty_yclass_ptr_result yetty_ycomplex2_shadertoy_class_get(void)
{
    ...
    ydebug("registering class=yetty_ycomplex2_shadertoy");

    static const struct yetty_yclass_descriptor desc = {
        .name = "yetty_ycomplex2_shadertoy",
        .type = YETTY_YCLASS_TYPE_REGULAR,
        .data_size = sizeof(struct yetty_ycomplex2_shadertoy),
    ...
    static const struct yetty_yclass_op ops[] = {
        ...
        {"yetty_ydrawlist2", "pack", (yetty_yclass_method_id_t)yetty_ydrawlist2_pack,
         (yetty_yclass_impl_t)shadertoy_pack},
    };
    struct yetty_yclass_ptr_result parent_class_r = yetty_ydrawlist2_drawable_class_get();
    if (YETTY_IS_ERR(parent_class_r)) {
        yerror("yetty_ycomplex2_shadertoy_class_get: parent accessor failed: %s",
               parent_class_r.error.msg);
        return YETTY_ERR(yetty_yclass_ptr,
                         "yetty_ycomplex2_shadertoy_class_get: parent accessor failed",
                         parent_class_r);
    }
    struct yetty_yclass_ptr_result register_class_r = yetty_yclass_register(
        &desc, ops, sizeof(ops) / sizeof(ops[0]), parent_class_r.value, NULL, 0);
    if (YETTY_IS_ERR(register_class_r)) {
        yerror("yetty_ycomplex2_shadertoy_class_get: class_register failed: %s",
               register_class_r.error.msg);
        return YETTY_ERR(yetty_yclass_ptr,
                         "yetty_ycomplex2_shadertoy_class_get: class_register failed",
                         register_class_r);
    }
    ...
    struct yetty_yclass_object *obj)
{
    ...
    if (YETTY_IS_ERR(class_r)) {
        return YETTY_ERR(yetty_ycomplex2_shadertoy_ptr,
                         "yetty_ycomplex2_shadertoy_from: class accessor", class_r);
    }
    struct yetty_yclass_void_ptr_result slice_r = yetty_yclass_object_data(obj, class_r.value);
    if (YETTY_IS_ERR(slice_r)) {
        return YETTY_ERR(yetty_ycomplex2_shadertoy_ptr,
                         "yetty_ycomplex2_shadertoy_from: object_data", slice_r);
    }
    return YETTY_OK(yetty_ycomplex2_shadertoy_ptr,
                    (struct yetty_ycomplex2_shadertoy *)slice_r.value);
}
    ...
    struct yetty_ycomplex2_shadertoy *data)
{
    ...
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, class_r,
                        "yetty_ycomplex2_shadertoy_to: class accessor");
    struct yetty_ycore_size_result offset_r =
        yetty_yclass_object_data_offset(class_r.value, class_r.value);
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, offset_r,
                        "yetty_ycomplex2_shadertoy_to: data offset");
...
{
    struct yetty_ycomplex2_shadertoy_ptr_result data = yetty_ycomplex2_shadertoy_from(obj);
    if (YETTY_IS_ERR(data)) {
        return YETTY_ERR(float, "yetty_ycomplex2_shadertoy_x_get: data block", data);
    }
                                                               ...
                                                               float value)
{
    struct yetty_ycomplex2_shadertoy_ptr_result data = yetty_ycomplex2_shadertoy_from(obj);
    if (YETTY_IS_ERR(data)) {
        return YETTY_ERR(yetty_ycore_void, "yetty_ycomplex2_shadertoy_x_set: data block", data);
    }
    data.value->x = value;
...
struct float_result yetty_ycomplex2_shadertoy_y_get(struct yetty_yclass_object *obj)
{
    struct yetty_ycomplex2_shadertoy_ptr_result data = yetty_ycomplex2_shadertoy_from(obj);
    if (YETTY_IS_ERR(data)) {
        return YETTY_ERR(float, "yetty_ycomplex2_shadertoy_y_get: data block", data);
    }
                                                               ...
                                                               float value)
{
    struct yetty_ycomplex2_shadertoy_ptr_result data = yetty_ycomplex2_shadertoy_from(obj);
    if (YETTY_IS_ERR(data)) {
        return YETTY_ERR(yetty_ycore_void, "yetty_ycomplex2_shadertoy_y_set: data block", data);
    }
    data.value->y = value;
    return YETTY_OK_VOID();
}
...
struct float_result yetty_ycomplex2_shadertoy_width_get(struct yetty_yclass_object *obj)
{
    struct yetty_ycomplex2_shadertoy_ptr_result data = yetty_ycomplex2_shadertoy_from(obj);
    if (YETTY_IS_ERR(data)) {
        return YETTY_ERR(float, "yetty_ycomplex2_shadertoy_width_get: data block", data);
    }
                                                                   ...
                                                                   float value)
{
    struct yetty_ycomplex2_shadertoy_ptr_result data = yetty_ycomplex2_shadertoy_from(obj);
    if (YETTY_IS_ERR(data)) {
        return YETTY_ERR(yetty_ycore_void, "yetty_ycomplex2_shadertoy_width_set: data block", data);
    }
...
struct float_result yetty_ycomplex2_shadertoy_height_get(struct yetty_yclass_object *obj)
{
    struct yetty_ycomplex2_shadertoy_ptr_result data = yetty_ycomplex2_shadertoy_from(obj);
    if (YETTY_IS_ERR(data)) {
        return YETTY_ERR(float, "yetty_ycomplex2_shadertoy_height_get: data block", data);
    }
                                                                    ...
                                                                    float value)
{
    struct yetty_ycomplex2_shadertoy_ptr_result data = yetty_ycomplex2_shadertoy_from(obj);
    if (YETTY_IS_ERR(data)) {
        return YETTY_ERR(yetty_ycore_void, "yetty_ycomplex2_shadertoy_height_set: data block",
                         data);
    }
...
struct yetty_ycore_int_result yetty_ycomplex2_shadertoy_layer_get(struct yetty_yclass_object *obj)
{
    struct yetty_ycomplex2_shadertoy_ptr_result data = yetty_ycomplex2_shadertoy_from(obj);
    if (YETTY_IS_ERR(data)) {
        return YETTY_ERR(yetty_ycore_int, "yetty_ycomplex2_shadertoy_layer_get: data block", data);
    }
                                                                   ...
                                                                   int32_t value)
{
    struct yetty_ycomplex2_shadertoy_ptr_result data = yetty_ycomplex2_shadertoy_from(obj);
    if (YETTY_IS_ERR(data)) {
        return YETTY_ERR(yetty_ycore_void, "yetty_ycomplex2_shadertoy_layer_set: data block", data);
    }
...
struct uint32_result yetty_ycomplex2_shadertoy_id_get(struct yetty_yclass_object *obj)
{
    struct yetty_ycomplex2_shadertoy_ptr_result data = yetty_ycomplex2_shadertoy_from(obj);
    if (YETTY_IS_ERR(data)) {
        return YETTY_ERR(uint32, "yetty_ycomplex2_shadertoy_id_get: data block", data);
    }
                                                                ...
                                                                uint32_t value)
{
    struct yetty_ycomplex2_shadertoy_ptr_result data = yetty_ycomplex2_shadertoy_from(obj);
    if (YETTY_IS_ERR(data)) {
        return YETTY_ERR(yetty_ycore_void, "yetty_ycomplex2_shadertoy_id_set: data block", data);
    }
    data.value->id = value;
    return YETTY_OK_VOID();
}
...
struct yetty_yclass_object_ptr_result yetty_ycomplex2_shadertoy_create(struct yetty_yclass_ctx *ctx)
{
    ydebug("class=yetty_ycomplex2_shadertoy");
    if (ctx && ctx->session) {
        return YETTY_ERR(
            yetty_yclass_object_ptr,
            "yetty_ycomplex2_shadertoy_create: remote create unsupported for a split-mode class; "
            "wrap a server handle via yetty_yclass_object_proxy_create");
    }
    struct yetty_yclass_ptr_result class_accessor_r = yetty_ycomplex2_shadertoy_class_get();
    if (YETTY_IS_ERR(class_accessor_r)) {
        return YETTY_ERR(yetty_yclass_object_ptr,
                         "yetty_ycomplex2_shadertoy_create: class accessor failed",
                         class_accessor_r);
    }
...
/* ---- ycomplex2_shadertoy: class name -> accessor (lazy) ---------------------- */

static struct yetty_yclass_ptr_result yetty_ycomplex2_shadertoy_accessor_lookup(const char *name)
{
    if (strcmp(name, "yetty_ycomplex2_shadertoy") == 0) {
        return yetty_ycomplex2_shadertoy_class_get();
    }
    /* "Not mine": OK with NULL value -- yetty_yclass_by_name walks to next hook. */
    return YETTY_OK(yetty_yclass_ptr, NULL);
}

/* ---- ycomplex2_shadertoy: explicit yclass-RPC hook registration ------------- */
...
struct yetty_ycore_void_result yetty_ycomplex2_shadertoy_register(void)
{
    ...
    struct yetty_ycore_void_result add_accessor_r =
        yetty_yclass_add_accessor_lookup(yetty_ycomplex2_shadertoy_accessor_lookup);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, add_accessor_r,
                        "yetty_ycomplex2_shadertoy_register: add_accessor_lookup");
    registered = true;
    return YETTY_OK_VOID();
}
