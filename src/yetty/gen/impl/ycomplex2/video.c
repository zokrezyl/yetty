...
YETTY_MAYBE_UNUSED
static yetty_ycomplex2_set_h264_fn
    yetty_ycomplex2_video_yetty_ycomplex2_set_h264_video_set_h264_check = video_set_h264;
YETTY_MAYBE_UNUSED
static yetty_ydrawlist2_pack_fn yetty_ycomplex2_video_yetty_ydrawlist2_pack_video_pack_check =
    video_pack;
...
struct yetty_yclass_ptr_result yetty_ycomplex2_video_class_get(void)
{
    ...
    ydebug("registering class=yetty_ycomplex2_video");

    static const struct yetty_yclass_descriptor desc = {
        .name = "yetty_ycomplex2_video",
        .type = YETTY_YCLASS_TYPE_REGULAR,
        .data_size = sizeof(struct yetty_ycomplex2_video),
        .data_align = _Alignof(struct yetty_ycomplex2_video),
    };
    static const struct yetty_yclass_op ops[] = {
        {"yetty_ycomplex2", "set_h264", (yetty_yclass_method_id_t)yetty_ycomplex2_set_h264,
         (yetty_yclass_impl_t)video_set_h264},
        {"yetty_ydrawlist2", "pack", (yetty_yclass_method_id_t)yetty_ydrawlist2_pack,
         (yetty_yclass_impl_t)video_pack},
    };
    struct yetty_yclass_ptr_result parent_class_r = yetty_ydrawlist2_drawable_class_get();
    if (YETTY_IS_ERR(parent_class_r)) {
        yerror("yetty_ycomplex2_video_class_get: parent accessor failed: %s",
               parent_class_r.error.msg);
        return YETTY_ERR(yetty_yclass_ptr,
                         "yetty_ycomplex2_video_class_get: parent accessor failed", parent_class_r);
    }
    struct yetty_yclass_ptr_result register_class_r = yetty_yclass_register(
        &desc, ops, sizeof(ops) / sizeof(ops[0]), parent_class_r.value, NULL, 0);
    if (YETTY_IS_ERR(register_class_r)) {
        yerror("yetty_ycomplex2_video_class_get: class_register failed: %s",
               register_class_r.error.msg);
        return YETTY_ERR(yetty_yclass_ptr, "yetty_ycomplex2_video_class_get: class_register failed",
                         register_class_r);
    }
...
struct yetty_ycomplex2_video_ptr_result yetty_ycomplex2_video_from(struct yetty_yclass_object *obj)
{
    ...
    if (YETTY_IS_ERR(class_r)) {
        return YETTY_ERR(yetty_ycomplex2_video_ptr, "yetty_ycomplex2_video_from: class accessor",
                         class_r);
    }
    struct yetty_yclass_void_ptr_result slice_r = yetty_yclass_object_data(obj, class_r.value);
    if (YETTY_IS_ERR(slice_r)) {
        return YETTY_ERR(yetty_ycomplex2_video_ptr, "yetty_ycomplex2_video_from: object_data",
                         slice_r);
    }
    return YETTY_OK(yetty_ycomplex2_video_ptr, (struct yetty_ycomplex2_video *)slice_r.value);
}
...
struct yetty_yclass_object_ptr_result yetty_ycomplex2_video_to(struct yetty_ycomplex2_video *data)
{
    ...
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, class_r,
                        "yetty_ycomplex2_video_to: class accessor");
    struct yetty_ycore_size_result offset_r =
        yetty_yclass_object_data_offset(class_r.value, class_r.value);
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, offset_r, "yetty_ycomplex2_video_to: data offset");
...
struct float_result yetty_ycomplex2_video_x_get(struct yetty_yclass_object *obj)
{
    ...
    if (YETTY_IS_ERR(data)) {
        return YETTY_ERR(float, "yetty_ycomplex2_video_x_get: data block", data);
    }
                                                           ...
                                                           float value)
{
    struct yetty_ycomplex2_video_ptr_result data = yetty_ycomplex2_video_from(obj);
    if (YETTY_IS_ERR(data)) {
        return YETTY_ERR(yetty_ycore_void, "yetty_ycomplex2_video_x_set: data block", data);
    }
    data.value->x = value;
...
struct float_result yetty_ycomplex2_video_y_get(struct yetty_yclass_object *obj)
{
    struct yetty_ycomplex2_video_ptr_result data = yetty_ycomplex2_video_from(obj);
    if (YETTY_IS_ERR(data)) {
        return YETTY_ERR(float, "yetty_ycomplex2_video_y_get: data block", data);
    }
                                                           ...
                                                           float value)
{
    struct yetty_ycomplex2_video_ptr_result data = yetty_ycomplex2_video_from(obj);
    if (YETTY_IS_ERR(data)) {
        return YETTY_ERR(yetty_ycore_void, "yetty_ycomplex2_video_y_set: data block", data);
    }
    data.value->y = value;
    return YETTY_OK_VOID();
}
...
struct float_result yetty_ycomplex2_video_width_get(struct yetty_yclass_object *obj)
{
    struct yetty_ycomplex2_video_ptr_result data = yetty_ycomplex2_video_from(obj);
    if (YETTY_IS_ERR(data)) {
        return YETTY_ERR(float, "yetty_ycomplex2_video_width_get: data block", data);
    }
                                                               ...
                                                               float value)
{
    struct yetty_ycomplex2_video_ptr_result data = yetty_ycomplex2_video_from(obj);
    if (YETTY_IS_ERR(data)) {
        return YETTY_ERR(yetty_ycore_void, "yetty_ycomplex2_video_width_set: data block", data);
    }
...
struct float_result yetty_ycomplex2_video_height_get(struct yetty_yclass_object *obj)
{
    struct yetty_ycomplex2_video_ptr_result data = yetty_ycomplex2_video_from(obj);
    if (YETTY_IS_ERR(data)) {
        return YETTY_ERR(float, "yetty_ycomplex2_video_height_get: data block", data);
    }
                                                                ...
                                                                float value)
{
    struct yetty_ycomplex2_video_ptr_result data = yetty_ycomplex2_video_from(obj);
    if (YETTY_IS_ERR(data)) {
        return YETTY_ERR(yetty_ycore_void, "yetty_ycomplex2_video_height_set: data block", data);
    }
...
struct uint32_result yetty_ycomplex2_video_video_w_get(struct yetty_yclass_object *obj)
{
    struct yetty_ycomplex2_video_ptr_result data = yetty_ycomplex2_video_from(obj);
    if (YETTY_IS_ERR(data)) {
        return YETTY_ERR(uint32, "yetty_ycomplex2_video_video_w_get: data block", data);
    }
    return YETTY_OK(uint32, data.value->video_w);
}
                                                                 ...
                                                                 uint32_t value)
{
    struct yetty_ycomplex2_video_ptr_result data = yetty_ycomplex2_video_from(obj);
    if (YETTY_IS_ERR(data)) {
        return YETTY_ERR(yetty_ycore_void, "yetty_ycomplex2_video_video_w_set: data block", data);
    }
    data.value->video_w = value;
    return YETTY_OK_VOID();
}
...
struct uint32_result yetty_ycomplex2_video_video_h_get(struct yetty_yclass_object *obj)
{
    struct yetty_ycomplex2_video_ptr_result data = yetty_ycomplex2_video_from(obj);
    if (YETTY_IS_ERR(data)) {
        return YETTY_ERR(uint32, "yetty_ycomplex2_video_video_h_get: data block", data);
    }
    return YETTY_OK(uint32, data.value->video_h);
}
                                                                 ...
                                                                 uint32_t value)
{
    struct yetty_ycomplex2_video_ptr_result data = yetty_ycomplex2_video_from(obj);
    if (YETTY_IS_ERR(data)) {
        return YETTY_ERR(yetty_ycore_void, "yetty_ycomplex2_video_video_h_set: data block", data);
    }
    data.value->video_h = value;
    return YETTY_OK_VOID();
}
...
struct float_result yetty_ycomplex2_video_fps_get(struct yetty_yclass_object *obj)
{
    struct yetty_ycomplex2_video_ptr_result data = yetty_ycomplex2_video_from(obj);
    if (YETTY_IS_ERR(data)) {
        return YETTY_ERR(float, "yetty_ycomplex2_video_fps_get: data block", data);
    }
    return YETTY_OK(float, data.value->fps);
}
                                                             ...
                                                             float value)
{
    struct yetty_ycomplex2_video_ptr_result data = yetty_ycomplex2_video_from(obj);
    if (YETTY_IS_ERR(data)) {
        return YETTY_ERR(yetty_ycore_void, "yetty_ycomplex2_video_fps_set: data block", data);
    }
    data.value->fps = value;
    return YETTY_OK_VOID();
}
...
struct yetty_yclass_object_ptr_result yetty_ycomplex2_video_create(struct yetty_yclass_ctx *ctx)
{
    ydebug("class=yetty_ycomplex2_video");
    if (ctx && ctx->session) {
        return YETTY_ERR(
            yetty_yclass_object_ptr,
            "yetty_ycomplex2_video_create: remote create unsupported for a split-mode class; "
            "wrap a server handle via yetty_yclass_object_proxy_create");
    }
    struct yetty_yclass_ptr_result class_accessor_r = yetty_ycomplex2_video_class_get();
    if (YETTY_IS_ERR(class_accessor_r)) {
        return YETTY_ERR(yetty_yclass_object_ptr,
                         "yetty_ycomplex2_video_create: class accessor failed", class_accessor_r);
    }
...
/* ---- ycomplex2_video: class name -> accessor (lazy) ---------------------- */

static struct yetty_yclass_ptr_result yetty_ycomplex2_video_accessor_lookup(const char *name)
{
    if (strcmp(name, "yetty_ycomplex2_video") == 0) {
        return yetty_ycomplex2_video_class_get();
    }
    /* "Not mine": OK with NULL value -- yetty_yclass_by_name walks to next hook. */
    return YETTY_OK(yetty_yclass_ptr, NULL);
}

/* ---- ycomplex2_video: explicit yclass-RPC hook registration ------------- */
...
struct yetty_ycore_void_result yetty_ycomplex2_video_register(void)
{
    ...
    struct yetty_ycore_void_result add_accessor_r =
        yetty_yclass_add_accessor_lookup(yetty_ycomplex2_video_accessor_lookup);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, add_accessor_r,
                        "yetty_ycomplex2_video_register: add_accessor_lookup");
    registered = true;
    return YETTY_OK_VOID();
}
