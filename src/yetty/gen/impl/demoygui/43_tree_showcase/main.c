...
YETTY_MAYBE_UNUSED
static yetty_yguiapp_build_fn yetty_demoygui_43_tree_showcase_yetty_yguiapp_build_build_check =
    build;
    ...
    struct yetty_yclass_ctx *ctx)
{
    ...
    if (ctx && ctx->session) {
        return YETTY_ERR(yetty_yclass_object_ptr,
                         "yetty_demoygui_43_tree_showcase_create: remote create unsupported for a "
                         "split-mode class; "
