...
typedef struct yetty_ycore_void_result (*yetty_ygrid_add_record_fn)(struct yetty_yclass_object *, struct yetty_ycore_buffer);
...
YETTY_MAYBE_UNUSED
static yetty_yfigure_apply_scroll_anchor_fn yetty_ygrid_grid_yetty_yfigure_apply_scroll_anchor_check = yetty_ygrid_grid_apply_scroll_anchor_impl;
...
struct yetty_yclass_ptr_result yetty_ygrid_grid_class_get(void)
{
    ...
    static const struct yetty_yclass_op ops[] = {
        ...
        {"yetty_yfigure", "apply_scroll_anchor", (yetty_yclass_method_id_t)yetty_yfigure_apply_scroll_anchor, (yetty_yclass_impl_t)yetty_ygrid_grid_apply_scroll_anchor_impl},
    };
...
size_t yetty_ygrid_add_record_skel(const void *body, size_t body_len,
...
#pragma pack(pop)
    ...
    struct yetty_ycore_void_result call_r = yetty_ygrid_add_record((struct yetty_yclass_object *)obj_resolve_r.value, record_buf);
...
YETTY_EXTERNAL_CALLBACK
size_t yetty_ygrid_clear_skel(const void *body, size_t body_len,
                   void *resp, size_t resp_max)
{
/* Byte-exact wire layout — #pragma pack matches the first-party
 * convention (yvnc/ydvnc/libvterm) and compiles on MSVC, unlike a GNU
...
#pragma pack(pop)
    ...
    struct yetty_ycore_void_result call_r = yetty_ygrid_clear((struct yetty_yclass_object *)obj_resolve_r.value);
    if (resp_max < 1) return 0;
    if (YETTY_IS_ERR(call_r)) {
...
YETTY_EXTERNAL_CALLBACK
size_t yetty_ygrid_destroy_skel(const void *body, size_t body_len,
                   void *resp, size_t resp_max)
{
/* Byte-exact wire layout — #pragma pack matches the first-party
 * convention (yvnc/ydvnc/libvterm) and compiles on MSVC, unlike a GNU
...
#pragma pack(pop)
    ...
    struct yetty_ycore_void_result call_r = yetty_ygrid_destroy((struct yetty_yclass_object *)obj_resolve_r.value);
    if (resp_max < 1) return 0;
    if (YETTY_IS_ERR(call_r)) {
