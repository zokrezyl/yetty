...
struct yetty_ycore_void_result yetty_ygui_colorpicker_set_color(struct yetty_yclass_object *obj, uint32_t c);
struct yetty_ycore_uint32_result yetty_ygui_colorpicker_get_color(const struct yetty_yclass_object *obj);
