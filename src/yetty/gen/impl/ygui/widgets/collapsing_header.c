...
YETTY_MAYBE_UNUSED
static yetty_ygui_widget_on_press_fn yetty_ygui_collapsing_header_yetty_ygui_widget_on_press_check =
    on_press;
YETTY_MAYBE_UNUSED
static yetty_ygui_widget_paint_fn yetty_ygui_collapsing_header_yetty_ygui_widget_paint_check =
    paint;
...
struct yetty_yclass_ptr_result yetty_ygui_collapsing_header_class_get(void)
{
    ...
    if (YETTY_IS_ERR(parent_class_r)) {
        yerror("yetty_ygui_collapsing_header_class_get: parent accessor failed: %s",
               parent_class_r.error.msg);
        return YETTY_ERR(yetty_yclass_ptr,
                         "yetty_ygui_collapsing_header_class_get: parent accessor failed",
                         parent_class_r);
    }
    struct yetty_yclass_ptr_result register_class_r = yetty_yclass_register(
        &desc, ops, sizeof(ops) / sizeof(ops[0]), parent_class_r.value, NULL, 0);
    if (YETTY_IS_ERR(register_class_r)) {
        yerror("yetty_ygui_collapsing_header_class_get: class_register failed: %s",
               register_class_r.error.msg);
        return YETTY_ERR(yetty_yclass_ptr,
                         "yetty_ygui_collapsing_header_class_get: class_register failed",
                         register_class_r);
    }
    ...
    struct yetty_yclass_object *obj)
{
    ...
    if (YETTY_IS_ERR(class_r)) {
        return YETTY_ERR(yetty_ygui_collapsing_header_ptr,
                         "yetty_ygui_collapsing_header_from: class accessor", class_r);
    }
    struct yetty_yclass_void_ptr_result slice_r = yetty_yclass_object_data(obj, class_r.value);
    if (YETTY_IS_ERR(slice_r)) {
        return YETTY_ERR(yetty_ygui_collapsing_header_ptr,
                         "yetty_ygui_collapsing_header_from: object_data", slice_r);
    }
    return YETTY_OK(yetty_ygui_collapsing_header_ptr,
                    (struct yetty_ygui_collapsing_header *)slice_r.value);
}

struct yetty_yclass_object_ptr_result yetty_ygui_collapsing_header_to(
    struct yetty_ygui_collapsing_header *data)
{
    ...
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, class_r,
                        "yetty_ygui_collapsing_header_to: class accessor");
    struct yetty_ycore_size_result offset_r =
        yetty_yclass_object_data_offset(class_r.value, class_r.value);
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, offset_r,
                        "yetty_ygui_collapsing_header_to: data offset");
    ...
    struct yetty_yclass_ctx *ctx)
{
    ...
    if (ctx && ctx->session) {
        return YETTY_ERR(yetty_yclass_object_ptr,
                         "yetty_ygui_collapsing_header_create: remote create unsupported for a "
                         "split-mode class; "
