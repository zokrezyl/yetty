...
YETTY_MAYBE_UNUSED
static yetty_ygui_constructor_fn yetty_ygui_collapsing_header_yetty_ygui_constructor_ctor_check =
    ctor;
YETTY_MAYBE_UNUSED
static yetty_ygui_destructor_fn yetty_ygui_collapsing_header_yetty_ygui_destructor_dtor_check =
    dtor;
YETTY_MAYBE_UNUSED
static yetty_ygui_widget_on_press_fn
    yetty_ygui_collapsing_header_yetty_ygui_widget_on_press_on_press_check = on_press;
YETTY_MAYBE_UNUSED
static yetty_ygui_widget_paint_fn yetty_ygui_collapsing_header_yetty_ygui_widget_paint_paint_check =
    paint;
