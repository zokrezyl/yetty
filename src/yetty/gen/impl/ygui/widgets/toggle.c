...
YETTY_MAYBE_UNUSED
static yetty_ygui_constructor_fn yetty_ygui_toggle_yetty_ygui_constructor_toggle_constructor_check =
    toggle_constructor;
YETTY_MAYBE_UNUSED
static yetty_ygui_destructor_fn yetty_ygui_toggle_yetty_ygui_destructor_toggle_destructor_check =
    toggle_destructor;
YETTY_MAYBE_UNUSED
static yetty_ygui_widget_paint_fn yetty_ygui_toggle_yetty_ygui_widget_paint_toggle_paint_check =
    toggle_paint;
...
struct yetty_yclass_ptr_result yetty_ygui_toggle_class_get(void)
{
    ...
    static const struct yetty_yclass_op ops[] = {
        {"yetty_ygui", "constructor", (yetty_yclass_method_id_t)yetty_ygui_constructor,
         (yetty_yclass_impl_t)toggle_constructor},
        {"yetty_ygui", "destructor", (yetty_yclass_method_id_t)yetty_ygui_destructor,
         (yetty_yclass_impl_t)toggle_destructor},
    ...
    if (YETTY_IS_ERR(parent_class_r)) {
        ...
        return YETTY_ERR(yetty_yclass_ptr, "yetty_ygui_toggle_class_get: parent accessor failed",
                         parent_class_r);
    }
    struct yetty_yclass_ptr_result mixin_class_r_0 = yetty_ygui_clickable_mixin_get();
    if (YETTY_IS_ERR(mixin_class_r_0)) {
        yerror("yetty_ygui_toggle_class_get: mixin0 accessor failed: %s",
               mixin_class_r_0.error.msg);
        return YETTY_ERR(yetty_yclass_ptr, "yetty_ygui_toggle_class_get: mixin0 accessor failed",
                         mixin_class_r_0);
    }
    ...
    if (YETTY_IS_ERR(register_class_r)) {
        yerror("yetty_ygui_toggle_class_get: class_register failed: %s",
               register_class_r.error.msg);
        return YETTY_ERR(yetty_yclass_ptr, "yetty_ygui_toggle_class_get: class_register failed",
                         register_class_r);
    }
...
struct yetty_yclass_object_ptr_result yetty_ygui_toggle_to(struct yetty_ygui_toggle *data)
{
    ...
    struct yetty_yclass_ptr_result class_r = yetty_ygui_toggle_class_get();
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, class_r, "yetty_ygui_toggle_to: class accessor");
    struct yetty_ycore_size_result offset_r =
        yetty_yclass_object_data_offset(class_r.value, class_r.value);
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, offset_r, "yetty_ygui_toggle_to: data offset");
...
struct yetty_yclass_object_ptr_result yetty_ygui_toggle_create(struct yetty_yclass_ctx *ctx)
{
    ...
    if (ctx && ctx->session) {
        return YETTY_ERR(
            ...
            "yetty_ygui_toggle_create: remote create unsupported for a split-mode class; "
    ...
    if (YETTY_IS_ERR(ctor_r)) {
        ...
        return YETTY_ERR(yetty_yclass_object_ptr, "yetty_ygui_toggle_create: constructor failed",
                         ctor_r);
    }
    return alloc_r;
}
...
/* ---- ygui_toggle: class name -> accessor (lazy) ---------------------- */

static struct yetty_yclass_ptr_result yetty_ygui_toggle_accessor_lookup(const char *name)
{
...
/* ---- ygui_toggle: explicit yclass-RPC hook registration ------------- */
...
struct yetty_ycore_void_result yetty_ygui_toggle_register(void)
{
    ...
    struct yetty_ycore_void_result add_accessor_r =
        yetty_yclass_add_accessor_lookup(yetty_ygui_toggle_accessor_lookup);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, add_accessor_r,
                        "yetty_ygui_toggle_register: add_accessor_lookup");
    registered = true;
    return YETTY_OK_VOID();
}
