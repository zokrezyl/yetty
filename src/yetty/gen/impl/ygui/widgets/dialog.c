...
YETTY_MAYBE_UNUSED
static yetty_ygui_constructor_fn yetty_ygui_dialog_yetty_ygui_constructor_dialog_constructor_check =
    dialog_constructor;
YETTY_MAYBE_UNUSED
static yetty_ygui_destructor_fn yetty_ygui_dialog_yetty_ygui_destructor_dialog_destructor_check =
    dialog_destructor;
YETTY_MAYBE_UNUSED
static yetty_ygui_widget_paint_fn yetty_ygui_dialog_yetty_ygui_widget_paint_dialog_paint_check =
    dialog_paint;
...
struct yetty_yclass_object_ptr_result yetty_ygui_dialog_create(struct yetty_yclass_ctx *ctx)
{
    ...
    if (YETTY_IS_ERR(ctor_r)) {
        ...
        return YETTY_ERR(yetty_yclass_object_ptr, "yetty_ygui_dialog_create: constructor failed",
                         ctor_r);
    }
    return alloc_r;
}
