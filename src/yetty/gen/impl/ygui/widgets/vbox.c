...
YETTY_MAYBE_UNUSED
static yetty_ygui_constructor_fn yetty_ygui_vbox_yetty_ygui_constructor_vbox_constructor_check =
    vbox_constructor;
...
struct yetty_yclass_object_ptr_result yetty_ygui_vbox_to(struct yetty_ygui_vbox *data)
{
    if (!data) {
        return YETTY_OK(yetty_yclass_object_ptr, NULL);
    }
    struct yetty_yclass_ptr_result class_r = yetty_ygui_vbox_class_get();
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, class_r, "yetty_ygui_vbox_to: class accessor");
    struct yetty_ycore_size_result offset_r =
        yetty_yclass_object_data_offset(class_r.value, class_r.value);
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, offset_r, "yetty_ygui_vbox_to: data offset");
...
struct yetty_yclass_object_ptr_result yetty_ygui_vbox_create(struct yetty_yclass_ctx *ctx)
{
    ...
    if (ctx && ctx->session) {
        return YETTY_ERR(
            ...
            "yetty_ygui_vbox_create: remote create unsupported for a split-mode class; "
...
/* ---- ygui_vbox: class name -> accessor (lazy) ---------------------- */

static struct yetty_yclass_ptr_result yetty_ygui_vbox_accessor_lookup(const char *name)
{
...
/* ---- ygui_vbox: explicit yclass-RPC hook registration ------------- */
...
struct yetty_ycore_void_result yetty_ygui_vbox_register(void)
{
    ...
    struct yetty_ycore_void_result add_accessor_r =
        yetty_yclass_add_accessor_lookup(yetty_ygui_vbox_accessor_lookup);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, add_accessor_r,
                        "yetty_ygui_vbox_register: add_accessor_lookup");
    registered = true;
    return YETTY_OK_VOID();
}
