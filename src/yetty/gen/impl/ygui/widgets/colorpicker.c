...
struct yetty_ygui_colorpicker_ptr_result yetty_ygui_colorpicker_from(struct yetty_yclass_object *obj)
{
    struct yetty_yclass_ptr_result class_r = yetty_ygui_colorpicker_class_get();
    if (YETTY_IS_ERR(class_r))
        return YETTY_ERR(yetty_ygui_colorpicker_ptr, "yetty_ygui_colorpicker_from: class accessor", class_r);
    struct yetty_yclass_void_ptr_result slice_r =
        yetty_yclass_object_data(obj, class_r.value);
    if (YETTY_IS_ERR(slice_r))
        return YETTY_ERR(yetty_ygui_colorpicker_ptr, "yetty_ygui_colorpicker_from: object_data", slice_r);
...
struct yetty_yclass_object_ptr_result yetty_ygui_colorpicker_to(struct yetty_ygui_colorpicker *data)
{
    ...
    struct yetty_yclass_ptr_result class_r = yetty_ygui_colorpicker_class_get();
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, class_r, "yetty_ygui_colorpicker_to: class accessor");
    struct yetty_ycore_size_result offset_r =
        yetty_yclass_object_data_offset(class_r.value, class_r.value);
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, offset_r, "yetty_ygui_colorpicker_to: data offset");
