...
YETTY_MAYBE_UNUSED
static yetty_ygui_widget_on_press_fn yetty_ygui_ynode_yetty_ygui_widget_on_press_check = ynode_on_press;
YETTY_MAYBE_UNUSED
static yetty_ygui_widget_on_motion_fn yetty_ygui_ynode_yetty_ygui_widget_on_motion_check = ynode_on_motion;
YETTY_MAYBE_UNUSED
static yetty_ygui_widget_on_release_fn yetty_ygui_ynode_yetty_ygui_widget_on_release_check = ynode_on_release;
...
struct yetty_yclass_ptr_result yetty_ygui_ynode_class_get(void)
{
    ...
    static const struct yetty_yclass_op ops[] = {
        {"yetty_ygui", "constructor", (yetty_yclass_method_id_t)yetty_ygui_constructor, (yetty_yclass_impl_t)ynode_constructor},
        {"yetty_ygui", "destructor", (yetty_yclass_method_id_t)yetty_ygui_destructor, (yetty_yclass_impl_t)ynode_destructor},
        {"yetty_ygui", "widget_paint", (yetty_yclass_method_id_t)yetty_ygui_widget_paint, (yetty_yclass_impl_t)ynode_paint},
        {"yetty_ygui", "widget_on_press", (yetty_yclass_method_id_t)yetty_ygui_widget_on_press, (yetty_yclass_impl_t)ynode_on_press},
        {"yetty_ygui", "widget_on_motion", (yetty_yclass_method_id_t)yetty_ygui_widget_on_motion, (yetty_yclass_impl_t)ynode_on_motion},
        {"yetty_ygui", "widget_on_release", (yetty_yclass_method_id_t)yetty_ygui_widget_on_release, (yetty_yclass_impl_t)ynode_on_release},
    };
    ...
    if (YETTY_IS_ERR(parent_class_r)) {
        ...
        return YETTY_ERR(yetty_yclass_ptr, "yetty_ygui_ynode_class_get: parent accessor failed", parent_class_r);
    }
    ...
    if (YETTY_IS_ERR(register_class_r)) {
        ...
        return YETTY_ERR(yetty_yclass_ptr, "yetty_ygui_ynode_class_get: class_register failed", register_class_r);
    }
...
struct yetty_yclass_object_ptr_result yetty_ygui_ynode_to(struct yetty_ygui_ynode *data)
{
    ...
    struct yetty_yclass_ptr_result class_r = yetty_ygui_ynode_class_get();
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, class_r, "yetty_ygui_ynode_to: class accessor");
    struct yetty_ycore_size_result offset_r =
        yetty_yclass_object_data_offset(class_r.value, class_r.value);
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, offset_r, "yetty_ygui_ynode_to: data offset");
...
struct yetty_yclass_object_ptr_result yetty_ygui_ynode_create(struct yetty_yclass_ctx *ctx)
{
    ...
    if (ctx && ctx->session)
        return YETTY_ERR(yetty_yclass_object_ptr,
                         "yetty_ygui_ynode_create: remote create unsupported for a split-mode class; "
...
/* ---- ygui_ynode: class name -> accessor (lazy) ---------------------- */

static struct yetty_yclass_ptr_result yetty_ygui_ynode_accessor_lookup(const char *name)
{
...
/* ---- ygui_ynode: explicit yclass-RPC hook registration ------------- */
...
struct yetty_ycore_void_result yetty_ygui_ynode_register(void)
{
    ...
    struct yetty_ycore_void_result add_accessor_r =
        yetty_yclass_add_accessor_lookup(yetty_ygui_ynode_accessor_lookup);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, add_accessor_r,
                        "yetty_ygui_ynode_register: add_accessor_lookup");
    registered = true;
    return YETTY_OK_VOID();
}
