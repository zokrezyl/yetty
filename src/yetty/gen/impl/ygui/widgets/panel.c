...
struct yetty_yclass_ptr_result yetty_ygui_panel_class_get(void)
{
    ...
    static const struct yetty_yclass_op ops[] = {
        {"yetty_ygui", "constructor", (yetty_yclass_method_id_t)yetty_ygui_constructor,
         (yetty_yclass_impl_t)panel_constructor},
    ...
    if (YETTY_IS_ERR(parent_class_r)) {
        ...
        return YETTY_ERR(yetty_yclass_ptr, "yetty_ygui_panel_class_get: parent accessor failed",
                         parent_class_r);
    }
    ...
    if (YETTY_IS_ERR(register_class_r)) {
        ...
        return YETTY_ERR(yetty_yclass_ptr, "yetty_ygui_panel_class_get: class_register failed",
                         register_class_r);
    }
