...
YETTY_MAYBE_UNUSED
static yetty_ygui_constructor_fn yetty_ygui_ynodes_yetty_ygui_constructor_check = ynodes_constructor;
YETTY_MAYBE_UNUSED
...
YETTY_MAYBE_UNUSED
static yetty_ygui_widget_on_press_fn yetty_ygui_ynodes_yetty_ygui_widget_on_press_check = ynodes_on_press;
YETTY_MAYBE_UNUSED
static yetty_ygui_widget_on_motion_fn yetty_ygui_ynodes_yetty_ygui_widget_on_motion_check = ynodes_on_motion;
YETTY_MAYBE_UNUSED
static yetty_ygui_widget_on_release_fn yetty_ygui_ynodes_yetty_ygui_widget_on_release_check = ynodes_on_release;
YETTY_MAYBE_UNUSED
static yetty_ygui_widget_on_scroll_fn yetty_ygui_ynodes_yetty_ygui_widget_on_scroll_check = ynodes_on_scroll;
...
struct yetty_yclass_ptr_result yetty_ygui_ynodes_class_get(void)
{
    ...
    static const struct yetty_yclass_op ops[] = {
        {"yetty_ygui", "constructor", (yetty_yclass_method_id_t)yetty_ygui_constructor, (yetty_yclass_impl_t)ynodes_constructor},
        {"yetty_ygui", "destructor", (yetty_yclass_method_id_t)yetty_ygui_destructor, (yetty_yclass_impl_t)ynodes_destructor},
        {"yetty_ygui", "widget_paint", (yetty_yclass_method_id_t)yetty_ygui_widget_paint, (yetty_yclass_impl_t)ynodes_paint},
        {"yetty_ygui", "widget_on_press", (yetty_yclass_method_id_t)yetty_ygui_widget_on_press, (yetty_yclass_impl_t)ynodes_on_press},
        {"yetty_ygui", "widget_on_motion", (yetty_yclass_method_id_t)yetty_ygui_widget_on_motion, (yetty_yclass_impl_t)ynodes_on_motion},
        {"yetty_ygui", "widget_on_release", (yetty_yclass_method_id_t)yetty_ygui_widget_on_release, (yetty_yclass_impl_t)ynodes_on_release},
        {"yetty_ygui", "widget_on_scroll", (yetty_yclass_method_id_t)yetty_ygui_widget_on_scroll, (yetty_yclass_impl_t)ynodes_on_scroll},
    };
    ...
    if (YETTY_IS_ERR(parent_class_r)) {
        ...
        return YETTY_ERR(yetty_yclass_ptr, "yetty_ygui_ynodes_class_get: parent accessor failed", parent_class_r);
    }
    struct yetty_yclass_ptr_result register_class_r =
        yetty_yclass_register(&desc, ops, sizeof(ops) / sizeof(ops[0]),
                              parent_class_r.value, NULL, 0);
    if (YETTY_IS_ERR(register_class_r)) {
        yerror("yetty_ygui_ynodes_class_get: class_register failed: %s", register_class_r.error.msg);
        return YETTY_ERR(yetty_yclass_ptr, "yetty_ygui_ynodes_class_get: class_register failed", register_class_r);
    }
...
struct yetty_yclass_object_ptr_result yetty_ygui_ynodes_to(struct yetty_ygui_ynodes *data)
{
    ...
    struct yetty_yclass_ptr_result class_r = yetty_ygui_ynodes_class_get();
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, class_r, "yetty_ygui_ynodes_to: class accessor");
    struct yetty_ycore_size_result offset_r =
        yetty_yclass_object_data_offset(class_r.value, class_r.value);
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, offset_r, "yetty_ygui_ynodes_to: data offset");
...
struct yetty_yclass_object_ptr_result yetty_ygui_ynodes_create(struct yetty_yclass_ctx *ctx)
{
    ...
    if (ctx && ctx->session)
        return YETTY_ERR(yetty_yclass_object_ptr,
                         "yetty_ygui_ynodes_create: remote create unsupported for a split-mode class; "
...
/* ---- ygui_ynodes: class name -> accessor (lazy) ---------------------- */

static struct yetty_yclass_ptr_result yetty_ygui_ynodes_accessor_lookup(const char *name)
{
...
/* ---- ygui_ynodes: explicit yclass-RPC hook registration ------------- */
...
struct yetty_ycore_void_result yetty_ygui_ynodes_register(void)
{
    ...
    struct yetty_ycore_void_result add_accessor_r =
        yetty_yclass_add_accessor_lookup(yetty_ygui_ynodes_accessor_lookup);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, add_accessor_r,
                        "yetty_ygui_ynodes_register: add_accessor_lookup");
    registered = true;
    return YETTY_OK_VOID();
}
