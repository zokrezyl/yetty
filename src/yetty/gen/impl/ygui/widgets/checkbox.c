...
static yetty_ygui_constructor_fn
    yetty_ygui_checkbox_yetty_ygui_constructor_checkbox_constructor_check = checkbox_constructor;
YETTY_MAYBE_UNUSED
static yetty_ygui_destructor_fn
    yetty_ygui_checkbox_yetty_ygui_destructor_checkbox_destructor_check = checkbox_destructor;
YETTY_MAYBE_UNUSED
static yetty_ygui_widget_paint_fn yetty_ygui_checkbox_yetty_ygui_widget_paint_checkbox_paint_check =
    checkbox_paint;
...
struct yetty_yclass_ptr_result yetty_ygui_checkbox_class_get(void)
{
    ...
    ydebug("registering class=yetty_ygui_checkbox");

    static const struct yetty_yclass_descriptor desc = {
        .name = "yetty_ygui_checkbox",
        .type = YETTY_YCLASS_TYPE_REGULAR,
        .data_size = sizeof(struct yetty_ygui_checkbox),
        .data_align = _Alignof(struct yetty_ygui_checkbox),
    };
    static const struct yetty_yclass_op ops[] = {
        {"yetty_ygui", "constructor", (yetty_yclass_method_id_t)yetty_ygui_constructor,
         (yetty_yclass_impl_t)checkbox_constructor},
        {"yetty_ygui", "destructor", (yetty_yclass_method_id_t)yetty_ygui_destructor,
         (yetty_yclass_impl_t)checkbox_destructor},
        {"yetty_ygui", "widget_paint", (yetty_yclass_method_id_t)yetty_ygui_widget_paint,
         (yetty_yclass_impl_t)checkbox_paint},
    };
    struct yetty_yclass_ptr_result parent_class_r = yetty_ygui_primitive_widget_class_get();
    if (YETTY_IS_ERR(parent_class_r)) {
        yerror("yetty_ygui_checkbox_class_get: parent accessor failed: %s",
               parent_class_r.error.msg);
        return YETTY_ERR(yetty_yclass_ptr, "yetty_ygui_checkbox_class_get: parent accessor failed",
                         parent_class_r);
    }
    struct yetty_yclass_ptr_result mixin_class_r_0 = yetty_ygui_clickable_mixin_get();
    if (YETTY_IS_ERR(mixin_class_r_0)) {
        yerror("yetty_ygui_checkbox_class_get: mixin0 accessor failed: %s",
               mixin_class_r_0.error.msg);
        return YETTY_ERR(yetty_yclass_ptr, "yetty_ygui_checkbox_class_get: mixin0 accessor failed",
                         mixin_class_r_0);
    }
    ...
    if (YETTY_IS_ERR(register_class_r)) {
        yerror("yetty_ygui_checkbox_class_get: class_register failed: %s",
               register_class_r.error.msg);
        return YETTY_ERR(yetty_yclass_ptr, "yetty_ygui_checkbox_class_get: class_register failed",
                         register_class_r);
    }
...
{
    struct yetty_yclass_ptr_result class_r = yetty_ygui_checkbox_class_get();
    if (YETTY_IS_ERR(class_r)) {
        return YETTY_ERR(yetty_ygui_checkbox_ptr, "yetty_ygui_checkbox_from: class accessor",
                         class_r);
    }
    struct yetty_yclass_void_ptr_result slice_r = yetty_yclass_object_data(obj, class_r.value);
    if (YETTY_IS_ERR(slice_r)) {
        return YETTY_ERR(yetty_ygui_checkbox_ptr, "yetty_ygui_checkbox_from: object_data", slice_r);
    }
    return YETTY_OK(yetty_ygui_checkbox_ptr, (struct yetty_ygui_checkbox *)slice_r.value);
}
...
struct yetty_yclass_object_ptr_result yetty_ygui_checkbox_to(struct yetty_ygui_checkbox *data)
{
    ...
    struct yetty_yclass_ptr_result class_r = yetty_ygui_checkbox_class_get();
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, class_r, "yetty_ygui_checkbox_to: class accessor");
    struct yetty_ycore_size_result offset_r =
        yetty_yclass_object_data_offset(class_r.value, class_r.value);
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, offset_r, "yetty_ygui_checkbox_to: data offset");
...
struct yetty_yclass_object_ptr_result yetty_ygui_checkbox_create(struct yetty_yclass_ctx *ctx)
{
    ...
    if (ctx && ctx->session) {
        return YETTY_ERR(
            ...
            "yetty_ygui_checkbox_create: remote create unsupported for a split-mode class; "
    ...
    if (YETTY_IS_ERR(ctor_r)) {
        ...
        return YETTY_ERR(yetty_yclass_object_ptr, "yetty_ygui_checkbox_create: constructor failed",
                         ctor_r);
    }
    return alloc_r;
}
...
/* ---- ygui_checkbox: class name -> accessor (lazy) ---------------------- */

static struct yetty_yclass_ptr_result yetty_ygui_checkbox_accessor_lookup(const char *name)
{
...
/* ---- ygui_checkbox: explicit yclass-RPC hook registration ------------- */
...
struct yetty_ycore_void_result yetty_ygui_checkbox_register(void)
{
    ...
    struct yetty_ycore_void_result add_accessor_r =
        yetty_yclass_add_accessor_lookup(yetty_ygui_checkbox_accessor_lookup);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, add_accessor_r,
                        "yetty_ygui_checkbox_register: add_accessor_lookup");
    registered = true;
    return YETTY_OK_VOID();
}
