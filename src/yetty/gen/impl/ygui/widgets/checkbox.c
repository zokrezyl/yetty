...
struct yetty_yclass_ptr_result yetty_ygui_checkbox_class_get(void)
{
    ...
    static const struct yetty_yclass_op ops[] = {
        {"yetty_ygui", "constructor", (yetty_yclass_method_id_t)yetty_ygui_constructor, (yetty_yclass_impl_t)checkbox_constructor},
    ...
    if (YETTY_IS_ERR(parent_class_r)) {
        yerror("yetty_ygui_checkbox_class_get: parent accessor failed: %s", parent_class_r.error.msg);
    ...
    if (YETTY_IS_ERR(mixin_class_r_0)) {
        yerror("yetty_ygui_checkbox_class_get: mixin0 accessor failed: %s", mixin_class_r_0.error.msg);
    ...
    if (YETTY_IS_ERR(register_class_r)) {
        yerror("yetty_ygui_checkbox_class_get: class_register failed: %s", register_class_r.error.msg);
...
struct yetty_ygui_checkbox_ptr_result yetty_ygui_checkbox_from(struct yetty_yclass_object *obj)
{
    ...
    if (YETTY_IS_ERR(class_r))
        return YETTY_ERR(yetty_ygui_checkbox_ptr, "yetty_ygui_checkbox_from: class accessor", class_r);
