...
YETTY_MAYBE_UNUSED
static yetty_ygui_widget_emit_container_fn yetty_ygui_yvideo_yetty_ygui_widget_emit_container_check = emit_container;
YETTY_MAYBE_UNUSED
static yetty_ygui_widget_emit_body_fn yetty_ygui_yvideo_yetty_ygui_widget_emit_body_check = emit_body;
...
struct yetty_yclass_ptr_result yetty_ygui_yvideo_class_get(void)
{
    ...
    if (YETTY_IS_ERR(parent_class_r)) {
        ...
        return YETTY_ERR(yetty_yclass_ptr, "yetty_ygui_yvideo_class_get: parent accessor failed", parent_class_r);
    }
    struct yetty_yclass_ptr_result register_class_r =
        yetty_yclass_register(&desc, ops, sizeof(ops) / sizeof(ops[0]),
                              parent_class_r.value, NULL, 0);
    if (YETTY_IS_ERR(register_class_r)) {
        yerror("yetty_ygui_yvideo_class_get: class_register failed: %s", register_class_r.error.msg);
        return YETTY_ERR(yetty_yclass_ptr, "yetty_ygui_yvideo_class_get: class_register failed", register_class_r);
    }
