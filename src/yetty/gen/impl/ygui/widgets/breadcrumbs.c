...
struct yetty_yclass_ptr_result yetty_ygui_breadcrumbs_class_get(void)
{
    ...
    if (YETTY_IS_ERR(parent_class_r)) {
        yerror("yetty_ygui_breadcrumbs_class_get: parent accessor failed: %s", parent_class_r.error.msg);
        return YETTY_ERR(yetty_yclass_ptr, "yetty_ygui_breadcrumbs_class_get: parent accessor failed", parent_class_r);
    }
    struct yetty_yclass_ptr_result register_class_r =
        yetty_yclass_register(&desc, ops, sizeof(ops) / sizeof(ops[0]),
                              parent_class_r.value, NULL, 0);
    if (YETTY_IS_ERR(register_class_r)) {
        yerror("yetty_ygui_breadcrumbs_class_get: class_register failed: %s", register_class_r.error.msg);
        return YETTY_ERR(yetty_yclass_ptr, "yetty_ygui_breadcrumbs_class_get: class_register failed", register_class_r);
    }
...
struct yetty_ygui_breadcrumbs_ptr_result yetty_ygui_breadcrumbs_from(struct yetty_yclass_object *obj)
{
    ...
    if (YETTY_IS_ERR(class_r))
        return YETTY_ERR(yetty_ygui_breadcrumbs_ptr, "yetty_ygui_breadcrumbs_from: class accessor", class_r);
    struct yetty_yclass_void_ptr_result slice_r =
        yetty_yclass_object_data(obj, class_r.value);
    if (YETTY_IS_ERR(slice_r))
        return YETTY_ERR(yetty_ygui_breadcrumbs_ptr, "yetty_ygui_breadcrumbs_from: object_data", slice_r);
...
struct yetty_yclass_object_ptr_result yetty_ygui_breadcrumbs_to(struct yetty_ygui_breadcrumbs *data)
{
    ...
    struct yetty_yclass_ptr_result class_r = yetty_ygui_breadcrumbs_class_get();
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, class_r, "yetty_ygui_breadcrumbs_to: class accessor");
    struct yetty_ycore_size_result offset_r =
        yetty_yclass_object_data_offset(class_r.value, class_r.value);
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, offset_r, "yetty_ygui_breadcrumbs_to: data offset");
...
struct yetty_ycore_void_result yetty_ygui_register(void)
{
    ...
    }
    {
        ...
        YETTY_RETURN_IF_ERR(yetty_ycore_void, sub_r,
                            "yetty_ygui_register: submodule ygui_button");
    }
    {
        /* Submodule aggregator is always compiled into the same
         * library, so this strong call is always resolved. */
    ...
    }
    {
        ...
        YETTY_RETURN_IF_ERR(yetty_ycore_void, sub_r,
                            "yetty_ygui_register: submodule ygui_chip");
    }
    {
        /* Submodule aggregator is always compiled into the same
         * library, so this strong call is always resolved. */
    ...
    }
    {
        ...
        YETTY_RETURN_IF_ERR(yetty_ycore_void, sub_r,
                            "yetty_ygui_register: submodule ygui_dialog");
    }
    {
        /* Submodule aggregator is always compiled into the same
         * library, so this strong call is always resolved. */
    ...
    }
    {
        ...
        YETTY_RETURN_IF_ERR(yetty_ycore_void, sub_r,
                            "yetty_ygui_register: submodule ygui_hbox");
    }
    {
        /* Submodule aggregator is always compiled into the same
         * library, so this strong call is always resolved. */
        ...
        YETTY_RETURN_IF_ERR(yetty_ycore_void, sub_r,
                            "yetty_ygui_register: submodule ygui_label");
    }
    {
        /* Submodule aggregator is always compiled into the same
         * library, so this strong call is always resolved. */
        ...
        YETTY_RETURN_IF_ERR(yetty_ycore_void, sub_r,
                            "yetty_ygui_register: submodule ygui_list");
    }
    {
        /* Submodule aggregator is always compiled into the same
         * library, so this strong call is always resolved. */
        ...
        YETTY_RETURN_IF_ERR(yetty_ycore_void, sub_r,
                            "yetty_ygui_register: submodule ygui_menubar");
    }
    {
        /* Submodule aggregator is always compiled into the same
         * library, so this strong call is always resolved. */
        ...
        YETTY_RETURN_IF_ERR(yetty_ycore_void, sub_r,
                            "yetty_ygui_register: submodule ygui_panel");
    }
    {
        /* Submodule aggregator is always compiled into the same
         * library, so this strong call is always resolved. */
    ...
    }
    {
        ...
        YETTY_RETURN_IF_ERR(yetty_ycore_void, sub_r,
                            "yetty_ygui_register: submodule ygui_radio");
    }
    {
        /* Submodule aggregator is always compiled into the same
         * library, so this strong call is always resolved. */
        ...
        YETTY_RETURN_IF_ERR(yetty_ycore_void, sub_r,
                            "yetty_ygui_register: submodule ygui_rich");
    }
    {
        /* Submodule aggregator is always compiled into the same
         * library, so this strong call is always resolved. */
    ...
    }
    {
        ...
        YETTY_RETURN_IF_ERR(yetty_ycore_void, sub_r,
                            "yetty_ygui_register: submodule ygui_slider");
    }
    {
        /* Submodule aggregator is always compiled into the same
         * library, so this strong call is always resolved. */
        ...
        YETTY_RETURN_IF_ERR(yetty_ycore_void, sub_r,
                            "yetty_ygui_register: submodule ygui_spinner");
    }
    {
        /* Submodule aggregator is always compiled into the same
         * library, so this strong call is always resolved. */
    ...
    }
    {
        ...
        YETTY_RETURN_IF_ERR(yetty_ycore_void, sub_r,
                            "yetty_ygui_register: submodule ygui_stepper");
    }
    {
        /* Submodule aggregator is always compiled into the same
         * library, so this strong call is always resolved. */
        ...
        YETTY_RETURN_IF_ERR(yetty_ycore_void, sub_r,
                            "yetty_ygui_register: submodule ygui_tabbar");
    }
    {
        /* Submodule aggregator is always compiled into the same
         * library, so this strong call is always resolved. */
        ...
        YETTY_RETURN_IF_ERR(yetty_ycore_void, sub_r,
                            "yetty_ygui_register: submodule ygui_table");
    }
    {
        /* Submodule aggregator is always compiled into the same
         * library, so this strong call is always resolved. */
    ...
    }
    {
        ...
        YETTY_RETURN_IF_ERR(yetty_ycore_void, sub_r,
                            "yetty_ygui_register: submodule ygui_toggle");
    }
    {
        /* Submodule aggregator is always compiled into the same
         * library, so this strong call is always resolved. */
        ...
        YETTY_RETURN_IF_ERR(yetty_ycore_void, sub_r,
                            "yetty_ygui_register: submodule ygui_tooltip");
    }
    {
        /* Submodule aggregator is always compiled into the same
         * library, so this strong call is always resolved. */
    ...
    }
    {
        ...
        YETTY_RETURN_IF_ERR(yetty_ycore_void, sub_r,
                            "yetty_ygui_register: submodule ygui_vbox");
    }
    {
        /* Submodule aggregator is always compiled into the same
         * library, so this strong call is always resolved. */
        ...
        YETTY_RETURN_IF_ERR(yetty_ycore_void, sub_r,
                            "yetty_ygui_register: submodule ygui_widget");
    }
    {
        /* Submodule aggregator is always compiled into the same
         * library, so this strong call is always resolved. */
        ...
        YETTY_RETURN_IF_ERR(yetty_ycore_void, sub_r,
                            "yetty_ygui_register: submodule ygui_window");
    }
    {
        /* Submodule aggregator is always compiled into the same
         * library, so this strong call is always resolved. */
    ...
    }
    {
        ...
        YETTY_RETURN_IF_ERR(yetty_ycore_void, sub_r,
                            "yetty_ygui_register: submodule ygui_yimage");
    }
    {
        /* Submodule aggregator is always compiled into the same
         * library, so this strong call is always resolved. */
        ...
        YETTY_RETURN_IF_ERR(yetty_ycore_void, sub_r,
                            "yetty_ygui_register: submodule ygui_yjungle");
    }
    {
        /* Submodule aggregator is always compiled into the same
         * library, so this strong call is always resolved. */
    ...
    }
    {
        ...
        YETTY_RETURN_IF_ERR(yetty_ycore_void, sub_r,
                            "yetty_ygui_register: submodule ygui_ymaze");
    }
    {
        /* Submodule aggregator is always compiled into the same
         * library, so this strong call is always resolved. */
        ...
        YETTY_RETURN_IF_ERR(yetty_ycore_void, sub_r,
                            "yetty_ygui_register: submodule ygui_ynode");
    }
    {
        /* Submodule aggregator is always compiled into the same
         * library, so this strong call is always resolved. */
        ...
        YETTY_RETURN_IF_ERR(yetty_ycore_void, sub_r,
                            "yetty_ygui_register: submodule ygui_ynodes");
    }
    {
        /* Submodule aggregator is always compiled into the same
         * library, so this strong call is always resolved. */
        ...
        YETTY_RETURN_IF_ERR(yetty_ycore_void, sub_r,
                            "yetty_ygui_register: submodule ygui_ypdf");
    }
    {
        /* Submodule aggregator is always compiled into the same
         * library, so this strong call is always resolved. */
        ...
        YETTY_RETURN_IF_ERR(yetty_ycore_void, sub_r,
                            "yetty_ygui_register: submodule ygui_yplot");
    }
    {
        /* Submodule aggregator is always compiled into the same
         * library, so this strong call is always resolved. */
    ...
    }
    {
        ...
        YETTY_RETURN_IF_ERR(yetty_ycore_void, sub_r,
                            "yetty_ygui_register: submodule ygui_yvideo");
    }
    {
        /* Submodule aggregator is always compiled into the same
         * library, so this strong call is always resolved. */
        ...
        YETTY_RETURN_IF_ERR(yetty_ycore_void, sub_r,
                            "yetty_ygui_register: submodule ygui_yzoo");
    }
    registered = true;
    return YETTY_OK_VOID();
}
