...
struct yetty_yclass_ptr_result yetty_ygui_label_class_get(void)
{
    ...
    if (YETTY_IS_ERR(parent_class_r)) {
        ...
        return YETTY_ERR(yetty_yclass_ptr, "yetty_ygui_label_class_get: parent accessor failed",
                         parent_class_r);
    }
    ...
    if (YETTY_IS_ERR(register_class_r)) {
        ...
        return YETTY_ERR(yetty_yclass_ptr, "yetty_ygui_label_class_get: class_register failed",
                         register_class_r);
    }
