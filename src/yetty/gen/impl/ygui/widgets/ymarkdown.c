...
YETTY_MAYBE_UNUSED
static yetty_ygui_constructor_fn yetty_ygui_ymarkdown_yetty_ygui_constructor_ymd_constructor_check =
    ymd_constructor;
YETTY_MAYBE_UNUSED
static yetty_ygui_destructor_fn yetty_ygui_ymarkdown_yetty_ygui_destructor_ymd_destructor_check =
    ymd_destructor;
YETTY_MAYBE_UNUSED
static yetty_ygui_widget_emit_body_fn
    yetty_ygui_ymarkdown_yetty_ygui_widget_emit_body_ymd_emit_body_check = ymd_emit_body;
...
struct yetty_yclass_ptr_result yetty_ygui_ymarkdown_class_get(void)
{
    ...
    static const struct yetty_yclass_descriptor desc = {
        ...
        .data_align = _Alignof(struct yetty_ygui_ymarkdown),
    };
...
struct yetty_yclass_object_ptr_result yetty_ygui_ymarkdown_to(struct yetty_ygui_ymarkdown *data)
{
    ...
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, class_r,
                        "yetty_ygui_ymarkdown_to: class accessor");
    struct yetty_ycore_size_result offset_r =
        yetty_yclass_object_data_offset(class_r.value, class_r.value);
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, offset_r, "yetty_ygui_ymarkdown_to: data offset");
...
struct yetty_yclass_object_ptr_result yetty_ygui_ymarkdown_create(struct yetty_yclass_ctx *ctx)
{
    ...
    if (ctx && ctx->session) {
        return YETTY_ERR(
            ...
            "yetty_ygui_ymarkdown_create: remote create unsupported for a split-mode class; "
    ...
    if (YETTY_IS_ERR(ctor_r)) {
        ...
        return YETTY_ERR(yetty_yclass_object_ptr, "yetty_ygui_ymarkdown_create: constructor failed",
                         ctor_r);
    }
    return alloc_r;
}
...
/* ---- ygui_ymarkdown: class name -> accessor (lazy) ---------------------- */

static struct yetty_yclass_ptr_result yetty_ygui_ymarkdown_accessor_lookup(const char *name)
{
...
/* ---- ygui_ymarkdown: explicit yclass-RPC hook registration ------------- */
...
struct yetty_ycore_void_result yetty_ygui_ymarkdown_register(void)
{
    ...
    struct yetty_ycore_void_result add_accessor_r =
        yetty_yclass_add_accessor_lookup(yetty_ygui_ymarkdown_accessor_lookup);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, add_accessor_r,
                        "yetty_ygui_ymarkdown_register: add_accessor_lookup");
    registered = true;
    return YETTY_OK_VOID();
}
