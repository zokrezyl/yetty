...
struct yetty_ygui_ymarkdown_ptr_result yetty_ygui_ymarkdown_from(struct yetty_yclass_object *obj)
{
    ...
    if (YETTY_IS_ERR(class_r))
        return YETTY_ERR(yetty_ygui_ymarkdown_ptr, "yetty_ygui_ymarkdown_from: class accessor", class_r);
    struct yetty_yclass_void_ptr_result slice_r =
        yetty_yclass_object_data(obj, class_r.value);
    if (YETTY_IS_ERR(slice_r))
        return YETTY_ERR(yetty_ygui_ymarkdown_ptr, "yetty_ygui_ymarkdown_from: object_data", slice_r);
...
struct yetty_yclass_object_ptr_result yetty_ygui_ymarkdown_to(struct yetty_ygui_ymarkdown *data)
{
    ...
    struct yetty_yclass_ptr_result class_r = yetty_ygui_ymarkdown_class_get();
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, class_r, "yetty_ygui_ymarkdown_to: class accessor");
