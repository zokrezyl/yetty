...
struct yetty_yclass_ptr_result yetty_ygui_statusbar_class_get(void)
{
    ...
    if (YETTY_IS_ERR(parent_class_r)) {
        yerror("yetty_ygui_statusbar_class_get: parent accessor failed: %s", parent_class_r.error.msg);
    ...
    if (YETTY_IS_ERR(register_class_r)) {
        yerror("yetty_ygui_statusbar_class_get: class_register failed: %s", register_class_r.error.msg);
...
struct yetty_ygui_statusbar_ptr_result yetty_ygui_statusbar_from(struct yetty_yclass_object *obj)
{
    ...
    if (YETTY_IS_ERR(class_r))
        return YETTY_ERR(yetty_ygui_statusbar_ptr, "yetty_ygui_statusbar_from: class accessor", class_r);
    struct yetty_yclass_void_ptr_result slice_r =
        yetty_yclass_object_data(obj, class_r.value);
    if (YETTY_IS_ERR(slice_r))
        return YETTY_ERR(yetty_ygui_statusbar_ptr, "yetty_ygui_statusbar_from: object_data", slice_r);
...
struct yetty_yclass_object_ptr_result yetty_ygui_statusbar_to(struct yetty_ygui_statusbar *data)
{
    ...
    struct yetty_yclass_ptr_result class_r = yetty_ygui_statusbar_class_get();
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, class_r, "yetty_ygui_statusbar_to: class accessor");
