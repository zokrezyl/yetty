...
static yetty_ygui_constructor_fn
    yetty_ygui_ydiagram_yetty_ygui_constructor_ydiagram_constructor_check = ydiagram_constructor;
YETTY_MAYBE_UNUSED
static yetty_ygui_destructor_fn
    yetty_ygui_ydiagram_yetty_ygui_destructor_ydiagram_destructor_check = ydiagram_destructor;
...
struct yetty_yclass_object_ptr_result yetty_ygui_ydiagram_to(struct yetty_ygui_ydiagram *data)
{
    ...
    struct yetty_yclass_ptr_result class_r = yetty_ygui_ydiagram_class_get();
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, class_r, "yetty_ygui_ydiagram_to: class accessor");
    struct yetty_ycore_size_result offset_r =
        yetty_yclass_object_data_offset(class_r.value, class_r.value);
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, offset_r, "yetty_ygui_ydiagram_to: data offset");
...
struct yetty_yclass_object_ptr_result yetty_ygui_ydiagram_create(struct yetty_yclass_ctx *ctx)
{
    ...
    if (ctx && ctx->session) {
        return YETTY_ERR(
            ...
            "yetty_ygui_ydiagram_create: remote create unsupported for a split-mode class; "
    ...
    if (YETTY_IS_ERR(ctor_r)) {
        ...
        return YETTY_ERR(yetty_yclass_object_ptr, "yetty_ygui_ydiagram_create: constructor failed",
                         ctor_r);
    }
    return alloc_r;
}
...
/* ---- ygui_ydiagram: class name -> accessor (lazy) ---------------------- */

static struct yetty_yclass_ptr_result yetty_ygui_ydiagram_accessor_lookup(const char *name)
{
...
/* ---- ygui_ydiagram: explicit yclass-RPC hook registration ------------- */
...
struct yetty_ycore_void_result yetty_ygui_ydiagram_register(void)
{
    ...
    struct yetty_ycore_void_result add_accessor_r =
        yetty_yclass_add_accessor_lookup(yetty_ygui_ydiagram_accessor_lookup);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, add_accessor_r,
                        "yetty_ygui_ydiagram_register: add_accessor_lookup");
    registered = true;
    return YETTY_OK_VOID();
}
