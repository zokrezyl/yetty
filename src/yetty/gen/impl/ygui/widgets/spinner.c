...
static yetty_ygui_constructor_fn
    yetty_ygui_spinner_yetty_ygui_constructor_spinner_constructor_check = spinner_constructor;
YETTY_MAYBE_UNUSED
static yetty_ygui_widget_on_press_fn
    yetty_ygui_spinner_yetty_ygui_widget_on_press_spinner_on_press_check = spinner_on_press;
YETTY_MAYBE_UNUSED
static yetty_ygui_widget_paint_fn yetty_ygui_spinner_yetty_ygui_widget_paint_spinner_paint_check =
    spinner_paint;
...
struct yetty_yclass_ptr_result yetty_ygui_spinner_class_get(void)
{
    ...
    static const struct yetty_yclass_op ops[] = {
        {"yetty_ygui", "constructor", (yetty_yclass_method_id_t)yetty_ygui_constructor,
         (yetty_yclass_impl_t)spinner_constructor},
    ...
    if (YETTY_IS_ERR(parent_class_r)) {
        yerror("yetty_ygui_spinner_class_get: parent accessor failed: %s",
               parent_class_r.error.msg);
        return YETTY_ERR(yetty_yclass_ptr, "yetty_ygui_spinner_class_get: parent accessor failed",
                         parent_class_r);
    }
    struct yetty_yclass_ptr_result register_class_r = yetty_yclass_register(
        &desc, ops, sizeof(ops) / sizeof(ops[0]), parent_class_r.value, NULL, 0);
    if (YETTY_IS_ERR(register_class_r)) {
        yerror("yetty_ygui_spinner_class_get: class_register failed: %s",
               register_class_r.error.msg);
        return YETTY_ERR(yetty_yclass_ptr, "yetty_ygui_spinner_class_get: class_register failed",
                         register_class_r);
    }
...
struct yetty_ygui_spinner_ptr_result yetty_ygui_spinner_from(struct yetty_yclass_object *obj)
{
    ...
    if (YETTY_IS_ERR(class_r)) {
        return YETTY_ERR(yetty_ygui_spinner_ptr, "yetty_ygui_spinner_from: class accessor",
                         class_r);
    }
...
struct yetty_yclass_object_ptr_result yetty_ygui_spinner_create(struct yetty_yclass_ctx *ctx)
{
    ...
    if (YETTY_IS_ERR(ctor_r)) {
        ...
        return YETTY_ERR(yetty_yclass_object_ptr, "yetty_ygui_spinner_create: constructor failed",
                         ctor_r);
    }
    return alloc_r;
}
