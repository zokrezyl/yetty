...
YETTY_MAYBE_UNUSED
static yetty_ygui_constructor_fn yetty_ygui_ydraw_embed_yetty_ygui_constructor_ctor_check = ctor;
YETTY_MAYBE_UNUSED
static yetty_ygui_destructor_fn yetty_ygui_ydraw_embed_yetty_ygui_destructor_dtor_check = dtor;
YETTY_MAYBE_UNUSED
static yetty_ygui_widget_paint_fn yetty_ygui_ydraw_embed_yetty_ygui_widget_paint_paint_check =
    paint;
...
struct yetty_yclass_object_ptr_result yetty_ygui_ydraw_embed_to(struct yetty_ygui_ydraw_embed *data)
{
    ...
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, class_r,
                        "yetty_ygui_ydraw_embed_to: class accessor");
    struct yetty_ycore_size_result offset_r =
        yetty_yclass_object_data_offset(class_r.value, class_r.value);
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, offset_r,
                        "yetty_ygui_ydraw_embed_to: data offset");
