...
YETTY_MAYBE_UNUSED
static yetty_ygui_constructor_fn yetty_ygui_stepper_yetty_ygui_constructor_ctor_check = ctor;
YETTY_MAYBE_UNUSED
static yetty_ygui_destructor_fn yetty_ygui_stepper_yetty_ygui_destructor_dtor_check = dtor;
YETTY_MAYBE_UNUSED
static yetty_ygui_widget_paint_fn yetty_ygui_stepper_yetty_ygui_widget_paint_paint_check = paint;
...
struct yetty_yclass_ptr_result yetty_ygui_stepper_class_get(void)
{
    ...
    ydebug("registering class=yetty_ygui_stepper");

    static const struct yetty_yclass_descriptor desc = {
        .name = "yetty_ygui_stepper",
        .type = YETTY_YCLASS_TYPE_REGULAR,
        .data_size = sizeof(struct yetty_ygui_stepper),
        .data_align = _Alignof(struct yetty_ygui_stepper),
    };
    ...
    if (YETTY_IS_ERR(parent_class_r)) {
        yerror("yetty_ygui_stepper_class_get: parent accessor failed: %s",
               parent_class_r.error.msg);
        return YETTY_ERR(yetty_yclass_ptr, "yetty_ygui_stepper_class_get: parent accessor failed",
                         parent_class_r);
    }
    struct yetty_yclass_ptr_result register_class_r = yetty_yclass_register(
        &desc, ops, sizeof(ops) / sizeof(ops[0]), parent_class_r.value, NULL, 0);
    if (YETTY_IS_ERR(register_class_r)) {
        yerror("yetty_ygui_stepper_class_get: class_register failed: %s",
               register_class_r.error.msg);
        return YETTY_ERR(yetty_yclass_ptr, "yetty_ygui_stepper_class_get: class_register failed",
                         register_class_r);
    }
...
{
    struct yetty_yclass_ptr_result class_r = yetty_ygui_stepper_class_get();
    if (YETTY_IS_ERR(class_r)) {
        return YETTY_ERR(yetty_ygui_stepper_ptr, "yetty_ygui_stepper_from: class accessor",
                         class_r);
    }
    struct yetty_yclass_void_ptr_result slice_r = yetty_yclass_object_data(obj, class_r.value);
    if (YETTY_IS_ERR(slice_r)) {
        return YETTY_ERR(yetty_ygui_stepper_ptr, "yetty_ygui_stepper_from: object_data", slice_r);
    }
    return YETTY_OK(yetty_ygui_stepper_ptr, (struct yetty_ygui_stepper *)slice_r.value);
}
...
struct yetty_yclass_object_ptr_result yetty_ygui_stepper_to(struct yetty_ygui_stepper *data)
{
    ...
    struct yetty_yclass_ptr_result class_r = yetty_ygui_stepper_class_get();
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, class_r, "yetty_ygui_stepper_to: class accessor");
    struct yetty_ycore_size_result offset_r =
        yetty_yclass_object_data_offset(class_r.value, class_r.value);
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, offset_r, "yetty_ygui_stepper_to: data offset");
...
struct yetty_yclass_object_ptr_result yetty_ygui_stepper_create(struct yetty_yclass_ctx *ctx)
{
    ...
    if (ctx && ctx->session) {
        return YETTY_ERR(
            ...
            "yetty_ygui_stepper_create: remote create unsupported for a split-mode class; "
    ...
    if (YETTY_IS_ERR(ctor_r)) {
        ...
        return YETTY_ERR(yetty_yclass_object_ptr, "yetty_ygui_stepper_create: constructor failed",
                         ctor_r);
    }
    return alloc_r;
}
...
/* ---- ygui_stepper: class name -> accessor (lazy) ---------------------- */

static struct yetty_yclass_ptr_result yetty_ygui_stepper_accessor_lookup(const char *name)
{
...
/* ---- ygui_stepper: explicit yclass-RPC hook registration ------------- */
...
struct yetty_ycore_void_result yetty_ygui_stepper_register(void)
{
    ...
    struct yetty_ycore_void_result add_accessor_r =
        yetty_yclass_add_accessor_lookup(yetty_ygui_stepper_accessor_lookup);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, add_accessor_r,
                        "yetty_ygui_stepper_register: add_accessor_lookup");
    registered = true;
    return YETTY_OK_VOID();
}
