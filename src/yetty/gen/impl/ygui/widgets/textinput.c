...
YETTY_MAYBE_UNUSED
static yetty_ygui_widget_on_press_fn yetty_ygui_textinput_yetty_ygui_widget_on_press_check = textinput_on_press;
YETTY_MAYBE_UNUSED
static yetty_ygui_widget_on_motion_fn yetty_ygui_textinput_yetty_ygui_widget_on_motion_check = textinput_on_motion;
YETTY_MAYBE_UNUSED
static yetty_ygui_widget_on_release_fn yetty_ygui_textinput_yetty_ygui_widget_on_release_check = textinput_on_release;
YETTY_MAYBE_UNUSED
...
struct yetty_yclass_ptr_result yetty_ygui_textinput_class_get(void)
{
    ...
    static const struct yetty_yclass_descriptor desc = {
        ...
        .data_align = _Alignof(struct yetty_ygui_textinput),
    };
    static const struct yetty_yclass_op ops[] = {
        {"yetty_ygui", "widget_on_press", (yetty_yclass_method_id_t)yetty_ygui_widget_on_press, (yetty_yclass_impl_t)textinput_on_press},
        {"yetty_ygui", "widget_on_motion", (yetty_yclass_method_id_t)yetty_ygui_widget_on_motion, (yetty_yclass_impl_t)textinput_on_motion},
        {"yetty_ygui", "widget_on_release", (yetty_yclass_method_id_t)yetty_ygui_widget_on_release, (yetty_yclass_impl_t)textinput_on_release},
    ...
    if (YETTY_IS_ERR(parent_class_r)) {
        yerror("yetty_ygui_textinput_class_get: parent accessor failed: %s", parent_class_r.error.msg);
    ...
    if (YETTY_IS_ERR(register_class_r)) {
        yerror("yetty_ygui_textinput_class_get: class_register failed: %s", register_class_r.error.msg);
...
{
    struct yetty_yclass_ptr_result class_r = yetty_ygui_textinput_class_get();
    if (YETTY_IS_ERR(class_r))
        return YETTY_ERR(yetty_ygui_textinput_ptr, "yetty_ygui_textinput_from: class accessor", class_r);
    struct yetty_yclass_void_ptr_result slice_r =
        yetty_yclass_object_data(obj, class_r.value);
    if (YETTY_IS_ERR(slice_r))
        return YETTY_ERR(yetty_ygui_textinput_ptr, "yetty_ygui_textinput_from: object_data", slice_r);
    return YETTY_OK(yetty_ygui_textinput_ptr, (struct yetty_ygui_textinput *)slice_r.value);
}
...
struct yetty_yclass_object_ptr_result yetty_ygui_textinput_to(struct yetty_ygui_textinput *data)
{
    ...
    struct yetty_yclass_ptr_result class_r = yetty_ygui_textinput_class_get();
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, class_r, "yetty_ygui_textinput_to: class accessor");
    struct yetty_ycore_size_result offset_r =
        yetty_yclass_object_data_offset(class_r.value, class_r.value);
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, offset_r, "yetty_ygui_textinput_to: data offset");
...
struct yetty_yclass_object_ptr_result yetty_ygui_textinput_create(struct yetty_yclass_ctx *ctx)
{
    ...
    if (ctx && ctx->session)
        return YETTY_ERR(yetty_yclass_object_ptr,
                         "yetty_ygui_textinput_create: remote create unsupported for a split-mode class; "
...
/* ---- ygui_textinput: class name -> accessor (lazy) ---------------------- */

static struct yetty_yclass_ptr_result yetty_ygui_textinput_accessor_lookup(const char *name)
{
...
/* ---- ygui_textinput: explicit yclass-RPC hook registration ------------- */
...
struct yetty_ycore_void_result yetty_ygui_textinput_register(void)
{
    ...
    struct yetty_ycore_void_result add_accessor_r =
        yetty_yclass_add_accessor_lookup(yetty_ygui_textinput_accessor_lookup);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, add_accessor_r,
                        "yetty_ygui_textinput_register: add_accessor_lookup");
    registered = true;
    return YETTY_OK_VOID();
}
