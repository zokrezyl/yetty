...
YETTY_MAYBE_UNUSED
static yetty_ygui_constructor_fn yetty_ygui_window_yetty_ygui_constructor_ctor_check = ctor;
YETTY_MAYBE_UNUSED
static yetty_ygui_destructor_fn yetty_ygui_window_yetty_ygui_destructor_dtor_check = dtor;
YETTY_MAYBE_UNUSED
static yetty_ygui_widget_paint_fn yetty_ygui_window_yetty_ygui_widget_paint_paint_check = paint;
YETTY_MAYBE_UNUSED
static yetty_ygui_widget_on_press_fn yetty_ygui_window_yetty_ygui_widget_on_press_on_press_check =
    on_press;
YETTY_MAYBE_UNUSED
static yetty_ygui_widget_on_motion_fn
    yetty_ygui_window_yetty_ygui_widget_on_motion_on_motion_check = on_motion;
YETTY_MAYBE_UNUSED
static yetty_ygui_widget_on_release_fn
    yetty_ygui_window_yetty_ygui_widget_on_release_on_release_check = on_release;
...
struct yetty_yclass_object_ptr_result yetty_ygui_window_to(struct yetty_ygui_window *data)
{
    ...
    struct yetty_yclass_ptr_result class_r = yetty_ygui_window_class_get();
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, class_r, "yetty_ygui_window_to: class accessor");
    struct yetty_ycore_size_result offset_r =
        yetty_yclass_object_data_offset(class_r.value, class_r.value);
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, offset_r, "yetty_ygui_window_to: data offset");
...
struct yetty_yclass_object_ptr_result yetty_ygui_window_create(struct yetty_yclass_ctx *ctx)
{
    ...
    if (ctx && ctx->session) {
        return YETTY_ERR(
            ...
            "yetty_ygui_window_create: remote create unsupported for a split-mode class; "
    ...
    if (YETTY_IS_ERR(ctor_r)) {
        ...
        return YETTY_ERR(yetty_yclass_object_ptr, "yetty_ygui_window_create: constructor failed",
                         ctor_r);
    }
    return alloc_r;
}
...
/* ---- ygui_window: class name -> accessor (lazy) ---------------------- */

static struct yetty_yclass_ptr_result yetty_ygui_window_accessor_lookup(const char *name)
{
...
/* ---- ygui_window: explicit yclass-RPC hook registration ------------- */
...
struct yetty_ycore_void_result yetty_ygui_window_register(void)
{
    ...
    struct yetty_ycore_void_result add_accessor_r =
        yetty_yclass_add_accessor_lookup(yetty_ygui_window_accessor_lookup);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, add_accessor_r,
                        "yetty_ygui_window_register: add_accessor_lookup");
    registered = true;
    return YETTY_OK_VOID();
}
