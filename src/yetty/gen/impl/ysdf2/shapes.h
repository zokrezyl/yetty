...
/* Public interface for regular class(es) `circle, box, segment, triangle, ellipse, arc, rounded_box, rhombus, pentagon, hexagon, star, pie, ring, heart, cross, rounded_x, capsule, moon, egg, octogon, hexagram, pentagram, linear_gradient_box, radial_gradient_box, sphere_3d, box_3d, torus_3d, cylinder_3d` (module: ysdf2).
 * Fully generated from the source .c — do not edit. This single
 * header is the source's complete public interface: class
 * accessors, method stubs, create()/register(), exposed
 * functions, and the public types the signatures use. */
#ifndef YETTY_YCLASSGEN_YSDF2_SHAPES_H
#define YETTY_YCLASSGEN_YSDF2_SHAPES_H
