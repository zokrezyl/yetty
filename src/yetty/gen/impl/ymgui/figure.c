...
struct yetty_yclass_ptr_result yetty_ymgui_figure_class_get(void)
{
    ...
    if (YETTY_IS_ERR(parent_class_r)) {
        yerror("yetty_ymgui_figure_class_get: parent accessor failed: %s", parent_class_r.error.msg);
    ...
    if (YETTY_IS_ERR(register_class_r)) {
        yerror("yetty_ymgui_figure_class_get: class_register failed: %s", register_class_r.error.msg);
...
struct yetty_ymgui_figure_ptr_result yetty_ymgui_figure_from(struct yetty_yclass_object *obj)
{
    ...
    if (YETTY_IS_ERR(class_r))
        return YETTY_ERR(yetty_ymgui_figure_ptr, "yetty_ymgui_figure_from: class accessor", class_r);
