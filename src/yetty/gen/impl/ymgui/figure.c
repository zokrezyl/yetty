...
struct yetty_yclass_object_ptr_result yetty_ymgui_figure_to(struct yetty_ymgui_figure *data)
{
    ...
    struct yetty_yclass_ptr_result class_r = yetty_ymgui_figure_class_get();
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, class_r, "yetty_ymgui_figure_to: class accessor");
    struct yetty_ycore_size_result offset_r =
        yetty_yclass_object_data_offset(class_r.value, class_r.value);
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, offset_r, "yetty_ymgui_figure_to: data offset");
...
struct yetty_yclass_object_ptr_result yetty_ymgui_figure_create(struct yetty_yclass_ctx *ctx)
{
    ...
    if (ctx && ctx->session) {
        return YETTY_ERR(
            ...
            "yetty_ymgui_figure_create: remote create unsupported for a split-mode class; "
...
/* ---- ymgui: explicit yclass-RPC hook registration ------------- */
...
struct yetty_ycore_void_result yetty_ymgui_register(void)
{
    ...
    YETTY_RETURN_IF_ERR(yetty_ycore_void, add_accessor_r,
                        "yetty_ymgui_register: add_accessor_lookup");
    registered = true;
    return YETTY_OK_VOID();
}
