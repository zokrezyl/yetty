...
struct yetty_yclass_object_ptr_result yetty_yrich_element_to(struct yetty_yrich_element *data)
{
    ...
    struct yetty_yclass_ptr_result class_r = yetty_yrich_element_class_get();
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, class_r, "yetty_yrich_element_to: class accessor");
    struct yetty_ycore_size_result offset_r =
        yetty_yclass_object_data_offset(class_r.value, class_r.value);
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, offset_r, "yetty_yrich_element_to: data offset");
...
struct yetty_yclass_object_ptr_result yetty_yrich_element_create(struct yetty_yclass_ctx *ctx)
{
    ...
    if (ctx && ctx->session)
        return YETTY_ERR(yetty_yclass_object_ptr,
                         "yetty_yrich_element_create: remote create unsupported for a split-mode class; "
...
size_t yetty_yrich_element_insert_text_skel(const void *, size_t, void *, size_t);
size_t yetty_yrich_element_delete_sel_skel(const void *, size_t, void *, size_t);
struct yetty_ycore_void_result yetty_yrich_element_register(void);

/* ---- yrich_element: class name -> accessor (lazy) ---------------------- */

static struct yetty_yclass_ptr_result yetty_yrich_element_accessor_lookup(const char *name)
{
...
/* ---- yrich_element: slot -> skel, name-keyed static data --------------- */

struct yetty_yrich_element_skel_row { const char *name; yetty_yclass_rpc_skel_fn fn; };

static const struct yetty_yrich_element_skel_row yetty_yrich_element_skel_rows[] = {
...
YETTY_EXTERNAL_CALLBACK
static yetty_yclass_rpc_skel_fn yetty_yrich_element_skel_lookup(yetty_yclass_method_slot slot)
{
    ...
    for (size_t i = 0;
         i < sizeof(yetty_yrich_element_skel_rows) / sizeof(yetty_yrich_element_skel_rows[0]); ++i)
        if (strcmp(yetty_yrich_element_skel_rows[i].name, name) == 0)
            return yetty_yrich_element_skel_rows[i].fn;
    return NULL;
}

/* ---- yrich_element: explicit yclass-RPC hook registration ------------- */
...
struct yetty_ycore_void_result yetty_yrich_element_register(void)
{
    ...
    struct yetty_ycore_void_result add_accessor_r =
        yetty_yclass_add_accessor_lookup(yetty_yrich_element_accessor_lookup);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, add_accessor_r,
                        "yetty_yrich_element_register: add_accessor_lookup");
    {
        struct yetty_ycore_void_result add_skel_r =
            yetty_yclass_rpc_add_skel_lookup(yetty_yrich_element_skel_lookup);
        YETTY_RETURN_IF_ERR(yetty_ycore_void, add_skel_r,
                            "yetty_yrich_element_register: rpc_add_skel_lookup");
    }
    registered = true;
    return YETTY_OK_VOID();
}
