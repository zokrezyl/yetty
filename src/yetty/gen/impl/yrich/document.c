...
struct yetty_yclass_object_ptr_result yetty_yrich_document_to(struct yetty_yrich_document *data)
{
    ...
    struct yetty_yclass_ptr_result class_r = yetty_yrich_document_class_get();
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, class_r, "yetty_yrich_document_to: class accessor");
...
struct yetty_yrich_document_skel_row { const char *name; yetty_yclass_rpc_skel_fn fn; };
...
static yetty_yclass_rpc_skel_fn yetty_yrich_document_skel_lookup(yetty_yclass_method_slot slot)
{
    ...
    for (size_t i = 0;
         i < sizeof(yetty_yrich_document_skel_rows) / sizeof(yetty_yrich_document_skel_rows[0]); ++i)
