...
YETTY_MAYBE_UNUSED
static yetty_ycircuit_configure_fn yetty_ycircuit_circuit_yetty_ycircuit_configure_check = circuit_configure;
YETTY_MAYBE_UNUSED
...
YETTY_MAYBE_UNUSED
static yetty_ycircuit_add_component_fn yetty_ycircuit_circuit_yetty_ycircuit_add_component_check = circuit_add_component;
YETTY_MAYBE_UNUSED
static yetty_ycircuit_add_ic_fn yetty_ycircuit_circuit_yetty_ycircuit_add_ic_check = circuit_add_ic;
YETTY_MAYBE_UNUSED
static yetty_ycircuit_add_wire_fn yetty_ycircuit_circuit_yetty_ycircuit_add_wire_check = circuit_add_wire;
YETTY_MAYBE_UNUSED
static yetty_ycircuit_add_junction_fn yetty_ycircuit_circuit_yetty_ycircuit_add_junction_check = circuit_add_junction;
YETTY_MAYBE_UNUSED
static yetty_ycircuit_add_label_fn yetty_ycircuit_circuit_yetty_ycircuit_add_label_check = circuit_add_label;
YETTY_MAYBE_UNUSED
static yetty_ycircuit_render_fn yetty_ycircuit_circuit_yetty_ycircuit_render_check = circuit_render;
YETTY_MAYBE_UNUSED
static yetty_ycircuit_hit_test_fn yetty_ycircuit_circuit_yetty_ycircuit_hit_test_check = circuit_hit_test;
YETTY_MAYBE_UNUSED
static yetty_ycircuit_set_highlight_fn yetty_ycircuit_circuit_yetty_ycircuit_set_highlight_check = circuit_set_highlight;
YETTY_MAYBE_UNUSED
static yetty_ycircuit_destroy_fn yetty_ycircuit_circuit_yetty_ycircuit_destroy_check = circuit_obj_destroy;
...
struct yetty_yclass_ptr_result yetty_ycircuit_circuit_class_get(void)
{
    ...
    static const struct yetty_yclass_op ops[] = {
        {"yetty_ycircuit", "configure", (yetty_yclass_method_id_t)yetty_ycircuit_configure, (yetty_yclass_impl_t)circuit_configure},
        {"yetty_ycircuit", "parse", (yetty_yclass_method_id_t)yetty_ycircuit_parse, (yetty_yclass_impl_t)circuit_parse},
        {"yetty_ycircuit", "clear", (yetty_yclass_method_id_t)yetty_ycircuit_clear, (yetty_yclass_impl_t)circuit_clear},
        {"yetty_ycircuit", "add_component", (yetty_yclass_method_id_t)yetty_ycircuit_add_component, (yetty_yclass_impl_t)circuit_add_component},
        {"yetty_ycircuit", "add_ic", (yetty_yclass_method_id_t)yetty_ycircuit_add_ic, (yetty_yclass_impl_t)circuit_add_ic},
        {"yetty_ycircuit", "add_wire", (yetty_yclass_method_id_t)yetty_ycircuit_add_wire, (yetty_yclass_impl_t)circuit_add_wire},
        {"yetty_ycircuit", "add_junction", (yetty_yclass_method_id_t)yetty_ycircuit_add_junction, (yetty_yclass_impl_t)circuit_add_junction},
        {"yetty_ycircuit", "add_label", (yetty_yclass_method_id_t)yetty_ycircuit_add_label, (yetty_yclass_impl_t)circuit_add_label},
        {"yetty_ycircuit", "render", (yetty_yclass_method_id_t)yetty_ycircuit_render, (yetty_yclass_impl_t)circuit_render},
        {"yetty_ycircuit", "hit_test", (yetty_yclass_method_id_t)yetty_ycircuit_hit_test, (yetty_yclass_impl_t)circuit_hit_test},
        {"yetty_ycircuit", "set_highlight", (yetty_yclass_method_id_t)yetty_ycircuit_set_highlight, (yetty_yclass_impl_t)circuit_set_highlight},
        {"yetty_ycircuit", "destroy", (yetty_yclass_method_id_t)yetty_ycircuit_destroy, (yetty_yclass_impl_t)circuit_obj_destroy},
    };
    struct yetty_yclass_ptr_result register_class_r =
        yetty_yclass_register(&desc, ops, sizeof(ops) / sizeof(ops[0]),
                              NULL, NULL, 0);
    if (YETTY_IS_ERR(register_class_r)) {
        yerror("yetty_ycircuit_circuit_class_get: class_register failed: %s", register_class_r.error.msg);
        return YETTY_ERR(yetty_yclass_ptr, "yetty_ycircuit_circuit_class_get: class_register failed", register_class_r);
    }
    cls = register_class_r.value;
    return register_class_r;
}

struct yetty_ycircuit_circuit_ptr_result yetty_ycircuit_circuit_from(struct yetty_yclass_object *obj)
{
    struct yetty_yclass_ptr_result class_r = yetty_ycircuit_circuit_class_get();
    if (YETTY_IS_ERR(class_r))
        return YETTY_ERR(yetty_ycircuit_circuit_ptr, "yetty_ycircuit_circuit_from: class accessor", class_r);
    struct yetty_yclass_void_ptr_result slice_r =
        yetty_yclass_object_data(obj, class_r.value);
    if (YETTY_IS_ERR(slice_r))
        return YETTY_ERR(yetty_ycircuit_circuit_ptr, "yetty_ycircuit_circuit_from: object_data", slice_r);
...
struct yetty_yclass_object_ptr_result yetty_ycircuit_circuit_to(struct yetty_ycircuit_circuit *data)
{
    ...
    struct yetty_yclass_ptr_result class_r = yetty_ycircuit_circuit_class_get();
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, class_r, "yetty_ycircuit_circuit_to: class accessor");
    struct yetty_ycore_size_result offset_r =
        yetty_yclass_object_data_offset(class_r.value, class_r.value);
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, offset_r, "yetty_ycircuit_circuit_to: data offset");
