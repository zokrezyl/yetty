...
struct yetty_yclass_object_ptr_result yetty_yplatform_window_to(struct yetty_yplatform_window *data)
{
    ...
    struct yetty_yclass_ptr_result class_r = yetty_yplatform_window_class_get();
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, class_r, "yetty_yplatform_window_to: class accessor");
    struct yetty_ycore_size_result offset_r =
        yetty_yclass_object_data_offset(class_r.value, class_r.value);
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, offset_r, "yetty_yplatform_window_to: data offset");
