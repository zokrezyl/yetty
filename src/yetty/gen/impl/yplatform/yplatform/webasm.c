...
struct yetty_yclass_object_ptr_result yetty_yplatform_webasm_platform_to(struct yetty_yplatform_webasm_platform *data)
{
    ...
    struct yetty_yclass_ptr_result class_r = yetty_yplatform_webasm_platform_class_get();
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, class_r, "yetty_yplatform_webasm_platform_to: class accessor");
    struct yetty_ycore_size_result offset_r =
        yetty_yclass_object_data_offset(class_r.value, class_r.value);
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, offset_r, "yetty_yplatform_webasm_platform_to: data offset");
...
struct yetty_yclass_object_ptr_result yetty_yplatform_webasm_platform_create(struct yetty_yclass_ctx *ctx)
{
    ...
    if (ctx && ctx->session)
        return YETTY_ERR(yetty_yclass_object_ptr,
                         "yetty_yplatform_webasm_platform_create: remote create unsupported for a split-mode class; "
