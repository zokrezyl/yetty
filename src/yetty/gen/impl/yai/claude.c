...
YETTY_MAYBE_UNUSED
static yetty_yai_resolve_permission_fn
    yetty_yai_claude_yetty_yai_resolve_permission_claude_resolve_permission_check =
        claude_resolve_permission;
YETTY_MAYBE_UNUSED
static yetty_yai_handle_event_fn yetty_yai_claude_yetty_yai_handle_event_claude_handle_event_check =
    claude_handle_event;
YETTY_MAYBE_UNUSED
static yetty_yai_send_user_message_fn
    yetty_yai_claude_yetty_yai_send_user_message_claude_send_user_message_check =
        claude_send_user_message;
YETTY_MAYBE_UNUSED
static yetty_yai_interrupt_fn yetty_yai_claude_yetty_yai_interrupt_claude_interrupt_check =
    claude_interrupt;
YETTY_MAYBE_UNUSED
static yetty_yai_start_fn yetty_yai_claude_yetty_yai_start_claude_start_check = claude_start;
YETTY_MAYBE_UNUSED
static yetty_yai_describe_config_fn
    yetty_yai_claude_yetty_yai_describe_config_claude_describe_config_check =
        claude_describe_config;
YETTY_MAYBE_UNUSED
static yetty_yai_config_knob_fn yetty_yai_claude_yetty_yai_config_knob_claude_config_knob_check =
    claude_config_knob;
YETTY_MAYBE_UNUSED
static yetty_yai_apply_config_fn yetty_yai_claude_yetty_yai_apply_config_claude_apply_config_check =
    claude_apply_config;
YETTY_MAYBE_UNUSED
static yetty_yai_on_child_exit_fn
    yetty_yai_claude_yetty_yai_on_child_exit_claude_on_child_exit_check = claude_on_child_exit;
YETTY_MAYBE_UNUSED
static yetty_yai_on_child_eof_fn yetty_yai_claude_yetty_yai_on_child_eof_claude_on_child_eof_check =
    claude_on_child_eof;
...
struct yetty_yclass_ptr_result yetty_yai_claude_class_get(void)
{
    ...
    if (YETTY_IS_ERR(parent_class_r)) {
        ...
        return YETTY_ERR(yetty_yclass_ptr, "yetty_yai_claude_class_get: parent accessor failed",
                         parent_class_r);
    }
    ...
    if (YETTY_IS_ERR(register_class_r)) {
        ...
        return YETTY_ERR(yetty_yclass_ptr, "yetty_yai_claude_class_get: class_register failed",
                         register_class_r);
    }
...
struct yetty_yclass_object_ptr_result yetty_yai_claude_create(struct yetty_yclass_ctx *ctx)
{
    ...
    if (YETTY_IS_ERR(class_accessor_r)) {
        return YETTY_ERR(yetty_yclass_object_ptr, "yetty_yai_claude_create: class accessor failed",
                         class_accessor_r);
    }
...
struct yetty_ycore_void_result yetty_yai_register(void)
{
...

    {
        ...
        YETTY_RETURN_IF_ERR(yetty_ycore_void, sub_r, "yetty_yai_register: submodule yai_claude");
    }
    {
        /* Submodule aggregator is always compiled into the same
         * library, so this strong call is always resolved. */
        struct yetty_ycore_void_result sub_r = yetty_yai_codex_register();
        YETTY_RETURN_IF_ERR(yetty_ycore_void, sub_r, "yetty_yai_register: submodule yai_codex");
    }
    {
        /* Submodule aggregator is always compiled into the same
         * library, so this strong call is always resolved. */
        struct yetty_ycore_void_result sub_r = yetty_yai_editor_register();
        YETTY_RETURN_IF_ERR(yetty_ycore_void, sub_r, "yetty_yai_register: submodule yai_editor");
    }
    {
        /* Submodule aggregator is always compiled into the same
         * library, so this strong call is always resolved. */
    ...
    }
    {
        ...
        YETTY_RETURN_IF_ERR(yetty_ycore_void, sub_r, "yetty_yai_register: submodule yai_editor_vi");
    }
    {
        /* Submodule aggregator is always compiled into the same
         * library, so this strong call is always resolved. */
        struct yetty_ycore_void_result sub_r = yetty_yai_engine_register();
        YETTY_RETURN_IF_ERR(yetty_ycore_void, sub_r, "yetty_yai_register: submodule yai_engine");
    }
    {
        /* Submodule aggregator is always compiled into the same
         * library, so this strong call is always resolved. */
        struct yetty_ycore_void_result sub_r = yetty_yai_gemini_register();
        YETTY_RETURN_IF_ERR(yetty_ycore_void, sub_r, "yetty_yai_register: submodule yai_gemini");
    }
    {
        /* Submodule aggregator is always compiled into the same
         * library, so this strong call is always resolved. */
