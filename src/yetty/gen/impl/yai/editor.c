...
YETTY_MAYBE_UNUSED
static yetty_yai_feed_byte_fn yetty_yai_editor_yetty_yai_feed_byte_editor_feed_byte_check =
    editor_feed_byte;
...
struct yetty_yclass_ptr_result yetty_yai_editor_class_get(void)
{
    ...
    static const struct yetty_yclass_op ops[] = {
        {"yetty_yai", "feed_byte", (yetty_yclass_method_id_t)yetty_yai_feed_byte,
         (yetty_yclass_impl_t)editor_feed_byte},
    };
    ...
    if (YETTY_IS_ERR(register_class_r)) {
        ...
        return YETTY_ERR(yetty_yclass_ptr, "yetty_yai_editor_class_get: class_register failed",
                         register_class_r);
    }
...
struct yetty_yclass_object_ptr_result yetty_yai_editor_create(struct yetty_yclass_ctx *ctx)
{
    ...
    if (ctx && ctx->session) {
        return YETTY_ERR(
            ...
            "yetty_yai_editor_create: remote create unsupported for a split-mode class; "
    ...
    if (YETTY_IS_ERR(class_accessor_r)) {
        return YETTY_ERR(yetty_yclass_object_ptr, "yetty_yai_editor_create: class accessor failed",
                         class_accessor_r);
    }
...
/* ---- yai_editor: class name -> accessor (lazy) ---------------------- */

static struct yetty_yclass_ptr_result yetty_yai_editor_accessor_lookup(const char *name)
{
...
/* ---- yai_editor: explicit yclass-RPC hook registration ------------- */
...
struct yetty_ycore_void_result yetty_yai_editor_register(void)
{
    ...
    struct yetty_ycore_void_result add_accessor_r =
        yetty_yclass_add_accessor_lookup(yetty_yai_editor_accessor_lookup);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, add_accessor_r,
                        "yetty_yai_editor_register: add_accessor_lookup");
    registered = true;
    return YETTY_OK_VOID();
}
