...
struct yetty_yclass_ptr_result yetty_yai_gemini_class_get(void)
{
    ...
    if (YETTY_IS_ERR(parent_class_r)) {
        ...
        return YETTY_ERR(yetty_yclass_ptr, "yetty_yai_gemini_class_get: parent accessor failed",
                         parent_class_r);
    }
    ...
    if (YETTY_IS_ERR(register_class_r)) {
        ...
        return YETTY_ERR(yetty_yclass_ptr, "yetty_yai_gemini_class_get: class_register failed",
                         register_class_r);
    }
...
struct yetty_yclass_object_ptr_result yetty_yai_gemini_to(struct yetty_yai_gemini *data)
{
    ...
    struct yetty_yclass_ptr_result class_r = yetty_yai_gemini_class_get();
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, class_r, "yetty_yai_gemini_to: class accessor");
    struct yetty_ycore_size_result offset_r =
        yetty_yclass_object_data_offset(class_r.value, class_r.value);
    YETTY_RETURN_IF_ERR(yetty_yclass_object_ptr, offset_r, "yetty_yai_gemini_to: data offset");
...
struct yetty_yclass_object_ptr_result yetty_yai_gemini_create(struct yetty_yclass_ctx *ctx)
{
    ...
    if (ctx && ctx->session) {
        return YETTY_ERR(
            ...
            "yetty_yai_gemini_create: remote create unsupported for a split-mode class; "
    ...
    if (YETTY_IS_ERR(class_accessor_r)) {
        return YETTY_ERR(yetty_yclass_object_ptr, "yetty_yai_gemini_create: class accessor failed",
                         class_accessor_r);
    }
...
/* ---- yai_gemini: class name -> accessor (lazy) ---------------------- */

static struct yetty_yclass_ptr_result yetty_yai_gemini_accessor_lookup(const char *name)
{
...
/* ---- yai_gemini: explicit yclass-RPC hook registration ------------- */
...
struct yetty_ycore_void_result yetty_yai_gemini_register(void)
{
    ...
    struct yetty_ycore_void_result add_accessor_r =
        yetty_yclass_add_accessor_lookup(yetty_yai_gemini_accessor_lookup);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, add_accessor_r,
                        "yetty_yai_gemini_register: add_accessor_lookup");
    registered = true;
    return YETTY_OK_VOID();
}
