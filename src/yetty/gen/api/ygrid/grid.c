...
struct yetty_ycore_void_result yetty_ygrid_add_record(struct yetty_yclass_object * obj, struct yetty_ycore_buffer record)
{
    ...
    if (obj->session) {
        struct uint32_result remote_id_r =
            yetty_yclass_rpc_session_ensure_remote_id_by_name(obj->session, "yetty_ygrid_add_record");
        YETTY_RETURN_IF_ERR(yetty_ycore_void, remote_id_r, "yetty_ygrid_add_record: ensure_remote_id_by_name failed");
...
#pragma pack(pop)
        ...
        if (method_slot == YETTY_YCLASS_METHOD_SLOT_UNDEFINED) {
            struct yetty_yclass_method_slot_result method_slot_r =
                yetty_yclass_method_slot_get("yetty_ygrid",
                                             (yetty_yclass_method_id_t)yetty_ygrid_add_record);
...
struct yetty_ycore_void_result yetty_ygrid_clear(struct yetty_yclass_object * obj)
{
    ...
    if (obj->session) {
        ...
        YETTY_RETURN_IF_ERR(yetty_ycore_void, remote_id_r, "yetty_ygrid_clear: ensure_remote_id_by_name failed");
        uint32_t remote_id = remote_id_r.value;
/* Byte-exact wire layout — #pragma pack matches the first-party
 * convention (yvnc/ydvnc/libvterm) and compiles on MSVC, unlike a GNU
 * packed attribute. */
...
#pragma pack(pop)
        ...
        if (method_slot == YETTY_YCLASS_METHOD_SLOT_UNDEFINED) {
            struct yetty_yclass_method_slot_result method_slot_r =
                yetty_yclass_method_slot_get("yetty_ygrid",
                                             (yetty_yclass_method_id_t)yetty_ygrid_clear);
            if (YETTY_IS_ERR(method_slot_r))
...
struct yetty_ycore_void_result yetty_ygrid_destroy(struct yetty_yclass_object * obj)
{
    ...
    if (obj->session) {
        ...
        YETTY_RETURN_IF_ERR(yetty_ycore_void, remote_id_r, "yetty_ygrid_destroy: ensure_remote_id_by_name failed");
        uint32_t remote_id = remote_id_r.value;
/* Byte-exact wire layout — #pragma pack matches the first-party
 * convention (yvnc/ydvnc/libvterm) and compiles on MSVC, unlike a GNU
 * packed attribute. */
...
#pragma pack(pop)
        ...
        if (method_slot == YETTY_YCLASS_METHOD_SLOT_UNDEFINED) {
            struct yetty_yclass_method_slot_result method_slot_r =
                yetty_yclass_method_slot_get("yetty_ygrid",
                                             (yetty_yclass_method_id_t)yetty_ygrid_destroy);
            if (YETTY_IS_ERR(method_slot_r))
