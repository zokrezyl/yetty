...
struct yetty_ycore_void_result yetty_ymap_overlay_geojson(struct yetty_yclass_object * obj, const char * geojson_text);
...
typedef struct yetty_ycore_void_result (*yetty_ymap_overlay_geojson_fn)(struct yetty_yclass_object *, const char *);
...
struct yetty_ycore_void_result yetty_ymap_overlay_geojson(struct yetty_yclass_object * obj, const char * geojson_text)
{
    ...
    if (method_slot == YETTY_YCLASS_METHOD_SLOT_UNDEFINED) {
        struct yetty_yclass_method_slot_result method_slot_r =
            yetty_yclass_method_slot_get("yetty_ymap", (yetty_yclass_method_id_t)yetty_ymap_overlay_geojson);
        if (YETTY_IS_ERR(method_slot_r))
            return YETTY_ERR(yetty_ycore_void, "yetty_ymap_overlay_geojson: method_slot_get failed", method_slot_r);
        method_slot = method_slot_r.value;
    }

    if (!obj) return YETTY_ERR(yetty_ycore_void, "yetty_ymap_overlay_geojson: NULL object");

    struct yetty_yclass_ptr_result object_class_r =
        yetty_yclass_object_class(obj);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, object_class_r, "yetty_ymap_overlay_geojson: object_class failed");
    struct yetty_yclass_impl_t_result dispatch_impl_r =
        yetty_yclass_dispatch_lookup(object_class_r.value, method_slot);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, dispatch_impl_r, "yetty_ymap_overlay_geojson: dispatch_lookup failed");
