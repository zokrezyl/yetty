...
#include <yetty/api/ycomplex2/video.h>
                                                        ...
                                                        const char *path)
{
    ...
    if (method_slot == YETTY_YCLASS_METHOD_SLOT_UNDEFINED) {
        struct yetty_yclass_method_slot_result method_slot_r = yetty_yclass_method_slot_get(
            "yetty_ycomplex2", (yetty_yclass_method_id_t)yetty_ycomplex2_set_h264);
        if (YETTY_IS_ERR(method_slot_r)) {
            return YETTY_ERR(yetty_ycore_void, "yetty_ycomplex2_set_h264: method_slot_get failed",
                             method_slot_r);
        }
    ...
    if (!obj) {
        return YETTY_ERR(yetty_ycore_void, "yetty_ycomplex2_set_h264: NULL object");
    }
    ...
    YETTY_RETURN_IF_ERR(yetty_ycore_void, object_class_r,
                        "yetty_ycomplex2_set_h264: object_class failed");
    struct yetty_yclass_impl_t_result dispatch_impl_r =
        yetty_yclass_dispatch_lookup(object_class_r.value, method_slot);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, dispatch_impl_r,
                        "yetty_ycomplex2_set_h264: dispatch_lookup failed");
    return ((yetty_ycomplex2_set_h264_fn)dispatch_impl_r.value)(obj, path);
}
