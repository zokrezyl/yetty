 ...
 */
typedef parserutils_error (*parserutils_charset_detect_func)(const uint8_t *data, size_t len,
...
parserutils_error parserutils_inputstream_create(const char *enc, uint32_t encsrc,
...
parserutils_error parserutils_inputstream_peek_slow(parserutils_inputstream *stream, size_t offset,
 ...
 */
static inline parserutils_error parserutils_inputstream_peek(parserutils_inputstream *stream,
                                                             size_t offset, const uint8_t **ptr,
                                                             size_t *length)
{
