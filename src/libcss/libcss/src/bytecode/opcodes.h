...
enum op_align_items {
    ...
    ALIGN_ITEMS_START = 0x0005,
    ALIGN_ITEMS_END = 0x0006,
    ALIGN_ITEMS_LEFT = 0x0007,
    ALIGN_ITEMS_RIGHT = 0x0008
};
...
enum op_align_self {
    ...
    ALIGN_SELF_START = 0x0006,
    ALIGN_SELF_END = 0x0007,
    ALIGN_SELF_LEFT = 0x0008,
    ALIGN_SELF_RIGHT = 0x0009
};
...
enum op_bottom { BOTTOM_SET = 0x0080, BOTTOM_AUTO = 0x0000 };
...
enum op_column_count { COLUMN_COUNT_AUTO = 0x0000, COLUMN_COUNT_SET = 0x0080 };

enum op_column_fill { COLUMN_FILL_BALANCE = 0x0000, COLUMN_FILL_AUTO = 0x0001 };

enum op_column_gap { COLUMN_GAP_NORMAL = 0x0000, COLUMN_GAP_SET = 0x0080 };
...
enum op_column_width { COLUMN_WIDTH_AUTO = 0x0000, COLUMN_WIDTH_SET = 0x0080 };
...
enum op_flex_grow { FLEX_GROW_SET = 0x0080 };

enum op_flex_shrink { FLEX_SHRINK_SET = 0x0080 };
...
enum op_height { HEIGHT_SET = 0x0080, HEIGHT_AUTO = 0x0000 };
...
enum op_justify_content {
    ...
    JUSTIFY_CONTENT_START = 0x0006,
    JUSTIFY_CONTENT_END = 0x0007,
    JUSTIFY_CONTENT_LEFT = 0x0008,
    JUSTIFY_CONTENT_RIGHT = 0x0009
};

enum op_justify_self {
    JUSTIFY_SELF_STRETCH = 0x0000,
    JUSTIFY_SELF_FLEX_START = 0x0001,
    JUSTIFY_SELF_FLEX_END = 0x0002,
    JUSTIFY_SELF_CENTER = 0x0003,
    JUSTIFY_SELF_BASELINE = 0x0004,
    JUSTIFY_SELF_AUTO = 0x0005,
    JUSTIFY_SELF_START = 0x0006,
    JUSTIFY_SELF_END = 0x0007,
    JUSTIFY_SELF_LEFT = 0x0008,
    JUSTIFY_SELF_RIGHT = 0x0009
};

enum op_justify_items {
    JUSTIFY_ITEMS_STRETCH = 0x0000,
    JUSTIFY_ITEMS_FLEX_START = 0x0001,
    JUSTIFY_ITEMS_FLEX_END = 0x0002,
    JUSTIFY_ITEMS_CENTER = 0x0003,
    JUSTIFY_ITEMS_BASELINE = 0x0004,
    JUSTIFY_ITEMS_START = 0x0005,
    JUSTIFY_ITEMS_END = 0x0006,
    JUSTIFY_ITEMS_LEFT = 0x0007,
    JUSTIFY_ITEMS_RIGHT = 0x0008
};

enum op_left { LEFT_SET = BOTTOM_SET, LEFT_AUTO = BOTTOM_AUTO };

enum op_letter_spacing { LETTER_SPACING_SET = 0x0080, LETTER_SPACING_NORMAL = 0x0000 };
...
enum op_margin { MARGIN_SET = 0x0080, MARGIN_AUTO = 0x0000 };

enum op_max_height { MAX_HEIGHT_SET = 0x0080, MAX_HEIGHT_NONE = 0x0000 };

enum op_max_width { MAX_WIDTH_SET = 0x0080, MAX_WIDTH_NONE = 0x0000 };

enum op_min_height { MIN_HEIGHT_SET = 0x0080, MIN_HEIGHT_AUTO = 0x0000 };

enum op_min_width { MIN_WIDTH_SET = 0x0080, MIN_WIDTH_AUTO = 0x0000 };

enum op_opacity { OPACITY_SET = 0x0080 };

enum op_order { ORDER_SET = 0x0080 };

enum op_orphans { ORPHANS_SET = 0x0080 };
...
enum op_padding { PADDING_SET = 0x0080 };
...
enum op_pause_after { PAUSE_AFTER_SET = 0x0080 };

enum op_pause_before { PAUSE_BEFORE_SET = 0x0080 };

enum op_pitch_range { PITCH_RANGE_SET = 0x0080 };
...
enum op_richness { RICHNESS_SET = 0x0080 };
...
enum op_stress { STRESS_SET = 0x0080 };
...
enum op_text_indent { TEXT_INDENT_SET = 0x0080 };
...
enum op_top { TOP_SET = BOTTOM_SET, TOP_AUTO = BOTTOM_AUTO };
...
enum op_widows { WIDOWS_SET = 0x0080 };
