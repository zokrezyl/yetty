                                 ...
                                 css_style *result)
{
    ...
    do {
        ...
        if ((color) &&
            (error = css__parse_column_rule_color(c, vector, ctx, color_style)) == CSS_OK) {
            color = false;
        } else if ((style) &&
                   (error = css__parse_column_rule_style(c, vector, ctx, style_style)) == CSS_OK) {
            style = false;
        } else if ((width) &&
                   (error = css__parse_column_rule_width(c, vector, ctx, width_style)) == CSS_OK) {
            width = false;
        }
    ...
    if (color) {
        error = css__stylesheet_style_appendOPV(color_style, CSS_PROP_COLUMN_RULE_COLOR, 0,
    ...
    if (style) {
        error = css__stylesheet_style_appendOPV(style_style, CSS_PROP_COLUMN_RULE_STYLE, 0,
    ...
    if (width) {
        error = css__stylesheet_style_appendOPV(width_style, CSS_PROP_COLUMN_RULE_WIDTH, 0,
