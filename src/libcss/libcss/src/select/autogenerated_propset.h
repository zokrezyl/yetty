...
/* Widened to 4 bits and moved to word 14 (css-align start/end keywords)
 * — matching move in autogenerated_propget.h. */
#define ALIGN_ITEMS_INDEX 14
#define ALIGN_ITEMS_SHIFT 4
#define ALIGN_ITEMS_MASK 0xf0
...
static inline css_error set_align_items(css_computed_style *style, uint8_t type)
{
    ...
    /* 4bits: tttt : type */
    *bits = (*bits & ~ALIGN_ITEMS_MASK) | (((uint32_t)type & 0xf) << ALIGN_ITEMS_SHIFT);
...
static inline css_error set_align_self(css_computed_style *style, uint8_t type)
{
    ...
    /* 4bits: tttt : type */
    *bits = (*bits & ~ALIGN_SELF_MASK) | (((uint32_t)type & 0xf) << ALIGN_SELF_SHIFT);
...
/* Widened from 3 bits in word 13 to 4 bits in word 14 (bits 0..15 unused
 * there) for the css-align keywords start/end/left/right — matching move in
 * autogenerated_propget.h. */
#define JUSTIFY_CONTENT_INDEX 14
#define JUSTIFY_CONTENT_SHIFT 0
#define JUSTIFY_CONTENT_MASK 0xf
...
static inline css_error set_justify_content(css_computed_style *style, uint8_t type)
{
    ...
    /* 4bits: tttt : type */
    *bits = (*bits & ~JUSTIFY_CONTENT_MASK) | (((uint32_t)type & 0xf) << JUSTIFY_CONTENT_SHIFT);
...
/* Added properties — word 14 bits 12..15 / word 15 bits 0..3. */
#define JUSTIFY_SELF_INDEX 14
#define JUSTIFY_SELF_SHIFT 12
#define JUSTIFY_SELF_MASK 0xf000

static inline css_error set_justify_self(css_computed_style *style, uint8_t type)
{
    uint32_t *bits = &style->i.bits[JUSTIFY_SELF_INDEX];

    /* 4bits: tttt : type */
    *bits = (*bits & ~JUSTIFY_SELF_MASK) | (((uint32_t)type & 0xf) << JUSTIFY_SELF_SHIFT);
...
#define JUSTIFY_ITEMS_SHIFT 0
#define JUSTIFY_ITEMS_MASK 0xf
...
static inline css_error set_justify_items(css_computed_style *style, uint8_t type)
{
    ...
    /* 4bits: tttt : type */
    *bits = (*bits & ~JUSTIFY_ITEMS_MASK) | (((uint32_t)type & 0xf) << JUSTIFY_ITEMS_SHIFT);
