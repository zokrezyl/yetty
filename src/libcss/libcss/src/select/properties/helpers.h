...
css_error css__cascade_border_style(uint32_t opv, css_style *style, css_select_state *state,
...
css_error css__cascade_number(uint32_t opv, css_style *style, css_select_state *state,
                              css_error (*fun)(css_computed_style *, uint8_t, css_fixed));
css_error css__cascade_page_break_after_before_inside(uint32_t opv, css_style *style,
                                                      css_select_state *state,
                                                      css_error (*fun)(css_computed_style *,
                                                                       uint8_t));
css_error css__cascade_break_after_before_inside(uint32_t opv, css_style *style,
                                                 css_select_state *state,
                                                 css_error (*fun)(css_computed_style *, uint8_t));
...
static inline css_error css__copy_lwc_string_array(bool ref, lwc_string *const *orig,
                                                   lwc_string ***copy_out)
{
    size_t count = 0;
...
static inline css_error css__copy_computed_counter_array(bool ref, const css_computed_counter *orig,
...
static inline css_error css__copy_computed_content_item_array(bool ref,
