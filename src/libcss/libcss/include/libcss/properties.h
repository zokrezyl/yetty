...
enum css_properties_e {
    ...
    CSS_PROP_JUSTIFY_SELF = 0x07e,
    CSS_PROP_JUSTIFY_ITEMS = 0x07f,
...
enum css_align_items_e {
    ...
    /* css-align-3 keywords (self-start/self-end and left/right fold
	 * into these at parse time — LTR engine). */
    CSS_ALIGN_ITEMS_START = 0x7,
    CSS_ALIGN_ITEMS_END = 0x8,
    CSS_ALIGN_ITEMS_LEFT = 0x9,
    CSS_ALIGN_ITEMS_RIGHT = 0xa
};
...
enum css_align_self_e {
    ...
    CSS_ALIGN_SELF_START = CSS_ALIGN_ITEMS_START,
    CSS_ALIGN_SELF_END = CSS_ALIGN_ITEMS_END,
    CSS_ALIGN_SELF_LEFT = CSS_ALIGN_ITEMS_LEFT,
    CSS_ALIGN_SELF_RIGHT = CSS_ALIGN_ITEMS_RIGHT
};

/* css-align justify-self / justify-items (grid inline-axis alignment).
 * self-start/self-end fold into start/end at parse (LTR engine);
 * normal folds into stretch. */
enum css_justify_self_e {
    ...
    CSS_JUSTIFY_SELF_START = 0x7,
    CSS_JUSTIFY_SELF_END = 0x8,
    CSS_JUSTIFY_SELF_LEFT = 0x9,
    CSS_JUSTIFY_SELF_RIGHT = 0xa
};

enum css_justify_items_e {
    CSS_JUSTIFY_ITEMS_INHERIT = CSS_JUSTIFY_SELF_INHERIT,
    CSS_JUSTIFY_ITEMS_STRETCH = CSS_JUSTIFY_SELF_STRETCH,
    CSS_JUSTIFY_ITEMS_FLEX_START = CSS_JUSTIFY_SELF_FLEX_START,
    CSS_JUSTIFY_ITEMS_FLEX_END = CSS_JUSTIFY_SELF_FLEX_END,
    CSS_JUSTIFY_ITEMS_CENTER = CSS_JUSTIFY_SELF_CENTER,
    CSS_JUSTIFY_ITEMS_BASELINE = CSS_JUSTIFY_SELF_BASELINE,
    CSS_JUSTIFY_ITEMS_START = CSS_JUSTIFY_SELF_START,
    CSS_JUSTIFY_ITEMS_END = CSS_JUSTIFY_SELF_END,
    CSS_JUSTIFY_ITEMS_LEFT = CSS_JUSTIFY_SELF_LEFT,
    CSS_JUSTIFY_ITEMS_RIGHT = CSS_JUSTIFY_SELF_RIGHT
};
...
enum css_justify_content_e {
    ...
    /* css-align-3 content-position keywords (LTR engine maps start/end
	 * to physical left/right at use time). */
    CSS_JUSTIFY_CONTENT_START = 0x7,
    CSS_JUSTIFY_CONTENT_END = 0x8,
    CSS_JUSTIFY_CONTENT_LEFT = 0x9,
    CSS_JUSTIFY_CONTENT_RIGHT = 0xa
};
