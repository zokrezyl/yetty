 ...
 */
typedef css_fixed (*css_unit_len_measure)(void *pw, const css_computed_style *style,
                                          const css_unit unit);
 ...
 */
static inline css_fixed css_unit_css2device_px(const css_fixed css_pixels,
