                                                      ...
                                                      struct yetty_yclass_object *platform)
{
    ...
    YETTY_RETURN_IF_ERR(yetty_ycore_void, gpu_res, "yjungle:app:run: gpu_context");
    ...
    YETTY_RETURN_IF_ERR(yetty_ycore_void, input_pipe_res, "yjungle:app:run: input_pipe");
    struct yetty_ycore_xthread_event_pipe *input_pipe = input_pipe_res.value;
    if (!gpu || !input_pipe) {
        return YETTY_ERR(yetty_ycore_void, "yjungle:app:run: platform state not populated");
    }
...
#include "yetty/gen/impl/yjungle/app.c"
