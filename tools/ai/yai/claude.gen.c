...
struct yetty_yclass_object *yetty_yai_claude_to(struct yetty_yai_claude *data)
{
    if (!data)
        return NULL;
    struct yetty_yclass_ptr_result class_r = yetty_yai_claude_class_get();
...
struct yetty_yclass_object_ptr_result yetty_yai_claude_create(struct yetty_yclass_ctx *ctx)
{
     ...
     * response isn't silently swallowed. */
    {
        struct yetty_ycore_void_result translate_class_r =
            yetty_yclass_rpc_session_translate_class(ctx->session, "yetty_yai_claude");
        if (YETTY_IS_ERR(translate_class_r)) {
            yetty_ycore_error_print(stderr,
                "yetty_yai_claude_create: translate_class (degraded — will lazy-resolve)",
    ...
    uint64_t handle = 0;
    const char *class_name = "yetty_yai_claude";
    ...
    if (YETTY_IS_ERR(create_call_r))
        return YETTY_ERR(yetty_yclass_object_ptr,
                         "yetty_yai_claude_create: CREATE call failed", create_call_r);
    if (create_call_r.value != sizeof(handle) || !handle)
        return YETTY_ERR(yetty_yclass_object_ptr,
                         "yetty_yai_claude_create: CREATE returned no/invalid handle");
...
/* ---- yai/claude: class name -> accessor ---------------------- */
static struct yetty_yclass_ptr_result yetty_yai_claude_accessor_lookup(const char *name)
{
    if (strcmp(name, "yetty_yai_claude") == 0) return yetty_yai_claude_class_get();
    return YETTY_OK(yetty_yclass_ptr, NULL);
}

struct yetty_ycore_void_result yetty_yai_claude_register_hooks(void)
{
    struct yetty_ycore_void_result add_accessor_r =
        yetty_yclass_add_accessor_lookup(yetty_yai_claude_accessor_lookup);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, add_accessor_r,
                        "yetty_yai_claude_register_hooks: accessor");
...
struct yetty_ycore_void_result yetty_yai_editor_register_hooks(void);
struct yetty_ycore_void_result yetty_yai_editor_emacs_register_hooks(void);
struct yetty_ycore_void_result yetty_yai_editor_vi_register_hooks(void);
struct yetty_ycore_void_result yetty_yai_engine_register_hooks(void);
struct yetty_ycore_void_result yetty_yai_gemini_register_hooks(void);
struct yetty_ycore_void_result yetty_yai_turn_engine_register_hooks(void);
...
struct yetty_ycore_void_result yetty_yai_register(void)
{
    ...
    if (registered)
        return YETTY_OK_VOID();
    {
        struct yetty_ycore_void_result hook_r = yetty_yai_claude_register_hooks();
        YETTY_RETURN_IF_ERR(yetty_ycore_void, hook_r, "yetty_yai_register: claude");
    }
    {
        struct yetty_ycore_void_result hook_r = yetty_yai_codex_register_hooks();
        YETTY_RETURN_IF_ERR(yetty_ycore_void, hook_r, "yetty_yai_register: codex");
    }
    {
        struct yetty_ycore_void_result hook_r = yetty_yai_editor_register_hooks();
        YETTY_RETURN_IF_ERR(yetty_ycore_void, hook_r, "yetty_yai_register: editor");
    }
    {
        struct yetty_ycore_void_result hook_r = yetty_yai_editor_emacs_register_hooks();
        YETTY_RETURN_IF_ERR(yetty_ycore_void, hook_r, "yetty_yai_register: editor_emacs");
    }
    {
        struct yetty_ycore_void_result hook_r = yetty_yai_editor_vi_register_hooks();
        YETTY_RETURN_IF_ERR(yetty_ycore_void, hook_r, "yetty_yai_register: editor_vi");
    }
    {
        struct yetty_ycore_void_result hook_r = yetty_yai_engine_register_hooks();
        YETTY_RETURN_IF_ERR(yetty_ycore_void, hook_r, "yetty_yai_register: engine");
    }
    {
        struct yetty_ycore_void_result hook_r = yetty_yai_gemini_register_hooks();
        YETTY_RETURN_IF_ERR(yetty_ycore_void, hook_r, "yetty_yai_register: gemini");
    }
    {
        struct yetty_ycore_void_result hook_r = yetty_yai_turn_engine_register_hooks();
        YETTY_RETURN_IF_ERR(yetty_ycore_void, hook_r, "yetty_yai_register: turn_engine");
    }
    registered = true;
    return YETTY_OK_VOID();
}
