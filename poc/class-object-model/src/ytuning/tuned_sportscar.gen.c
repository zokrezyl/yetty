...
__attribute__((unused)) static yvehicle_vehicle_start_fn
    _ytuning_tuned_sportscar_yvehicle_vehicle_start_check = tuned_sportscar_start;
__attribute__((unused)) static yvehicle_vehicle_describe_fn
    _ytuning_tuned_sportscar_yvehicle_vehicle_describe_check = tuned_sportscar_describe;
...
{
    if (!obj) {
        return YETTY_ERR(ytuning_tuned_sportscar_data_ptr,
                         "ytuning_tuned_sportscar_data_get: NULL object");
    }
    struct class_ptr_result class_result = ytuning_tuned_sportscar_class_get();
    YETTY_RETURN_IF_ERR(ytuning_tuned_sportscar_data_ptr, class_result,
                        "ytuning_tuned_sportscar_data_get: class accessor failed");
    struct yetty_ycore_size_result offset_result =
        object_data_offset(object_class(obj), class_result.value);
    YETTY_RETURN_IF_ERR(ytuning_tuned_sportscar_data_ptr, offset_result,
                        "ytuning_tuned_sportscar_data_get: object_data_offset failed");
    return YETTY_OK(ytuning_tuned_sportscar_data_ptr,
                    (struct tuned_sportscar_data *)((char *)obj + offset_result.value));
}
...
struct yetty_ycore_int_result ytuning_tuned_sportscar_boost_level_get(struct object *obj)
{
    ...
    YETTY_RETURN_IF_ERR(yetty_ycore_int, data,
                        "ytuning_tuned_sportscar_boost_level_get: data block");
    return YETTY_OK(yetty_ycore_int, data.value->boost_level);
}

struct yetty_ycore_void_result ytuning_tuned_sportscar_boost_level_set(struct object *obj,
                                                                       int value)
{
    struct ytuning_tuned_sportscar_data_ptr_result data = ytuning_tuned_sportscar_data_get(obj);
    YETTY_RETURN_IF_ERR(yetty_ycore_void, data,
                        "ytuning_tuned_sportscar_boost_level_set: data block");
