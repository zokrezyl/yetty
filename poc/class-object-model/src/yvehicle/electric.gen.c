...
__attribute__((
    unused)) static yvehicle_vehicle_brake_fn _yvehicle_electric_yvehicle_vehicle_brake_check =
    electric_brake;
...
struct yvehicle_electric_data_ptr_result yvehicle_electric_data_get(struct object *obj)
{
    ...
    YETTY_RETURN_IF_ERR(yvehicle_electric_data_ptr, class_result,
                        "yvehicle_electric_data_get: class accessor failed");
    struct yetty_ycore_size_result offset_result =
        object_data_offset(object_class(obj), class_result.value);
    YETTY_RETURN_IF_ERR(yvehicle_electric_data_ptr, offset_result,
                        "yvehicle_electric_data_get: object_data_offset failed");
    return YETTY_OK(yvehicle_electric_data_ptr,
                    (struct electric_data *)((char *)obj + offset_result.value));
}
...
struct yetty_ycore_void_result yvehicle_electric_battery_percent_set(struct object *obj, int value)
{
    ...
    YETTY_RETURN_IF_ERR(yetty_ycore_void, data,
                        "yvehicle_electric_battery_percent_set: data block");
