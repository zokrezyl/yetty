                          ...
                          void *_resp, size_t _resp_max)
{
    ...
    struct ctx _local = {0};
    struct yetty_ycore_void_result _r = yvehicle_vehicle_ctor(&_local, (struct object *)rpc_handle_resolve(_a.obj_handle));
                          ...
                          void *_resp, size_t _resp_max)
{
    ...
    memcpy(&_a, _body, sizeof(_a));
    struct ctx _local = {0};
    struct yetty_ycore_void_result _r = yvehicle_vehicle_dtor(&_local, (struct object *)rpc_handle_resolve(_a.obj_handle));
    if (_resp_max < 1) return 0;
    if (YETTY_IS_ERR(_r)) {
                          ...
                          void *_resp, size_t _resp_max)
{
    ...
    memcpy(&_a, _body, sizeof(_a));
    struct ctx _local = {0};
    struct yetty_ycore_void_result _r = yvehicle_vehicle_start(&_local, (struct object *)rpc_handle_resolve(_a.obj_handle));
    if (_resp_max < 1) return 0;
    if (YETTY_IS_ERR(_r)) {
                          ...
                          void *_resp, size_t _resp_max)
{
    ...
    memcpy(&_a, _body, sizeof(_a));
    struct ctx _local = {0};
    struct yetty_ycore_int_result _r = yvehicle_vehicle_accelerate(&_local, (struct object *)rpc_handle_resolve(_a.obj_handle), _a.speed);
    if (_resp_max < 1) return 0;
    if (YETTY_IS_ERR(_r)) {
                          ...
                          void *_resp, size_t _resp_max)
{
    ...
    memcpy(&_a, _body, sizeof(_a));
    struct ctx _local = {0};
    struct yetty_ycore_int_result _r = yvehicle_vehicle_brake(&_local, (struct object *)rpc_handle_resolve(_a.obj_handle), _a.intensity);
    if (_resp_max < 1) return 0;
    if (YETTY_IS_ERR(_r)) {
                          ...
                          void *_resp, size_t _resp_max)
{
    ...
    memcpy(&_a, _body, sizeof(_a));
    struct ctx _local = {0};
    struct str_result _r = yvehicle_vehicle_describe(&_local, (struct object *)rpc_handle_resolve(_a.obj_handle), _a.distance);
    if (_resp_max < 1) return 0;
    if (YETTY_IS_ERR(_r)) {
