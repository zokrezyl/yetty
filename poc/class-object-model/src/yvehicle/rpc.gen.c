                          ...
                          void *_resp, size_t _resp_max)
{
    ...
    struct yetty_ycore_void_result _r = yvehicle_vehicle_ctor((struct object *)rpc_handle_resolve(_a.obj_handle));
                          ...
                          void *_resp, size_t _resp_max)
{
    ...
    if (_body_len < sizeof(_a)) return 0;
    memcpy(&_a, _body, sizeof(_a));
    struct yetty_ycore_void_result _r = yvehicle_vehicle_dtor((struct object *)rpc_handle_resolve(_a.obj_handle));
    if (_resp_max < 1) return 0;
    if (YETTY_IS_ERR(_r)) {
                          ...
                          void *_resp, size_t _resp_max)
{
    ...
    if (_body_len < sizeof(_a)) return 0;
    memcpy(&_a, _body, sizeof(_a));
    struct yetty_ycore_void_result _r = yvehicle_vehicle_start((struct object *)rpc_handle_resolve(_a.obj_handle));
    if (_resp_max < 1) return 0;
    if (YETTY_IS_ERR(_r)) {
                          ...
                          void *_resp, size_t _resp_max)
{
    ...
    if (_body_len < sizeof(_a)) return 0;
    memcpy(&_a, _body, sizeof(_a));
    struct yetty_ycore_int_result _r = yvehicle_vehicle_accelerate((struct object *)rpc_handle_resolve(_a.obj_handle), _a.speed);
    if (_resp_max < 1) return 0;
    if (YETTY_IS_ERR(_r)) {
                          ...
                          void *_resp, size_t _resp_max)
{
    ...
    if (_body_len < sizeof(_a)) return 0;
    memcpy(&_a, _body, sizeof(_a));
    struct yetty_ycore_int_result _r = yvehicle_vehicle_brake((struct object *)rpc_handle_resolve(_a.obj_handle), _a.intensity);
    if (_resp_max < 1) return 0;
    if (YETTY_IS_ERR(_r)) {
                          ...
                          void *_resp, size_t _resp_max)
{
    ...
    if (_body_len < sizeof(_a)) return 0;
    memcpy(&_a, _body, sizeof(_a));
    struct str_result _r = yvehicle_vehicle_describe((struct object *)rpc_handle_resolve(_a.obj_handle), _a.distance);
    if (_resp_max < 1) return 0;
    if (YETTY_IS_ERR(_r)) {
