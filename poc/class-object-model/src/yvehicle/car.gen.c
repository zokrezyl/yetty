...
__attribute__((
    unused)) static yvehicle_vehicle_describe_fn _yvehicle_car_yvehicle_vehicle_describe_check =
    car_describe;
...
struct yvehicle_car_data_ptr_result yvehicle_car_data_get(struct object *obj)
{
    ...
    YETTY_RETURN_IF_ERR(yvehicle_car_data_ptr, class_result,
                        "yvehicle_car_data_get: class accessor failed");
    struct yetty_ycore_size_result offset_result =
        object_data_offset(object_class(obj), class_result.value);
    YETTY_RETURN_IF_ERR(yvehicle_car_data_ptr, offset_result,
                        "yvehicle_car_data_get: object_data_offset failed");
