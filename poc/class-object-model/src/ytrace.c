...
/* PoC adaptation: the upstream ytrace.c pulls in yetty_yplatform_*
 * shims for mutex, terminal color detection, and timestamp
 * formatting. This PoC is POSIX-only, so we inline the equivalents
 * here instead of dragging the platform tree into the PoC. */
