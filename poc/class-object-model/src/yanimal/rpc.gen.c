                          ...
                          void *_resp, size_t _resp_max)
{
    ...
    struct yetty_ycore_void_result _r = yanimal_animal_ctor((struct object *)rpc_handle_resolve(_a.obj_handle));
                          ...
                          void *_resp, size_t _resp_max)
{
    ...
    if (_body_len < sizeof(_a)) return 0;
    memcpy(&_a, _body, sizeof(_a));
    struct yetty_ycore_void_result _r = yanimal_animal_dtor((struct object *)rpc_handle_resolve(_a.obj_handle));
    if (_resp_max < 1) return 0;
    if (YETTY_IS_ERR(_r)) {
                          ...
                          void *_resp, size_t _resp_max)
{
    ...
    if (_body_len < sizeof(_a)) return 0;
    memcpy(&_a, _body, sizeof(_a));
    struct yetty_ycore_void_result _r = yanimal_animal_breathe((struct object *)rpc_handle_resolve(_a.obj_handle));
    if (_resp_max < 1) return 0;
    if (YETTY_IS_ERR(_r)) {
                          ...
                          void *_resp, size_t _resp_max)
{
    ...
    if (_body_len < sizeof(_a)) return 0;
    memcpy(&_a, _body, sizeof(_a));
    struct str_result _r = yanimal_animal_speak((struct object *)rpc_handle_resolve(_a.obj_handle), _a.volume);
    if (_resp_max < 1) return 0;
    if (YETTY_IS_ERR(_r)) {
                          ...
                          void *_resp, size_t _resp_max)
{
    ...
    if (_body_len < sizeof(_a)) return 0;
    memcpy(&_a, _body, sizeof(_a));
    struct yetty_ycore_int_result _r = yanimal_animal_eat((struct object *)rpc_handle_resolve(_a.obj_handle), _a.amount);
    if (_resp_max < 1) return 0;
    if (YETTY_IS_ERR(_r)) {
