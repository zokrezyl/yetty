...
__attribute__((unused)) static yanimal_animal_ctor_fn _yanimal_dog_yanimal_animal_ctor_check =
    dog_ctor;
__attribute__((unused)) static yanimal_animal_speak_fn _yanimal_dog_yanimal_animal_speak_check =
    dog_speak;
...
struct yanimal_dog_data_ptr_result yanimal_dog_data_get(struct object *obj)
{
    ...
    YETTY_RETURN_IF_ERR(yanimal_dog_data_ptr, class_result,
                        "yanimal_dog_data_get: class accessor failed");
    struct yetty_ycore_size_result offset_result =
        object_data_offset(object_class(obj), class_result.value);
    YETTY_RETURN_IF_ERR(yanimal_dog_data_ptr, offset_result,
                        "yanimal_dog_data_get: object_data_offset failed");
